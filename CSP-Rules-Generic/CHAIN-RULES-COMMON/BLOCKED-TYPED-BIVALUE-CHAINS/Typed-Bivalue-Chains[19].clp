...
;;;
;;;                              CSP-RULES / GENERIC
;;;                              BLOCKED-TYPED-BIVALUE-CHAIN[19]
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule apply1-typed-bivalue-chain[19]
...
=>
   ...
   (if (or ?*print-actions* ?*print-L19* ?*print-typed-bivalue-chain* ?*print-typed-bivalue-chain-19*) then
      (print-typed-bivalue-chain-without-crlf ?csp-type 19 ?zzz $?llcs $?rlcs $?csp-vars)
   )
   (assert (apply-rule-as-a-pseudo-block ?cont))
   (assert (pseudo-blocked ?cont typed-bivalue-chain[19] ?csp-type 19 ?zzz $?llcs $?rlcs $?csp-vars))
)



(defrule apply2-typed-bivalue-chain[19]
   ...
   (pseudo-blocked ?cont typed-bivalue-chain[19] ?csp-type 19 ?zzz $?llcs $?rlcs $?csp-vars)
