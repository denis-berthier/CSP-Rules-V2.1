...
(defrule track-forcing-braid[13]
   (declare (salience ?*activate-forcing-braid[13]-salience*))
   ?level <- (technique ?cont forcing-braid[13])
=>
...
(defrule forcing-braid[13]-value
   (declare (salience ?*forcing-braid[13]-value-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-braid[13])
   (chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L13* ?*print-forcing-braid* ?*print-forcing-braid-13*) then
...
(defrule forcing-braid[13]-candidate
   (declare (salience ?*forcing-braid[13]-candidate-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-braid[13])
   (chain
      (type ?type1&partial-whip|partial-braid)
