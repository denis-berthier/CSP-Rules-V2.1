...
(defrule activate-forcing-braid[4]
   (declare (salience ?*activate-forcing-braid[4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont forcing-braid[4]))
   (bind ?*technique* FB[4])
)



(defrule track-forcing-braid[4]
   (declare (salience ?*activate-forcing-braid[4]-salience*))
   ?level <- (technique ?cont forcing-braid[4])
=>
...
(defrule forcing-braid[4]-value
   (declare (salience ?*forcing-braid[4]-value-salience*))
...
=>
   ...
   (if (or ?*print-actions* ?*print-L4* ?*print-forcing-braid* ?*print-forcing-braid-4*) then
...
(defrule forcing-braid[4]-candidate
   (declare (salience ?*forcing-braid[4]-candidate-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-braid[4])
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-braid)))
