...
(defrule activate-forcing-braid[5]
   (declare (salience ?*activate-forcing-braid[5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont forcing-braid[5]))
   (bind ?*technique* FB[5])
)



(defrule track-forcing-braid[5]
   (declare (salience ?*activate-forcing-braid[5]-salience*))
   ?level <- (technique ?cont forcing-braid[5])
=>
...
(defrule forcing-braid[5]-value
   (declare (salience ?*forcing-braid[5]-value-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-braid[5])
   (chain
...
(defrule forcing-braid[5]-candidate
   (declare (salience ?*forcing-braid[5]-candidate-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-braid[5])
   (chain
      (type ?type1&partial-whip|partial-braid)
