...
(defrule activate-forcing-gbraid[10]
   (declare (salience ?*activate-forcing-gbraid[10]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_FB10))
   (assert (technique ?cont forcing-gbraid[10]))
   (bind ?*technique* FgB[10])
)



(defrule track-forcing-gbraid[10]
   (declare (salience ?*activate-forcing-gbraid[10]-salience*))
   ?level <- (technique ?cont forcing-gbraid[10])
=>
...
(defrule forcing-gbraid[10]-value
   (declare (salience ?*forcing-gbraid[10]-value-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[10])
   (chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L10* ?*print-forcing-gbraid* ?*print-forcing-gbraid-10*) then
...
(defrule forcing-gbraid[10]-candidate
   (declare (salience ?*forcing-gbraid[10]-candidate-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[10])
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip) (eq ?type1 partial-braid) (eq ?type1 partial-gbraid)))
