...
(defrule activate-forcing-gbraid[13]
   (declare (salience ?*activate-forcing-gbraid[13]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont forcing-gbraid[13]))
   (bind ?*technique* FgB[13])
)



(defrule track-forcing-gbraid[13]
   (declare (salience ?*activate-forcing-gbraid[13]-salience*))
   ?level <- (technique ?cont forcing-gbraid[13])
=>
...
(defrule forcing-gbraid[13]-value
   (declare (salience ?*forcing-gbraid[13]-value-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[13])
   (chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L13* ?*print-forcing-gbraid* ?*print-forcing-gbraid-13*) then
...
(defrule forcing-gbraid[13]-candidate
   (declare (salience ?*forcing-gbraid[13]-candidate-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[13])
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip) (eq ?type1 partial-braid) (eq ?type1 partial-gbraid)))
