...
(defrule activate-forcing-gbraid[15]
   (declare (salience ?*activate-forcing-gbraid[15]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_FB15))
   (assert (technique ?cont forcing-gbraid[15]))
   (bind ?*technique* FgB[15])
)



(defrule track-forcing-gbraid[15]
   (declare (salience ?*activate-forcing-gbraid[15]-salience*))
   ?level <- (technique ?cont forcing-gbraid[15])
=>
...
(defrule forcing-gbraid[15]-value
   (declare (salience ?*forcing-gbraid[15]-value-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[15])
   (chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L15* ?*print-forcing-gbraid* ?*print-forcing-gbraid-15*) then
...
(defrule forcing-gbraid[15]-candidate
   (declare (salience ?*forcing-gbraid[15]-candidate-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[15])
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip) (eq ?type1 partial-braid) (eq ?type1 partial-gbraid)))
