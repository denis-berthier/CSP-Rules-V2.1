...
(defrule activate-forcing-gbraid[18]
   (declare (salience ?*activate-forcing-gbraid[18]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_FB18))
   (assert (technique ?cont forcing-gbraid[18]))
   (bind ?*technique* FgB[18])
)



(defrule track-forcing-gbraid[18]
   (declare (salience ?*activate-forcing-gbraid[18]-salience*))
   ?level <- (technique ?cont forcing-gbraid[18])
=>
...
(defrule forcing-gbraid[18]-value
   (declare (salience ?*forcing-gbraid[18]-value-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[18])
   (chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L18* ?*print-forcing-gbraid* ?*print-forcing-gbraid-18*) then
...
(defrule forcing-gbraid[18]-candidate
   (declare (salience ?*forcing-gbraid[18]-candidate-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[18])
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip) (eq ?type1 partial-braid) (eq ?type1 partial-gbraid)))
