...
(defrule activate-forcing-gbraid[19]
   (declare (salience ?*activate-forcing-gbraid[19]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_FB19))
   (assert (technique ?cont forcing-gbraid[19]))
   (bind ?*technique* FgB[19])
)



(defrule track-forcing-gbraid[19]
   (declare (salience ?*activate-forcing-gbraid[19]-salience*))
   ?level <- (technique ?cont forcing-gbraid[19])
=>
...
(defrule forcing-gbraid[19]-value
   (declare (salience ?*forcing-gbraid[19]-value-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[19])
   (chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L19* ?*print-forcing-gbraid* ?*print-forcing-gbraid-19*) then
...
(defrule forcing-gbraid[19]-candidate
   (declare (salience ?*forcing-gbraid[19]-candidate-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[19])
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip) (eq ?type1 partial-braid) (eq ?type1 partial-gbraid)))
