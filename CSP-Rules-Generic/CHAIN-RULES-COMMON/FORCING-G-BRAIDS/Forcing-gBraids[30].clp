...
=>
   ...
   (bind ?*technique* FgB[30])
)



(defrule track-forcing-gbraid[30]
   (declare (salience ?*activate-forcing-gbraid[30]-salience*))
   ?level <- (technique ?cont forcing-gbraid[30])
=>
...
(defrule forcing-gbraid[30]-value
   (declare (salience ?*forcing-gbraid[30]-value-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[30])
   (chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L30* ?*print-forcing-gbraid* ?*print-forcing-gbraid-30*) then
...
(defrule forcing-gbraid[30]-candidate
   (declare (salience ?*forcing-gbraid[30]-candidate-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[30])
   (chain
      (type ?type1&partial-whip|partial-gwhip|partial-braid|partial-gbraid)
