...
(defrule activate-forcing-gbraid[33]
   (declare (salience ?*activate-forcing-gbraid[33]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont forcing-gbraid[33]))
   (bind ?*technique* FgB[33])
)



(defrule track-forcing-gbraid[33]
   (declare (salience ?*activate-forcing-gbraid[33]-salience*))
   ?level <- (technique ?cont forcing-gbraid[33])
=>
...
(defrule forcing-gbraid[33]-value
   (declare (salience ?*forcing-gbraid[33]-value-salience*))
...
(defrule forcing-gbraid[33]-candidate
   (declare (salience ?*forcing-gbraid[33]-candidate-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[33])
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip) (eq ?type1 partial-braid) (eq ?type1 partial-gbraid)))
