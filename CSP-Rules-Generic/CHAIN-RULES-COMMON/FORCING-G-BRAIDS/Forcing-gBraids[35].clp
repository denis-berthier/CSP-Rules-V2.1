...
(defrule activate-forcing-gbraid[35]
   (declare (salience ?*activate-forcing-gbraid[35]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
(defrule track-forcing-gbraid[35]
   (declare (salience ?*activate-forcing-gbraid[35]-salience*))
   ?level <- (technique ?cont forcing-gbraid[35])
=>
...
(defrule forcing-gbraid[35]-value
   (declare (salience ?*forcing-gbraid[35]-value-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[35])
   (chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L35* ?*print-forcing-gbraid* ?*print-forcing-gbraid-35*) then
...
(defrule forcing-gbraid[35]-candidate
   (declare (salience ?*forcing-gbraid[35]-candidate-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-gbraid[35])
   (chain
      (type ?type1&partial-whip|partial-gwhip|partial-braid|partial-gbraid)
