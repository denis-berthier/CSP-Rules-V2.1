...
=>
   ...
   (bind ?*technique* FW[19])
)



(defrule track-forcing-whip[19]
   (declare (salience ?*activate-forcing-whip[19]-salience*))
   ?level <- (technique ?cont forcing-whip[19])
=>
...
(defrule forcing-whip[19]-candidate-0p
   (declare (salience ?*forcing-whip[19]-candidate-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-whip[19])
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p2&:(= ?p2 18))
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L19* ?*print-forcing-whip* ?*print-forcing-whip-19*) then
...
(defrule forcing-whip[19]-candidate-pq
   (declare (salience ?*forcing-whip[19]-candidate-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-whip[19])
   (chain
...
(defrule forcing-whip[19]-value
   (declare (salience ?*forcing-whip[19]-value-salience*))
   (bivalue ?cont ?zzz1 ?zzz2 ?ll)
   (technique ?cont forcing-whip[19])
   (chain
      (type partial-whip)
