...
(defrule partial-oddagon[2]
    ...
    (logical
        ...
        ;;; First csp
        (or
            (bivalue ?cont ?cand1 ?cand2&:(< ?cand1 ?cand2) ?csp1)
            (and (csp-linked ?cont ?cand1 ?cand2&:(< ?cand1 ?cand2) ?csp1)
       ...
       ;;; Second csp
       (or
           (bivalue ?cont ?cand2 ?cand3&:(< ?cand1 ?cand3) ?csp2&~?csp1)
           (and (csp-linked ?cont ?cand2 ?cand3&:(< ?cand1 ?cand3) ?csp2&~?csp1)
...
(defrule oddagon[3]
    ...
    ;;; ?last csp
    (or (bivalue ?cont ?last-rlc ?cand1 ?new-csp&:(not (member$ ?new-csp $?csp-vars)))
        (and
