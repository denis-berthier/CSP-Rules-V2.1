...
(defrule activate-OR3-forcing-whip[11]
   (declare (salience ?*activate-OR3-forcing-whip[11]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR3-forcing-whip[11]))
   (assert (technique ?cont partial-whip[10]))
   (bind ?*technique* OR3FW[11])
)



(defrule track-OR3-forcing-whip[11]
   (declare (salience ?*activate-OR3-forcing-whip[11]-salience*))
   ?level <- (technique ?cont OR3-forcing-whip[11])
=>
...
(defrule OR3-forcing-whip[11]-candidate-00p
   (declare (salience ?*OR3-forcing-whip[11]-candidate-salience*))
   (technique ?cont OR3-forcing-whip[11])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L11* ?*print-OR3-forcing-whip* ?*print-OR3-forcing-whip-11*) then
...
(defrule OR3-forcing-whip[11]-candidate-0pq
   (declare (salience ?*OR3-forcing-whip[11]-candidate-salience*))
   (technique ?cont OR3-forcing-whip[11])
...
(defrule OR3-forcing-whip[11]-candidate-pqr
   (declare (salience ?*OR3-forcing-whip[11]-candidate-salience*))
   (technique ?cont OR3-forcing-whip[11])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-whip[11]-value
   (declare (salience ?*OR3-forcing-whip[11]-value-salience*))
   (technique ?cont OR3-forcing-whip[11])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type partial-whip)
