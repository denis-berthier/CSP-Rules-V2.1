...
(defrule activate-OR3-forcing-whip[6]
   (declare (salience ?*activate-OR3-forcing-whip[6]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR3-forcing-whip[6]))
   (assert (technique ?cont partial-whip[5]))
   (bind ?*technique* OR3FW[6])
)



(defrule track-OR3-forcing-whip[6]
   (declare (salience ?*activate-OR3-forcing-whip[6]-salience*))
   ?level <- (technique ?cont OR3-forcing-whip[6])
=>
...
(defrule OR3-forcing-whip[6]-candidate-00p
   (declare (salience ?*OR3-forcing-whip[6]-candidate-salience*))
   (technique ?cont OR3-forcing-whip[6])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L6* ?*print-OR3-forcing-whip* ?*print-OR3-forcing-whip-6*) then
...
(defrule OR3-forcing-whip[6]-candidate-0pq
   (declare (salience ?*OR3-forcing-whip[6]-candidate-salience*))
   (technique ?cont OR3-forcing-whip[6])
...
(defrule OR3-forcing-whip[6]-candidate-pqr
   (declare (salience ?*OR3-forcing-whip[6]-candidate-salience*))
   (technique ?cont OR3-forcing-whip[6])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-whip[6]-value
   (declare (salience ?*OR3-forcing-whip[6]-value-salience*))
   (technique ?cont OR3-forcing-whip[6])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type partial-whip)
