...
(defrule activate-OR4-forcing-whip[11]
   (declare (salience ?*activate-OR4-forcing-whip[11]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW11))
   (assert (technique ?cont OR4-forcing-whip[11]))
   (assert (technique ?cont partial-whip[10]))
   (bind ?*technique* OR4FW[11])
)



(defrule track-OR4-forcing-whip[11]
   (declare (salience ?*activate-OR4-forcing-whip[11]-salience*))
   ?level <- (technique ?cont OR4-forcing-whip[11])
=>
...
(defrule OR4-forcing-whip[11]-candidate-000p
   (declare (salience ?*OR4-forcing-whip[11]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[11])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L11* ?*print-OR4-forcing-whip* ?*print-OR4-forcing-whip-11*) then
...
(defrule OR4-forcing-whip[11]-candidate-00pq
   (declare (salience ?*OR4-forcing-whip[11]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[11])
...
(defrule OR4-forcing-whip[11]-candidate-0pqr
   (declare (salience ?*OR4-forcing-whip[11]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[11])
...
(defrule OR4-forcing-whip[11]-candidate-pqrs
   (declare (salience ?*OR4-forcing-whip[11]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[11])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-whip[11]-value
   (declare (salience ?*OR4-forcing-whip[11]-value-salience*))
   (technique ?cont OR4-forcing-whip[11])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type partial-whip)
