...
(defrule activate-OR4-forcing-whip[15]
   (declare (salience ?*activate-OR4-forcing-whip[15]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-whip[15]))
   (assert (technique ?cont partial-whip[14]))
   (bind ?*technique* OR4FW[15])
)



(defrule track-OR4-forcing-whip[15]
   (declare (salience ?*activate-OR4-forcing-whip[15]-salience*))
   ?level <- (technique ?cont OR4-forcing-whip[15])
=>
...
(defrule OR4-forcing-whip[15]-candidate-000p
   (declare (salience ?*OR4-forcing-whip[15]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[15])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L15* ?*print-OR4-forcing-whip* ?*print-OR4-forcing-whip-15*) then
...
(defrule OR4-forcing-whip[15]-candidate-00pq
   (declare (salience ?*OR4-forcing-whip[15]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[15])
...
(defrule OR4-forcing-whip[15]-candidate-0pqr
   (declare (salience ?*OR4-forcing-whip[15]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[15])
...
(defrule OR4-forcing-whip[15]-candidate-pqrs
   (declare (salience ?*OR4-forcing-whip[15]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[15])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-whip[15]-value
   (declare (salience ?*OR4-forcing-whip[15]-value-salience*))
   (technique ?cont OR4-forcing-whip[15])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type partial-whip)
