...
(defrule activate-OR4-forcing-whip[17]
   (declare (salience ?*activate-OR4-forcing-whip[17]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW17))
   (assert (technique ?cont OR4-forcing-whip[17]))
   (assert (technique ?cont partial-whip[16]))
   (bind ?*technique* OR4FW[17])
)



(defrule track-OR4-forcing-whip[17]
   (declare (salience ?*activate-OR4-forcing-whip[17]-salience*))
   ?level <- (technique ?cont OR4-forcing-whip[17])
=>
...
(defrule OR4-forcing-whip[17]-candidate-000p
   (declare (salience ?*OR4-forcing-whip[17]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[17])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L17* ?*print-OR4-forcing-whip* ?*print-OR4-forcing-whip-17*) then
...
(defrule OR4-forcing-whip[17]-candidate-00pq
   (declare (salience ?*OR4-forcing-whip[17]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[17])
...
(defrule OR4-forcing-whip[17]-candidate-0pqr
   (declare (salience ?*OR4-forcing-whip[17]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[17])
...
(defrule OR4-forcing-whip[17]-candidate-pqrs
   (declare (salience ?*OR4-forcing-whip[17]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[17])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-whip[17]-value
   (declare (salience ?*OR4-forcing-whip[17]-value-salience*))
   (technique ?cont OR4-forcing-whip[17])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type partial-whip)
