...
(defrule activate-OR4-forcing-whip[18]
   (declare (salience ?*activate-OR4-forcing-whip[18]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW18))
   (assert (technique ?cont OR4-forcing-whip[18]))
   (assert (technique ?cont partial-whip[17]))
   (bind ?*technique* OR4FW[18])
)



(defrule track-OR4-forcing-whip[18]
   (declare (salience ?*activate-OR4-forcing-whip[18]-salience*))
   ?level <- (technique ?cont OR4-forcing-whip[18])
=>
...
(defrule OR4-forcing-whip[18]-candidate-000p
   (declare (salience ?*OR4-forcing-whip[18]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[18])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L18* ?*print-OR4-forcing-whip* ?*print-OR4-forcing-whip-18*) then
...
(defrule OR4-forcing-whip[18]-candidate-00pq
   (declare (salience ?*OR4-forcing-whip[18]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[18])
...
(defrule OR4-forcing-whip[18]-candidate-0pqr
   (declare (salience ?*OR4-forcing-whip[18]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[18])
...
(defrule OR4-forcing-whip[18]-candidate-pqrs
   (declare (salience ?*OR4-forcing-whip[18]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[18])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-whip[18]-value
   (declare (salience ?*OR4-forcing-whip[18]-value-salience*))
   (technique ?cont OR4-forcing-whip[18])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type partial-whip)
