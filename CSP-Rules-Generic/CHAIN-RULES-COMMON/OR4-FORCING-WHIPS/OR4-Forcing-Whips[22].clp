...
(defrule activate-OR4-forcing-whip[22]
   (declare (salience ?*activate-OR4-forcing-whip[22]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-whip[22]))
   (assert (technique ?cont partial-whip[21]))
   (bind ?*technique* OR4FW[22])
)



(defrule track-OR4-forcing-whip[22]
   (declare (salience ?*activate-OR4-forcing-whip[22]-salience*))
   ?level <- (technique ?cont OR4-forcing-whip[22])
=>
...
(defrule OR4-forcing-whip[22]-candidate-000p
   (declare (salience ?*OR4-forcing-whip[22]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[22])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L22* ?*print-OR4-forcing-whip* ?*print-OR4-forcing-whip-22*) then
...
(defrule OR4-forcing-whip[22]-candidate-00pq
   (declare (salience ?*OR4-forcing-whip[22]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[22])
...
(defrule OR4-forcing-whip[22]-candidate-0pqr
   (declare (salience ?*OR4-forcing-whip[22]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[22])
...
(defrule OR4-forcing-whip[22]-candidate-pqrs
   (declare (salience ?*OR4-forcing-whip[22]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[22])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-whip[22]-value
   (declare (salience ?*OR4-forcing-whip[22]-value-salience*))
   (technique ?cont OR4-forcing-whip[22])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type partial-whip)
