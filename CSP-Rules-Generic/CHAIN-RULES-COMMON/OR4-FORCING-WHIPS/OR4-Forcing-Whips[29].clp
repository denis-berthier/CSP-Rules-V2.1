...
(defrule activate-OR4-forcing-whip[29]
   (declare (salience ?*activate-OR4-forcing-whip[29]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-whip[29]))
   (assert (technique ?cont partial-whip[28]))
   (bind ?*technique* OR4FW[29])
)



(defrule track-OR4-forcing-whip[29]
   (declare (salience ?*activate-OR4-forcing-whip[29]-salience*))
   ?level <- (technique ?cont OR4-forcing-whip[29])
=>
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L29* ?*print-OR4-forcing-whip* ?*print-OR4-forcing-whip-29*) then
