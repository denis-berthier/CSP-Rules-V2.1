...
(defrule activate-OR4-forcing-whip[5]
   (declare (salience ?*activate-OR4-forcing-whip[5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW5))
   (assert (technique ?cont OR4-forcing-whip[5]))
   (assert (technique ?cont partial-whip[4]))
   (bind ?*technique* OR4FW[5])
)



(defrule track-OR4-forcing-whip[5]
   (declare (salience ?*activate-OR4-forcing-whip[5]-salience*))
   ?level <- (technique ?cont OR4-forcing-whip[5])
=>
...
(defrule OR4-forcing-whip[5]-candidate-000p
   (declare (salience ?*OR4-forcing-whip[5]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[5])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L5* ?*print-OR4-forcing-whip* ?*print-OR4-forcing-whip-5*) then
...
(defrule OR4-forcing-whip[5]-candidate-00pq
   (declare (salience ?*OR4-forcing-whip[5]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[5])
...
(defrule OR4-forcing-whip[5]-candidate-0pqr
   (declare (salience ?*OR4-forcing-whip[5]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[5])
...
(defrule OR4-forcing-whip[5]-candidate-pqrs
   (declare (salience ?*OR4-forcing-whip[5]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[5])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-whip[5]-value
   (declare (salience ?*OR4-forcing-whip[5]-value-salience*))
   (technique ?cont OR4-forcing-whip[5])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type partial-whip)
