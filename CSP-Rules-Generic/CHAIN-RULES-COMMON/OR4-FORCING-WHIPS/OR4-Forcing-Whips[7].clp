...
(defrule activate-OR4-forcing-whip[7]
   (declare (salience ?*activate-OR4-forcing-whip[7]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-whip[7]))
   (assert (technique ?cont partial-whip[6]))
   (bind ?*technique* OR4FW[7])
)



(defrule track-OR4-forcing-whip[7]
   (declare (salience ?*activate-OR4-forcing-whip[7]-salience*))
   ?level <- (technique ?cont OR4-forcing-whip[7])
=>
...
(defrule OR4-forcing-whip[7]-candidate-000p
   (declare (salience ?*OR4-forcing-whip[7]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[7])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L7* ?*print-OR4-forcing-whip* ?*print-OR4-forcing-whip-7*) then
...
(defrule OR4-forcing-whip[7]-candidate-00pq
   (declare (salience ?*OR4-forcing-whip[7]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[7])
...
(defrule OR4-forcing-whip[7]-candidate-0pqr
   (declare (salience ?*OR4-forcing-whip[7]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[7])
...
(defrule OR4-forcing-whip[7]-candidate-pqrs
   (declare (salience ?*OR4-forcing-whip[7]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[7])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-whip[7]-value
   (declare (salience ?*OR4-forcing-whip[7]-value-salience*))
   (technique ?cont OR4-forcing-whip[7])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type partial-whip)
