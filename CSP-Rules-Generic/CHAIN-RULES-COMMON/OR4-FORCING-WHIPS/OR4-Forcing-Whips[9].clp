...
(defrule activate-OR4-forcing-whip[9]
   (declare (salience ?*activate-OR4-forcing-whip[9]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-whip[9]))
   (assert (technique ?cont partial-whip[8]))
   (bind ?*technique* OR4FW[9])
)



(defrule track-OR4-forcing-whip[9]
   (declare (salience ?*activate-OR4-forcing-whip[9]-salience*))
   ?level <- (technique ?cont OR4-forcing-whip[9])
=>
...
(defrule OR4-forcing-whip[9]-candidate-000p
   (declare (salience ?*OR4-forcing-whip[9]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[9])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L9* ?*print-OR4-forcing-whip* ?*print-OR4-forcing-whip-9*) then
...
(defrule OR4-forcing-whip[9]-candidate-00pq
   (declare (salience ?*OR4-forcing-whip[9]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[9])
...
(defrule OR4-forcing-whip[9]-candidate-0pqr
   (declare (salience ?*OR4-forcing-whip[9]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[9])
...
(defrule OR4-forcing-whip[9]-candidate-pqrs
   (declare (salience ?*OR4-forcing-whip[9]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[9])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-whip[9]-value
   (declare (salience ?*OR4-forcing-whip[9]-value-salience*))
   (technique ?cont OR4-forcing-whip[9])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type partial-whip)
