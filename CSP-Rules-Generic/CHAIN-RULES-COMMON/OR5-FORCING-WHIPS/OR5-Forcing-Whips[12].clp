...
(defrule activate-OR5-forcing-whip[12]
   (declare (salience ?*activate-OR5-forcing-whip[12]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5FW12))
   (assert (technique ?cont OR5-forcing-whip[12]))
   (assert (technique ?cont partial-whip[11]))
   (bind ?*technique* OR5FW[12])
)



(defrule track-OR5-forcing-whip[12]
   (declare (salience ?*activate-OR5-forcing-whip[12]-salience*))
   ?level <- (technique ?cont OR5-forcing-whip[12])
=>
...
(defrule OR5-forcing-whip[12]-candidate-0000p
   (declare (salience ?*OR5-forcing-whip[12]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[12])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L12* ?*print-OR5-forcing-whip* ?*print-OR5-forcing-whip-12*) then
...
(defrule OR5-forcing-whip[12]-candidate-000pq
   (declare (salience ?*OR5-forcing-whip[12]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[12])
...
(defrule OR5-forcing-whip[12]-candidate-00pqr
   (declare (salience ?*OR5-forcing-whip[12]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[12])
...
(defrule OR5-forcing-whip[12]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-whip[12]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[12])
...
(defrule OR5-forcing-whip[12]-candidate-pqrst
   (declare (salience ?*OR5-forcing-whip[12]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[12])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-whip[12]-value
   (declare (salience ?*OR5-forcing-whip[12]-value-salience*))
   (technique ?cont OR5-forcing-whip[12])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type partial-whip)
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p2&:(or (< ?p1 ?p2) (and (= ?p1 ?p2) (< ?zzz1 ?zzz2)))&:(< ?p2 9))
      (target ?zzz2)
      (llcs $?llcs2)
      (rlcs $?rlcs2)
      (csp-vars $?csps2)
