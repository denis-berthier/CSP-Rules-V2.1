...
(defrule activate-OR5-forcing-whip[13]
   (declare (salience ?*activate-OR5-forcing-whip[13]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-whip[13]))
   (assert (technique ?cont partial-whip[12]))
   (bind ?*technique* OR5FW[13])
)



(defrule track-OR5-forcing-whip[13]
   (declare (salience ?*activate-OR5-forcing-whip[13]-salience*))
   ?level <- (technique ?cont OR5-forcing-whip[13])
=>
...
(defrule OR5-forcing-whip[13]-candidate-0000p
   (declare (salience ?*OR5-forcing-whip[13]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[13])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L13* ?*print-OR5-forcing-whip* ?*print-OR5-forcing-whip-13*) then
...
(defrule OR5-forcing-whip[13]-candidate-000pq
   (declare (salience ?*OR5-forcing-whip[13]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[13])
...
(defrule OR5-forcing-whip[13]-candidate-00pqr
   (declare (salience ?*OR5-forcing-whip[13]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[13])
...
(defrule OR5-forcing-whip[13]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-whip[13]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[13])
...
(defrule OR5-forcing-whip[13]-candidate-pqrst
   (declare (salience ?*OR5-forcing-whip[13]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[13])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-whip[13]-value
   (declare (salience ?*OR5-forcing-whip[13]-value-salience*))
   (technique ?cont OR5-forcing-whip[13])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type partial-whip)
