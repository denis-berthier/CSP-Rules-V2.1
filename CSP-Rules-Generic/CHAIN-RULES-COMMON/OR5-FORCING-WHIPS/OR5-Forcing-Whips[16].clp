...
(defrule activate-OR5-forcing-whip[16]
   (declare (salience ?*activate-OR5-forcing-whip[16]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-whip[16]))
   (assert (technique ?cont partial-whip[15]))
   (bind ?*technique* OR5FW[16])
)



(defrule track-OR5-forcing-whip[16]
   (declare (salience ?*activate-OR5-forcing-whip[16]-salience*))
   ?level <- (technique ?cont OR5-forcing-whip[16])
=>
...
(defrule OR5-forcing-whip[16]-candidate-0000p
   (declare (salience ?*OR5-forcing-whip[16]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[16])
...
(defrule OR5-forcing-whip[16]-candidate-000pq
   (declare (salience ?*OR5-forcing-whip[16]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[16])
...
(defrule OR5-forcing-whip[16]-candidate-00pqr
   (declare (salience ?*OR5-forcing-whip[16]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[16])
...
(defrule OR5-forcing-whip[16]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-whip[16]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[16])
...
(defrule OR5-forcing-whip[16]-candidate-pqrst
   (declare (salience ?*OR5-forcing-whip[16]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[16])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-whip[16]-value
   (declare (salience ?*OR5-forcing-whip[16]-value-salience*))
   (technique ?cont OR5-forcing-whip[16])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type partial-whip)
