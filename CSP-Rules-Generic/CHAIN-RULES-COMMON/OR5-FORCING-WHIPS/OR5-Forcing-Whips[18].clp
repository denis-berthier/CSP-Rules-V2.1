...
(defrule activate-OR5-forcing-whip[18]
   (declare (salience ?*activate-OR5-forcing-whip[18]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5FW18))
   (assert (technique ?cont OR5-forcing-whip[18]))
   (assert (technique ?cont partial-whip[17]))
   (bind ?*technique* OR5FW[18])
)



(defrule track-OR5-forcing-whip[18]
   (declare (salience ?*activate-OR5-forcing-whip[18]-salience*))
   ?level <- (technique ?cont OR5-forcing-whip[18])
=>
...
(defrule OR5-forcing-whip[18]-candidate-0000p
   (declare (salience ?*OR5-forcing-whip[18]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[18])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L18* ?*print-OR5-forcing-whip* ?*print-OR5-forcing-whip-18*) then
...
(defrule OR5-forcing-whip[18]-candidate-000pq
   (declare (salience ?*OR5-forcing-whip[18]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[18])
...
(defrule OR5-forcing-whip[18]-candidate-00pqr
   (declare (salience ?*OR5-forcing-whip[18]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[18])
...
(defrule OR5-forcing-whip[18]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-whip[18]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[18])
...
(defrule OR5-forcing-whip[18]-candidate-pqrst
   (declare (salience ?*OR5-forcing-whip[18]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[18])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-whip[18]-value
   (declare (salience ?*OR5-forcing-whip[18]-value-salience*))
   (technique ?cont OR5-forcing-whip[18])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type partial-whip)
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p2&:(or (< ?p1 ?p2) (and (= ?p1 ?p2) (< ?zzz1 ?zzz2)))&:(< ?p2 15))
      (target ?zzz2)
      (llcs $?llcs2)
      (rlcs $?rlcs2)
      (csp-vars $?csps2)
