...
(defrule activate-OR5-forcing-whip[23]
   (declare (salience ?*activate-OR5-forcing-whip[23]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-whip[23]))
   (assert (technique ?cont partial-whip[22]))
   (bind ?*technique* OR5FW[23])
)



(defrule track-OR5-forcing-whip[23]
   (declare (salience ?*activate-OR5-forcing-whip[23]-salience*))
   ?level <- (technique ?cont OR5-forcing-whip[23])
=>
...
(defrule OR5-forcing-whip[23]-candidate-0000p
   (declare (salience ?*OR5-forcing-whip[23]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[23])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L23* ?*print-OR5-forcing-whip* ?*print-OR5-forcing-whip-23*) then
...
(defrule OR5-forcing-whip[23]-candidate-000pq
   (declare (salience ?*OR5-forcing-whip[23]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[23])
...
(defrule OR5-forcing-whip[23]-candidate-00pqr
   (declare (salience ?*OR5-forcing-whip[23]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[23])
...
(defrule OR5-forcing-whip[23]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-whip[23]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[23])
...
(defrule OR5-forcing-whip[23]-candidate-pqrst
   (declare (salience ?*OR5-forcing-whip[23]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[23])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-whip[23]-value
   (declare (salience ?*OR5-forcing-whip[23]-value-salience*))
   (technique ?cont OR5-forcing-whip[23])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type partial-whip)
