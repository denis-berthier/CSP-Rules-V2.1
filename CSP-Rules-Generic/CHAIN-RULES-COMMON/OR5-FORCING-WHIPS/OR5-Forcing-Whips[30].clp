...
(defrule activate-OR5-forcing-whip[30]
   (declare (salience ?*activate-OR5-forcing-whip[30]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-whip[30]))
   (assert (technique ?cont partial-whip[29]))
   (bind ?*technique* OR5FW[30])
)



(defrule track-OR5-forcing-whip[30]
   (declare (salience ?*activate-OR5-forcing-whip[30]-salience*))
   ?level <- (technique ?cont OR5-forcing-whip[30])
=>
...
(defrule OR5-forcing-whip[30]-candidate-0000p
   (declare (salience ?*OR5-forcing-whip[30]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[30])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L30* ?*print-OR5-forcing-whip* ?*print-OR5-forcing-whip-30*) then
...
(defrule OR5-forcing-whip[30]-candidate-000pq
   (declare (salience ?*OR5-forcing-whip[30]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[30])
...
(defrule OR5-forcing-whip[30]-candidate-00pqr
   (declare (salience ?*OR5-forcing-whip[30]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[30])
...
(defrule OR5-forcing-whip[30]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-whip[30]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[30])
...
(defrule OR5-forcing-whip[30]-candidate-pqrst
   (declare (salience ?*OR5-forcing-whip[30]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[30])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-whip[30]-value
   (declare (salience ?*OR5-forcing-whip[30]-value-salience*))
   (technique ?cont OR5-forcing-whip[30])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type partial-whip)
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p2&:(or (< ?p1 ?p2) (and (= ?p1 ?p2) (< ?zzz1 ?zzz2)))&:(< ?p2 27))
      (target ?zzz2)
      (llcs $?llcs2)
      (rlcs $?rlcs2)
      (csp-vars $?csps2)
