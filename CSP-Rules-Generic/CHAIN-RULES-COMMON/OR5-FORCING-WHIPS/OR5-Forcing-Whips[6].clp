...
(defrule activate-OR5-forcing-whip[6]
   (declare (salience ?*activate-OR5-forcing-whip[6]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5FW6))
   (assert (technique ?cont OR5-forcing-whip[6]))
   (assert (technique ?cont partial-whip[5]))
   (bind ?*technique* OR5FW[6])
)



(defrule track-OR5-forcing-whip[6]
   (declare (salience ?*activate-OR5-forcing-whip[6]-salience*))
   ?level <- (technique ?cont OR5-forcing-whip[6])
=>
...
(defrule OR5-forcing-whip[6]-candidate-0000p
   (declare (salience ?*OR5-forcing-whip[6]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[6])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L6* ?*print-OR5-forcing-whip* ?*print-OR5-forcing-whip-6*) then
...
(defrule OR5-forcing-whip[6]-candidate-000pq
   (declare (salience ?*OR5-forcing-whip[6]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[6])
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p5&:(or (< ?p4 ?p5) (and (= ?p4 ?p5) (< ?zzz4 ?zzz5)))&:(= (+ ?p4 ?p5) 5))
      (target ?zzz5)
      (llcs $?llcs5)
      (rlcs $?rlcs5)
      (csp-vars $?csps5)
...
(defrule OR5-forcing-whip[6]-candidate-00pqr
   (declare (salience ?*OR5-forcing-whip[6]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[6])
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p5&:(or (< ?p4 ?p5) (and (= ?p4 ?p5) (< ?zzz4 ?zzz5)))&:(= (+ ?p3 ?p4 ?p5) 5))
      (target ?zzz5)
      (llcs $?llcs5)
      (rlcs $?rlcs5)
      (csp-vars $?csps5)
...
(defrule OR5-forcing-whip[6]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-whip[6]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[6])
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p5&:(or (< ?p4 ?p5) (and (= ?p4 ?p5) (< ?zzz4 ?zzz5)))&:(= (+ ?p2 ?p3 ?p4 ?p5) 5))
      (target ?zzz5)
      (llcs $?llcs5)
      (rlcs $?rlcs5)
      (csp-vars $?csps5)
...
(defrule OR5-forcing-whip[6]-candidate-pqrst
   (declare (salience ?*OR5-forcing-whip[6]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[6])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p4&:(or (< ?p3 ?p4) (and (= ?p3 ?p4) (< ?zzz3 ?zzz4)))&:(< (+ ?p1 ?p2 ?p3 ?p4) 4))
      (target ?zzz4)
      (llcs $?llcs4)
      (rlcs $?rlcs4)
      (csp-vars $?csps4)
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p5&:(or (< ?p4 ?p5) (and (= ?p4 ?p5) (< ?zzz4 ?zzz5)))&:(= (+ ?p1 ?p2 ?p3 ?p4 ?p5) 5))
      (target ?zzz5)
      (llcs $?llcs5)
      (rlcs $?rlcs5)
      (csp-vars $?csps5)
...
(defrule OR5-forcing-whip[6]-value
   (declare (salience ?*OR5-forcing-whip[6]-value-salience*))
   (technique ?cont OR5-forcing-whip[6])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type partial-whip)
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p2&:(or (< ?p1 ?p2) (and (= ?p1 ?p2) (< ?zzz1 ?zzz2)))&:(< ?p2 3))
      (target ?zzz2)
      (llcs $?llcs2)
      (rlcs $?rlcs2)
      (csp-vars $?csps2)
