...
(defrule activate-OR5-forcing-whip[8]
   (declare (salience ?*activate-OR5-forcing-whip[8]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-whip[8]))
   (assert (technique ?cont partial-whip[7]))
   (bind ?*technique* OR5FW[8])
)



(defrule track-OR5-forcing-whip[8]
   (declare (salience ?*activate-OR5-forcing-whip[8]-salience*))
   ?level <- (technique ?cont OR5-forcing-whip[8])
=>
...
(defrule OR5-forcing-whip[8]-candidate-0000p
   (declare (salience ?*OR5-forcing-whip[8]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[8])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L8* ?*print-OR5-forcing-whip* ?*print-OR5-forcing-whip-8*) then
...
(defrule OR5-forcing-whip[8]-candidate-000pq
   (declare (salience ?*OR5-forcing-whip[8]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[8])
...
(defrule OR5-forcing-whip[8]-candidate-00pqr
   (declare (salience ?*OR5-forcing-whip[8]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[8])
...
(defrule OR5-forcing-whip[8]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-whip[8]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[8])
...
(defrule OR5-forcing-whip[8]-candidate-pqrst
   (declare (salience ?*OR5-forcing-whip[8]-candidate-salience*))
   (technique ?cont OR5-forcing-whip[8])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-whip[8]-value
   (declare (salience ?*OR5-forcing-whip[8]-value-salience*))
   (technique ?cont OR5-forcing-whip[8])
   (OR-k-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type partial-whip)
