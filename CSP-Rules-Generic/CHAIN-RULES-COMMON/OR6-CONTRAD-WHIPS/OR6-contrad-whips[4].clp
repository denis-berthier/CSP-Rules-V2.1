...
(defrule activate-OR6-contrad-whip[4]
   (declare (salience ?*activate-OR6-contrad-whip[4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CW4))
   (assert (technique ?cont OR6-contrad-whip[4]))
   (assert (technique ?cont partial-whip[3]))
   (bind ?*technique* OR6CW[4])
)



(defrule track-OR6-contrad-whip[4]
   (declare (salience ?*activate-OR6-contrad-whip[4]-salience*))
   ?level <- (technique ?cont OR6-contrad-whip[4])
=>
...
(defrule OR6-contrad-whip[4]
   (declare (salience ?*OR6-contrad-whip[4]-salience*))
   (technique ?cont OR6-contrad-whip[4])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L4* ?*print-OR6-contrad-whip* ?*print-OR6-contrad-whip-4*) then
