...
(defrule activate-OR6-contrad-whip[9]
   (declare (salience ?*activate-OR6-contrad-whip[9]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CW9))
   (assert (technique ?cont OR6-contrad-whip[9]))
   (assert (technique ?cont partial-whip[8]))
   (bind ?*technique* OR6CW[9])
)



(defrule track-OR6-contrad-whip[9]
   (declare (salience ?*activate-OR6-contrad-whip[9]-salience*))
   ?level <- (technique ?cont OR6-contrad-whip[9])
=>
...
(defrule OR6-contrad-whip[9]
   (declare (salience ?*OR6-contrad-whip[9]-salience*))
   (technique ?cont OR6-contrad-whip[9])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L9* ?*print-OR6-contrad-whip* ?*print-OR6-contrad-whip-9*) then
