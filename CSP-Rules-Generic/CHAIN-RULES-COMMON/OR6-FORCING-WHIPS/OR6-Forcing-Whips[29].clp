...
(defrule activate-OR6-forcing-whip[29]
   (declare (salience ?*activate-OR6-forcing-whip[29]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR6-forcing-whip[29]))
   (assert (technique ?cont partial-whip[28]))
   (bind ?*technique* OR6FW[29])
)



(defrule track-OR6-forcing-whip[29]
   (declare (salience ?*activate-OR6-forcing-whip[29]-salience*))
   ?level <- (technique ?cont OR6-forcing-whip[29])
=>
...
(defrule OR6-forcing-whip[29]-candidate-00000p
   (declare (salience ?*OR6-forcing-whip[29]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[29])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L29* ?*print-OR6-forcing-whip* ?*print-OR6-forcing-whip-29*) then
...
(defrule OR6-forcing-whip[29]-candidate-0000pq
   (declare (salience ?*OR6-forcing-whip[29]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[29])
...
(defrule OR6-forcing-whip[29]-candidate-000pqr
   (declare (salience ?*OR6-forcing-whip[29]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[29])
...
(defrule OR6-forcing-whip[29]-candidate-00pqrs
   (declare (salience ?*OR6-forcing-whip[29]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[29])
...
(defrule OR6-forcing-whip[29]-candidate-0pqrst
   (declare (salience ?*OR6-forcing-whip[29]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[29])
...
(defrule OR6-forcing-whip[29]-candidate-pqrstu
   (declare (salience ?*OR6-forcing-whip[29]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[29])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
...
(defrule OR6-forcing-whip[29]-value
   (declare (salience ?*OR6-forcing-whip[29]-value-salience*))
   (technique ?cont OR6-forcing-whip[29])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
      (type partial-whip)
