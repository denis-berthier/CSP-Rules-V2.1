...
(defrule activate-OR6-forcing-whip[6]
   (declare (salience ?*activate-OR6-forcing-whip[6]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR6-forcing-whip[6]))
   (assert (technique ?cont partial-whip[5]))
   (bind ?*technique* OR6FW[6])
)



(defrule track-OR6-forcing-whip[6]
   (declare (salience ?*activate-OR6-forcing-whip[6]-salience*))
   ?level <- (technique ?cont OR6-forcing-whip[6])
=>
...
(defrule OR6-forcing-whip[6]-candidate-00000p
   (declare (salience ?*OR6-forcing-whip[6]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[6])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L6* ?*print-OR6-forcing-whip* ?*print-OR6-forcing-whip-6*) then
...
(defrule OR6-forcing-whip[6]-candidate-0000pq
   (declare (salience ?*OR6-forcing-whip[6]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[6])
...
(defrule OR6-forcing-whip[6]-candidate-000pqr
   (declare (salience ?*OR6-forcing-whip[6]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[6])
...
(defrule OR6-forcing-whip[6]-candidate-00pqrs
   (declare (salience ?*OR6-forcing-whip[6]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[6])
...
(defrule OR6-forcing-whip[6]-candidate-0pqrst
   (declare (salience ?*OR6-forcing-whip[6]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[6])
