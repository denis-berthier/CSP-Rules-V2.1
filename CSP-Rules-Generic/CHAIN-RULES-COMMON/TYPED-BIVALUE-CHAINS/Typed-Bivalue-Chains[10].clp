...
;;;
;;;                              CSP-RULES / GENERIC
;;;                              BLOCKED-TYPED-BIVALUE-CHAIN[10]
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-typed-bivalue-chain[10]
   (declare (salience ?*activate-typed-bivalue-chain[10]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TyBC10))
   (assert (technique ?cont typed-bivalue-chain[10]))
   (bind ?*technique* TyBC[10])
)



(defrule track-typed-bivalue-chain[10]
   (declare (salience ?*activate-typed-bivalue-chain[10]-salience*))
   ?level <- (technique ?cont typed-bivalue-chain[10])
=>
...
(defrule typed-partial-bivalue-chain[10]
   (declare (salience ?*typed-partial-bivalue-chain[10]-salience*))
   (logical
      (typed-chain
      ...
      (technique ?cont typed-bivalue-chain[10])
      ;;; ?new-llc
...
(defrule typed-bivalue-chain[10]
   (declare (salience ?*typed-bivalue-chain[10]-salience*))
   (typed-chain
      (type typed-bivalue-chain)
      (csp-type ?csp-type)
      (context ?cont)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L10* ?*print-typed-bivalue-chain* ?*print-typed-bivalue-chain-10*) then
      (print-typed-bivalue-chain-without-crlf ?csp-type 10 ?zzz $?llcs $?rlcs $?csp-vars)
   )
   (if (not ?*blocked-bivalue-chains*)
      then (printout t crlf)
      else ; prepare for finding more targets
         (assert (apply-rule-as-a-pseudo-block ?cont))
         (assert (pseudo-blocked ?cont typed-bivalue-chain[10] ?csp-type 10 ?zzz $?llcs $?rlcs $?csp-vars))
   )
)



(defrule apply-typed-bivalue-chain-to-more-targets[10]
   ...
   (pseudo-blocked ?cont typed-bivalue-chain[10] ?csp-type 10 ?zzz $?llcs $?rlcs $?csp-vars)
