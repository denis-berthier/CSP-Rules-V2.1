...
;;;
;;;                              CSP-RULES / GENERIC
;;;                              BLOCKED-TYPED-BIVALUE-CHAIN[14]
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-typed-bivalue-chain[14]
   (declare (salience ?*activate-typed-bivalue-chain[14]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TyBC14))
   (assert (technique ?cont typed-bivalue-chain[14]))
   (bind ?*technique* TyBC[14])
)



(defrule track-typed-bivalue-chain[14]
   (declare (salience ?*activate-typed-bivalue-chain[14]-salience*))
   ?level <- (technique ?cont typed-bivalue-chain[14])
=>
...
(defrule typed-partial-bivalue-chain[14]
   (declare (salience ?*typed-partial-bivalue-chain[14]-salience*))
   (logical
      (typed-chain
      ...
      (technique ?cont typed-bivalue-chain[14])
      ;;; ?new-llc
...
(defrule typed-bivalue-chain[14]
   (declare (salience ?*typed-bivalue-chain[14]-salience*))
   (typed-chain
      (type typed-bivalue-chain)
      (csp-type ?csp-type)
      (context ?cont)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L14* ?*print-typed-bivalue-chain* ?*print-typed-bivalue-chain-14*) then
      (print-typed-bivalue-chain-without-crlf ?csp-type 14 ?zzz $?llcs $?rlcs $?csp-vars)
   )
   (if (not ?*blocked-bivalue-chains*)
      then (printout t crlf)
      else ; prepare for finding more targets
         (assert (apply-rule-as-a-pseudo-block ?cont))
         (assert (pseudo-blocked ?cont typed-bivalue-chain[14] ?csp-type 14 ?zzz $?llcs $?rlcs $?csp-vars))
   )
)



(defrule apply-typed-bivalue-chain-to-more-targets[14]
   ...
   (pseudo-blocked ?cont typed-bivalue-chain[14] ?csp-type 14 ?zzz $?llcs $?rlcs $?csp-vars)
