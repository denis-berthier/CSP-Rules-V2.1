...
;;;
;;;                              CSP-RULES / GENERIC
;;;                              BLOCKED-TYPED-BIVALUE-CHAIN[20]
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-typed-bivalue-chain[20]
   (declare (salience ?*activate-typed-bivalue-chain[20]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TyBC20))
   (assert (technique ?cont typed-bivalue-chain[20]))
   (bind ?*technique* TyBC[20])
)



(defrule track-typed-bivalue-chain[20]
   (declare (salience ?*activate-typed-bivalue-chain[20]-salience*))
   ?level <- (technique ?cont typed-bivalue-chain[20])
=>
...
(defrule typed-partial-bivalue-chain[20]
   (declare (salience ?*typed-partial-bivalue-chain[20]-salience*))
   (logical
      (typed-chain
      ...
      (technique ?cont typed-bivalue-chain[20])
      ;;; ?new-llc
...
(defrule typed-bivalue-chain[20]
   (declare (salience ?*typed-bivalue-chain[20]-salience*))
   (typed-chain
      (type typed-bivalue-chain)
      (csp-type ?csp-type)
      (context ?cont)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L20* ?*print-typed-bivalue-chain* ?*print-typed-bivalue-chain-20*) then
      (print-typed-bivalue-chain-without-crlf ?csp-type 20 ?zzz $?llcs $?rlcs $?csp-vars)
   )
   (if (not ?*blocked-bivalue-chains*)
      then (printout t crlf)
      else ; prepare for finding more targets
         (assert (apply-rule-as-a-pseudo-block ?cont))
         (assert (pseudo-blocked ?cont typed-bivalue-chain[20] ?csp-type 20 ?zzz $?llcs $?rlcs $?csp-vars))
   )
)



(defrule apply-typed-bivalue-chain-to-more-targets[20]
   ...
   (pseudo-blocked ?cont typed-bivalue-chain[20] ?csp-type 20 ?zzz $?llcs $?rlcs $?csp-vars)
