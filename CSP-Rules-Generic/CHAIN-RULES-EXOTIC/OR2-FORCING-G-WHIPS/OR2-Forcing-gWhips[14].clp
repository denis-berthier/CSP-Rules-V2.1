...
(defrule activate-OR2-forcing-gwhip[14]
   (declare (salience ?*activate-OR2-forcing-gwhip[14]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW14))
   (assert (technique ?cont OR2-forcing-gwhip[14]))
   (assert (technique ?cont partial-whip[13]))
   (assert (technique ?cont partial-gwhip[13]))
   (bind ?*technique* OR2FgW[14])
)



(defrule track-OR2-forcing-gwhip[14]
   (declare (salience ?*activate-OR2-forcing-gwhip[14]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[14])
=>
...
(defrule OR2-forcing-gwhip[14]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[14]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[14])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L14* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-14*) then
...
(defrule OR2-forcing-gwhip[14]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[14]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[14])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[14]-value
   (declare (salience ?*OR2-forcing-gwhip[14]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[14])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
