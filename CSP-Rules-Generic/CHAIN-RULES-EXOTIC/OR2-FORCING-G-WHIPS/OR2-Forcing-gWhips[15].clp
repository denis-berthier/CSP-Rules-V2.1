...
(defrule activate-OR2-forcing-gwhip[15]
   (declare (salience ?*activate-OR2-forcing-gwhip[15]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW15))
   (assert (technique ?cont OR2-forcing-gwhip[15]))
   (assert (technique ?cont partial-whip[14]))
   (assert (technique ?cont partial-gwhip[14]))
   (bind ?*technique* OR2FgW[15])
)



(defrule track-OR2-forcing-gwhip[15]
   (declare (salience ?*activate-OR2-forcing-gwhip[15]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[15])
=>
...
(defrule OR2-forcing-gwhip[15]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[15]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[15])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L15* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-15*) then
...
(defrule OR2-forcing-gwhip[15]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[15]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[15])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[15]-value
   (declare (salience ?*OR2-forcing-gwhip[15]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[15])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
