...
(defrule activate-OR2-forcing-gwhip[17]
   (declare (salience ?*activate-OR2-forcing-gwhip[17]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW17))
   (assert (technique ?cont OR2-forcing-gwhip[17]))
   (assert (technique ?cont partial-whip[16]))
   (assert (technique ?cont partial-gwhip[16]))
   (bind ?*technique* OR2FgW[17])
)



(defrule track-OR2-forcing-gwhip[17]
   (declare (salience ?*activate-OR2-forcing-gwhip[17]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[17])
=>
...
(defrule OR2-forcing-gwhip[17]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[17]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[17])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L17* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-17*) then
...
(defrule OR2-forcing-gwhip[17]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[17]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[17])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[17]-value
   (declare (salience ?*OR2-forcing-gwhip[17]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[17])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
