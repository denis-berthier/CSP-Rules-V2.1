...
(defrule activate-OR2-forcing-gwhip[18]
   (declare (salience ?*activate-OR2-forcing-gwhip[18]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW18))
   (assert (technique ?cont OR2-forcing-gwhip[18]))
   (assert (technique ?cont partial-whip[17]))
   (assert (technique ?cont partial-gwhip[17]))
   (bind ?*technique* OR2FgW[18])
)



(defrule track-OR2-forcing-gwhip[18]
   (declare (salience ?*activate-OR2-forcing-gwhip[18]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[18])
=>
...
(defrule OR2-forcing-gwhip[18]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[18])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L18* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-18*) then
...
(defrule OR2-forcing-gwhip[18]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[18])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[18]-value
   (declare (salience ?*OR2-forcing-gwhip[18]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[18])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
