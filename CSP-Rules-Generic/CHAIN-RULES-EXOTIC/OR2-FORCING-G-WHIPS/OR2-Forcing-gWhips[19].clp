...
(defrule activate-OR2-forcing-gwhip[19]
   (declare (salience ?*activate-OR2-forcing-gwhip[19]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW19))
   (assert (technique ?cont OR2-forcing-gwhip[19]))
   (assert (technique ?cont partial-whip[18]))
   (assert (technique ?cont partial-gwhip[18]))
   (bind ?*technique* OR2FgW[19])
)



(defrule track-OR2-forcing-gwhip[19]
   (declare (salience ?*activate-OR2-forcing-gwhip[19]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[19])
=>
...
(defrule OR2-forcing-gwhip[19]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[19]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[19])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L19* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-19*) then
...
(defrule OR2-forcing-gwhip[19]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[19]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[19])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[19]-value
   (declare (salience ?*OR2-forcing-gwhip[19]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[19])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
