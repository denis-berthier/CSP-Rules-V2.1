...
(defrule activate-OR2-forcing-gwhip[21]
   (declare (salience ?*activate-OR2-forcing-gwhip[21]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW21))
   (assert (technique ?cont OR2-forcing-gwhip[21]))
   (assert (technique ?cont partial-whip[20]))
   (assert (technique ?cont partial-gwhip[20]))
   (bind ?*technique* OR2FgW[21])
)



(defrule track-OR2-forcing-gwhip[21]
   (declare (salience ?*activate-OR2-forcing-gwhip[21]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[21])
=>
...
(defrule OR2-forcing-gwhip[21]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[21]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[21])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L21* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-21*) then
...
(defrule OR2-forcing-gwhip[21]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[21]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[21])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[21]-value
   (declare (salience ?*OR2-forcing-gwhip[21]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[21])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
