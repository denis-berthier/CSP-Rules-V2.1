...
(defrule activate-OR2-forcing-gwhip[22]
   (declare (salience ?*activate-OR2-forcing-gwhip[22]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW22))
   (assert (technique ?cont OR2-forcing-gwhip[22]))
   (assert (technique ?cont partial-whip[21]))
   (assert (technique ?cont partial-gwhip[21]))
   (bind ?*technique* OR2FgW[22])
)



(defrule track-OR2-forcing-gwhip[22]
   (declare (salience ?*activate-OR2-forcing-gwhip[22]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[22])
=>
...
(defrule OR2-forcing-gwhip[22]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[22]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[22])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L22* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-22*) then
...
(defrule OR2-forcing-gwhip[22]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[22]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[22])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[22]-value
   (declare (salience ?*OR2-forcing-gwhip[22]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[22])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
