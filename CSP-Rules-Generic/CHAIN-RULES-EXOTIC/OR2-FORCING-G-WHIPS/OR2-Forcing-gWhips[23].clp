...
(defrule activate-OR2-forcing-gwhip[23]
   (declare (salience ?*activate-OR2-forcing-gwhip[23]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW23))
   (assert (technique ?cont OR2-forcing-gwhip[23]))
   (assert (technique ?cont partial-whip[22]))
   (assert (technique ?cont partial-gwhip[22]))
   (bind ?*technique* OR2FgW[23])
)



(defrule track-OR2-forcing-gwhip[23]
   (declare (salience ?*activate-OR2-forcing-gwhip[23]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[23])
=>
...
(defrule OR2-forcing-gwhip[23]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[23]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[23])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L23* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-23*) then
...
(defrule OR2-forcing-gwhip[23]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[23]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[23])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[23]-value
   (declare (salience ?*OR2-forcing-gwhip[23]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[23])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
