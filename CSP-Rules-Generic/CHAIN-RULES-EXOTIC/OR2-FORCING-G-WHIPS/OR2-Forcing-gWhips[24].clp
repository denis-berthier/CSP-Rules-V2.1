...
(defrule activate-OR2-forcing-gwhip[24]
   (declare (salience ?*activate-OR2-forcing-gwhip[24]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW24))
   (assert (technique ?cont OR2-forcing-gwhip[24]))
   (assert (technique ?cont partial-whip[23]))
   (assert (technique ?cont partial-gwhip[23]))
   (bind ?*technique* OR2FgW[24])
)



(defrule track-OR2-forcing-gwhip[24]
   (declare (salience ?*activate-OR2-forcing-gwhip[24]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[24])
=>
...
(defrule OR2-forcing-gwhip[24]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[24])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L24* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-24*) then
...
(defrule OR2-forcing-gwhip[24]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[24])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[24]-value
   (declare (salience ?*OR2-forcing-gwhip[24]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[24])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
