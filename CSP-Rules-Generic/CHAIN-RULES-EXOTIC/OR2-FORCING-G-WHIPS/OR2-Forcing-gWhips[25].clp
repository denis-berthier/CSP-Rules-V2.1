...
(defrule activate-OR2-forcing-gwhip[25]
   (declare (salience ?*activate-OR2-forcing-gwhip[25]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW25))
   (assert (technique ?cont OR2-forcing-gwhip[25]))
   (assert (technique ?cont partial-whip[24]))
   (assert (technique ?cont partial-gwhip[24]))
   (bind ?*technique* OR2FgW[25])
)



(defrule track-OR2-forcing-gwhip[25]
   (declare (salience ?*activate-OR2-forcing-gwhip[25]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[25])
=>
...
(defrule OR2-forcing-gwhip[25]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[25]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[25])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L25* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-25*) then
...
(defrule OR2-forcing-gwhip[25]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[25]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[25])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[25]-value
   (declare (salience ?*OR2-forcing-gwhip[25]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[25])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
