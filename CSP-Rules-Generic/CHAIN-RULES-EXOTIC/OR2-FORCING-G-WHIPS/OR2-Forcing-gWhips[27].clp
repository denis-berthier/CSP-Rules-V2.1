...
(defrule activate-OR2-forcing-gwhip[27]
   (declare (salience ?*activate-OR2-forcing-gwhip[27]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW27))
   (assert (technique ?cont OR2-forcing-gwhip[27]))
   (assert (technique ?cont partial-whip[26]))
   (assert (technique ?cont partial-gwhip[26]))
   (bind ?*technique* OR2FgW[27])
)



(defrule track-OR2-forcing-gwhip[27]
   (declare (salience ?*activate-OR2-forcing-gwhip[27]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[27])
=>
...
(defrule OR2-forcing-gwhip[27]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[27]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[27])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L27* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-27*) then
...
(defrule OR2-forcing-gwhip[27]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[27]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[27])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[27]-value
   (declare (salience ?*OR2-forcing-gwhip[27]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[27])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
