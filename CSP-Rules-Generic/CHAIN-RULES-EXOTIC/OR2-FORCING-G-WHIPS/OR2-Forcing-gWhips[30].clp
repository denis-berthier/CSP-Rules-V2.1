...
(defrule activate-OR2-forcing-gwhip[30]
   (declare (salience ?*activate-OR2-forcing-gwhip[30]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW30))
   (assert (technique ?cont OR2-forcing-gwhip[30]))
   (assert (technique ?cont partial-whip[29]))
   (assert (technique ?cont partial-gwhip[29]))
   (bind ?*technique* OR2FgW[30])
)



(defrule track-OR2-forcing-gwhip[30]
   (declare (salience ?*activate-OR2-forcing-gwhip[30]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[30])
=>
...
(defrule OR2-forcing-gwhip[30]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[30]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[30])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L30* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-30*) then
...
(defrule OR2-forcing-gwhip[30]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[30]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[30])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[30]-value
   (declare (salience ?*OR2-forcing-gwhip[30]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[30])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
