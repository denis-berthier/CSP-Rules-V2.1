...
(defrule activate-OR2-forcing-gwhip[34]
   (declare (salience ?*activate-OR2-forcing-gwhip[34]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW34))
   (assert (technique ?cont OR2-forcing-gwhip[34]))
   (assert (technique ?cont partial-whip[33]))
   (assert (technique ?cont partial-gwhip[33]))
   (bind ?*technique* OR2FgW[34])
)



(defrule track-OR2-forcing-gwhip[34]
   (declare (salience ?*activate-OR2-forcing-gwhip[34]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[34])
=>
...
(defrule OR2-forcing-gwhip[34]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[34]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[34])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L34* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-34*) then
...
(defrule OR2-forcing-gwhip[34]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[34]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[34])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[34]-value
   (declare (salience ?*OR2-forcing-gwhip[34]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[34])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
