...
(defrule activate-OR2-forcing-gwhip[36]
   (declare (salience ?*activate-OR2-forcing-gwhip[36]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR2-forcing-gwhip[36]))
   (assert (technique ?cont partial-whip[35]))
   (assert (technique ?cont partial-gwhip[35]))
   (bind ?*technique* OR2FgW[36])
)



(defrule track-OR2-forcing-gwhip[36]
   (declare (salience ?*activate-OR2-forcing-gwhip[36]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[36])
=>
...
(defrule OR2-forcing-gwhip[36]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[36])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L36* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-36*) then
...
(defrule OR2-forcing-gwhip[36]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[36])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[36]-value
   (declare (salience ?*OR2-forcing-gwhip[36]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[36])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
