...
(defrule activate-OR2-forcing-gwhip[4]
   (declare (salience ?*activate-OR2-forcing-gwhip[4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW4))
   (assert (technique ?cont OR2-forcing-gwhip[4]))
   (assert (technique ?cont partial-whip[3]))
   (assert (technique ?cont partial-gwhip[3]))
   (bind ?*technique* OR2FgW[4])
)



(defrule track-OR2-forcing-gwhip[4]
   (declare (salience ?*activate-OR2-forcing-gwhip[4]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[4])
=>
...
(defrule OR2-forcing-gwhip[4]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[4]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[4])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L4* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-4*) then
...
(defrule OR2-forcing-gwhip[4]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[4]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[4])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[4]-value
   (declare (salience ?*OR2-forcing-gwhip[4]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[4])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
