...
(defrule activate-OR2-forcing-gwhip[5]
   (declare (salience ?*activate-OR2-forcing-gwhip[5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW5))
   (assert (technique ?cont OR2-forcing-gwhip[5]))
   (assert (technique ?cont partial-whip[4]))
   (assert (technique ?cont partial-gwhip[4]))
   (bind ?*technique* OR2FgW[5])
)



(defrule track-OR2-forcing-gwhip[5]
   (declare (salience ?*activate-OR2-forcing-gwhip[5]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[5])
=>
...
(defrule OR2-forcing-gwhip[5]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[5]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[5])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L5* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-5*) then
...
(defrule OR2-forcing-gwhip[5]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[5]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[5])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[5]-value
   (declare (salience ?*OR2-forcing-gwhip[5]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[5])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
