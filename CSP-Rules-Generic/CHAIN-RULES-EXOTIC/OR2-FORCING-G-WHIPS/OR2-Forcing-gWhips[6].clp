...
(defrule activate-OR2-forcing-gwhip[6]
   (declare (salience ?*activate-OR2-forcing-gwhip[6]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW6))
   (assert (technique ?cont OR2-forcing-gwhip[6]))
   (assert (technique ?cont partial-whip[5]))
   (assert (technique ?cont partial-gwhip[5]))
   (bind ?*technique* OR2FgW[6])
)



(defrule track-OR2-forcing-gwhip[6]
   (declare (salience ?*activate-OR2-forcing-gwhip[6]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[6])
=>
...
(defrule OR2-forcing-gwhip[6]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[6])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L6* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-6*) then
...
(defrule OR2-forcing-gwhip[6]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[6])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[6]-value
   (declare (salience ?*OR2-forcing-gwhip[6]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[6])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
