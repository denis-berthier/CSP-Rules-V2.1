...
(defrule activate-OR2-forcing-gwhip[8]
   (declare (salience ?*activate-OR2-forcing-gwhip[8]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2FW8))
   (assert (technique ?cont OR2-forcing-gwhip[8]))
   (assert (technique ?cont partial-whip[7]))
   (assert (technique ?cont partial-gwhip[7]))
   (bind ?*technique* OR2FgW[8])
)



(defrule track-OR2-forcing-gwhip[8]
   (declare (salience ?*activate-OR2-forcing-gwhip[8]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[8])
=>
...
(defrule OR2-forcing-gwhip[8]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[8]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[8])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L8* ?*print-OR2-forcing-gwhip* ?*print-OR2-forcing-gwhip-8*) then
...
(defrule OR2-forcing-gwhip[8]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[8]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[8])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[8]-value
   (declare (salience ?*OR2-forcing-gwhip[8]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[8])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
