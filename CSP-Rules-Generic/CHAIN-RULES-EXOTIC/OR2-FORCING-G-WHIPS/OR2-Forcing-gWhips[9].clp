...
(defrule activate-OR2-forcing-gwhip[9]
   (declare (salience ?*activate-OR2-forcing-gwhip[9]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR2-forcing-gwhip[9]))
   (assert (technique ?cont partial-whip[8]))
   (assert (technique ?cont partial-gwhip[8]))
   (bind ?*technique* OR2FgW[9])
)



(defrule track-OR2-forcing-gwhip[9]
   (declare (salience ?*activate-OR2-forcing-gwhip[9]-salience*))
   ?level <- (technique ?cont OR2-forcing-gwhip[9])
=>
...
(defrule OR2-forcing-gwhip[9]-candidate-0p
   (declare (salience ?*OR2-forcing-gwhip[9]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[9])
...
(defrule OR2-forcing-gwhip[9]-candidate-pq
   (declare (salience ?*OR2-forcing-gwhip[9]-candidate-salience*))
   (technique ?cont OR2-forcing-gwhip[9])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
...
(defrule OR2-forcing-gwhip[9]-value
   (declare (salience ?*OR2-forcing-gwhip[9]-value-salience*))
   (technique ?cont OR2-forcing-gwhip[9])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 2) (OR-candidates ?zzz1 ?zzz2))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
