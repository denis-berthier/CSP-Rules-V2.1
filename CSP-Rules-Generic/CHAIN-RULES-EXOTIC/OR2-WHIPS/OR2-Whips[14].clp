...
(defrule activate-OR2-whip[14]
   (declare (salience ?*activate-OR2-whip[14]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2W14))
   (assert (technique ?cont OR2-whip[14]))
   (assert (technique ?cont partial-whip[13]))
   (assert (technique ?cont partial-OR2-whip[13]))
   (bind ?*technique* OR2W[14])
)



(defrule track-OR2-whip[14]
   (declare (salience ?*activate-OR2-whip[14]-salience*))
   ?level <- (technique ?cont OR2-whip[14])
=>
...
(defrule OR2-whip[14]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR2-whip[14]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L14* ?*print-OR2-whip* ?*print-OR2-whip-14*) then
...
(defrule OR2-whip[14]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR2-whip[14]-salience-2*))
   (ORk-chain
      (type partial-OR2-whip)
      (context ?cont)
      (length 13)
