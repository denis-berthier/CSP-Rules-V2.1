...
(defrule activate-OR2-whip[4]
   (declare (salience ?*activate-OR2-whip[4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR2W4))
   (assert (technique ?cont OR2-whip[4]))
   (assert (technique ?cont partial-whip[3]))
   (assert (technique ?cont partial-OR2-whip[3]))
   (bind ?*technique* OR2W[4])
)



(defrule track-OR2-whip[4]
   (declare (salience ?*activate-OR2-whip[4]-salience*))
   ?level <- (technique ?cont OR2-whip[4])
=>
...
(defrule OR2-whip[4]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR2-whip[4]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L4* ?*print-OR2-whip* ?*print-OR2-whip-4*) then
...
(defrule OR2-whip[4]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR2-whip[4]-salience-2*))
   (ORk-chain
      (type partial-OR2-whip)
      (context ?cont)
      (length 3)
