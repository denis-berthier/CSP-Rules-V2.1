...
(defrule activate-OR3-forcing-gwhip[10]
   (declare (salience ?*activate-OR3-forcing-gwhip[10]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR3-forcing-gwhip[10]))
   (assert (technique ?cont partial-whip[9]))
   (assert (technique ?cont partial-gwhip[9]))
   (bind ?*technique* OR3FgW[10])
)



(defrule track-OR3-forcing-gwhip[10]
   (declare (salience ?*activate-OR3-forcing-gwhip[10]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[10])
=>
...
(defrule OR3-forcing-gwhip[10]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[10]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[10])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L10* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-10*) then
...
(defrule OR3-forcing-gwhip[10]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[10]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[10])
...
(defrule OR3-forcing-gwhip[10]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[10]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[10])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[10]-value
   (declare (salience ?*OR3-forcing-gwhip[10]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[10])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
