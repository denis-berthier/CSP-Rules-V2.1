...
(defrule activate-OR3-forcing-gwhip[11]
   (declare (salience ?*activate-OR3-forcing-gwhip[11]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW11))
   (assert (technique ?cont OR3-forcing-gwhip[11]))
   (assert (technique ?cont partial-whip[10]))
   (assert (technique ?cont partial-gwhip[10]))
   (bind ?*technique* OR3FgW[11])
)



(defrule track-OR3-forcing-gwhip[11]
   (declare (salience ?*activate-OR3-forcing-gwhip[11]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[11])
=>
...
(defrule OR3-forcing-gwhip[11]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[11]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[11])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L11* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-11*) then
...
(defrule OR3-forcing-gwhip[11]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[11]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[11])
...
(defrule OR3-forcing-gwhip[11]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[11]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[11])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[11]-value
   (declare (salience ?*OR3-forcing-gwhip[11]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[11])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
