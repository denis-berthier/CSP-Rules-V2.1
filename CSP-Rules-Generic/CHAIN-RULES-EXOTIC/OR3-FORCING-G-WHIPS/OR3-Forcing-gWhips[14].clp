...
(defrule activate-OR3-forcing-gwhip[14]
   (declare (salience ?*activate-OR3-forcing-gwhip[14]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW14))
   (assert (technique ?cont OR3-forcing-gwhip[14]))
   (assert (technique ?cont partial-whip[13]))
   (assert (technique ?cont partial-gwhip[13]))
   (bind ?*technique* OR3FgW[14])
)



(defrule track-OR3-forcing-gwhip[14]
   (declare (salience ?*activate-OR3-forcing-gwhip[14]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[14])
=>
...
(defrule OR3-forcing-gwhip[14]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[14]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[14])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L14* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-14*) then
...
(defrule OR3-forcing-gwhip[14]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[14]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[14])
...
(defrule OR3-forcing-gwhip[14]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[14]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[14])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[14]-value
   (declare (salience ?*OR3-forcing-gwhip[14]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[14])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
