...
(defrule activate-OR3-forcing-gwhip[16]
   (declare (salience ?*activate-OR3-forcing-gwhip[16]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW16))
   (assert (technique ?cont OR3-forcing-gwhip[16]))
   (assert (technique ?cont partial-whip[15]))
   (assert (technique ?cont partial-gwhip[15]))
   (bind ?*technique* OR3FgW[16])
)



(defrule track-OR3-forcing-gwhip[16]
   (declare (salience ?*activate-OR3-forcing-gwhip[16]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[16])
=>
...
(defrule OR3-forcing-gwhip[16]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[16]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[16])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L16* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-16*) then
...
(defrule OR3-forcing-gwhip[16]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[16]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[16])
...
(defrule OR3-forcing-gwhip[16]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[16]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[16])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[16]-value
   (declare (salience ?*OR3-forcing-gwhip[16]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[16])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
