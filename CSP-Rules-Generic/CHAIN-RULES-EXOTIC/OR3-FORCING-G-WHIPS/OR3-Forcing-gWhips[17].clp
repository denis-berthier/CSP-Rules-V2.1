...
(defrule activate-OR3-forcing-gwhip[17]
   (declare (salience ?*activate-OR3-forcing-gwhip[17]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR3-forcing-gwhip[17]))
   (assert (technique ?cont partial-whip[16]))
   (assert (technique ?cont partial-gwhip[16]))
   (bind ?*technique* OR3FgW[17])
)



(defrule track-OR3-forcing-gwhip[17]
   (declare (salience ?*activate-OR3-forcing-gwhip[17]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[17])
=>
...
(defrule OR3-forcing-gwhip[17]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[17]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[17])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L17* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-17*) then
...
(defrule OR3-forcing-gwhip[17]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[17]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[17])
...
(defrule OR3-forcing-gwhip[17]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[17]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[17])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[17]-value
   (declare (salience ?*OR3-forcing-gwhip[17]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[17])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
