...
(defrule activate-OR3-forcing-gwhip[18]
   (declare (salience ?*activate-OR3-forcing-gwhip[18]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW18))
   (assert (technique ?cont OR3-forcing-gwhip[18]))
   (assert (technique ?cont partial-whip[17]))
   (assert (technique ?cont partial-gwhip[17]))
   (bind ?*technique* OR3FgW[18])
)



(defrule track-OR3-forcing-gwhip[18]
   (declare (salience ?*activate-OR3-forcing-gwhip[18]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[18])
=>
...
(defrule OR3-forcing-gwhip[18]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[18])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L18* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-18*) then
...
(defrule OR3-forcing-gwhip[18]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[18])
...
(defrule OR3-forcing-gwhip[18]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[18])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[18]-value
   (declare (salience ?*OR3-forcing-gwhip[18]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[18])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
