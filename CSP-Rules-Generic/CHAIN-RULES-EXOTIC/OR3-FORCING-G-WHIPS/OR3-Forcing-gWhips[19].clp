...
(defrule activate-OR3-forcing-gwhip[19]
   (declare (salience ?*activate-OR3-forcing-gwhip[19]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW19))
   (assert (technique ?cont OR3-forcing-gwhip[19]))
   (assert (technique ?cont partial-whip[18]))
   (assert (technique ?cont partial-gwhip[18]))
   (bind ?*technique* OR3FgW[19])
)



(defrule track-OR3-forcing-gwhip[19]
   (declare (salience ?*activate-OR3-forcing-gwhip[19]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[19])
=>
...
(defrule OR3-forcing-gwhip[19]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[19]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[19])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L19* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-19*) then
...
(defrule OR3-forcing-gwhip[19]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[19]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[19])
...
(defrule OR3-forcing-gwhip[19]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[19]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[19])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[19]-value
   (declare (salience ?*OR3-forcing-gwhip[19]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[19])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
