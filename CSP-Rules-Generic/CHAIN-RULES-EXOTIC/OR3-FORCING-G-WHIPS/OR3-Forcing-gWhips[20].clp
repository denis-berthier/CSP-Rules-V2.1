...
(defrule activate-OR3-forcing-gwhip[20]
   (declare (salience ?*activate-OR3-forcing-gwhip[20]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW20))
   (assert (technique ?cont OR3-forcing-gwhip[20]))
   (assert (technique ?cont partial-whip[19]))
   (assert (technique ?cont partial-gwhip[19]))
   (bind ?*technique* OR3FgW[20])
)



(defrule track-OR3-forcing-gwhip[20]
   (declare (salience ?*activate-OR3-forcing-gwhip[20]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[20])
=>
...
(defrule OR3-forcing-gwhip[20]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[20]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[20])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L20* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-20*) then
...
(defrule OR3-forcing-gwhip[20]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[20]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[20])
...
(defrule OR3-forcing-gwhip[20]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[20]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[20])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[20]-value
   (declare (salience ?*OR3-forcing-gwhip[20]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[20])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
