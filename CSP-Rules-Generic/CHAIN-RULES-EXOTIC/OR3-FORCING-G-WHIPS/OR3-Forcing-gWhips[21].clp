...
(defrule activate-OR3-forcing-gwhip[21]
   (declare (salience ?*activate-OR3-forcing-gwhip[21]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW21))
   (assert (technique ?cont OR3-forcing-gwhip[21]))
   (assert (technique ?cont partial-whip[20]))
   (assert (technique ?cont partial-gwhip[20]))
   (bind ?*technique* OR3FgW[21])
)



(defrule track-OR3-forcing-gwhip[21]
   (declare (salience ?*activate-OR3-forcing-gwhip[21]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[21])
=>
...
(defrule OR3-forcing-gwhip[21]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[21]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[21])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L21* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-21*) then
...
(defrule OR3-forcing-gwhip[21]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[21]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[21])
...
(defrule OR3-forcing-gwhip[21]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[21]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[21])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[21]-value
   (declare (salience ?*OR3-forcing-gwhip[21]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[21])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
