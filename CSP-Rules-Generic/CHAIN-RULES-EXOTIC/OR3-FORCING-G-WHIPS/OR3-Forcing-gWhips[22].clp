...
(defrule activate-OR3-forcing-gwhip[22]
   (declare (salience ?*activate-OR3-forcing-gwhip[22]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR3-forcing-gwhip[22]))
   (assert (technique ?cont partial-whip[21]))
   (assert (technique ?cont partial-gwhip[21]))
   (bind ?*technique* OR3FgW[22])
)



(defrule track-OR3-forcing-gwhip[22]
   (declare (salience ?*activate-OR3-forcing-gwhip[22]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[22])
=>
...
(defrule OR3-forcing-gwhip[22]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[22]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[22])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L22* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-22*) then
...
(defrule OR3-forcing-gwhip[22]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[22]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[22])
...
(defrule OR3-forcing-gwhip[22]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[22]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[22])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[22]-value
   (declare (salience ?*OR3-forcing-gwhip[22]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[22])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
