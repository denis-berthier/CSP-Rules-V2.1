...
(defrule activate-OR3-forcing-gwhip[23]
   (declare (salience ?*activate-OR3-forcing-gwhip[23]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW23))
   (assert (technique ?cont OR3-forcing-gwhip[23]))
   (assert (technique ?cont partial-whip[22]))
   (assert (technique ?cont partial-gwhip[22]))
   (bind ?*technique* OR3FgW[23])
)



(defrule track-OR3-forcing-gwhip[23]
   (declare (salience ?*activate-OR3-forcing-gwhip[23]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[23])
=>
...
(defrule OR3-forcing-gwhip[23]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[23]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[23])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L23* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-23*) then
...
(defrule OR3-forcing-gwhip[23]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[23]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[23])
...
(defrule OR3-forcing-gwhip[23]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[23]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[23])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[23]-value
   (declare (salience ?*OR3-forcing-gwhip[23]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[23])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
