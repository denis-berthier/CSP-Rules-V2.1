...
(defrule activate-OR3-forcing-gwhip[24]
   (declare (salience ?*activate-OR3-forcing-gwhip[24]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW24))
   (assert (technique ?cont OR3-forcing-gwhip[24]))
   (assert (technique ?cont partial-whip[23]))
   (assert (technique ?cont partial-gwhip[23]))
   (bind ?*technique* OR3FgW[24])
)



(defrule track-OR3-forcing-gwhip[24]
   (declare (salience ?*activate-OR3-forcing-gwhip[24]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[24])
=>
...
(defrule OR3-forcing-gwhip[24]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[24])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L24* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-24*) then
...
(defrule OR3-forcing-gwhip[24]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[24])
...
(defrule OR3-forcing-gwhip[24]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[24])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[24]-value
   (declare (salience ?*OR3-forcing-gwhip[24]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[24])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
