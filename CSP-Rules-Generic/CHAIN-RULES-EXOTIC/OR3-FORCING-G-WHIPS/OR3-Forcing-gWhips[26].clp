...
(defrule activate-OR3-forcing-gwhip[26]
   (declare (salience ?*activate-OR3-forcing-gwhip[26]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW26))
   (assert (technique ?cont OR3-forcing-gwhip[26]))
   (assert (technique ?cont partial-whip[25]))
   (assert (technique ?cont partial-gwhip[25]))
   (bind ?*technique* OR3FgW[26])
)



(defrule track-OR3-forcing-gwhip[26]
   (declare (salience ?*activate-OR3-forcing-gwhip[26]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[26])
=>
...
(defrule OR3-forcing-gwhip[26]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[26]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[26])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L26* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-26*) then
...
(defrule OR3-forcing-gwhip[26]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[26]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[26])
...
(defrule OR3-forcing-gwhip[26]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[26]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[26])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[26]-value
   (declare (salience ?*OR3-forcing-gwhip[26]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[26])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
