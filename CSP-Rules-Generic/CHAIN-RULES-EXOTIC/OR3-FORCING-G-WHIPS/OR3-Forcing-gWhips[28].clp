...
(defrule activate-OR3-forcing-gwhip[28]
   (declare (salience ?*activate-OR3-forcing-gwhip[28]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW28))
   (assert (technique ?cont OR3-forcing-gwhip[28]))
   (assert (technique ?cont partial-whip[27]))
   (assert (technique ?cont partial-gwhip[27]))
   (bind ?*technique* OR3FgW[28])
)



(defrule track-OR3-forcing-gwhip[28]
   (declare (salience ?*activate-OR3-forcing-gwhip[28]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[28])
=>
...
(defrule OR3-forcing-gwhip[28]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[28]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[28])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L28* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-28*) then
...
(defrule OR3-forcing-gwhip[28]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[28]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[28])
...
(defrule OR3-forcing-gwhip[28]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[28]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[28])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[28]-value
   (declare (salience ?*OR3-forcing-gwhip[28]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[28])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
