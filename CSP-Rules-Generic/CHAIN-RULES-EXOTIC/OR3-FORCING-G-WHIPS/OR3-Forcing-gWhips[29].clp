...
(defrule activate-OR3-forcing-gwhip[29]
   (declare (salience ?*activate-OR3-forcing-gwhip[29]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW29))
   (assert (technique ?cont OR3-forcing-gwhip[29]))
   (assert (technique ?cont partial-whip[28]))
   (assert (technique ?cont partial-gwhip[28]))
   (bind ?*technique* OR3FgW[29])
)



(defrule track-OR3-forcing-gwhip[29]
   (declare (salience ?*activate-OR3-forcing-gwhip[29]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[29])
=>
...
(defrule OR3-forcing-gwhip[29]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[29]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[29])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L29* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-29*) then
...
(defrule OR3-forcing-gwhip[29]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[29]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[29])
...
(defrule OR3-forcing-gwhip[29]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[29]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[29])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[29]-value
   (declare (salience ?*OR3-forcing-gwhip[29]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[29])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
