...
(defrule activate-OR3-forcing-gwhip[31]
   (declare (salience ?*activate-OR3-forcing-gwhip[31]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW31))
   (assert (technique ?cont OR3-forcing-gwhip[31]))
   (assert (technique ?cont partial-whip[30]))
   (assert (technique ?cont partial-gwhip[30]))
   (bind ?*technique* OR3FgW[31])
)



(defrule track-OR3-forcing-gwhip[31]
   (declare (salience ?*activate-OR3-forcing-gwhip[31]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[31])
=>
...
(defrule OR3-forcing-gwhip[31]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[31]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[31])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L31* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-31*) then
...
(defrule OR3-forcing-gwhip[31]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[31]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[31])
...
(defrule OR3-forcing-gwhip[31]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[31]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[31])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[31]-value
   (declare (salience ?*OR3-forcing-gwhip[31]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[31])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
