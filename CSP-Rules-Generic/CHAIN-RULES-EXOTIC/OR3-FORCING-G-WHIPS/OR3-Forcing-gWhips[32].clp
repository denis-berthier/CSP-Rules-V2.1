...
(defrule activate-OR3-forcing-gwhip[32]
   (declare (salience ?*activate-OR3-forcing-gwhip[32]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW32))
   (assert (technique ?cont OR3-forcing-gwhip[32]))
   (assert (technique ?cont partial-whip[31]))
   (assert (technique ?cont partial-gwhip[31]))
   (bind ?*technique* OR3FgW[32])
)



(defrule track-OR3-forcing-gwhip[32]
   (declare (salience ?*activate-OR3-forcing-gwhip[32]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[32])
=>
...
(defrule OR3-forcing-gwhip[32]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[32]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[32])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L32* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-32*) then
...
(defrule OR3-forcing-gwhip[32]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[32]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[32])
...
(defrule OR3-forcing-gwhip[32]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[32]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[32])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[32]-value
   (declare (salience ?*OR3-forcing-gwhip[32]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[32])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
