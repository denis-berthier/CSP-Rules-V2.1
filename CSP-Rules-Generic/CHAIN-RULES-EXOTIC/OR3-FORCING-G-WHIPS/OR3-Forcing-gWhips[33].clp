...
(defrule activate-OR3-forcing-gwhip[33]
   (declare (salience ?*activate-OR3-forcing-gwhip[33]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW33))
   (assert (technique ?cont OR3-forcing-gwhip[33]))
   (assert (technique ?cont partial-whip[32]))
   (assert (technique ?cont partial-gwhip[32]))
   (bind ?*technique* OR3FgW[33])
)



(defrule track-OR3-forcing-gwhip[33]
   (declare (salience ?*activate-OR3-forcing-gwhip[33]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[33])
=>
...
(defrule OR3-forcing-gwhip[33]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[33]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[33])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L33* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-33*) then
...
(defrule OR3-forcing-gwhip[33]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[33]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[33])
...
(defrule OR3-forcing-gwhip[33]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[33]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[33])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[33]-value
   (declare (salience ?*OR3-forcing-gwhip[33]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[33])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
