...
(defrule activate-OR3-forcing-gwhip[35]
   (declare (salience ?*activate-OR3-forcing-gwhip[35]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW35))
   (assert (technique ?cont OR3-forcing-gwhip[35]))
   (assert (technique ?cont partial-whip[34]))
   (assert (technique ?cont partial-gwhip[34]))
   (bind ?*technique* OR3FgW[35])
)



(defrule track-OR3-forcing-gwhip[35]
   (declare (salience ?*activate-OR3-forcing-gwhip[35]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[35])
=>
...
(defrule OR3-forcing-gwhip[35]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[35]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[35])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L35* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-35*) then
...
(defrule OR3-forcing-gwhip[35]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[35]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[35])
...
(defrule OR3-forcing-gwhip[35]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[35]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[35])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[35]-value
   (declare (salience ?*OR3-forcing-gwhip[35]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[35])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
