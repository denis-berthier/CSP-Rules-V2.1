...
(defrule activate-OR3-forcing-gwhip[36]
   (declare (salience ?*activate-OR3-forcing-gwhip[36]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW36))
   (assert (technique ?cont OR3-forcing-gwhip[36]))
   (assert (technique ?cont partial-whip[35]))
   (assert (technique ?cont partial-gwhip[35]))
   (bind ?*technique* OR3FgW[36])
)



(defrule track-OR3-forcing-gwhip[36]
   (declare (salience ?*activate-OR3-forcing-gwhip[36]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[36])
=>
...
(defrule OR3-forcing-gwhip[36]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[36])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L36* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-36*) then
...
(defrule OR3-forcing-gwhip[36]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[36])
...
(defrule OR3-forcing-gwhip[36]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[36])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[36]-value
   (declare (salience ?*OR3-forcing-gwhip[36]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[36])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
