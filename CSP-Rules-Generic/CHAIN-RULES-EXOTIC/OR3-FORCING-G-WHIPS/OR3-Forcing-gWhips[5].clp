...
(defrule activate-OR3-forcing-gwhip[5]
   (declare (salience ?*activate-OR3-forcing-gwhip[5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW5))
   (assert (technique ?cont OR3-forcing-gwhip[5]))
   (assert (technique ?cont partial-whip[4]))
   (assert (technique ?cont partial-gwhip[4]))
   (bind ?*technique* OR3FgW[5])
)



(defrule track-OR3-forcing-gwhip[5]
   (declare (salience ?*activate-OR3-forcing-gwhip[5]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[5])
=>
...
(defrule OR3-forcing-gwhip[5]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[5]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[5])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L5* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-5*) then
...
(defrule OR3-forcing-gwhip[5]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[5]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[5])
...
(defrule OR3-forcing-gwhip[5]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[5]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[5])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[5]-value
   (declare (salience ?*OR3-forcing-gwhip[5]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[5])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
