...
(defrule activate-OR3-forcing-gwhip[6]
   (declare (salience ?*activate-OR3-forcing-gwhip[6]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW6))
   (assert (technique ?cont OR3-forcing-gwhip[6]))
   (assert (technique ?cont partial-whip[5]))
   (assert (technique ?cont partial-gwhip[5]))
   (bind ?*technique* OR3FgW[6])
)



(defrule track-OR3-forcing-gwhip[6]
   (declare (salience ?*activate-OR3-forcing-gwhip[6]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[6])
=>
...
(defrule OR3-forcing-gwhip[6]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[6])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L6* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-6*) then
...
(defrule OR3-forcing-gwhip[6]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[6])
...
(defrule OR3-forcing-gwhip[6]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[6])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[6]-value
   (declare (salience ?*OR3-forcing-gwhip[6]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[6])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
