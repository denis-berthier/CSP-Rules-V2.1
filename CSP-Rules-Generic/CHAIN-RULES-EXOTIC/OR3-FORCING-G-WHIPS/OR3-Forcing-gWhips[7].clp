...
(defrule activate-OR3-forcing-gwhip[7]
   (declare (salience ?*activate-OR3-forcing-gwhip[7]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW7))
   (assert (technique ?cont OR3-forcing-gwhip[7]))
   (assert (technique ?cont partial-whip[6]))
   (assert (technique ?cont partial-gwhip[6]))
   (bind ?*technique* OR3FgW[7])
)



(defrule track-OR3-forcing-gwhip[7]
   (declare (salience ?*activate-OR3-forcing-gwhip[7]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[7])
=>
...
(defrule OR3-forcing-gwhip[7]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[7]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[7])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L7* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-7*) then
...
(defrule OR3-forcing-gwhip[7]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[7]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[7])
...
(defrule OR3-forcing-gwhip[7]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[7]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[7])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[7]-value
   (declare (salience ?*OR3-forcing-gwhip[7]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[7])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
