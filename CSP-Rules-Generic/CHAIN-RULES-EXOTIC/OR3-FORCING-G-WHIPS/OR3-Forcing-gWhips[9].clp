...
(defrule activate-OR3-forcing-gwhip[9]
   (declare (salience ?*activate-OR3-forcing-gwhip[9]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3FW9))
   (assert (technique ?cont OR3-forcing-gwhip[9]))
   (assert (technique ?cont partial-whip[8]))
   (assert (technique ?cont partial-gwhip[8]))
   (bind ?*technique* OR3FgW[9])
)



(defrule track-OR3-forcing-gwhip[9]
   (declare (salience ?*activate-OR3-forcing-gwhip[9]-salience*))
   ?level <- (technique ?cont OR3-forcing-gwhip[9])
=>
...
(defrule OR3-forcing-gwhip[9]-candidate-00p
   (declare (salience ?*OR3-forcing-gwhip[9]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[9])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L9* ?*print-OR3-forcing-gwhip* ?*print-OR3-forcing-gwhip-9*) then
...
(defrule OR3-forcing-gwhip[9]-candidate-0pq
   (declare (salience ?*OR3-forcing-gwhip[9]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[9])
...
(defrule OR3-forcing-gwhip[9]-candidate-pqr
   (declare (salience ?*OR3-forcing-gwhip[9]-candidate-salience*))
   (technique ?cont OR3-forcing-gwhip[9])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-gwhip[9]-value
   (declare (salience ?*OR3-forcing-gwhip[9]-value-salience*))
   (technique ?cont OR3-forcing-gwhip[9])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
