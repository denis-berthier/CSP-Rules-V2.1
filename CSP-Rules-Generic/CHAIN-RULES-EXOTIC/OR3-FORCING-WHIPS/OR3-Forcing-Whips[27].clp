...
(defrule activate-OR3-forcing-whip[27]
   (declare (salience ?*activate-OR3-forcing-whip[27]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR3-forcing-whip[27]))
   (assert (technique ?cont partial-whip[26]))
   (bind ?*technique* OR3FW[27])
)



(defrule track-OR3-forcing-whip[27]
   (declare (salience ?*activate-OR3-forcing-whip[27]-salience*))
   ?level <- (technique ?cont OR3-forcing-whip[27])
=>
...
(defrule OR3-forcing-whip[27]-candidate-00p
   (declare (salience ?*OR3-forcing-whip[27]-candidate-salience*))
   (technique ?cont OR3-forcing-whip[27])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L27* ?*print-OR3-forcing-whip* ?*print-OR3-forcing-whip-27*) then
...
(defrule OR3-forcing-whip[27]-candidate-0pq
   (declare (salience ?*OR3-forcing-whip[27]-candidate-salience*))
   (technique ?cont OR3-forcing-whip[27])
...
(defrule OR3-forcing-whip[27]-candidate-pqr
   (declare (salience ?*OR3-forcing-whip[27]-candidate-salience*))
   (technique ?cont OR3-forcing-whip[27])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-whip[27]-value
   (declare (salience ?*OR3-forcing-whip[27]-value-salience*))
   (technique ?cont OR3-forcing-whip[27])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type partial-whip)
