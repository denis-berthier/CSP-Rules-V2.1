...
(defrule activate-OR3-forcing-whip[7]
   (declare (salience ?*activate-OR3-forcing-whip[7]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR3-forcing-whip[7]))
   (assert (technique ?cont partial-whip[6]))
   (bind ?*technique* OR3FW[7])
)



(defrule track-OR3-forcing-whip[7]
   (declare (salience ?*activate-OR3-forcing-whip[7]-salience*))
   ?level <- (technique ?cont OR3-forcing-whip[7])
=>
...
(defrule OR3-forcing-whip[7]-candidate-00p
   (declare (salience ?*OR3-forcing-whip[7]-candidate-salience*))
   (technique ?cont OR3-forcing-whip[7])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L7* ?*print-OR3-forcing-whip* ?*print-OR3-forcing-whip-7*) then
...
(defrule OR3-forcing-whip[7]-candidate-0pq
   (declare (salience ?*OR3-forcing-whip[7]-candidate-salience*))
   (technique ?cont OR3-forcing-whip[7])
...
(defrule OR3-forcing-whip[7]-candidate-pqr
   (declare (salience ?*OR3-forcing-whip[7]-candidate-salience*))
   (technique ?cont OR3-forcing-whip[7])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
...
(defrule OR3-forcing-whip[7]-value
   (declare (salience ?*OR3-forcing-whip[7]-value-salience*))
   (technique ?cont OR3-forcing-whip[7])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 3) (OR-candidates ?zzz1 ?zzz2 ?zzz3))
   (chain
      (type partial-whip)
