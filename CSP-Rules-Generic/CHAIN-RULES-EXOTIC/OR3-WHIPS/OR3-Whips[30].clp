...
(defrule activate-OR3-whip[30]
   (declare (salience ?*activate-OR3-whip[30]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR3W30))
   (assert (technique ?cont OR3-whip[30]))
   (assert (technique ?cont partial-whip[29]))
   (assert (technique ?cont partial-OR3-whip[29]))
   (bind ?*technique* OR3W[30])
)



(defrule track-OR3-whip[30]
   (declare (salience ?*activate-OR3-whip[30]-salience*))
   ?level <- (technique ?cont OR3-whip[30])
=>
...
(defrule OR3-whip[30]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR3-whip[30]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L30* ?*print-OR3-whip* ?*print-OR3-whip-30*) then
...
(defrule OR3-whip[30]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR3-whip[30]-salience-2*))
   (ORk-chain
      (type partial-OR3-whip)
      (context ?cont)
      (length 29)
