...
(defrule activate-OR4-contrad-gwhip[10]
   (declare (salience ?*activate-OR4-contrad-gwhip[10]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW10))
   (assert (technique ?cont OR4-contrad-gwhip[10]))
   (assert (technique ?cont partial-whip[9]))
   (assert (technique ?cont partial-gwhip[9]))
   (bind ?*technique* OR4CgW[10])
)



(defrule track-OR4-contrad-gwhip[10]
   (declare (salience ?*activate-OR4-contrad-gwhip[10]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[10])
=>
...
(defrule OR4-contrad-gwhip[10]
   (declare (salience ?*OR4-contrad-gwhip[10]-salience*))
   (technique ?cont OR4-contrad-gwhip[10])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L10* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-10*) then
