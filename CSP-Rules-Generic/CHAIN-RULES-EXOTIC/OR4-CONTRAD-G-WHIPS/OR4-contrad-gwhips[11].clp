...
(defrule activate-OR4-contrad-gwhip[11]
   (declare (salience ?*activate-OR4-contrad-gwhip[11]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW11))
   (assert (technique ?cont OR4-contrad-gwhip[11]))
   (assert (technique ?cont partial-whip[10]))
   (assert (technique ?cont partial-gwhip[10]))
   (bind ?*technique* OR4CgW[11])
)



(defrule track-OR4-contrad-gwhip[11]
   (declare (salience ?*activate-OR4-contrad-gwhip[11]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[11])
=>
...
(defrule OR4-contrad-gwhip[11]
   (declare (salience ?*OR4-contrad-gwhip[11]-salience*))
   (technique ?cont OR4-contrad-gwhip[11])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L11* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-11*) then
