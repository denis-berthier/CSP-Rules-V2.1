...
(defrule activate-OR4-contrad-gwhip[12]
   (declare (salience ?*activate-OR4-contrad-gwhip[12]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW12))
   (assert (technique ?cont OR4-contrad-gwhip[12]))
   (assert (technique ?cont partial-whip[11]))
   (assert (technique ?cont partial-gwhip[11]))
   (bind ?*technique* OR4CgW[12])
)



(defrule track-OR4-contrad-gwhip[12]
   (declare (salience ?*activate-OR4-contrad-gwhip[12]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[12])
=>
...
(defrule OR4-contrad-gwhip[12]
   (declare (salience ?*OR4-contrad-gwhip[12]-salience*))
   (technique ?cont OR4-contrad-gwhip[12])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L12* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-12*) then
