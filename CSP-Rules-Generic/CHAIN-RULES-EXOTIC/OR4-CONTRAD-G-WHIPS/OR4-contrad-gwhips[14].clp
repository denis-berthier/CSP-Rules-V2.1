...
(defrule activate-OR4-contrad-gwhip[14]
   (declare (salience ?*activate-OR4-contrad-gwhip[14]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW14))
   (assert (technique ?cont OR4-contrad-gwhip[14]))
   (assert (technique ?cont partial-whip[13]))
   (assert (technique ?cont partial-gwhip[13]))
   (bind ?*technique* OR4CgW[14])
)



(defrule track-OR4-contrad-gwhip[14]
   (declare (salience ?*activate-OR4-contrad-gwhip[14]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[14])
=>
...
(defrule OR4-contrad-gwhip[14]
   (declare (salience ?*OR4-contrad-gwhip[14]-salience*))
   (technique ?cont OR4-contrad-gwhip[14])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L14* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-14*) then
