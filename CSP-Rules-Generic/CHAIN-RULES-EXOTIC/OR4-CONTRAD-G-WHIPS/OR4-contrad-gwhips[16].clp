...
(defrule activate-OR4-contrad-gwhip[16]
   (declare (salience ?*activate-OR4-contrad-gwhip[16]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW16))
   (assert (technique ?cont OR4-contrad-gwhip[16]))
   (assert (technique ?cont partial-whip[15]))
   (assert (technique ?cont partial-gwhip[15]))
   (bind ?*technique* OR4CgW[16])
)



(defrule track-OR4-contrad-gwhip[16]
   (declare (salience ?*activate-OR4-contrad-gwhip[16]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[16])
=>
...
(defrule OR4-contrad-gwhip[16]
   (declare (salience ?*OR4-contrad-gwhip[16]-salience*))
   (technique ?cont OR4-contrad-gwhip[16])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L16* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-16*) then
