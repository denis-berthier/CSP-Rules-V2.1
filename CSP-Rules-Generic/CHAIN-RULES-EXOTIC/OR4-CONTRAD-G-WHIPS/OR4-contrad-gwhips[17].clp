...
(defrule activate-OR4-contrad-gwhip[17]
   (declare (salience ?*activate-OR4-contrad-gwhip[17]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW17))
   (assert (technique ?cont OR4-contrad-gwhip[17]))
   (assert (technique ?cont partial-whip[16]))
   (assert (technique ?cont partial-gwhip[16]))
   (bind ?*technique* OR4CgW[17])
)



(defrule track-OR4-contrad-gwhip[17]
   (declare (salience ?*activate-OR4-contrad-gwhip[17]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[17])
=>
...
(defrule OR4-contrad-gwhip[17]
   (declare (salience ?*OR4-contrad-gwhip[17]-salience*))
   (technique ?cont OR4-contrad-gwhip[17])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L17* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-17*) then
