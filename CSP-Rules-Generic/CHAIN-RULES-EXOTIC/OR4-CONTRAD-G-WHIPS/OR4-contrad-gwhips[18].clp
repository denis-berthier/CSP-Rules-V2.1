...
(defrule activate-OR4-contrad-gwhip[18]
   (declare (salience ?*activate-OR4-contrad-gwhip[18]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW18))
   (assert (technique ?cont OR4-contrad-gwhip[18]))
   (assert (technique ?cont partial-whip[17]))
   (assert (technique ?cont partial-gwhip[17]))
   (bind ?*technique* OR4CgW[18])
)



(defrule track-OR4-contrad-gwhip[18]
   (declare (salience ?*activate-OR4-contrad-gwhip[18]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[18])
=>
...
(defrule OR4-contrad-gwhip[18]
   (declare (salience ?*OR4-contrad-gwhip[18]-salience*))
   (technique ?cont OR4-contrad-gwhip[18])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L18* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-18*) then
