...
(defrule activate-OR4-contrad-gwhip[19]
   (declare (salience ?*activate-OR4-contrad-gwhip[19]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW19))
   (assert (technique ?cont OR4-contrad-gwhip[19]))
   (assert (technique ?cont partial-whip[18]))
   (assert (technique ?cont partial-gwhip[18]))
   (bind ?*technique* OR4CgW[19])
)



(defrule track-OR4-contrad-gwhip[19]
   (declare (salience ?*activate-OR4-contrad-gwhip[19]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[19])
=>
...
(defrule OR4-contrad-gwhip[19]
   (declare (salience ?*OR4-contrad-gwhip[19]-salience*))
   (technique ?cont OR4-contrad-gwhip[19])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L19* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-19*) then
