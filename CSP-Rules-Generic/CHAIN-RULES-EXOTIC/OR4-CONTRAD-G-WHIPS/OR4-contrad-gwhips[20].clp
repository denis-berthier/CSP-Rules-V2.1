...
(defrule activate-OR4-contrad-gwhip[20]
   (declare (salience ?*activate-OR4-contrad-gwhip[20]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW20))
   (assert (technique ?cont OR4-contrad-gwhip[20]))
   (assert (technique ?cont partial-whip[19]))
   (assert (technique ?cont partial-gwhip[19]))
   (bind ?*technique* OR4CgW[20])
)



(defrule track-OR4-contrad-gwhip[20]
   (declare (salience ?*activate-OR4-contrad-gwhip[20]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[20])
=>
...
(defrule OR4-contrad-gwhip[20]
   (declare (salience ?*OR4-contrad-gwhip[20]-salience*))
   (technique ?cont OR4-contrad-gwhip[20])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L20* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-20*) then
