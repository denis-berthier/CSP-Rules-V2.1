...
(defrule activate-OR4-contrad-gwhip[21]
   (declare (salience ?*activate-OR4-contrad-gwhip[21]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW21))
   (assert (technique ?cont OR4-contrad-gwhip[21]))
   (assert (technique ?cont partial-whip[20]))
   (assert (technique ?cont partial-gwhip[20]))
   (bind ?*technique* OR4CgW[21])
)



(defrule track-OR4-contrad-gwhip[21]
   (declare (salience ?*activate-OR4-contrad-gwhip[21]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[21])
=>
...
(defrule OR4-contrad-gwhip[21]
   (declare (salience ?*OR4-contrad-gwhip[21]-salience*))
   (technique ?cont OR4-contrad-gwhip[21])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L21* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-21*) then
