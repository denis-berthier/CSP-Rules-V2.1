...
(defrule activate-OR4-contrad-gwhip[22]
   (declare (salience ?*activate-OR4-contrad-gwhip[22]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW22))
   (assert (technique ?cont OR4-contrad-gwhip[22]))
   (assert (technique ?cont partial-whip[21]))
   (assert (technique ?cont partial-gwhip[21]))
   (bind ?*technique* OR4CgW[22])
)



(defrule track-OR4-contrad-gwhip[22]
   (declare (salience ?*activate-OR4-contrad-gwhip[22]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[22])
=>
...
(defrule OR4-contrad-gwhip[22]
   (declare (salience ?*OR4-contrad-gwhip[22]-salience*))
   (technique ?cont OR4-contrad-gwhip[22])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L22* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-22*) then
