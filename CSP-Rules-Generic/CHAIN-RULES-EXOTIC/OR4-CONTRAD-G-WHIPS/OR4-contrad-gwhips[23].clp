...
(defrule activate-OR4-contrad-gwhip[23]
   (declare (salience ?*activate-OR4-contrad-gwhip[23]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW23))
   (assert (technique ?cont OR4-contrad-gwhip[23]))
   (assert (technique ?cont partial-whip[22]))
   (assert (technique ?cont partial-gwhip[22]))
   (bind ?*technique* OR4CgW[23])
)



(defrule track-OR4-contrad-gwhip[23]
   (declare (salience ?*activate-OR4-contrad-gwhip[23]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[23])
=>
...
(defrule OR4-contrad-gwhip[23]
   (declare (salience ?*OR4-contrad-gwhip[23]-salience*))
   (technique ?cont OR4-contrad-gwhip[23])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L23* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-23*) then
