...
(defrule activate-OR4-contrad-gwhip[24]
   (declare (salience ?*activate-OR4-contrad-gwhip[24]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW24))
   (assert (technique ?cont OR4-contrad-gwhip[24]))
   (assert (technique ?cont partial-whip[23]))
   (assert (technique ?cont partial-gwhip[23]))
   (bind ?*technique* OR4CgW[24])
)



(defrule track-OR4-contrad-gwhip[24]
   (declare (salience ?*activate-OR4-contrad-gwhip[24]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[24])
=>
...
(defrule OR4-contrad-gwhip[24]
   (declare (salience ?*OR4-contrad-gwhip[24]-salience*))
   (technique ?cont OR4-contrad-gwhip[24])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L24* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-24*) then
