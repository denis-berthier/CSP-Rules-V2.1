...
(defrule activate-OR4-contrad-gwhip[25]
   (declare (salience ?*activate-OR4-contrad-gwhip[25]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW25))
   (assert (technique ?cont OR4-contrad-gwhip[25]))
   (assert (technique ?cont partial-whip[24]))
   (assert (technique ?cont partial-gwhip[24]))
   (bind ?*technique* OR4CgW[25])
)



(defrule track-OR4-contrad-gwhip[25]
   (declare (salience ?*activate-OR4-contrad-gwhip[25]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[25])
=>
...
(defrule OR4-contrad-gwhip[25]
   (declare (salience ?*OR4-contrad-gwhip[25]-salience*))
   (technique ?cont OR4-contrad-gwhip[25])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L25* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-25*) then
