...
(defrule activate-OR4-contrad-gwhip[26]
   (declare (salience ?*activate-OR4-contrad-gwhip[26]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW26))
   (assert (technique ?cont OR4-contrad-gwhip[26]))
   (assert (technique ?cont partial-whip[25]))
   (assert (technique ?cont partial-gwhip[25]))
   (bind ?*technique* OR4CgW[26])
)



(defrule track-OR4-contrad-gwhip[26]
   (declare (salience ?*activate-OR4-contrad-gwhip[26]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[26])
=>
...
(defrule OR4-contrad-gwhip[26]
   (declare (salience ?*OR4-contrad-gwhip[26]-salience*))
   (technique ?cont OR4-contrad-gwhip[26])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L26* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-26*) then
