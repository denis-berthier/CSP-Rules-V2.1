...
(defrule activate-OR4-contrad-gwhip[29]
   (declare (salience ?*activate-OR4-contrad-gwhip[29]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW29))
   (assert (technique ?cont OR4-contrad-gwhip[29]))
   (assert (technique ?cont partial-whip[28]))
   (assert (technique ?cont partial-gwhip[28]))
   (bind ?*technique* OR4CgW[29])
)



(defrule track-OR4-contrad-gwhip[29]
   (declare (salience ?*activate-OR4-contrad-gwhip[29]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[29])
=>
...
(defrule OR4-contrad-gwhip[29]
   (declare (salience ?*OR4-contrad-gwhip[29]-salience*))
   (technique ?cont OR4-contrad-gwhip[29])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L29* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-29*) then
