...
(defrule activate-OR4-contrad-gwhip[2]
   (declare (salience ?*activate-OR4-contrad-gwhip[2]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW2))
   (assert (technique ?cont OR4-contrad-gwhip[2]))
   (assert (technique ?cont partial-whip[1]))
   (assert (technique ?cont partial-gwhip[1]))
   (bind ?*technique* OR4CgW[2])
)



(defrule track-OR4-contrad-gwhip[2]
   (declare (salience ?*activate-OR4-contrad-gwhip[2]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[2])
=>
...
(defrule OR4-contrad-gwhip[2]
   (declare (salience ?*OR4-contrad-gwhip[2]-salience*))
   (technique ?cont OR4-contrad-gwhip[2])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L2* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-2*) then
