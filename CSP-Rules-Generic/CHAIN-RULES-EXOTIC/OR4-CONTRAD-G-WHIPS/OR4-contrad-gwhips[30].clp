...
(defrule activate-OR4-contrad-gwhip[30]
   (declare (salience ?*activate-OR4-contrad-gwhip[30]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW30))
   (assert (technique ?cont OR4-contrad-gwhip[30]))
   (assert (technique ?cont partial-whip[29]))
   (assert (technique ?cont partial-gwhip[29]))
   (bind ?*technique* OR4CgW[30])
)



(defrule track-OR4-contrad-gwhip[30]
   (declare (salience ?*activate-OR4-contrad-gwhip[30]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[30])
=>
...
(defrule OR4-contrad-gwhip[30]
   (declare (salience ?*OR4-contrad-gwhip[30]-salience*))
   (technique ?cont OR4-contrad-gwhip[30])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L30* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-30*) then
