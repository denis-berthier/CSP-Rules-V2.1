...
(defrule activate-OR4-contrad-gwhip[31]
   (declare (salience ?*activate-OR4-contrad-gwhip[31]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW31))
   (assert (technique ?cont OR4-contrad-gwhip[31]))
   (assert (technique ?cont partial-whip[30]))
   (assert (technique ?cont partial-gwhip[30]))
   (bind ?*technique* OR4CgW[31])
)



(defrule track-OR4-contrad-gwhip[31]
   (declare (salience ?*activate-OR4-contrad-gwhip[31]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[31])
=>
...
(defrule OR4-contrad-gwhip[31]
   (declare (salience ?*OR4-contrad-gwhip[31]-salience*))
   (technique ?cont OR4-contrad-gwhip[31])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L31* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-31*) then
