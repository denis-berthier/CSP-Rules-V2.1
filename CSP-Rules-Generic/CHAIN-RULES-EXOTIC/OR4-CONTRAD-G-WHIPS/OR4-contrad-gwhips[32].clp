...
(defrule activate-OR4-contrad-gwhip[32]
   (declare (salience ?*activate-OR4-contrad-gwhip[32]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW32))
   (assert (technique ?cont OR4-contrad-gwhip[32]))
   (assert (technique ?cont partial-whip[31]))
   (assert (technique ?cont partial-gwhip[31]))
   (bind ?*technique* OR4CgW[32])
)



(defrule track-OR4-contrad-gwhip[32]
   (declare (salience ?*activate-OR4-contrad-gwhip[32]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[32])
=>
...
(defrule OR4-contrad-gwhip[32]
   (declare (salience ?*OR4-contrad-gwhip[32]-salience*))
   (technique ?cont OR4-contrad-gwhip[32])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L32* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-32*) then
