...
(defrule activate-OR4-contrad-gwhip[33]
   (declare (salience ?*activate-OR4-contrad-gwhip[33]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW33))
   (assert (technique ?cont OR4-contrad-gwhip[33]))
   (assert (technique ?cont partial-whip[32]))
   (assert (technique ?cont partial-gwhip[32]))
   (bind ?*technique* OR4CgW[33])
)



(defrule track-OR4-contrad-gwhip[33]
   (declare (salience ?*activate-OR4-contrad-gwhip[33]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[33])
=>
...
(defrule OR4-contrad-gwhip[33]
   (declare (salience ?*OR4-contrad-gwhip[33]-salience*))
   (technique ?cont OR4-contrad-gwhip[33])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L33* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-33*) then
