...
(defrule activate-OR4-contrad-gwhip[34]
   (declare (salience ?*activate-OR4-contrad-gwhip[34]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW34))
   (assert (technique ?cont OR4-contrad-gwhip[34]))
   (assert (technique ?cont partial-whip[33]))
   (assert (technique ?cont partial-gwhip[33]))
   (bind ?*technique* OR4CgW[34])
)



(defrule track-OR4-contrad-gwhip[34]
   (declare (salience ?*activate-OR4-contrad-gwhip[34]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[34])
=>
...
(defrule OR4-contrad-gwhip[34]
   (declare (salience ?*OR4-contrad-gwhip[34]-salience*))
   (technique ?cont OR4-contrad-gwhip[34])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L34* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-34*) then
