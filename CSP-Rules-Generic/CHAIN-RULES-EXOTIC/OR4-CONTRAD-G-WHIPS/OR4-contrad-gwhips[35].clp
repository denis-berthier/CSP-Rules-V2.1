...
(defrule activate-OR4-contrad-gwhip[35]
   (declare (salience ?*activate-OR4-contrad-gwhip[35]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW35))
   (assert (technique ?cont OR4-contrad-gwhip[35]))
   (assert (technique ?cont partial-whip[34]))
   (assert (technique ?cont partial-gwhip[34]))
   (bind ?*technique* OR4CgW[35])
)



(defrule track-OR4-contrad-gwhip[35]
   (declare (salience ?*activate-OR4-contrad-gwhip[35]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[35])
=>
...
(defrule OR4-contrad-gwhip[35]
   (declare (salience ?*OR4-contrad-gwhip[35]-salience*))
   (technique ?cont OR4-contrad-gwhip[35])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L35* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-35*) then
