...
(defrule activate-OR4-contrad-gwhip[36]
   (declare (salience ?*activate-OR4-contrad-gwhip[36]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW36))
   (assert (technique ?cont OR4-contrad-gwhip[36]))
   (assert (technique ?cont partial-whip[35]))
   (assert (technique ?cont partial-gwhip[35]))
   (bind ?*technique* OR4CgW[36])
)



(defrule track-OR4-contrad-gwhip[36]
   (declare (salience ?*activate-OR4-contrad-gwhip[36]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[36])
=>
...
(defrule OR4-contrad-gwhip[36]
   (declare (salience ?*OR4-contrad-gwhip[36]-salience*))
   (technique ?cont OR4-contrad-gwhip[36])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L36* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-36*) then
