...
(defrule activate-OR4-contrad-gwhip[3]
   (declare (salience ?*activate-OR4-contrad-gwhip[3]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW3))
   (assert (technique ?cont OR4-contrad-gwhip[3]))
   (assert (technique ?cont partial-whip[2]))
   (assert (technique ?cont partial-gwhip[2]))
   (bind ?*technique* OR4CgW[3])
)



(defrule track-OR4-contrad-gwhip[3]
   (declare (salience ?*activate-OR4-contrad-gwhip[3]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[3])
=>
...
(defrule OR4-contrad-gwhip[3]
   (declare (salience ?*OR4-contrad-gwhip[3]-salience*))
   (technique ?cont OR4-contrad-gwhip[3])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L3* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-3*) then
