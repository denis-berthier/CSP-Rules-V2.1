...
(defrule activate-OR4-contrad-gwhip[4]
   (declare (salience ?*activate-OR4-contrad-gwhip[4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW4))
   (assert (technique ?cont OR4-contrad-gwhip[4]))
   (assert (technique ?cont partial-whip[3]))
   (assert (technique ?cont partial-gwhip[3]))
   (bind ?*technique* OR4CgW[4])
)



(defrule track-OR4-contrad-gwhip[4]
   (declare (salience ?*activate-OR4-contrad-gwhip[4]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[4])
=>
...
(defrule OR4-contrad-gwhip[4]
   (declare (salience ?*OR4-contrad-gwhip[4]-salience*))
   (technique ?cont OR4-contrad-gwhip[4])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L4* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-4*) then
