...
(defrule activate-OR4-contrad-gwhip[6]
   (declare (salience ?*activate-OR4-contrad-gwhip[6]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW6))
   (assert (technique ?cont OR4-contrad-gwhip[6]))
   (assert (technique ?cont partial-whip[5]))
   (assert (technique ?cont partial-gwhip[5]))
   (bind ?*technique* OR4CgW[6])
)



(defrule track-OR4-contrad-gwhip[6]
   (declare (salience ?*activate-OR4-contrad-gwhip[6]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[6])
=>
...
(defrule OR4-contrad-gwhip[6]
   (declare (salience ?*OR4-contrad-gwhip[6]-salience*))
   (technique ?cont OR4-contrad-gwhip[6])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L6* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-6*) then
