...
(defrule activate-OR4-contrad-gwhip[9]
   (declare (salience ?*activate-OR4-contrad-gwhip[9]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CgW9))
   (assert (technique ?cont OR4-contrad-gwhip[9]))
   (assert (technique ?cont partial-whip[8]))
   (assert (technique ?cont partial-gwhip[8]))
   (bind ?*technique* OR4CgW[9])
)



(defrule track-OR4-contrad-gwhip[9]
   (declare (salience ?*activate-OR4-contrad-gwhip[9]-salience*))
   ?level <- (technique ?cont OR4-contrad-gwhip[9])
=>
...
(defrule OR4-contrad-gwhip[9]
   (declare (salience ?*OR4-contrad-gwhip[9]-salience*))
   (technique ?cont OR4-contrad-gwhip[9])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L9* ?*print-OR4-contrad-gwhip* ?*print-OR4-contrad-gwhip-9*) then
