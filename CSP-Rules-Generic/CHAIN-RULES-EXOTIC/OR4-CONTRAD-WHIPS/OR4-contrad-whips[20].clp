...
(defrule activate-OR4-contrad-whip[20]
   (declare (salience ?*activate-OR4-contrad-whip[20]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4CW20))
   (assert (technique ?cont OR4-contrad-whip[20]))
   (assert (technique ?cont partial-whip[19]))
   (bind ?*technique* OR4CW[20])
)



(defrule track-OR4-contrad-whip[20]
   (declare (salience ?*activate-OR4-contrad-whip[20]-salience*))
   ?level <- (technique ?cont OR4-contrad-whip[20])
=>
...
(defrule OR4-contrad-whip[20]
   (declare (salience ?*OR4-contrad-whip[20]-salience*))
   (technique ?cont OR4-contrad-whip[20])
