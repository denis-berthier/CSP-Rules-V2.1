...
(defrule activate-OR4-forcing-gwhip[10]
   (declare (salience ?*activate-OR4-forcing-gwhip[10]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW10))
   (assert (technique ?cont OR4-forcing-gwhip[10]))
   (assert (technique ?cont partial-whip[9]))
   (assert (technique ?cont partial-gwhip[9]))
   (bind ?*technique* OR4FgW[10])
)



(defrule track-OR4-forcing-gwhip[10]
   (declare (salience ?*activate-OR4-forcing-gwhip[10]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[10])
=>
...
(defrule OR4-forcing-gwhip[10]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[10]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[10])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L10* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-10*) then
...
(defrule OR4-forcing-gwhip[10]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[10]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[10])
...
(defrule OR4-forcing-gwhip[10]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[10]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[10])
...
(defrule OR4-forcing-gwhip[10]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[10]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[10])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[10]-value
   (declare (salience ?*OR4-forcing-gwhip[10]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[10])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
