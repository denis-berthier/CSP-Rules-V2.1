...
(defrule activate-OR4-forcing-gwhip[12]
   (declare (salience ?*activate-OR4-forcing-gwhip[12]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-gwhip[12]))
   (assert (technique ?cont partial-whip[11]))
   (assert (technique ?cont partial-gwhip[11]))
   (bind ?*technique* OR4FgW[12])
)



(defrule track-OR4-forcing-gwhip[12]
   (declare (salience ?*activate-OR4-forcing-gwhip[12]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[12])
=>
...
(defrule OR4-forcing-gwhip[12]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[12]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[12])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L12* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-12*) then
...
(defrule OR4-forcing-gwhip[12]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[12]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[12])
...
(defrule OR4-forcing-gwhip[12]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[12]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[12])
...
(defrule OR4-forcing-gwhip[12]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[12]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[12])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[12]-value
   (declare (salience ?*OR4-forcing-gwhip[12]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[12])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
