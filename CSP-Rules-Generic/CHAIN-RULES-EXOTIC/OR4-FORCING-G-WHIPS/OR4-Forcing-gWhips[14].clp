...
(defrule activate-OR4-forcing-gwhip[14]
   (declare (salience ?*activate-OR4-forcing-gwhip[14]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-gwhip[14]))
   (assert (technique ?cont partial-whip[13]))
   (assert (technique ?cont partial-gwhip[13]))
   (bind ?*technique* OR4FgW[14])
)



(defrule track-OR4-forcing-gwhip[14]
   (declare (salience ?*activate-OR4-forcing-gwhip[14]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[14])
=>
...
(defrule OR4-forcing-gwhip[14]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[14]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[14])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L14* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-14*) then
...
(defrule OR4-forcing-gwhip[14]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[14]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[14])
...
(defrule OR4-forcing-gwhip[14]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[14]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[14])
...
(defrule OR4-forcing-gwhip[14]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[14]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[14])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[14]-value
   (declare (salience ?*OR4-forcing-gwhip[14]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[14])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
