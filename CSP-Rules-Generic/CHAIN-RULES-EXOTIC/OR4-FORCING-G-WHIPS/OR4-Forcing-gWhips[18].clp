...
(defrule activate-OR4-forcing-gwhip[18]
   (declare (salience ?*activate-OR4-forcing-gwhip[18]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-gwhip[18]))
   (assert (technique ?cont partial-whip[17]))
   (assert (technique ?cont partial-gwhip[17]))
   (bind ?*technique* OR4FgW[18])
)



(defrule track-OR4-forcing-gwhip[18]
   (declare (salience ?*activate-OR4-forcing-gwhip[18]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[18])
=>
...
(defrule OR4-forcing-gwhip[18]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[18])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L18* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-18*) then
...
(defrule OR4-forcing-gwhip[18]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[18])
...
(defrule OR4-forcing-gwhip[18]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[18])
...
(defrule OR4-forcing-gwhip[18]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[18])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[18]-value
   (declare (salience ?*OR4-forcing-gwhip[18]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[18])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
