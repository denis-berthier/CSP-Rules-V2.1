...
(defrule activate-OR4-forcing-gwhip[24]
   (declare (salience ?*activate-OR4-forcing-gwhip[24]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW24))
   (assert (technique ?cont OR4-forcing-gwhip[24]))
   (assert (technique ?cont partial-whip[23]))
   (assert (technique ?cont partial-gwhip[23]))
   (bind ?*technique* OR4FgW[24])
)



(defrule track-OR4-forcing-gwhip[24]
   (declare (salience ?*activate-OR4-forcing-gwhip[24]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[24])
=>
...
(defrule OR4-forcing-gwhip[24]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[24])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L24* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-24*) then
...
(defrule OR4-forcing-gwhip[24]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[24])
...
(defrule OR4-forcing-gwhip[24]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[24])
...
(defrule OR4-forcing-gwhip[24]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[24])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[24]-value
   (declare (salience ?*OR4-forcing-gwhip[24]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[24])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
