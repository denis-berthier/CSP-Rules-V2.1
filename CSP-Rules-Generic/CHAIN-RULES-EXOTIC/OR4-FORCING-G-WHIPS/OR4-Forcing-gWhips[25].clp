...
(defrule activate-OR4-forcing-gwhip[25]
   (declare (salience ?*activate-OR4-forcing-gwhip[25]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW25))
   (assert (technique ?cont OR4-forcing-gwhip[25]))
   (assert (technique ?cont partial-whip[24]))
   (assert (technique ?cont partial-gwhip[24]))
   (bind ?*technique* OR4FgW[25])
)



(defrule track-OR4-forcing-gwhip[25]
   (declare (salience ?*activate-OR4-forcing-gwhip[25]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[25])
=>
...
(defrule OR4-forcing-gwhip[25]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[25]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[25])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L25* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-25*) then
...
(defrule OR4-forcing-gwhip[25]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[25]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[25])
...
(defrule OR4-forcing-gwhip[25]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[25]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[25])
...
(defrule OR4-forcing-gwhip[25]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[25]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[25])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[25]-value
   (declare (salience ?*OR4-forcing-gwhip[25]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[25])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
