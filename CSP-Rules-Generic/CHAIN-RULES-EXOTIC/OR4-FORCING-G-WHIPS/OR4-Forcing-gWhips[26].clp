...
(defrule activate-OR4-forcing-gwhip[26]
   (declare (salience ?*activate-OR4-forcing-gwhip[26]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW26))
   (assert (technique ?cont OR4-forcing-gwhip[26]))
   (assert (technique ?cont partial-whip[25]))
   (assert (technique ?cont partial-gwhip[25]))
   (bind ?*technique* OR4FgW[26])
)



(defrule track-OR4-forcing-gwhip[26]
   (declare (salience ?*activate-OR4-forcing-gwhip[26]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[26])
=>
...
(defrule OR4-forcing-gwhip[26]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[26]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[26])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L26* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-26*) then
...
(defrule OR4-forcing-gwhip[26]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[26]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[26])
...
(defrule OR4-forcing-gwhip[26]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[26]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[26])
...
(defrule OR4-forcing-gwhip[26]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[26]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[26])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[26]-value
   (declare (salience ?*OR4-forcing-gwhip[26]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[26])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
