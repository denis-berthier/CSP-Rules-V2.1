...
(defrule activate-OR4-forcing-gwhip[27]
   (declare (salience ?*activate-OR4-forcing-gwhip[27]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW27))
   (assert (technique ?cont OR4-forcing-gwhip[27]))
   (assert (technique ?cont partial-whip[26]))
   (assert (technique ?cont partial-gwhip[26]))
   (bind ?*technique* OR4FgW[27])
)



(defrule track-OR4-forcing-gwhip[27]
   (declare (salience ?*activate-OR4-forcing-gwhip[27]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[27])
=>
...
(defrule OR4-forcing-gwhip[27]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[27]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[27])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L27* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-27*) then
...
(defrule OR4-forcing-gwhip[27]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[27]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[27])
...
(defrule OR4-forcing-gwhip[27]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[27]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[27])
...
(defrule OR4-forcing-gwhip[27]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[27]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[27])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[27]-value
   (declare (salience ?*OR4-forcing-gwhip[27]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[27])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
