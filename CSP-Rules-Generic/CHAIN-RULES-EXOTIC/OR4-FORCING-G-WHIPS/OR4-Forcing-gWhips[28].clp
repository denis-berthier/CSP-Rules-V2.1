...
(defrule activate-OR4-forcing-gwhip[28]
   (declare (salience ?*activate-OR4-forcing-gwhip[28]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-gwhip[28]))
   (assert (technique ?cont partial-whip[27]))
   (assert (technique ?cont partial-gwhip[27]))
   (bind ?*technique* OR4FgW[28])
)



(defrule track-OR4-forcing-gwhip[28]
   (declare (salience ?*activate-OR4-forcing-gwhip[28]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[28])
=>
...
(defrule OR4-forcing-gwhip[28]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[28]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[28])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L28* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-28*) then
...
(defrule OR4-forcing-gwhip[28]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[28]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[28])
...
(defrule OR4-forcing-gwhip[28]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[28]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[28])
...
(defrule OR4-forcing-gwhip[28]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[28]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[28])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[28]-value
   (declare (salience ?*OR4-forcing-gwhip[28]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[28])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
