...
(defrule activate-OR4-forcing-gwhip[29]
   (declare (salience ?*activate-OR4-forcing-gwhip[29]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW29))
   (assert (technique ?cont OR4-forcing-gwhip[29]))
   (assert (technique ?cont partial-whip[28]))
   (assert (technique ?cont partial-gwhip[28]))
   (bind ?*technique* OR4FgW[29])
)



(defrule track-OR4-forcing-gwhip[29]
   (declare (salience ?*activate-OR4-forcing-gwhip[29]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[29])
=>
...
(defrule OR4-forcing-gwhip[29]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[29]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[29])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L29* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-29*) then
...
(defrule OR4-forcing-gwhip[29]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[29]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[29])
...
(defrule OR4-forcing-gwhip[29]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[29]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[29])
...
(defrule OR4-forcing-gwhip[29]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[29]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[29])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[29]-value
   (declare (salience ?*OR4-forcing-gwhip[29]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[29])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
