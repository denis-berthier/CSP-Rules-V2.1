...
(defrule activate-OR4-forcing-gwhip[32]
   (declare (salience ?*activate-OR4-forcing-gwhip[32]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW32))
   (assert (technique ?cont OR4-forcing-gwhip[32]))
   (assert (technique ?cont partial-whip[31]))
   (assert (technique ?cont partial-gwhip[31]))
   (bind ?*technique* OR4FgW[32])
)



(defrule track-OR4-forcing-gwhip[32]
   (declare (salience ?*activate-OR4-forcing-gwhip[32]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[32])
=>
...
(defrule OR4-forcing-gwhip[32]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[32]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[32])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L32* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-32*) then
...
(defrule OR4-forcing-gwhip[32]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[32]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[32])
...
(defrule OR4-forcing-gwhip[32]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[32]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[32])
...
(defrule OR4-forcing-gwhip[32]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[32]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[32])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[32]-value
   (declare (salience ?*OR4-forcing-gwhip[32]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[32])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
