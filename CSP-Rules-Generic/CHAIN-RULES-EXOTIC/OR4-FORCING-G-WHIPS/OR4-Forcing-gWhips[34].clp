...
(defrule activate-OR4-forcing-gwhip[34]
   (declare (salience ?*activate-OR4-forcing-gwhip[34]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW34))
   (assert (technique ?cont OR4-forcing-gwhip[34]))
   (assert (technique ?cont partial-whip[33]))
   (assert (technique ?cont partial-gwhip[33]))
   (bind ?*technique* OR4FgW[34])
)



(defrule track-OR4-forcing-gwhip[34]
   (declare (salience ?*activate-OR4-forcing-gwhip[34]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[34])
=>
...
(defrule OR4-forcing-gwhip[34]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[34]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[34])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L34* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-34*) then
...
(defrule OR4-forcing-gwhip[34]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[34]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[34])
...
(defrule OR4-forcing-gwhip[34]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[34]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[34])
...
(defrule OR4-forcing-gwhip[34]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[34]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[34])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[34]-value
   (declare (salience ?*OR4-forcing-gwhip[34]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[34])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
