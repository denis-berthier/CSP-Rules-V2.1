...
(defrule activate-OR4-forcing-gwhip[35]
   (declare (salience ?*activate-OR4-forcing-gwhip[35]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW35))
   (assert (technique ?cont OR4-forcing-gwhip[35]))
   (assert (technique ?cont partial-whip[34]))
   (assert (technique ?cont partial-gwhip[34]))
   (bind ?*technique* OR4FgW[35])
)



(defrule track-OR4-forcing-gwhip[35]
   (declare (salience ?*activate-OR4-forcing-gwhip[35]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[35])
=>
...
(defrule OR4-forcing-gwhip[35]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[35]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[35])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L35* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-35*) then
...
(defrule OR4-forcing-gwhip[35]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[35]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[35])
...
(defrule OR4-forcing-gwhip[35]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[35]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[35])
...
(defrule OR4-forcing-gwhip[35]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[35]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[35])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[35]-value
   (declare (salience ?*OR4-forcing-gwhip[35]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[35])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
