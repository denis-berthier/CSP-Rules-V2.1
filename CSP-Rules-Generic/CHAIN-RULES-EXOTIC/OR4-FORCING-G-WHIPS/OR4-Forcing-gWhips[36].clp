...
(defrule activate-OR4-forcing-gwhip[36]
   (declare (salience ?*activate-OR4-forcing-gwhip[36]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4FW36))
   (assert (technique ?cont OR4-forcing-gwhip[36]))
   (assert (technique ?cont partial-whip[35]))
   (assert (technique ?cont partial-gwhip[35]))
   (bind ?*technique* OR4FgW[36])
)



(defrule track-OR4-forcing-gwhip[36]
   (declare (salience ?*activate-OR4-forcing-gwhip[36]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[36])
=>
...
(defrule OR4-forcing-gwhip[36]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[36])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L36* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-36*) then
...
(defrule OR4-forcing-gwhip[36]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[36])
...
(defrule OR4-forcing-gwhip[36]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[36])
   ...
   (chain
      (type ?type3&:(or (eq ?type3 partial-whip) (eq ?type3 partial-gwhip)))
      (context ?cont)
      (length ?p3&:(or (< ?p2 ?p3) (and (= ?p2 ?p3) (< ?zzz2 ?zzz3)))&:(< (+ ?p2 ?p3) 35))
      (target ?zzz3)
      (llcs $?llcs3)
      (rlcs $?rlcs3)
      (csp-vars $?csps3)
...
(defrule OR4-forcing-gwhip[36]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[36])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
   ...
   (chain
      (type ?type2&:(or (eq ?type2 partial-whip) (eq ?type2 partial-gwhip)))
      (context ?cont)
      (length ?p2&:(or (< ?p1 ?p2) (and (= ?p1 ?p2) (< ?zzz1 ?zzz2)))&:(< (+ ?p1 ?p2) 34))
      (target ?zzz2)
      (llcs $?llcs2)
      (rlcs $?rlcs2)
      (csp-vars $?csps2)
   ...
   (chain
      (type ?type3&:(or (eq ?type3 partial-whip) (eq ?type3 partial-gwhip)))
      (context ?cont)
      (length ?p3&:(or (< ?p2 ?p3) (and (= ?p2 ?p3) (< ?zzz2 ?zzz3)))&:(< (+ ?p1 ?p2 ?p3) 35))
      (target ?zzz3)
      (llcs $?llcs3)
      (rlcs $?rlcs3)
      (csp-vars $?csps3)
...
(defrule OR4-forcing-gwhip[36]-value
   (declare (salience ?*OR4-forcing-gwhip[36]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[36])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
