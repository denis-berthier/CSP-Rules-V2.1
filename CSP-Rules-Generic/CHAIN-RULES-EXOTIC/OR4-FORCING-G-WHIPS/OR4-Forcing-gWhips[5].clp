...
(defrule activate-OR4-forcing-gwhip[5]
   (declare (salience ?*activate-OR4-forcing-gwhip[5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-gwhip[5]))
   (assert (technique ?cont partial-whip[4]))
   (assert (technique ?cont partial-gwhip[4]))
   (bind ?*technique* OR4FgW[5])
)



(defrule track-OR4-forcing-gwhip[5]
   (declare (salience ?*activate-OR4-forcing-gwhip[5]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[5])
=>
...
(defrule OR4-forcing-gwhip[5]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[5]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[5])
...
(defrule OR4-forcing-gwhip[5]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[5]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[5])
...
(defrule OR4-forcing-gwhip[5]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[5]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[5])
...
(defrule OR4-forcing-gwhip[5]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[5]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[5])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[5]-value
   (declare (salience ?*OR4-forcing-gwhip[5]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[5])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
