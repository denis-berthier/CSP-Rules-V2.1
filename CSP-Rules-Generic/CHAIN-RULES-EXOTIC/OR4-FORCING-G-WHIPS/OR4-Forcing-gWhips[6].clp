...
(defrule activate-OR4-forcing-gwhip[6]
   (declare (salience ?*activate-OR4-forcing-gwhip[6]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-gwhip[6]))
   (assert (technique ?cont partial-whip[5]))
   (assert (technique ?cont partial-gwhip[5]))
   (bind ?*technique* OR4FgW[6])
)



(defrule track-OR4-forcing-gwhip[6]
   (declare (salience ?*activate-OR4-forcing-gwhip[6]-salience*))
   ?level <- (technique ?cont OR4-forcing-gwhip[6])
=>
...
(defrule OR4-forcing-gwhip[6]-candidate-000p
   (declare (salience ?*OR4-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[6])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L6* ?*print-OR4-forcing-gwhip* ?*print-OR4-forcing-gwhip-6*) then
...
(defrule OR4-forcing-gwhip[6]-candidate-00pq
   (declare (salience ?*OR4-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[6])
...
(defrule OR4-forcing-gwhip[6]-candidate-0pqr
   (declare (salience ?*OR4-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[6])
...
(defrule OR4-forcing-gwhip[6]-candidate-pqrs
   (declare (salience ?*OR4-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR4-forcing-gwhip[6])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-gwhip[6]-value
   (declare (salience ?*OR4-forcing-gwhip[6]-value-salience*))
   (technique ?cont OR4-forcing-gwhip[6])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
