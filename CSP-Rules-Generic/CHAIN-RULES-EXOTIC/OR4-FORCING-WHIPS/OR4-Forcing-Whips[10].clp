...
(defrule activate-OR4-forcing-whip[10]
   (declare (salience ?*activate-OR4-forcing-whip[10]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-whip[10]))
   (assert (technique ?cont partial-whip[9]))
   (bind ?*technique* OR4FW[10])
)



(defrule track-OR4-forcing-whip[10]
   (declare (salience ?*activate-OR4-forcing-whip[10]-salience*))
   ?level <- (technique ?cont OR4-forcing-whip[10])
=>
...
(defrule OR4-forcing-whip[10]-candidate-000p
   (declare (salience ?*OR4-forcing-whip[10]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[10])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L10* ?*print-OR4-forcing-whip* ?*print-OR4-forcing-whip-10*) then
...
(defrule OR4-forcing-whip[10]-candidate-00pq
   (declare (salience ?*OR4-forcing-whip[10]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[10])
...
(defrule OR4-forcing-whip[10]-candidate-0pqr
   (declare (salience ?*OR4-forcing-whip[10]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[10])
...
(defrule OR4-forcing-whip[10]-candidate-pqrs
   (declare (salience ?*OR4-forcing-whip[10]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[10])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-whip[10]-value
   (declare (salience ?*OR4-forcing-whip[10]-value-salience*))
   (technique ?cont OR4-forcing-whip[10])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type partial-whip)
