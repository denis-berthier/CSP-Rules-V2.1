...
(defrule activate-OR4-forcing-whip[27]
   (declare (salience ?*activate-OR4-forcing-whip[27]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-whip[27]))
   (assert (technique ?cont partial-whip[26]))
   (bind ?*technique* OR4FW[27])
)



(defrule track-OR4-forcing-whip[27]
   (declare (salience ?*activate-OR4-forcing-whip[27]-salience*))
   ?level <- (technique ?cont OR4-forcing-whip[27])
=>
...
(defrule OR4-forcing-whip[27]-candidate-000p
   (declare (salience ?*OR4-forcing-whip[27]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[27])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L27* ?*print-OR4-forcing-whip* ?*print-OR4-forcing-whip-27*) then
...
(defrule OR4-forcing-whip[27]-candidate-00pq
   (declare (salience ?*OR4-forcing-whip[27]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[27])
...
(defrule OR4-forcing-whip[27]-candidate-0pqr
   (declare (salience ?*OR4-forcing-whip[27]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[27])
...
(defrule OR4-forcing-whip[27]-candidate-pqrs
   (declare (salience ?*OR4-forcing-whip[27]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[27])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-whip[27]-value
   (declare (salience ?*OR4-forcing-whip[27]-value-salience*))
   (technique ?cont OR4-forcing-whip[27])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type partial-whip)
