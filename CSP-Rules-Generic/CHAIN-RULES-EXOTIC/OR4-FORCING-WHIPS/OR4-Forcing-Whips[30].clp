...
(defrule activate-OR4-forcing-whip[30]
   (declare (salience ?*activate-OR4-forcing-whip[30]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-whip[30]))
   (assert (technique ?cont partial-whip[29]))
   (bind ?*technique* OR4FW[30])
)



(defrule track-OR4-forcing-whip[30]
   (declare (salience ?*activate-OR4-forcing-whip[30]-salience*))
   ?level <- (technique ?cont OR4-forcing-whip[30])
=>
...
(defrule OR4-forcing-whip[30]-candidate-000p
   (declare (salience ?*OR4-forcing-whip[30]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[30])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L30* ?*print-OR4-forcing-whip* ?*print-OR4-forcing-whip-30*) then
...
(defrule OR4-forcing-whip[30]-candidate-00pq
   (declare (salience ?*OR4-forcing-whip[30]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[30])
...
(defrule OR4-forcing-whip[30]-candidate-0pqr
   (declare (salience ?*OR4-forcing-whip[30]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[30])
...
(defrule OR4-forcing-whip[30]-candidate-pqrs
   (declare (salience ?*OR4-forcing-whip[30]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[30])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
...
(defrule OR4-forcing-whip[30]-value
   (declare (salience ?*OR4-forcing-whip[30]-value-salience*))
   (technique ?cont OR4-forcing-whip[30])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 4) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4))
   (chain
      (type partial-whip)
