...
(defrule activate-OR4-forcing-whip[3]
   (declare (salience ?*activate-OR4-forcing-whip[3]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR4-forcing-whip[3]))
   (assert (technique ?cont partial-whip[2]))
   (bind ?*technique* OR4FW[3])
)



(defrule track-OR4-forcing-whip[3]
   (declare (salience ?*activate-OR4-forcing-whip[3]-salience*))
   ?level <- (technique ?cont OR4-forcing-whip[3])
=>
...
(defrule OR4-forcing-whip[3]-candidate-000p
   (declare (salience ?*OR4-forcing-whip[3]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[3])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L3* ?*print-OR4-forcing-whip* ?*print-OR4-forcing-whip-3*) then
...
(defrule OR4-forcing-whip[3]-candidate-00pq
   (declare (salience ?*OR4-forcing-whip[3]-candidate-salience*))
   (technique ?cont OR4-forcing-whip[3])
