...
(defrule activate-OR4-whip[34]
   (declare (salience ?*activate-OR4-whip[34]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4W34))
   (assert (technique ?cont OR4-whip[34]))
   (assert (technique ?cont partial-whip[33]))
   (assert (technique ?cont partial-OR4-whip[33]))
   (bind ?*technique* OR4W[34])
)



(defrule track-OR4-whip[34]
   (declare (salience ?*activate-OR4-whip[34]-salience*))
   ?level <- (technique ?cont OR4-whip[34])
=>
...
(defrule OR4-whip[34]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR4-whip[34]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L34* ?*print-OR4-whip* ?*print-OR4-whip-34*) then
...
(defrule OR4-whip[34]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR4-whip[34]-salience-2*))
   (ORk-chain
      (type partial-OR4-whip)
      (context ?cont)
      (length 33)
