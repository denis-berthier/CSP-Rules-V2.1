...
(defrule activate-OR4-whip[35]
   (declare (salience ?*activate-OR4-whip[35]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR4W35))
   (assert (technique ?cont OR4-whip[35]))
   (assert (technique ?cont partial-whip[34]))
   (assert (technique ?cont partial-OR4-whip[34]))
   (bind ?*technique* OR4W[35])
)



(defrule track-OR4-whip[35]
   (declare (salience ?*activate-OR4-whip[35]-salience*))
   ?level <- (technique ?cont OR4-whip[35])
=>
...
(defrule OR4-whip[35]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR4-whip[35]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L35* ?*print-OR4-whip* ?*print-OR4-whip-35*) then
...
(defrule OR4-whip[35]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR4-whip[35]-salience-2*))
   (ORk-chain
      (type partial-OR4-whip)
      (context ?cont)
      (length 34)
