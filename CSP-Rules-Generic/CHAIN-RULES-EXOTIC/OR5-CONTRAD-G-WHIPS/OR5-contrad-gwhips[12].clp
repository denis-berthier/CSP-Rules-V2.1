...
(defrule activate-OR5-contrad-gwhip[12]
   (declare (salience ?*activate-OR5-contrad-gwhip[12]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW12))
   (assert (technique ?cont OR5-contrad-gwhip[12]))
   (assert (technique ?cont partial-whip[11]))
   (assert (technique ?cont partial-gwhip[11]))
   (bind ?*technique* OR5CgW[12])
)



(defrule track-OR5-contrad-gwhip[12]
   (declare (salience ?*activate-OR5-contrad-gwhip[12]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[12])
=>
...
(defrule OR5-contrad-gwhip[12]
   (declare (salience ?*OR5-contrad-gwhip[12]-salience*))
   (technique ?cont OR5-contrad-gwhip[12])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L12* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-12*) then
