...
(defrule activate-OR5-contrad-gwhip[13]
   (declare (salience ?*activate-OR5-contrad-gwhip[13]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW13))
   (assert (technique ?cont OR5-contrad-gwhip[13]))
   (assert (technique ?cont partial-whip[12]))
   (assert (technique ?cont partial-gwhip[12]))
   (bind ?*technique* OR5CgW[13])
)



(defrule track-OR5-contrad-gwhip[13]
   (declare (salience ?*activate-OR5-contrad-gwhip[13]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[13])
=>
...
(defrule OR5-contrad-gwhip[13]
   (declare (salience ?*OR5-contrad-gwhip[13]-salience*))
   (technique ?cont OR5-contrad-gwhip[13])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L13* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-13*) then
