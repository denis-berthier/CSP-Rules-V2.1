...
(defrule activate-OR5-contrad-gwhip[14]
   (declare (salience ?*activate-OR5-contrad-gwhip[14]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW14))
   (assert (technique ?cont OR5-contrad-gwhip[14]))
   (assert (technique ?cont partial-whip[13]))
   (assert (technique ?cont partial-gwhip[13]))
   (bind ?*technique* OR5CgW[14])
)



(defrule track-OR5-contrad-gwhip[14]
   (declare (salience ?*activate-OR5-contrad-gwhip[14]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[14])
=>
...
(defrule OR5-contrad-gwhip[14]
   (declare (salience ?*OR5-contrad-gwhip[14]-salience*))
   (technique ?cont OR5-contrad-gwhip[14])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L14* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-14*) then
