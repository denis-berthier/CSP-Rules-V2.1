...
(defrule activate-OR5-contrad-gwhip[16]
   (declare (salience ?*activate-OR5-contrad-gwhip[16]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW16))
   (assert (technique ?cont OR5-contrad-gwhip[16]))
   (assert (technique ?cont partial-whip[15]))
   (assert (technique ?cont partial-gwhip[15]))
   (bind ?*technique* OR5CgW[16])
)



(defrule track-OR5-contrad-gwhip[16]
   (declare (salience ?*activate-OR5-contrad-gwhip[16]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[16])
=>
...
(defrule OR5-contrad-gwhip[16]
   (declare (salience ?*OR5-contrad-gwhip[16]-salience*))
   (technique ?cont OR5-contrad-gwhip[16])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L16* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-16*) then
