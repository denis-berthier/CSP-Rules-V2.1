...
(defrule activate-OR5-contrad-gwhip[17]
   (declare (salience ?*activate-OR5-contrad-gwhip[17]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW17))
   (assert (technique ?cont OR5-contrad-gwhip[17]))
   (assert (technique ?cont partial-whip[16]))
   (assert (technique ?cont partial-gwhip[16]))
   (bind ?*technique* OR5CgW[17])
)



(defrule track-OR5-contrad-gwhip[17]
   (declare (salience ?*activate-OR5-contrad-gwhip[17]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[17])
=>
...
(defrule OR5-contrad-gwhip[17]
   (declare (salience ?*OR5-contrad-gwhip[17]-salience*))
   (technique ?cont OR5-contrad-gwhip[17])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L17* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-17*) then
