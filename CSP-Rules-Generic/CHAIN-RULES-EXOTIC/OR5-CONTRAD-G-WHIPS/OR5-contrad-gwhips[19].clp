...
(defrule activate-OR5-contrad-gwhip[19]
   (declare (salience ?*activate-OR5-contrad-gwhip[19]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW19))
   (assert (technique ?cont OR5-contrad-gwhip[19]))
   (assert (technique ?cont partial-whip[18]))
   (assert (technique ?cont partial-gwhip[18]))
   (bind ?*technique* OR5CgW[19])
)



(defrule track-OR5-contrad-gwhip[19]
   (declare (salience ?*activate-OR5-contrad-gwhip[19]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[19])
=>
...
(defrule OR5-contrad-gwhip[19]
   (declare (salience ?*OR5-contrad-gwhip[19]-salience*))
   (technique ?cont OR5-contrad-gwhip[19])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L19* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-19*) then
