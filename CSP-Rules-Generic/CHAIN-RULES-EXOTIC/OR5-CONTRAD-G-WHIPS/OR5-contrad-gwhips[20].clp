...
(defrule activate-OR5-contrad-gwhip[20]
   (declare (salience ?*activate-OR5-contrad-gwhip[20]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW20))
   (assert (technique ?cont OR5-contrad-gwhip[20]))
   (assert (technique ?cont partial-whip[19]))
   (assert (technique ?cont partial-gwhip[19]))
   (bind ?*technique* OR5CgW[20])
)



(defrule track-OR5-contrad-gwhip[20]
   (declare (salience ?*activate-OR5-contrad-gwhip[20]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[20])
=>
...
(defrule OR5-contrad-gwhip[20]
   (declare (salience ?*OR5-contrad-gwhip[20]-salience*))
   (technique ?cont OR5-contrad-gwhip[20])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L20* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-20*) then
