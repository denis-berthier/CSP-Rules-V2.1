...
(defrule activate-OR5-contrad-gwhip[21]
   (declare (salience ?*activate-OR5-contrad-gwhip[21]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW21))
   (assert (technique ?cont OR5-contrad-gwhip[21]))
   (assert (technique ?cont partial-whip[20]))
   (assert (technique ?cont partial-gwhip[20]))
   (bind ?*technique* OR5CgW[21])
)



(defrule track-OR5-contrad-gwhip[21]
   (declare (salience ?*activate-OR5-contrad-gwhip[21]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[21])
=>
...
(defrule OR5-contrad-gwhip[21]
   (declare (salience ?*OR5-contrad-gwhip[21]-salience*))
   (technique ?cont OR5-contrad-gwhip[21])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L21* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-21*) then
