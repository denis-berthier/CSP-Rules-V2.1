...
(defrule activate-OR5-contrad-gwhip[22]
   (declare (salience ?*activate-OR5-contrad-gwhip[22]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW22))
   (assert (technique ?cont OR5-contrad-gwhip[22]))
   (assert (technique ?cont partial-whip[21]))
   (assert (technique ?cont partial-gwhip[21]))
   (bind ?*technique* OR5CgW[22])
)



(defrule track-OR5-contrad-gwhip[22]
   (declare (salience ?*activate-OR5-contrad-gwhip[22]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[22])
=>
...
(defrule OR5-contrad-gwhip[22]
   (declare (salience ?*OR5-contrad-gwhip[22]-salience*))
   (technique ?cont OR5-contrad-gwhip[22])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L22* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-22*) then
