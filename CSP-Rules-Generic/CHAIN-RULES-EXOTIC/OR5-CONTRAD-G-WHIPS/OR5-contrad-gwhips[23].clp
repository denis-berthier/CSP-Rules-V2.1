...
(defrule activate-OR5-contrad-gwhip[23]
   (declare (salience ?*activate-OR5-contrad-gwhip[23]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW23))
   (assert (technique ?cont OR5-contrad-gwhip[23]))
   (assert (technique ?cont partial-whip[22]))
   (assert (technique ?cont partial-gwhip[22]))
   (bind ?*technique* OR5CgW[23])
)



(defrule track-OR5-contrad-gwhip[23]
   (declare (salience ?*activate-OR5-contrad-gwhip[23]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[23])
=>
...
(defrule OR5-contrad-gwhip[23]
   (declare (salience ?*OR5-contrad-gwhip[23]-salience*))
   (technique ?cont OR5-contrad-gwhip[23])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L23* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-23*) then
