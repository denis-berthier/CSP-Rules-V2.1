...
(defrule activate-OR5-contrad-gwhip[25]
   (declare (salience ?*activate-OR5-contrad-gwhip[25]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW25))
   (assert (technique ?cont OR5-contrad-gwhip[25]))
   (assert (technique ?cont partial-whip[24]))
   (assert (technique ?cont partial-gwhip[24]))
   (bind ?*technique* OR5CgW[25])
)



(defrule track-OR5-contrad-gwhip[25]
   (declare (salience ?*activate-OR5-contrad-gwhip[25]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[25])
=>
...
(defrule OR5-contrad-gwhip[25]
   (declare (salience ?*OR5-contrad-gwhip[25]-salience*))
   (technique ?cont OR5-contrad-gwhip[25])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L25* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-25*) then
