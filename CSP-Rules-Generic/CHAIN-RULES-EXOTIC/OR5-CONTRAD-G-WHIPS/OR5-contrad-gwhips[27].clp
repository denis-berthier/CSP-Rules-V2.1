...
(defrule activate-OR5-contrad-gwhip[27]
   (declare (salience ?*activate-OR5-contrad-gwhip[27]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW27))
   (assert (technique ?cont OR5-contrad-gwhip[27]))
   (assert (technique ?cont partial-whip[26]))
   (assert (technique ?cont partial-gwhip[26]))
   (bind ?*technique* OR5CgW[27])
)



(defrule track-OR5-contrad-gwhip[27]
   (declare (salience ?*activate-OR5-contrad-gwhip[27]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[27])
=>
...
(defrule OR5-contrad-gwhip[27]
   (declare (salience ?*OR5-contrad-gwhip[27]-salience*))
   (technique ?cont OR5-contrad-gwhip[27])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L27* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-27*) then
