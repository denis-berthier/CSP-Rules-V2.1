...
(defrule activate-OR5-contrad-gwhip[28]
   (declare (salience ?*activate-OR5-contrad-gwhip[28]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW28))
   (assert (technique ?cont OR5-contrad-gwhip[28]))
   (assert (technique ?cont partial-whip[27]))
   (assert (technique ?cont partial-gwhip[27]))
   (bind ?*technique* OR5CgW[28])
)



(defrule track-OR5-contrad-gwhip[28]
   (declare (salience ?*activate-OR5-contrad-gwhip[28]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[28])
=>
...
(defrule OR5-contrad-gwhip[28]
   (declare (salience ?*OR5-contrad-gwhip[28]-salience*))
   (technique ?cont OR5-contrad-gwhip[28])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L28* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-28*) then
