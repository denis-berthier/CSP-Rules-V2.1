...
(defrule activate-OR5-contrad-gwhip[29]
   (declare (salience ?*activate-OR5-contrad-gwhip[29]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW29))
   (assert (technique ?cont OR5-contrad-gwhip[29]))
   (assert (technique ?cont partial-whip[28]))
   (assert (technique ?cont partial-gwhip[28]))
   (bind ?*technique* OR5CgW[29])
)



(defrule track-OR5-contrad-gwhip[29]
   (declare (salience ?*activate-OR5-contrad-gwhip[29]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[29])
=>
...
(defrule OR5-contrad-gwhip[29]
   (declare (salience ?*OR5-contrad-gwhip[29]-salience*))
   (technique ?cont OR5-contrad-gwhip[29])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L29* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-29*) then
