...
(defrule activate-OR5-contrad-gwhip[30]
   (declare (salience ?*activate-OR5-contrad-gwhip[30]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW30))
   (assert (technique ?cont OR5-contrad-gwhip[30]))
   (assert (technique ?cont partial-whip[29]))
   (assert (technique ?cont partial-gwhip[29]))
   (bind ?*technique* OR5CgW[30])
)



(defrule track-OR5-contrad-gwhip[30]
   (declare (salience ?*activate-OR5-contrad-gwhip[30]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[30])
=>
...
(defrule OR5-contrad-gwhip[30]
   (declare (salience ?*OR5-contrad-gwhip[30]-salience*))
   (technique ?cont OR5-contrad-gwhip[30])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L30* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-30*) then
