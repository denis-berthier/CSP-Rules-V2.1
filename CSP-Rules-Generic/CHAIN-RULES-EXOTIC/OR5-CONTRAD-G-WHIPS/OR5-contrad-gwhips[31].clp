...
(defrule activate-OR5-contrad-gwhip[31]
   (declare (salience ?*activate-OR5-contrad-gwhip[31]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW31))
   (assert (technique ?cont OR5-contrad-gwhip[31]))
   (assert (technique ?cont partial-whip[30]))
   (assert (technique ?cont partial-gwhip[30]))
   (bind ?*technique* OR5CgW[31])
)



(defrule track-OR5-contrad-gwhip[31]
   (declare (salience ?*activate-OR5-contrad-gwhip[31]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[31])
=>
...
(defrule OR5-contrad-gwhip[31]
   (declare (salience ?*OR5-contrad-gwhip[31]-salience*))
   (technique ?cont OR5-contrad-gwhip[31])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L31* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-31*) then
