...
(defrule activate-OR5-contrad-gwhip[32]
   (declare (salience ?*activate-OR5-contrad-gwhip[32]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW32))
   (assert (technique ?cont OR5-contrad-gwhip[32]))
   (assert (technique ?cont partial-whip[31]))
   (assert (technique ?cont partial-gwhip[31]))
   (bind ?*technique* OR5CgW[32])
)



(defrule track-OR5-contrad-gwhip[32]
   (declare (salience ?*activate-OR5-contrad-gwhip[32]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[32])
=>
...
(defrule OR5-contrad-gwhip[32]
   (declare (salience ?*OR5-contrad-gwhip[32]-salience*))
   (technique ?cont OR5-contrad-gwhip[32])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L32* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-32*) then
