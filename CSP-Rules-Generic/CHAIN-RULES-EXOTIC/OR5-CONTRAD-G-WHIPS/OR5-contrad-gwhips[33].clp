...
(defrule activate-OR5-contrad-gwhip[33]
   (declare (salience ?*activate-OR5-contrad-gwhip[33]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW33))
   (assert (technique ?cont OR5-contrad-gwhip[33]))
   (assert (technique ?cont partial-whip[32]))
   (assert (technique ?cont partial-gwhip[32]))
   (bind ?*technique* OR5CgW[33])
)



(defrule track-OR5-contrad-gwhip[33]
   (declare (salience ?*activate-OR5-contrad-gwhip[33]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[33])
=>
...
(defrule OR5-contrad-gwhip[33]
   (declare (salience ?*OR5-contrad-gwhip[33]-salience*))
   (technique ?cont OR5-contrad-gwhip[33])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L33* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-33*) then
