...
(defrule activate-OR5-contrad-gwhip[34]
   (declare (salience ?*activate-OR5-contrad-gwhip[34]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW34))
   (assert (technique ?cont OR5-contrad-gwhip[34]))
   (assert (technique ?cont partial-whip[33]))
   (assert (technique ?cont partial-gwhip[33]))
   (bind ?*technique* OR5CgW[34])
)



(defrule track-OR5-contrad-gwhip[34]
   (declare (salience ?*activate-OR5-contrad-gwhip[34]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[34])
=>
...
(defrule OR5-contrad-gwhip[34]
   (declare (salience ?*OR5-contrad-gwhip[34]-salience*))
   (technique ?cont OR5-contrad-gwhip[34])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L34* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-34*) then
