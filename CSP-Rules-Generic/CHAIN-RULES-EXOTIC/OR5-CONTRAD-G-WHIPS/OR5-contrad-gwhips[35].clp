...
(defrule activate-OR5-contrad-gwhip[35]
   (declare (salience ?*activate-OR5-contrad-gwhip[35]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW35))
   (assert (technique ?cont OR5-contrad-gwhip[35]))
   (assert (technique ?cont partial-whip[34]))
   (assert (technique ?cont partial-gwhip[34]))
   (bind ?*technique* OR5CgW[35])
)



(defrule track-OR5-contrad-gwhip[35]
   (declare (salience ?*activate-OR5-contrad-gwhip[35]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[35])
=>
...
(defrule OR5-contrad-gwhip[35]
   (declare (salience ?*OR5-contrad-gwhip[35]-salience*))
   (technique ?cont OR5-contrad-gwhip[35])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L35* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-35*) then
