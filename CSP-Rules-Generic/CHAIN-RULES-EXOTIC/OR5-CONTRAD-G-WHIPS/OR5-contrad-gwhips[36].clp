...
(defrule activate-OR5-contrad-gwhip[36]
   (declare (salience ?*activate-OR5-contrad-gwhip[36]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW36))
   (assert (technique ?cont OR5-contrad-gwhip[36]))
   (assert (technique ?cont partial-whip[35]))
   (assert (technique ?cont partial-gwhip[35]))
   (bind ?*technique* OR5CgW[36])
)



(defrule track-OR5-contrad-gwhip[36]
   (declare (salience ?*activate-OR5-contrad-gwhip[36]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[36])
=>
...
(defrule OR5-contrad-gwhip[36]
   (declare (salience ?*OR5-contrad-gwhip[36]-salience*))
   (technique ?cont OR5-contrad-gwhip[36])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L36* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-36*) then
