...
(defrule activate-OR5-contrad-gwhip[3]
   (declare (salience ?*activate-OR5-contrad-gwhip[3]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW3))
   (assert (technique ?cont OR5-contrad-gwhip[3]))
   (assert (technique ?cont partial-whip[2]))
   (assert (technique ?cont partial-gwhip[2]))
   (bind ?*technique* OR5CgW[3])
)



(defrule track-OR5-contrad-gwhip[3]
   (declare (salience ?*activate-OR5-contrad-gwhip[3]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[3])
=>
...
(defrule OR5-contrad-gwhip[3]
   (declare (salience ?*OR5-contrad-gwhip[3]-salience*))
   (technique ?cont OR5-contrad-gwhip[3])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L3* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-3*) then
