...
(defrule activate-OR5-contrad-gwhip[4]
   (declare (salience ?*activate-OR5-contrad-gwhip[4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW4))
   (assert (technique ?cont OR5-contrad-gwhip[4]))
   (assert (technique ?cont partial-whip[3]))
   (assert (technique ?cont partial-gwhip[3]))
   (bind ?*technique* OR5CgW[4])
)



(defrule track-OR5-contrad-gwhip[4]
   (declare (salience ?*activate-OR5-contrad-gwhip[4]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[4])
=>
...
(defrule OR5-contrad-gwhip[4]
   (declare (salience ?*OR5-contrad-gwhip[4]-salience*))
   (technique ?cont OR5-contrad-gwhip[4])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L4* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-4*) then
