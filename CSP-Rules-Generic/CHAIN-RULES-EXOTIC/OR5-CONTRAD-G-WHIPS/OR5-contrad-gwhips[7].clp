...
(defrule activate-OR5-contrad-gwhip[7]
   (declare (salience ?*activate-OR5-contrad-gwhip[7]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW7))
   (assert (technique ?cont OR5-contrad-gwhip[7]))
   (assert (technique ?cont partial-whip[6]))
   (assert (technique ?cont partial-gwhip[6]))
   (bind ?*technique* OR5CgW[7])
)



(defrule track-OR5-contrad-gwhip[7]
   (declare (salience ?*activate-OR5-contrad-gwhip[7]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[7])
=>
...
(defrule OR5-contrad-gwhip[7]
   (declare (salience ?*OR5-contrad-gwhip[7]-salience*))
   (technique ?cont OR5-contrad-gwhip[7])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L7* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-7*) then
