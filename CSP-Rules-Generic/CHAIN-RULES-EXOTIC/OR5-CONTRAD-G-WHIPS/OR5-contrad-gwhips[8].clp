...
(defrule activate-OR5-contrad-gwhip[8]
   (declare (salience ?*activate-OR5-contrad-gwhip[8]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW8))
   (assert (technique ?cont OR5-contrad-gwhip[8]))
   (assert (technique ?cont partial-whip[7]))
   (assert (technique ?cont partial-gwhip[7]))
   (bind ?*technique* OR5CgW[8])
)



(defrule track-OR5-contrad-gwhip[8]
   (declare (salience ?*activate-OR5-contrad-gwhip[8]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[8])
=>
...
(defrule OR5-contrad-gwhip[8]
   (declare (salience ?*OR5-contrad-gwhip[8]-salience*))
   (technique ?cont OR5-contrad-gwhip[8])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L8* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-8*) then
