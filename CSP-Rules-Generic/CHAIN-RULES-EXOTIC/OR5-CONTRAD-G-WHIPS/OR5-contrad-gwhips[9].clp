...
(defrule activate-OR5-contrad-gwhip[9]
   (declare (salience ?*activate-OR5-contrad-gwhip[9]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5CgW9))
   (assert (technique ?cont OR5-contrad-gwhip[9]))
   (assert (technique ?cont partial-whip[8]))
   (assert (technique ?cont partial-gwhip[8]))
   (bind ?*technique* OR5CgW[9])
)



(defrule track-OR5-contrad-gwhip[9]
   (declare (salience ?*activate-OR5-contrad-gwhip[9]-salience*))
   ?level <- (technique ?cont OR5-contrad-gwhip[9])
=>
...
(defrule OR5-contrad-gwhip[9]
   (declare (salience ?*OR5-contrad-gwhip[9]-salience*))
   (technique ?cont OR5-contrad-gwhip[9])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L9* ?*print-OR5-contrad-gwhip* ?*print-OR5-contrad-gwhip-9*) then
