...
(defrule activate-OR5-forcing-gwhip[10]
   (declare (salience ?*activate-OR5-forcing-gwhip[10]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-gwhip[10]))
   (assert (technique ?cont partial-whip[9]))
   (assert (technique ?cont partial-gwhip[9]))
   (bind ?*technique* OR5FgW[10])
)



(defrule track-OR5-forcing-gwhip[10]
   (declare (salience ?*activate-OR5-forcing-gwhip[10]-salience*))
   ?level <- (technique ?cont OR5-forcing-gwhip[10])
=>
...
(defrule OR5-forcing-gwhip[10]-candidate-0000p
   (declare (salience ?*OR5-forcing-gwhip[10]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[10])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L10* ?*print-OR5-forcing-gwhip* ?*print-OR5-forcing-gwhip-10*) then
...
(defrule OR5-forcing-gwhip[10]-candidate-000pq
   (declare (salience ?*OR5-forcing-gwhip[10]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[10])
...
(defrule OR5-forcing-gwhip[10]-candidate-00pqr
   (declare (salience ?*OR5-forcing-gwhip[10]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[10])
...
(defrule OR5-forcing-gwhip[10]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-gwhip[10]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[10])
...
(defrule OR5-forcing-gwhip[10]-candidate-pqrst
   (declare (salience ?*OR5-forcing-gwhip[10]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[10])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-gwhip[10]-value
   (declare (salience ?*OR5-forcing-gwhip[10]-value-salience*))
   (technique ?cont OR5-forcing-gwhip[10])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
