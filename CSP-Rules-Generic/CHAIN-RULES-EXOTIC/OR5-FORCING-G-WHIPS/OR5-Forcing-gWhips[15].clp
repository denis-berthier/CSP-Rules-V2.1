...
(defrule activate-OR5-forcing-gwhip[15]
   (declare (salience ?*activate-OR5-forcing-gwhip[15]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-gwhip[15]))
   (assert (technique ?cont partial-whip[14]))
   (assert (technique ?cont partial-gwhip[14]))
   (bind ?*technique* OR5FgW[15])
)



(defrule track-OR5-forcing-gwhip[15]
   (declare (salience ?*activate-OR5-forcing-gwhip[15]-salience*))
   ?level <- (technique ?cont OR5-forcing-gwhip[15])
=>
...
(defrule OR5-forcing-gwhip[15]-candidate-0000p
   (declare (salience ?*OR5-forcing-gwhip[15]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[15])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L15* ?*print-OR5-forcing-gwhip* ?*print-OR5-forcing-gwhip-15*) then
...
(defrule OR5-forcing-gwhip[15]-candidate-000pq
   (declare (salience ?*OR5-forcing-gwhip[15]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[15])
...
(defrule OR5-forcing-gwhip[15]-candidate-00pqr
   (declare (salience ?*OR5-forcing-gwhip[15]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[15])
...
(defrule OR5-forcing-gwhip[15]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-gwhip[15]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[15])
...
(defrule OR5-forcing-gwhip[15]-candidate-pqrst
   (declare (salience ?*OR5-forcing-gwhip[15]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[15])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-gwhip[15]-value
   (declare (salience ?*OR5-forcing-gwhip[15]-value-salience*))
   (technique ?cont OR5-forcing-gwhip[15])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
