...
(defrule activate-OR5-forcing-gwhip[18]
   (declare (salience ?*activate-OR5-forcing-gwhip[18]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-gwhip[18]))
   (assert (technique ?cont partial-whip[17]))
   (assert (technique ?cont partial-gwhip[17]))
   (bind ?*technique* OR5FgW[18])
)



(defrule track-OR5-forcing-gwhip[18]
   (declare (salience ?*activate-OR5-forcing-gwhip[18]-salience*))
   ?level <- (technique ?cont OR5-forcing-gwhip[18])
=>
...
(defrule OR5-forcing-gwhip[18]-candidate-0000p
   (declare (salience ?*OR5-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[18])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L18* ?*print-OR5-forcing-gwhip* ?*print-OR5-forcing-gwhip-18*) then
...
(defrule OR5-forcing-gwhip[18]-candidate-000pq
   (declare (salience ?*OR5-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[18])
...
(defrule OR5-forcing-gwhip[18]-candidate-00pqr
   (declare (salience ?*OR5-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[18])
...
(defrule OR5-forcing-gwhip[18]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[18])
...
(defrule OR5-forcing-gwhip[18]-candidate-pqrst
   (declare (salience ?*OR5-forcing-gwhip[18]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[18])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-gwhip[18]-value
   (declare (salience ?*OR5-forcing-gwhip[18]-value-salience*))
   (technique ?cont OR5-forcing-gwhip[18])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
