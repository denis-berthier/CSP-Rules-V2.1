...
(defrule activate-OR5-forcing-gwhip[20]
   (declare (salience ?*activate-OR5-forcing-gwhip[20]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5FW20))
   (assert (technique ?cont OR5-forcing-gwhip[20]))
   (assert (technique ?cont partial-whip[19]))
   (assert (technique ?cont partial-gwhip[19]))
   (bind ?*technique* OR5FgW[20])
)



(defrule track-OR5-forcing-gwhip[20]
   (declare (salience ?*activate-OR5-forcing-gwhip[20]-salience*))
   ?level <- (technique ?cont OR5-forcing-gwhip[20])
=>
...
(defrule OR5-forcing-gwhip[20]-candidate-0000p
   (declare (salience ?*OR5-forcing-gwhip[20]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[20])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L20* ?*print-OR5-forcing-gwhip* ?*print-OR5-forcing-gwhip-20*) then
...
(defrule OR5-forcing-gwhip[20]-candidate-000pq
   (declare (salience ?*OR5-forcing-gwhip[20]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[20])
...
(defrule OR5-forcing-gwhip[20]-candidate-00pqr
   (declare (salience ?*OR5-forcing-gwhip[20]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[20])
...
(defrule OR5-forcing-gwhip[20]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-gwhip[20]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[20])
...
(defrule OR5-forcing-gwhip[20]-candidate-pqrst
   (declare (salience ?*OR5-forcing-gwhip[20]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[20])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-gwhip[20]-value
   (declare (salience ?*OR5-forcing-gwhip[20]-value-salience*))
   (technique ?cont OR5-forcing-gwhip[20])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
