...
(defrule activate-OR5-forcing-gwhip[24]
   (declare (salience ?*activate-OR5-forcing-gwhip[24]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-gwhip[24]))
   (assert (technique ?cont partial-whip[23]))
   (assert (technique ?cont partial-gwhip[23]))
   (bind ?*technique* OR5FgW[24])
)



(defrule track-OR5-forcing-gwhip[24]
   (declare (salience ?*activate-OR5-forcing-gwhip[24]-salience*))
   ?level <- (technique ?cont OR5-forcing-gwhip[24])
=>
...
(defrule OR5-forcing-gwhip[24]-candidate-0000p
   (declare (salience ?*OR5-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[24])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L24* ?*print-OR5-forcing-gwhip* ?*print-OR5-forcing-gwhip-24*) then
...
(defrule OR5-forcing-gwhip[24]-candidate-000pq
   (declare (salience ?*OR5-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[24])
...
(defrule OR5-forcing-gwhip[24]-candidate-00pqr
   (declare (salience ?*OR5-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[24])
...
(defrule OR5-forcing-gwhip[24]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[24])
...
(defrule OR5-forcing-gwhip[24]-candidate-pqrst
   (declare (salience ?*OR5-forcing-gwhip[24]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[24])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-gwhip[24]-value
   (declare (salience ?*OR5-forcing-gwhip[24]-value-salience*))
   (technique ?cont OR5-forcing-gwhip[24])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
