...
(defrule activate-OR5-forcing-gwhip[26]
   (declare (salience ?*activate-OR5-forcing-gwhip[26]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-gwhip[26]))
   (assert (technique ?cont partial-whip[25]))
   (assert (technique ?cont partial-gwhip[25]))
   (bind ?*technique* OR5FgW[26])
)



(defrule track-OR5-forcing-gwhip[26]
   (declare (salience ?*activate-OR5-forcing-gwhip[26]-salience*))
   ?level <- (technique ?cont OR5-forcing-gwhip[26])
=>
...
(defrule OR5-forcing-gwhip[26]-candidate-0000p
   (declare (salience ?*OR5-forcing-gwhip[26]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[26])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L26* ?*print-OR5-forcing-gwhip* ?*print-OR5-forcing-gwhip-26*) then
...
(defrule OR5-forcing-gwhip[26]-candidate-000pq
   (declare (salience ?*OR5-forcing-gwhip[26]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[26])
...
(defrule OR5-forcing-gwhip[26]-candidate-00pqr
   (declare (salience ?*OR5-forcing-gwhip[26]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[26])
...
(defrule OR5-forcing-gwhip[26]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-gwhip[26]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[26])
...
(defrule OR5-forcing-gwhip[26]-candidate-pqrst
   (declare (salience ?*OR5-forcing-gwhip[26]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[26])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-gwhip[26]-value
   (declare (salience ?*OR5-forcing-gwhip[26]-value-salience*))
   (technique ?cont OR5-forcing-gwhip[26])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
