...
(defrule activate-OR5-forcing-gwhip[29]
   (declare (salience ?*activate-OR5-forcing-gwhip[29]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5FW29))
   (assert (technique ?cont OR5-forcing-gwhip[29]))
   (assert (technique ?cont partial-whip[28]))
   (assert (technique ?cont partial-gwhip[28]))
   (bind ?*technique* OR5FgW[29])
)



(defrule track-OR5-forcing-gwhip[29]
   (declare (salience ?*activate-OR5-forcing-gwhip[29]-salience*))
   ?level <- (technique ?cont OR5-forcing-gwhip[29])
=>
...
(defrule OR5-forcing-gwhip[29]-candidate-0000p
   (declare (salience ?*OR5-forcing-gwhip[29]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[29])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L29* ?*print-OR5-forcing-gwhip* ?*print-OR5-forcing-gwhip-29*) then
...
(defrule OR5-forcing-gwhip[29]-candidate-000pq
   (declare (salience ?*OR5-forcing-gwhip[29]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[29])
...
(defrule OR5-forcing-gwhip[29]-candidate-00pqr
   (declare (salience ?*OR5-forcing-gwhip[29]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[29])
...
(defrule OR5-forcing-gwhip[29]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-gwhip[29]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[29])
...
(defrule OR5-forcing-gwhip[29]-candidate-pqrst
   (declare (salience ?*OR5-forcing-gwhip[29]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[29])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-gwhip[29]-value
   (declare (salience ?*OR5-forcing-gwhip[29]-value-salience*))
   (technique ?cont OR5-forcing-gwhip[29])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
