...
(defrule activate-OR5-forcing-gwhip[32]
   (declare (salience ?*activate-OR5-forcing-gwhip[32]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-gwhip[32]))
   (assert (technique ?cont partial-whip[31]))
   (assert (technique ?cont partial-gwhip[31]))
   (bind ?*technique* OR5FgW[32])
)



(defrule track-OR5-forcing-gwhip[32]
   (declare (salience ?*activate-OR5-forcing-gwhip[32]-salience*))
   ?level <- (technique ?cont OR5-forcing-gwhip[32])
=>
...
(defrule OR5-forcing-gwhip[32]-candidate-0000p
   (declare (salience ?*OR5-forcing-gwhip[32]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[32])
...
(defrule OR5-forcing-gwhip[32]-candidate-000pq
   (declare (salience ?*OR5-forcing-gwhip[32]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[32])
...
(defrule OR5-forcing-gwhip[32]-candidate-00pqr
   (declare (salience ?*OR5-forcing-gwhip[32]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[32])
...
(defrule OR5-forcing-gwhip[32]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-gwhip[32]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[32])
...
(defrule OR5-forcing-gwhip[32]-candidate-pqrst
   (declare (salience ?*OR5-forcing-gwhip[32]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[32])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-gwhip[32]-value
   (declare (salience ?*OR5-forcing-gwhip[32]-value-salience*))
   (technique ?cont OR5-forcing-gwhip[32])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
