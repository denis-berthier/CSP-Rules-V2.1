...
(defrule activate-OR5-forcing-gwhip[36]
   (declare (salience ?*activate-OR5-forcing-gwhip[36]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-gwhip[36]))
   (assert (technique ?cont partial-whip[35]))
   (assert (technique ?cont partial-gwhip[35]))
   (bind ?*technique* OR5FgW[36])
)



(defrule track-OR5-forcing-gwhip[36]
   (declare (salience ?*activate-OR5-forcing-gwhip[36]-salience*))
   ?level <- (technique ?cont OR5-forcing-gwhip[36])
=>
...
(defrule OR5-forcing-gwhip[36]-candidate-0000p
   (declare (salience ?*OR5-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[36])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L36* ?*print-OR5-forcing-gwhip* ?*print-OR5-forcing-gwhip-36*) then
...
(defrule OR5-forcing-gwhip[36]-candidate-000pq
   (declare (salience ?*OR5-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[36])
...
(defrule OR5-forcing-gwhip[36]-candidate-00pqr
   (declare (salience ?*OR5-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[36])
...
(defrule OR5-forcing-gwhip[36]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[36])
...
(defrule OR5-forcing-gwhip[36]-candidate-pqrst
   (declare (salience ?*OR5-forcing-gwhip[36]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[36])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
   ...
   (chain
      (type ?type4&:(or (eq ?type4 partial-whip) (eq ?type4 partial-gwhip)))
      (context ?cont)
      (length ?p4&:(or (< ?p3 ?p4) (and (= ?p3 ?p4) (< ?zzz3 ?zzz4)))&:(< (+ ?p1 ?p2 ?p3 ?p4) 35))
      (target ?zzz4)
      (llcs $?llcs4)
      (rlcs $?rlcs4)
      (csp-vars $?csps4)
...
(defrule OR5-forcing-gwhip[36]-value
   (declare (salience ?*OR5-forcing-gwhip[36]-value-salience*))
   (technique ?cont OR5-forcing-gwhip[36])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
