...
(defrule activate-OR5-forcing-gwhip[5]
   (declare (salience ?*activate-OR5-forcing-gwhip[5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-gwhip[5]))
   (assert (technique ?cont partial-whip[4]))
   (assert (technique ?cont partial-gwhip[4]))
   (bind ?*technique* OR5FgW[5])
)



(defrule track-OR5-forcing-gwhip[5]
   (declare (salience ?*activate-OR5-forcing-gwhip[5]-salience*))
   ?level <- (technique ?cont OR5-forcing-gwhip[5])
=>
...
(defrule OR5-forcing-gwhip[5]-candidate-0000p
   (declare (salience ?*OR5-forcing-gwhip[5]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[5])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L5* ?*print-OR5-forcing-gwhip* ?*print-OR5-forcing-gwhip-5*) then
...
(defrule OR5-forcing-gwhip[5]-candidate-000pq
   (declare (salience ?*OR5-forcing-gwhip[5]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[5])
...
(defrule OR5-forcing-gwhip[5]-candidate-00pqr
   (declare (salience ?*OR5-forcing-gwhip[5]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[5])
...
(defrule OR5-forcing-gwhip[5]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-gwhip[5]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[5])
