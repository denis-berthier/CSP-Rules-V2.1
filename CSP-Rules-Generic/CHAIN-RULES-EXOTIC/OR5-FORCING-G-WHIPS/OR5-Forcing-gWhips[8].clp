...
(defrule activate-OR5-forcing-gwhip[8]
   (declare (salience ?*activate-OR5-forcing-gwhip[8]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5FW8))
   (assert (technique ?cont OR5-forcing-gwhip[8]))
   (assert (technique ?cont partial-whip[7]))
   (assert (technique ?cont partial-gwhip[7]))
   (bind ?*technique* OR5FgW[8])
)



(defrule track-OR5-forcing-gwhip[8]
   (declare (salience ?*activate-OR5-forcing-gwhip[8]-salience*))
   ?level <- (technique ?cont OR5-forcing-gwhip[8])
=>
...
(defrule OR5-forcing-gwhip[8]-candidate-0000p
   (declare (salience ?*OR5-forcing-gwhip[8]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[8])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L8* ?*print-OR5-forcing-gwhip* ?*print-OR5-forcing-gwhip-8*) then
...
(defrule OR5-forcing-gwhip[8]-candidate-000pq
   (declare (salience ?*OR5-forcing-gwhip[8]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[8])
...
(defrule OR5-forcing-gwhip[8]-candidate-00pqr
   (declare (salience ?*OR5-forcing-gwhip[8]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[8])
...
(defrule OR5-forcing-gwhip[8]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-gwhip[8]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[8])
...
(defrule OR5-forcing-gwhip[8]-candidate-pqrst
   (declare (salience ?*OR5-forcing-gwhip[8]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[8])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-gwhip[8]-value
   (declare (salience ?*OR5-forcing-gwhip[8]-value-salience*))
   (technique ?cont OR5-forcing-gwhip[8])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
