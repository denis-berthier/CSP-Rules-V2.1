...
(defrule activate-OR5-forcing-gwhip[6]
   (declare (salience ?*activate-OR5-forcing-gwhip[6]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR5-forcing-gwhip[6]))
   (assert (technique ?cont partial-whip[5]))
   (assert (technique ?cont partial-gwhip[5]))
   (bind ?*technique* OR5FgW[6])
)



(defrule track-OR5-forcing-gwhip[6]
   (declare (salience ?*activate-OR5-forcing-gwhip[6]-salience*))
   ?level <- (technique ?cont OR5-forcing-gwhip[6])
=>
...
(defrule OR5-forcing-gwhip[6]-candidate-0000p
   (declare (salience ?*OR5-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[6])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L6* ?*print-OR5-forcing-gwhip* ?*print-OR5-forcing-gwhip-6*) then
...
(defrule OR5-forcing-gwhip[6]-candidate-000pq
   (declare (salience ?*OR5-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[6])
...
(defrule OR5-forcing-gwhip[6]-candidate-00pqr
   (declare (salience ?*OR5-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[6])
...
(defrule OR5-forcing-gwhip[6]-candidate-0pqrs
   (declare (salience ?*OR5-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[6])
...
(defrule OR5-forcing-gwhip[6]-candidate-pqrst
   (declare (salience ?*OR5-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR5-forcing-gwhip[6])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
...
(defrule OR5-forcing-gwhip[6]-value
   (declare (salience ?*OR5-forcing-gwhip[6]-value-salience*))
   (technique ?cont OR5-forcing-gwhip[6])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 5) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
