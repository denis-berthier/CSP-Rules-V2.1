...
(defrule activate-OR5-gwhip[24]
   (declare (salience ?*activate-OR5-gwhip[24]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5gW24))
   (assert (technique ?cont OR5-gwhip[24]))
   (assert (technique ?cont partial-whip[23]))
   (assert (technique ?cont partial-gwhip[23]))
   (assert (technique ?cont partial-OR5-gwhip[23]))
   (bind ?*technique* OR5gW[24])
)



(defrule track-OR5-gwhip[24]
   (declare (salience ?*activate-OR5-gwhip[24]-salience*))
   ?level <- (technique ?cont OR5-gwhip[24])
=>
...
(defrule OR5-gwhip[24]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR5-gwhip[24]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L24* ?*print-OR5-gwhip* ?*print-OR5-gwhip-24*) then
...
(defrule OR5-gwhip[24]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR5-gwhip[24]-salience-2*))
   (ORk-chain
      (type partial-OR5-gwhip)
      (context ?cont)
      (length 23)
