...
(defrule activate-OR5-gwhip[26]
   (declare (salience ?*activate-OR5-gwhip[26]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5gW26))
   (assert (technique ?cont OR5-gwhip[26]))
   (assert (technique ?cont partial-whip[25]))
   (assert (technique ?cont partial-gwhip[25]))
   (assert (technique ?cont partial-OR5-gwhip[25]))
   (bind ?*technique* OR5gW[26])
)



(defrule track-OR5-gwhip[26]
   (declare (salience ?*activate-OR5-gwhip[26]-salience*))
   ?level <- (technique ?cont OR5-gwhip[26])
=>
...
(defrule OR5-gwhip[26]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR5-gwhip[26]-salience-1*))
   (ORk-chain
...
(defrule OR5-gwhip[26]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR5-gwhip[26]-salience-2*))
   (ORk-chain
      (type partial-OR5-gwhip)
      (context ?cont)
      (length 25)
