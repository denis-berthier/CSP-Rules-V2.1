...
(defrule activate-OR5-gwhip[30]
   (declare (salience ?*activate-OR5-gwhip[30]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5gW30))
   (assert (technique ?cont OR5-gwhip[30]))
   (assert (technique ?cont partial-whip[29]))
   (assert (technique ?cont partial-gwhip[29]))
   (assert (technique ?cont partial-OR5-gwhip[29]))
   (bind ?*technique* OR5gW[30])
)



(defrule track-OR5-gwhip[30]
   (declare (salience ?*activate-OR5-gwhip[30]-salience*))
   ?level <- (technique ?cont OR5-gwhip[30])
=>
...
(defrule OR5-gwhip[30]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR5-gwhip[30]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L30* ?*print-OR5-gwhip* ?*print-OR5-gwhip-30*) then
...
(defrule OR5-gwhip[30]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR5-gwhip[30]-salience-2*))
   (ORk-chain
      (type partial-OR5-gwhip)
      (context ?cont)
      (length 29)
