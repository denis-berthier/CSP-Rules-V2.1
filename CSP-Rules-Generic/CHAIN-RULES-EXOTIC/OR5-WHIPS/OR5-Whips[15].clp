...
(defrule activate-OR5-whip[15]
   (declare (salience ?*activate-OR5-whip[15]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5W15))
   (assert (technique ?cont OR5-whip[15]))
   (assert (technique ?cont partial-whip[14]))
   (assert (technique ?cont partial-OR5-whip[14]))
   (bind ?*technique* OR5W[15])
)



(defrule track-OR5-whip[15]
   (declare (salience ?*activate-OR5-whip[15]-salience*))
   ?level <- (technique ?cont OR5-whip[15])
=>
...
(defrule OR5-whip[15]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR5-whip[15]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L15* ?*print-OR5-whip* ?*print-OR5-whip-15*) then
...
(defrule OR5-whip[15]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR5-whip[15]-salience-2*))
   (ORk-chain
      (type partial-OR5-whip)
      (context ?cont)
      (length 14)
