...
(defrule activate-OR5-whip[27]
   (declare (salience ?*activate-OR5-whip[27]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5W27))
   (assert (technique ?cont OR5-whip[27]))
   (assert (technique ?cont partial-whip[26]))
   (assert (technique ?cont partial-OR5-whip[26]))
   (bind ?*technique* OR5W[27])
)



(defrule track-OR5-whip[27]
   (declare (salience ?*activate-OR5-whip[27]-salience*))
   ?level <- (technique ?cont OR5-whip[27])
=>
...
(defrule OR5-whip[27]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR5-whip[27]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L27* ?*print-OR5-whip* ?*print-OR5-whip-27*) then
...
(defrule OR5-whip[27]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR5-whip[27]-salience-2*))
   (ORk-chain
      (type partial-OR5-whip)
      (context ?cont)
      (length 26)
