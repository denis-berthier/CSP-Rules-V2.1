...
(defrule activate-OR5-whip[36]
   (declare (salience ?*activate-OR5-whip[36]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5W36))
   (assert (technique ?cont OR5-whip[36]))
   (assert (technique ?cont partial-whip[35]))
   (assert (technique ?cont partial-OR5-whip[35]))
   (bind ?*technique* OR5W[36])
)



(defrule track-OR5-whip[36]
   (declare (salience ?*activate-OR5-whip[36]-salience*))
   ?level <- (technique ?cont OR5-whip[36])
=>
...
(defrule OR5-whip[36]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR5-whip[36]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L36* ?*print-OR5-whip* ?*print-OR5-whip-36*) then
...
(defrule OR5-whip[36]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR5-whip[36]-salience-2*))
   (ORk-chain
      (type partial-OR5-whip)
      (context ?cont)
      (length 35)
