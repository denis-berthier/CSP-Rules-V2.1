...
(defrule activate-OR5-whip[3]
   (declare (salience ?*activate-OR5-whip[3]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5W3))
   (assert (technique ?cont OR5-whip[3]))
   (assert (technique ?cont partial-whip[2]))
   (assert (technique ?cont partial-OR5-whip[2]))
   (bind ?*technique* OR5W[3])
)



(defrule track-OR5-whip[3]
   (declare (salience ?*activate-OR5-whip[3]-salience*))
   ?level <- (technique ?cont OR5-whip[3])
=>
...
(defrule OR5-whip[3]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR5-whip[3]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L3* ?*print-OR5-whip* ?*print-OR5-whip-3*) then
...
(defrule OR5-whip[3]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR5-whip[3]-salience-2*))
   (ORk-chain
      (type partial-OR5-whip)
      (context ?cont)
      (length 2)
