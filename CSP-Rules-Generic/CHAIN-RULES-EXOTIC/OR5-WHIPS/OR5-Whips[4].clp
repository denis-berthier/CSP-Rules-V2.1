...
(defrule activate-OR5-whip[4]
   (declare (salience ?*activate-OR5-whip[4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5W4))
   (assert (technique ?cont OR5-whip[4]))
   (assert (technique ?cont partial-whip[3]))
   (assert (technique ?cont partial-OR5-whip[3]))
   (bind ?*technique* OR5W[4])
)



(defrule track-OR5-whip[4]
   (declare (salience ?*activate-OR5-whip[4]-salience*))
   ?level <- (technique ?cont OR5-whip[4])
=>
...
(defrule OR5-whip[4]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR5-whip[4]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L4* ?*print-OR5-whip* ?*print-OR5-whip-4*) then
...
(defrule OR5-whip[4]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR5-whip[4]-salience-2*))
   (ORk-chain
      (type partial-OR5-whip)
      (context ?cont)
      (length 3)
