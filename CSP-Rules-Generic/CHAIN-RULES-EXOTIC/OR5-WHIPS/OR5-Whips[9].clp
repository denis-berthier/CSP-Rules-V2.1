...
(defrule activate-OR5-whip[9]
   (declare (salience ?*activate-OR5-whip[9]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR5W9))
   (assert (technique ?cont OR5-whip[9]))
   (assert (technique ?cont partial-whip[8]))
   (assert (technique ?cont partial-OR5-whip[8]))
   (bind ?*technique* OR5W[9])
)



(defrule track-OR5-whip[9]
   (declare (salience ?*activate-OR5-whip[9]-salience*))
   ?level <- (technique ?cont OR5-whip[9])
=>
...
(defrule OR5-whip[9]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR5-whip[9]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L9* ?*print-OR5-whip* ?*print-OR5-whip-9*) then
...
(defrule OR5-whip[9]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR5-whip[9]-salience-2*))
   (ORk-chain
      (type partial-OR5-whip)
      (context ?cont)
      (length 8)
