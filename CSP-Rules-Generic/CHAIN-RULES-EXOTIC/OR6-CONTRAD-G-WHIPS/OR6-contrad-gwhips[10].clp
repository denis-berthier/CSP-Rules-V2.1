...
(defrule activate-OR6-contrad-gwhip[10]
   (declare (salience ?*activate-OR6-contrad-gwhip[10]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW10))
   (assert (technique ?cont OR6-contrad-gwhip[10]))
   (assert (technique ?cont partial-whip[9]))
   (assert (technique ?cont partial-gwhip[9]))
   (bind ?*technique* OR6CgW[10])
)



(defrule track-OR6-contrad-gwhip[10]
   (declare (salience ?*activate-OR6-contrad-gwhip[10]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[10])
=>
...
(defrule OR6-contrad-gwhip[10]
   (declare (salience ?*OR6-contrad-gwhip[10]-salience*))
   (technique ?cont OR6-contrad-gwhip[10])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L10* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-10*) then
