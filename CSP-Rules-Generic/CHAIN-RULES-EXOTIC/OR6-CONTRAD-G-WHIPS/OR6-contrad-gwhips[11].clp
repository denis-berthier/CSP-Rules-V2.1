...
(defrule activate-OR6-contrad-gwhip[11]
   (declare (salience ?*activate-OR6-contrad-gwhip[11]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW11))
   (assert (technique ?cont OR6-contrad-gwhip[11]))
   (assert (technique ?cont partial-whip[10]))
   (assert (technique ?cont partial-gwhip[10]))
   (bind ?*technique* OR6CgW[11])
)



(defrule track-OR6-contrad-gwhip[11]
   (declare (salience ?*activate-OR6-contrad-gwhip[11]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[11])
=>
...
(defrule OR6-contrad-gwhip[11]
   (declare (salience ?*OR6-contrad-gwhip[11]-salience*))
   (technique ?cont OR6-contrad-gwhip[11])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L11* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-11*) then
