...
(defrule activate-OR6-contrad-gwhip[12]
   (declare (salience ?*activate-OR6-contrad-gwhip[12]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW12))
   (assert (technique ?cont OR6-contrad-gwhip[12]))
   (assert (technique ?cont partial-whip[11]))
   (assert (technique ?cont partial-gwhip[11]))
   (bind ?*technique* OR6CgW[12])
)



(defrule track-OR6-contrad-gwhip[12]
   (declare (salience ?*activate-OR6-contrad-gwhip[12]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[12])
=>
...
(defrule OR6-contrad-gwhip[12]
   (declare (salience ?*OR6-contrad-gwhip[12]-salience*))
   (technique ?cont OR6-contrad-gwhip[12])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L12* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-12*) then
