...
(defrule activate-OR6-contrad-gwhip[13]
   (declare (salience ?*activate-OR6-contrad-gwhip[13]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW13))
   (assert (technique ?cont OR6-contrad-gwhip[13]))
   (assert (technique ?cont partial-whip[12]))
   (assert (technique ?cont partial-gwhip[12]))
   (bind ?*technique* OR6CgW[13])
)



(defrule track-OR6-contrad-gwhip[13]
   (declare (salience ?*activate-OR6-contrad-gwhip[13]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[13])
=>
...
(defrule OR6-contrad-gwhip[13]
   (declare (salience ?*OR6-contrad-gwhip[13]-salience*))
   (technique ?cont OR6-contrad-gwhip[13])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L13* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-13*) then
