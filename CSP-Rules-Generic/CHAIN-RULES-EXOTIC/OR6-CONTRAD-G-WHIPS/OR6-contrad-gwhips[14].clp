...
(defrule activate-OR6-contrad-gwhip[14]
   (declare (salience ?*activate-OR6-contrad-gwhip[14]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW14))
   (assert (technique ?cont OR6-contrad-gwhip[14]))
   (assert (technique ?cont partial-whip[13]))
   (assert (technique ?cont partial-gwhip[13]))
   (bind ?*technique* OR6CgW[14])
)



(defrule track-OR6-contrad-gwhip[14]
   (declare (salience ?*activate-OR6-contrad-gwhip[14]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[14])
=>
...
(defrule OR6-contrad-gwhip[14]
   (declare (salience ?*OR6-contrad-gwhip[14]-salience*))
   (technique ?cont OR6-contrad-gwhip[14])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L14* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-14*) then
