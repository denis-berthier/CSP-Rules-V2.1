...
(defrule activate-OR6-contrad-gwhip[15]
   (declare (salience ?*activate-OR6-contrad-gwhip[15]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW15))
   (assert (technique ?cont OR6-contrad-gwhip[15]))
   (assert (technique ?cont partial-whip[14]))
   (assert (technique ?cont partial-gwhip[14]))
   (bind ?*technique* OR6CgW[15])
)



(defrule track-OR6-contrad-gwhip[15]
   (declare (salience ?*activate-OR6-contrad-gwhip[15]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[15])
=>
...
(defrule OR6-contrad-gwhip[15]
   (declare (salience ?*OR6-contrad-gwhip[15]-salience*))
   (technique ?cont OR6-contrad-gwhip[15])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L15* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-15*) then
