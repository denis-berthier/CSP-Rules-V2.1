...
(defrule activate-OR6-contrad-gwhip[16]
   (declare (salience ?*activate-OR6-contrad-gwhip[16]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW16))
   (assert (technique ?cont OR6-contrad-gwhip[16]))
   (assert (technique ?cont partial-whip[15]))
   (assert (technique ?cont partial-gwhip[15]))
   (bind ?*technique* OR6CgW[16])
)



(defrule track-OR6-contrad-gwhip[16]
   (declare (salience ?*activate-OR6-contrad-gwhip[16]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[16])
=>
...
(defrule OR6-contrad-gwhip[16]
   (declare (salience ?*OR6-contrad-gwhip[16]-salience*))
   (technique ?cont OR6-contrad-gwhip[16])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L16* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-16*) then
