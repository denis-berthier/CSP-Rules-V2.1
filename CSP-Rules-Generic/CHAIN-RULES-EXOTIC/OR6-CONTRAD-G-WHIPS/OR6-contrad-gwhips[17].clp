...
(defrule activate-OR6-contrad-gwhip[17]
   (declare (salience ?*activate-OR6-contrad-gwhip[17]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW17))
   (assert (technique ?cont OR6-contrad-gwhip[17]))
   (assert (technique ?cont partial-whip[16]))
   (assert (technique ?cont partial-gwhip[16]))
   (bind ?*technique* OR6CgW[17])
)



(defrule track-OR6-contrad-gwhip[17]
   (declare (salience ?*activate-OR6-contrad-gwhip[17]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[17])
=>
...
(defrule OR6-contrad-gwhip[17]
   (declare (salience ?*OR6-contrad-gwhip[17]-salience*))
   (technique ?cont OR6-contrad-gwhip[17])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L17* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-17*) then
