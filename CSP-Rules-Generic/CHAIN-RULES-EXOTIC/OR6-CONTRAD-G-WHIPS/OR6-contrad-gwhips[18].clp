...
(defrule activate-OR6-contrad-gwhip[18]
   (declare (salience ?*activate-OR6-contrad-gwhip[18]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW18))
   (assert (technique ?cont OR6-contrad-gwhip[18]))
   (assert (technique ?cont partial-whip[17]))
   (assert (technique ?cont partial-gwhip[17]))
   (bind ?*technique* OR6CgW[18])
)



(defrule track-OR6-contrad-gwhip[18]
   (declare (salience ?*activate-OR6-contrad-gwhip[18]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[18])
=>
...
(defrule OR6-contrad-gwhip[18]
   (declare (salience ?*OR6-contrad-gwhip[18]-salience*))
   (technique ?cont OR6-contrad-gwhip[18])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L18* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-18*) then
