...
(defrule activate-OR6-contrad-gwhip[19]
   (declare (salience ?*activate-OR6-contrad-gwhip[19]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW19))
   (assert (technique ?cont OR6-contrad-gwhip[19]))
   (assert (technique ?cont partial-whip[18]))
   (assert (technique ?cont partial-gwhip[18]))
   (bind ?*technique* OR6CgW[19])
)



(defrule track-OR6-contrad-gwhip[19]
   (declare (salience ?*activate-OR6-contrad-gwhip[19]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[19])
=>
...
(defrule OR6-contrad-gwhip[19]
   (declare (salience ?*OR6-contrad-gwhip[19]-salience*))
   (technique ?cont OR6-contrad-gwhip[19])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L19* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-19*) then
