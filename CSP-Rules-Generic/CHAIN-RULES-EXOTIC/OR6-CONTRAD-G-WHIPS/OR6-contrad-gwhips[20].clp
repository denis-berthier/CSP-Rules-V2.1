...
(defrule activate-OR6-contrad-gwhip[20]
   (declare (salience ?*activate-OR6-contrad-gwhip[20]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW20))
   (assert (technique ?cont OR6-contrad-gwhip[20]))
   (assert (technique ?cont partial-whip[19]))
   (assert (technique ?cont partial-gwhip[19]))
   (bind ?*technique* OR6CgW[20])
)



(defrule track-OR6-contrad-gwhip[20]
   (declare (salience ?*activate-OR6-contrad-gwhip[20]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[20])
=>
...
(defrule OR6-contrad-gwhip[20]
   (declare (salience ?*OR6-contrad-gwhip[20]-salience*))
   (technique ?cont OR6-contrad-gwhip[20])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L20* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-20*) then
