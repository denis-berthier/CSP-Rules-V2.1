...
(defrule activate-OR6-contrad-gwhip[22]
   (declare (salience ?*activate-OR6-contrad-gwhip[22]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW22))
   (assert (technique ?cont OR6-contrad-gwhip[22]))
   (assert (technique ?cont partial-whip[21]))
   (assert (technique ?cont partial-gwhip[21]))
   (bind ?*technique* OR6CgW[22])
)



(defrule track-OR6-contrad-gwhip[22]
   (declare (salience ?*activate-OR6-contrad-gwhip[22]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[22])
=>
...
(defrule OR6-contrad-gwhip[22]
   (declare (salience ?*OR6-contrad-gwhip[22]-salience*))
   (technique ?cont OR6-contrad-gwhip[22])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L22* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-22*) then
