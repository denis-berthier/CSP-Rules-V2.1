...
(defrule activate-OR6-contrad-gwhip[23]
   (declare (salience ?*activate-OR6-contrad-gwhip[23]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW23))
   (assert (technique ?cont OR6-contrad-gwhip[23]))
   (assert (technique ?cont partial-whip[22]))
   (assert (technique ?cont partial-gwhip[22]))
   (bind ?*technique* OR6CgW[23])
)



(defrule track-OR6-contrad-gwhip[23]
   (declare (salience ?*activate-OR6-contrad-gwhip[23]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[23])
=>
...
(defrule OR6-contrad-gwhip[23]
   (declare (salience ?*OR6-contrad-gwhip[23]-salience*))
   (technique ?cont OR6-contrad-gwhip[23])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L23* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-23*) then
