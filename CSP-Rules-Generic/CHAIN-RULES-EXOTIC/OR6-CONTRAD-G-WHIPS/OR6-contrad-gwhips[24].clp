...
(defrule activate-OR6-contrad-gwhip[24]
   (declare (salience ?*activate-OR6-contrad-gwhip[24]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW24))
   (assert (technique ?cont OR6-contrad-gwhip[24]))
   (assert (technique ?cont partial-whip[23]))
   (assert (technique ?cont partial-gwhip[23]))
   (bind ?*technique* OR6CgW[24])
)



(defrule track-OR6-contrad-gwhip[24]
   (declare (salience ?*activate-OR6-contrad-gwhip[24]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[24])
=>
...
(defrule OR6-contrad-gwhip[24]
   (declare (salience ?*OR6-contrad-gwhip[24]-salience*))
   (technique ?cont OR6-contrad-gwhip[24])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L24* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-24*) then
