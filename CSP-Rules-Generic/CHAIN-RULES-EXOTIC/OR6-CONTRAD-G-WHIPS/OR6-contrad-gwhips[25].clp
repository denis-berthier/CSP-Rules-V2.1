...
(defrule activate-OR6-contrad-gwhip[25]
   (declare (salience ?*activate-OR6-contrad-gwhip[25]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW25))
   (assert (technique ?cont OR6-contrad-gwhip[25]))
   (assert (technique ?cont partial-whip[24]))
   (assert (technique ?cont partial-gwhip[24]))
   (bind ?*technique* OR6CgW[25])
)



(defrule track-OR6-contrad-gwhip[25]
   (declare (salience ?*activate-OR6-contrad-gwhip[25]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[25])
=>
...
(defrule OR6-contrad-gwhip[25]
   (declare (salience ?*OR6-contrad-gwhip[25]-salience*))
   (technique ?cont OR6-contrad-gwhip[25])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L25* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-25*) then
