...
(defrule activate-OR6-contrad-gwhip[28]
   (declare (salience ?*activate-OR6-contrad-gwhip[28]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW28))
   (assert (technique ?cont OR6-contrad-gwhip[28]))
   (assert (technique ?cont partial-whip[27]))
   (assert (technique ?cont partial-gwhip[27]))
   (bind ?*technique* OR6CgW[28])
)



(defrule track-OR6-contrad-gwhip[28]
   (declare (salience ?*activate-OR6-contrad-gwhip[28]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[28])
=>
...
(defrule OR6-contrad-gwhip[28]
   (declare (salience ?*OR6-contrad-gwhip[28]-salience*))
   (technique ?cont OR6-contrad-gwhip[28])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L28* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-28*) then
