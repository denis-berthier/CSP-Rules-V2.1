...
(defrule activate-OR6-contrad-gwhip[29]
   (declare (salience ?*activate-OR6-contrad-gwhip[29]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW29))
   (assert (technique ?cont OR6-contrad-gwhip[29]))
   (assert (technique ?cont partial-whip[28]))
   (assert (technique ?cont partial-gwhip[28]))
   (bind ?*technique* OR6CgW[29])
)



(defrule track-OR6-contrad-gwhip[29]
   (declare (salience ?*activate-OR6-contrad-gwhip[29]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[29])
=>
...
(defrule OR6-contrad-gwhip[29]
   (declare (salience ?*OR6-contrad-gwhip[29]-salience*))
   (technique ?cont OR6-contrad-gwhip[29])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L29* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-29*) then
