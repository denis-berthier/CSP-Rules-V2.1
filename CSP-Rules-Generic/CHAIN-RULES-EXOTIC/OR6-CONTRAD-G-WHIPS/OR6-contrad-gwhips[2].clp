...
(defrule activate-OR6-contrad-gwhip[2]
   (declare (salience ?*activate-OR6-contrad-gwhip[2]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW2))
   (assert (technique ?cont OR6-contrad-gwhip[2]))
   (assert (technique ?cont partial-whip[1]))
   (assert (technique ?cont partial-gwhip[1]))
   (bind ?*technique* OR6CgW[2])
)



(defrule track-OR6-contrad-gwhip[2]
   (declare (salience ?*activate-OR6-contrad-gwhip[2]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[2])
=>
...
(defrule OR6-contrad-gwhip[2]
   (declare (salience ?*OR6-contrad-gwhip[2]-salience*))
   (technique ?cont OR6-contrad-gwhip[2])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L2* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-2*) then
