...
(defrule activate-OR6-contrad-gwhip[30]
   (declare (salience ?*activate-OR6-contrad-gwhip[30]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW30))
   (assert (technique ?cont OR6-contrad-gwhip[30]))
   (assert (technique ?cont partial-whip[29]))
   (assert (technique ?cont partial-gwhip[29]))
   (bind ?*technique* OR6CgW[30])
)



(defrule track-OR6-contrad-gwhip[30]
   (declare (salience ?*activate-OR6-contrad-gwhip[30]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[30])
=>
...
(defrule OR6-contrad-gwhip[30]
   (declare (salience ?*OR6-contrad-gwhip[30]-salience*))
   (technique ?cont OR6-contrad-gwhip[30])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L30* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-30*) then
