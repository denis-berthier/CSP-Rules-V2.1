...
(defrule activate-OR6-contrad-gwhip[31]
   (declare (salience ?*activate-OR6-contrad-gwhip[31]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW31))
   (assert (technique ?cont OR6-contrad-gwhip[31]))
   (assert (technique ?cont partial-whip[30]))
   (assert (technique ?cont partial-gwhip[30]))
   (bind ?*technique* OR6CgW[31])
)



(defrule track-OR6-contrad-gwhip[31]
   (declare (salience ?*activate-OR6-contrad-gwhip[31]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[31])
=>
...
(defrule OR6-contrad-gwhip[31]
   (declare (salience ?*OR6-contrad-gwhip[31]-salience*))
   (technique ?cont OR6-contrad-gwhip[31])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L31* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-31*) then
