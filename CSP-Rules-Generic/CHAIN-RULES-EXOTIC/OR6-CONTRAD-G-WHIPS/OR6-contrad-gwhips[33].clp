...
(defrule activate-OR6-contrad-gwhip[33]
   (declare (salience ?*activate-OR6-contrad-gwhip[33]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW33))
   (assert (technique ?cont OR6-contrad-gwhip[33]))
   (assert (technique ?cont partial-whip[32]))
   (assert (technique ?cont partial-gwhip[32]))
   (bind ?*technique* OR6CgW[33])
)



(defrule track-OR6-contrad-gwhip[33]
   (declare (salience ?*activate-OR6-contrad-gwhip[33]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[33])
=>
...
(defrule OR6-contrad-gwhip[33]
   (declare (salience ?*OR6-contrad-gwhip[33]-salience*))
   (technique ?cont OR6-contrad-gwhip[33])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L33* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-33*) then
