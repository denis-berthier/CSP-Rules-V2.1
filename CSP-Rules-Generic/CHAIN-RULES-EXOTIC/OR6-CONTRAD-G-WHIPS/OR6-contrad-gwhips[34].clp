...
(defrule activate-OR6-contrad-gwhip[34]
   (declare (salience ?*activate-OR6-contrad-gwhip[34]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW34))
   (assert (technique ?cont OR6-contrad-gwhip[34]))
   (assert (technique ?cont partial-whip[33]))
   (assert (technique ?cont partial-gwhip[33]))
   (bind ?*technique* OR6CgW[34])
)



(defrule track-OR6-contrad-gwhip[34]
   (declare (salience ?*activate-OR6-contrad-gwhip[34]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[34])
=>
...
(defrule OR6-contrad-gwhip[34]
   (declare (salience ?*OR6-contrad-gwhip[34]-salience*))
   (technique ?cont OR6-contrad-gwhip[34])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L34* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-34*) then
