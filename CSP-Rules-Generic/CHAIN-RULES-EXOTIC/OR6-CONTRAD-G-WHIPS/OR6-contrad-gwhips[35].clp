...
(defrule activate-OR6-contrad-gwhip[35]
   (declare (salience ?*activate-OR6-contrad-gwhip[35]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW35))
   (assert (technique ?cont OR6-contrad-gwhip[35]))
   (assert (technique ?cont partial-whip[34]))
   (assert (technique ?cont partial-gwhip[34]))
   (bind ?*technique* OR6CgW[35])
)



(defrule track-OR6-contrad-gwhip[35]
   (declare (salience ?*activate-OR6-contrad-gwhip[35]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[35])
=>
...
(defrule OR6-contrad-gwhip[35]
   (declare (salience ?*OR6-contrad-gwhip[35]-salience*))
   (technique ?cont OR6-contrad-gwhip[35])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L35* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-35*) then
