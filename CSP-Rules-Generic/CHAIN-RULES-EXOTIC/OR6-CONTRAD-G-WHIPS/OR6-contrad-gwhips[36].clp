...
(defrule activate-OR6-contrad-gwhip[36]
   (declare (salience ?*activate-OR6-contrad-gwhip[36]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW36))
   (assert (technique ?cont OR6-contrad-gwhip[36]))
   (assert (technique ?cont partial-whip[35]))
   (assert (technique ?cont partial-gwhip[35]))
   (bind ?*technique* OR6CgW[36])
)



(defrule track-OR6-contrad-gwhip[36]
   (declare (salience ?*activate-OR6-contrad-gwhip[36]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[36])
=>
...
(defrule OR6-contrad-gwhip[36]
   (declare (salience ?*OR6-contrad-gwhip[36]-salience*))
   (technique ?cont OR6-contrad-gwhip[36])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L36* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-36*) then
