...
(defrule activate-OR6-contrad-gwhip[3]
   (declare (salience ?*activate-OR6-contrad-gwhip[3]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW3))
   (assert (technique ?cont OR6-contrad-gwhip[3]))
   (assert (technique ?cont partial-whip[2]))
   (assert (technique ?cont partial-gwhip[2]))
   (bind ?*technique* OR6CgW[3])
)



(defrule track-OR6-contrad-gwhip[3]
   (declare (salience ?*activate-OR6-contrad-gwhip[3]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[3])
=>
...
(defrule OR6-contrad-gwhip[3]
   (declare (salience ?*OR6-contrad-gwhip[3]-salience*))
   (technique ?cont OR6-contrad-gwhip[3])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L3* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-3*) then
