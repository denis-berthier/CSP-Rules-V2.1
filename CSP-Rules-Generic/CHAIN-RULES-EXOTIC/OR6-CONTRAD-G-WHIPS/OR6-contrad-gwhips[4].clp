...
(defrule activate-OR6-contrad-gwhip[4]
   (declare (salience ?*activate-OR6-contrad-gwhip[4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW4))
   (assert (technique ?cont OR6-contrad-gwhip[4]))
   (assert (technique ?cont partial-whip[3]))
   (assert (technique ?cont partial-gwhip[3]))
   (bind ?*technique* OR6CgW[4])
)



(defrule track-OR6-contrad-gwhip[4]
   (declare (salience ?*activate-OR6-contrad-gwhip[4]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[4])
=>
...
(defrule OR6-contrad-gwhip[4]
   (declare (salience ?*OR6-contrad-gwhip[4]-salience*))
   (technique ?cont OR6-contrad-gwhip[4])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L4* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-4*) then
