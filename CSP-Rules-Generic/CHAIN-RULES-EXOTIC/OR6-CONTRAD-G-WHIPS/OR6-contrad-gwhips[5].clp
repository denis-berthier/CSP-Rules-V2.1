...
(defrule activate-OR6-contrad-gwhip[5]
   (declare (salience ?*activate-OR6-contrad-gwhip[5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW5))
   (assert (technique ?cont OR6-contrad-gwhip[5]))
   (assert (technique ?cont partial-whip[4]))
   (assert (technique ?cont partial-gwhip[4]))
   (bind ?*technique* OR6CgW[5])
)



(defrule track-OR6-contrad-gwhip[5]
   (declare (salience ?*activate-OR6-contrad-gwhip[5]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[5])
=>
...
(defrule OR6-contrad-gwhip[5]
   (declare (salience ?*OR6-contrad-gwhip[5]-salience*))
   (technique ?cont OR6-contrad-gwhip[5])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L5* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-5*) then
