...
(defrule activate-OR6-contrad-gwhip[6]
   (declare (salience ?*activate-OR6-contrad-gwhip[6]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW6))
   (assert (technique ?cont OR6-contrad-gwhip[6]))
   (assert (technique ?cont partial-whip[5]))
   (assert (technique ?cont partial-gwhip[5]))
   (bind ?*technique* OR6CgW[6])
)



(defrule track-OR6-contrad-gwhip[6]
   (declare (salience ?*activate-OR6-contrad-gwhip[6]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[6])
=>
...
(defrule OR6-contrad-gwhip[6]
   (declare (salience ?*OR6-contrad-gwhip[6]-salience*))
   (technique ?cont OR6-contrad-gwhip[6])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L6* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-6*) then
