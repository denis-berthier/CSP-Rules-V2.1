...
(defrule activate-OR6-contrad-gwhip[9]
   (declare (salience ?*activate-OR6-contrad-gwhip[9]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CgW9))
   (assert (technique ?cont OR6-contrad-gwhip[9]))
   (assert (technique ?cont partial-whip[8]))
   (assert (technique ?cont partial-gwhip[8]))
   (bind ?*technique* OR6CgW[9])
)



(defrule track-OR6-contrad-gwhip[9]
   (declare (salience ?*activate-OR6-contrad-gwhip[9]-salience*))
   ?level <- (technique ?cont OR6-contrad-gwhip[9])
=>
...
(defrule OR6-contrad-gwhip[9]
   (declare (salience ?*OR6-contrad-gwhip[9]-salience*))
   (technique ?cont OR6-contrad-gwhip[9])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L9* ?*print-OR6-contrad-gwhip* ?*print-OR6-contrad-gwhip-9*) then
