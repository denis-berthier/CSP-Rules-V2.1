...
(defrule activate-OR6-contrad-whip[3]
   (declare (salience ?*activate-OR6-contrad-whip[3]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CW3))
   (assert (technique ?cont OR6-contrad-whip[3]))
   (assert (technique ?cont partial-whip[2]))
   (bind ?*technique* OR6CW[3])
)



(defrule track-OR6-contrad-whip[3]
   (declare (salience ?*activate-OR6-contrad-whip[3]-salience*))
   ?level <- (technique ?cont OR6-contrad-whip[3])
=>
...
(defrule OR6-contrad-whip[3]
   (declare (salience ?*OR6-contrad-whip[3]-salience*))
   (technique ?cont OR6-contrad-whip[3])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L3* ?*print-OR6-contrad-whip* ?*print-OR6-contrad-whip-3*) then
