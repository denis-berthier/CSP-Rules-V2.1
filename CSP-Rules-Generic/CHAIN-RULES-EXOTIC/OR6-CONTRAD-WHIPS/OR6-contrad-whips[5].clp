...
(defrule activate-OR6-contrad-whip[5]
   (declare (salience ?*activate-OR6-contrad-whip[5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CW5))
   (assert (technique ?cont OR6-contrad-whip[5]))
   (assert (technique ?cont partial-whip[4]))
   (bind ?*technique* OR6CW[5])
)



(defrule track-OR6-contrad-whip[5]
   (declare (salience ?*activate-OR6-contrad-whip[5]-salience*))
   ?level <- (technique ?cont OR6-contrad-whip[5])
=>
...
(defrule OR6-contrad-whip[5]
   (declare (salience ?*OR6-contrad-whip[5]-salience*))
   (technique ?cont OR6-contrad-whip[5])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L5* ?*print-OR6-contrad-whip* ?*print-OR6-contrad-whip-5*) then
