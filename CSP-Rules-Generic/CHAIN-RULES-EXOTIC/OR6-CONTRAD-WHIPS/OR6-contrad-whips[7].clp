...
(defrule activate-OR6-contrad-whip[7]
   (declare (salience ?*activate-OR6-contrad-whip[7]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CW7))
   (assert (technique ?cont OR6-contrad-whip[7]))
   (assert (technique ?cont partial-whip[6]))
   (bind ?*technique* OR6CW[7])
)



(defrule track-OR6-contrad-whip[7]
   (declare (salience ?*activate-OR6-contrad-whip[7]-salience*))
   ?level <- (technique ?cont OR6-contrad-whip[7])
=>
...
(defrule OR6-contrad-whip[7]
   (declare (salience ?*OR6-contrad-whip[7]-salience*))
   (technique ?cont OR6-contrad-whip[7])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L7* ?*print-OR6-contrad-whip* ?*print-OR6-contrad-whip-7*) then
