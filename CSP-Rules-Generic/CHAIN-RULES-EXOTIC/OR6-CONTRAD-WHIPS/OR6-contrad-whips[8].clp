...
(defrule activate-OR6-contrad-whip[8]
   (declare (salience ?*activate-OR6-contrad-whip[8]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6CW8))
   (assert (technique ?cont OR6-contrad-whip[8]))
   (assert (technique ?cont partial-whip[7]))
   (bind ?*technique* OR6CW[8])
)



(defrule track-OR6-contrad-whip[8]
   (declare (salience ?*activate-OR6-contrad-whip[8]-salience*))
   ?level <- (technique ?cont OR6-contrad-whip[8])
=>
...
(defrule OR6-contrad-whip[8]
   (declare (salience ?*OR6-contrad-whip[8]-salience*))
   (technique ?cont OR6-contrad-whip[8])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L8* ?*print-OR6-contrad-whip* ?*print-OR6-contrad-whip-8*) then
