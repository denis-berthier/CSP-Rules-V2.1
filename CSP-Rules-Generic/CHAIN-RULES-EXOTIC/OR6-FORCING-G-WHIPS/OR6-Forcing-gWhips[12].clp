...
(defrule activate-OR6-forcing-gwhip[12]
   (declare (salience ?*activate-OR6-forcing-gwhip[12]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR6-forcing-gwhip[12]))
   (assert (technique ?cont partial-whip[11]))
   (assert (technique ?cont partial-gwhip[11]))
   (bind ?*technique* OR6FgW[12])
)



(defrule track-OR6-forcing-gwhip[12]
   (declare (salience ?*activate-OR6-forcing-gwhip[12]-salience*))
   ?level <- (technique ?cont OR6-forcing-gwhip[12])
=>
...
(defrule OR6-forcing-gwhip[12]-candidate-00000p
   (declare (salience ?*OR6-forcing-gwhip[12]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[12])
...
(defrule OR6-forcing-gwhip[12]-candidate-0000pq
   (declare (salience ?*OR6-forcing-gwhip[12]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[12])
...
(defrule OR6-forcing-gwhip[12]-candidate-000pqr
   (declare (salience ?*OR6-forcing-gwhip[12]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[12])
...
(defrule OR6-forcing-gwhip[12]-candidate-00pqrs
   (declare (salience ?*OR6-forcing-gwhip[12]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[12])
...
(defrule OR6-forcing-gwhip[12]-candidate-0pqrst
   (declare (salience ?*OR6-forcing-gwhip[12]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[12])
...
(defrule OR6-forcing-gwhip[12]-candidate-pqrstu
   (declare (salience ?*OR6-forcing-gwhip[12]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[12])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
...
(defrule OR6-forcing-gwhip[12]-value
   (declare (salience ?*OR6-forcing-gwhip[12]-value-salience*))
   (technique ?cont OR6-forcing-gwhip[12])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
