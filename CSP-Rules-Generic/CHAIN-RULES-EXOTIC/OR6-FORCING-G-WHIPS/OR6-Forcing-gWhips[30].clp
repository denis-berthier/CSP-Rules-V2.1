...
(defrule activate-OR6-forcing-gwhip[30]
   (declare (salience ?*activate-OR6-forcing-gwhip[30]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6FW30))
   (assert (technique ?cont OR6-forcing-gwhip[30]))
   (assert (technique ?cont partial-whip[29]))
   (assert (technique ?cont partial-gwhip[29]))
   (bind ?*technique* OR6FgW[30])
)



(defrule track-OR6-forcing-gwhip[30]
   (declare (salience ?*activate-OR6-forcing-gwhip[30]-salience*))
   ?level <- (technique ?cont OR6-forcing-gwhip[30])
=>
...
(defrule OR6-forcing-gwhip[30]-candidate-00000p
   (declare (salience ?*OR6-forcing-gwhip[30]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[30])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L30* ?*print-OR6-forcing-gwhip* ?*print-OR6-forcing-gwhip-30*) then
...
(defrule OR6-forcing-gwhip[30]-candidate-0000pq
   (declare (salience ?*OR6-forcing-gwhip[30]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[30])
   ...
   (chain
      ...
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p5 ?p6) 29))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
...
(defrule OR6-forcing-gwhip[30]-candidate-000pqr
   (declare (salience ?*OR6-forcing-gwhip[30]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[30])
   ...
   (chain
      ...
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p4 ?p5 ?p6) 29))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
...
(defrule OR6-forcing-gwhip[30]-candidate-00pqrs
   (declare (salience ?*OR6-forcing-gwhip[30]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[30])
   ...
   (chain
      (type ?type4&:(or (eq ?type4 partial-whip) (eq ?type4 partial-gwhip)))
      (context ?cont)
      (length ?p4&:(or (< ?p3 ?p4) (and (= ?p3 ?p4) (< ?zzz3 ?zzz4)))&:(< (+ ?p3 ?p4) 28))
      (target ?zzz4)
      (llcs $?llcs4)
      (rlcs $?rlcs4)
      (csp-vars $?csps4)
   ...
   (chain
      ...
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p3 ?p4 ?p5 ?p6) 29))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
...
(defrule OR6-forcing-gwhip[30]-candidate-0pqrst
   (declare (salience ?*OR6-forcing-gwhip[30]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[30])
   ...
   (chain
      (type ?type3&:(or (eq ?type3 partial-whip) (eq ?type3 partial-gwhip)))
      (context ?cont)
      (length ?p3&:(or (< ?p2 ?p3) (and (= ?p2 ?p3) (< ?zzz2 ?zzz3)))&:(< (+ ?p2 ?p3) 27))
      (target ?zzz3)
      (llcs $?llcs3)
      (rlcs $?rlcs3)
      (csp-vars $?csps3)
   ...
   (chain
      (type ?type4&:(or (eq ?type4 partial-whip) (eq ?type4 partial-gwhip)))
      (context ?cont)
      (length ?p4&:(or (< ?p3 ?p4) (and (= ?p3 ?p4) (< ?zzz3 ?zzz4)))&:(< (+ ?p2 ?p3 ?p4) 28))
      (target ?zzz4)
      (llcs $?llcs4)
      (rlcs $?rlcs4)
      (csp-vars $?csps4)
   ...
   (chain
      ...
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p2 ?p3 ?p4 ?p5 ?p6) 29))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
...
(defrule OR6-forcing-gwhip[30]-candidate-pqrstu
   (declare (salience ?*OR6-forcing-gwhip[30]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[30])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
   ...
   (chain
      (type ?type3&:(or (eq ?type3 partial-whip) (eq ?type3 partial-gwhip)))
      (context ?cont)
      (length ?p3&:(or (< ?p2 ?p3) (and (= ?p2 ?p3) (< ?zzz2 ?zzz3)))&:(< (+ ?p1 ?p2 ?p3) 27))
      (target ?zzz3)
      (llcs $?llcs3)
      (rlcs $?rlcs3)
      (csp-vars $?csps3)
   ...
   (chain
      (type ?type4&:(or (eq ?type4 partial-whip) (eq ?type4 partial-gwhip)))
      (context ?cont)
      (length ?p4&:(or (< ?p3 ?p4) (and (= ?p3 ?p4) (< ?zzz3 ?zzz4)))&:(< (+ ?p1 ?p2 ?p3 ?p4) 28))
      (target ?zzz4)
      (llcs $?llcs4)
      (rlcs $?rlcs4)
      (csp-vars $?csps4)
   ...
   (chain
      ...
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p1 ?p2 ?p3 ?p4 ?p5 ?p6) 29))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
...
(defrule OR6-forcing-gwhip[30]-value
   (declare (salience ?*OR6-forcing-gwhip[30]-value-salience*))
   (technique ?cont OR6-forcing-gwhip[30])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
