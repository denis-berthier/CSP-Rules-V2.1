...
(defrule activate-OR6-forcing-gwhip[6]
   (declare (salience ?*activate-OR6-forcing-gwhip[6]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6FW6))
   (assert (technique ?cont OR6-forcing-gwhip[6]))
   (assert (technique ?cont partial-whip[5]))
   (assert (technique ?cont partial-gwhip[5]))
   (bind ?*technique* OR6FgW[6])
)



(defrule track-OR6-forcing-gwhip[6]
   (declare (salience ?*activate-OR6-forcing-gwhip[6]-salience*))
   ?level <- (technique ?cont OR6-forcing-gwhip[6])
=>
...
(defrule OR6-forcing-gwhip[6]-candidate-00000p
   (declare (salience ?*OR6-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[6])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L6* ?*print-OR6-forcing-gwhip* ?*print-OR6-forcing-gwhip-6*) then
...
(defrule OR6-forcing-gwhip[6]-candidate-0000pq
   (declare (salience ?*OR6-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[6])
   ...
   (chain
      ...
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p5 ?p6) 5))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
...
(defrule OR6-forcing-gwhip[6]-candidate-000pqr
   (declare (salience ?*OR6-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[6])
   ...
   (chain
      ...
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p4 ?p5 ?p6) 5))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
...
(defrule OR6-forcing-gwhip[6]-candidate-00pqrs
   (declare (salience ?*OR6-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[6])
   ...
   (chain
      ...
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p3 ?p4 ?p5 ?p6) 5))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
...
(defrule OR6-forcing-gwhip[6]-candidate-0pqrst
   (declare (salience ?*OR6-forcing-gwhip[6]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[6])
   ...
   (chain
      ...
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p2 ?p3 ?p4 ?p5 ?p6) 5))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
