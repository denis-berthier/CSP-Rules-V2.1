...
(defrule activate-OR6-forcing-gwhip[8]
   (declare (salience ?*activate-OR6-forcing-gwhip[8]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR6-forcing-gwhip[8]))
   (assert (technique ?cont partial-whip[7]))
   (assert (technique ?cont partial-gwhip[7]))
   (bind ?*technique* OR6FgW[8])
)



(defrule track-OR6-forcing-gwhip[8]
   (declare (salience ?*activate-OR6-forcing-gwhip[8]-salience*))
   ?level <- (technique ?cont OR6-forcing-gwhip[8])
=>
...
(defrule OR6-forcing-gwhip[8]-candidate-00000p
   (declare (salience ?*OR6-forcing-gwhip[8]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[8])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L8* ?*print-OR6-forcing-gwhip* ?*print-OR6-forcing-gwhip-8*) then
...
(defrule OR6-forcing-gwhip[8]-candidate-0000pq
   (declare (salience ?*OR6-forcing-gwhip[8]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[8])
...
(defrule OR6-forcing-gwhip[8]-candidate-000pqr
   (declare (salience ?*OR6-forcing-gwhip[8]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[8])
...
(defrule OR6-forcing-gwhip[8]-candidate-00pqrs
   (declare (salience ?*OR6-forcing-gwhip[8]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[8])
...
(defrule OR6-forcing-gwhip[8]-candidate-0pqrst
   (declare (salience ?*OR6-forcing-gwhip[8]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[8])
...
(defrule OR6-forcing-gwhip[8]-candidate-pqrstu
   (declare (salience ?*OR6-forcing-gwhip[8]-candidate-salience*))
   (technique ?cont OR6-forcing-gwhip[8])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
...
(defrule OR6-forcing-gwhip[8]-value
   (declare (salience ?*OR6-forcing-gwhip[8]-value-salience*))
   (technique ?cont OR6-forcing-gwhip[8])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
      (type ?type1&:(or (eq ?type1 partial-whip) (eq ?type1 partial-gwhip)))
