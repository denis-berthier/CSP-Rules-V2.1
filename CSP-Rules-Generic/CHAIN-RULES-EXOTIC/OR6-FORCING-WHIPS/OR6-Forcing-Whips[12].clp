...
(defrule activate-OR6-forcing-whip[12]
   (declare (salience ?*activate-OR6-forcing-whip[12]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6FW12))
   (assert (technique ?cont OR6-forcing-whip[12]))
   (assert (technique ?cont partial-whip[11]))
   (bind ?*technique* OR6FW[12])
)



(defrule track-OR6-forcing-whip[12]
   (declare (salience ?*activate-OR6-forcing-whip[12]-salience*))
   ?level <- (technique ?cont OR6-forcing-whip[12])
=>
...
(defrule OR6-forcing-whip[12]-candidate-00000p
   (declare (salience ?*OR6-forcing-whip[12]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[12])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L12* ?*print-OR6-forcing-whip* ?*print-OR6-forcing-whip-12*) then
...
(defrule OR6-forcing-whip[12]-candidate-0000pq
   (declare (salience ?*OR6-forcing-whip[12]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[12])
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p5 ?p6) 11))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
...
(defrule OR6-forcing-whip[12]-candidate-000pqr
   (declare (salience ?*OR6-forcing-whip[12]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[12])
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p5&:(or (< ?p4 ?p5) (and (= ?p4 ?p5) (< ?zzz4 ?zzz5)))&:(< (+ ?p4 ?p5) 11))
      (target ?zzz5)
      (llcs $?llcs5)
      (rlcs $?rlcs5)
      (csp-vars $?csps5)
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p4 ?p5 ?p6) 11))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
...
(defrule OR6-forcing-whip[12]-candidate-00pqrs
   (declare (salience ?*OR6-forcing-whip[12]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[12])
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p4&:(or (< ?p3 ?p4) (and (= ?p3 ?p4) (< ?zzz3 ?zzz4)))&:(< (+ ?p3 ?p4) 10))
      (target ?zzz4)
      (llcs $?llcs4)
      (rlcs $?rlcs4)
      (csp-vars $?csps4)
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p5&:(or (< ?p4 ?p5) (and (= ?p4 ?p5) (< ?zzz4 ?zzz5)))&:(< (+ ?p3 ?p4 ?p5) 11))
      (target ?zzz5)
      (llcs $?llcs5)
      (rlcs $?rlcs5)
      (csp-vars $?csps5)
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p3 ?p4 ?p5 ?p6) 11))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
...
(defrule OR6-forcing-whip[12]-candidate-0pqrst
   (declare (salience ?*OR6-forcing-whip[12]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[12])
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p4&:(or (< ?p3 ?p4) (and (= ?p3 ?p4) (< ?zzz3 ?zzz4)))&:(< (+ ?p2 ?p3 ?p4) 10))
      (target ?zzz4)
      (llcs $?llcs4)
      (rlcs $?rlcs4)
      (csp-vars $?csps4)
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p5&:(or (< ?p4 ?p5) (and (= ?p4 ?p5) (< ?zzz4 ?zzz5)))&:(< (+ ?p2 ?p3 ?p4 ?p5) 11))
      (target ?zzz5)
      (llcs $?llcs5)
      (rlcs $?rlcs5)
      (csp-vars $?csps5)
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p2 ?p3 ?p4 ?p5 ?p6) 11))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
...
(defrule OR6-forcing-whip[12]-candidate-pqrstu
   (declare (salience ?*OR6-forcing-whip[12]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[12])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p2&:(or (< ?p1 ?p2) (and (= ?p1 ?p2) (< ?zzz1 ?zzz2)))&:(< (+ ?p1 ?p2) 8))
      (target ?zzz2)
      (llcs $?llcs2)
      (rlcs $?rlcs2)
      (csp-vars $?csps2)
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p4&:(or (< ?p3 ?p4) (and (= ?p3 ?p4) (< ?zzz3 ?zzz4)))&:(< (+ ?p1 ?p2 ?p3 ?p4) 10))
      (target ?zzz4)
      (llcs $?llcs4)
      (rlcs $?rlcs4)
      (csp-vars $?csps4)
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p5&:(or (< ?p4 ?p5) (and (= ?p4 ?p5) (< ?zzz4 ?zzz5)))&:(< (+ ?p1 ?p2 ?p3 ?p4 ?p5) 11))
      (target ?zzz5)
      (llcs $?llcs5)
      (rlcs $?rlcs5)
      (csp-vars $?csps5)
   ...
   (chain
      (type partial-whip)
      (context ?cont)
      (length ?p6&:(or (< ?p5 ?p6) (and (= ?p5 ?p6) (< ?zzz5 ?zzz6)))&:(= (+ ?p1 ?p2 ?p3 ?p4 ?p5 ?p6) 11))
      (target ?zzz6)
      (llcs $?llcs6)
      (rlcs $?rlcs6)
      (csp-vars $?csps6)
...
(defrule OR6-forcing-whip[12]-value
   (declare (salience ?*OR6-forcing-whip[12]-value-salience*))
   (technique ?cont OR6-forcing-whip[12])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
      (type partial-whip)
