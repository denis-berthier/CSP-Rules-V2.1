...
(defrule activate-OR6-forcing-whip[19]
   (declare (salience ?*activate-OR6-forcing-whip[19]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR6-forcing-whip[19]))
   (assert (technique ?cont partial-whip[18]))
   (bind ?*technique* OR6FW[19])
)



(defrule track-OR6-forcing-whip[19]
   (declare (salience ?*activate-OR6-forcing-whip[19]-salience*))
   ?level <- (technique ?cont OR6-forcing-whip[19])
=>
...
(defrule OR6-forcing-whip[19]-candidate-00000p
   (declare (salience ?*OR6-forcing-whip[19]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[19])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L19* ?*print-OR6-forcing-whip* ?*print-OR6-forcing-whip-19*) then
...
(defrule OR6-forcing-whip[19]-candidate-0000pq
   (declare (salience ?*OR6-forcing-whip[19]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[19])
...
(defrule OR6-forcing-whip[19]-candidate-000pqr
   (declare (salience ?*OR6-forcing-whip[19]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[19])
...
(defrule OR6-forcing-whip[19]-candidate-00pqrs
   (declare (salience ?*OR6-forcing-whip[19]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[19])
...
(defrule OR6-forcing-whip[19]-candidate-0pqrst
   (declare (salience ?*OR6-forcing-whip[19]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[19])
...
(defrule OR6-forcing-whip[19]-candidate-pqrstu
   (declare (salience ?*OR6-forcing-whip[19]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[19])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
...
(defrule OR6-forcing-whip[19]-value
   (declare (salience ?*OR6-forcing-whip[19]-value-salience*))
   (technique ?cont OR6-forcing-whip[19])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
      (type partial-whip)
