...
(defrule activate-OR6-forcing-whip[24]
   (declare (salience ?*activate-OR6-forcing-whip[24]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR6-forcing-whip[24]))
   (assert (technique ?cont partial-whip[23]))
   (bind ?*technique* OR6FW[24])
)



(defrule track-OR6-forcing-whip[24]
   (declare (salience ?*activate-OR6-forcing-whip[24]-salience*))
   ?level <- (technique ?cont OR6-forcing-whip[24])
=>
...
(defrule OR6-forcing-whip[24]-candidate-00000p
   (declare (salience ?*OR6-forcing-whip[24]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[24])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L24* ?*print-OR6-forcing-whip* ?*print-OR6-forcing-whip-24*) then
...
(defrule OR6-forcing-whip[24]-candidate-0000pq
   (declare (salience ?*OR6-forcing-whip[24]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[24])
...
(defrule OR6-forcing-whip[24]-candidate-000pqr
   (declare (salience ?*OR6-forcing-whip[24]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[24])
...
(defrule OR6-forcing-whip[24]-candidate-00pqrs
   (declare (salience ?*OR6-forcing-whip[24]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[24])
...
(defrule OR6-forcing-whip[24]-candidate-0pqrst
   (declare (salience ?*OR6-forcing-whip[24]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[24])
...
(defrule OR6-forcing-whip[24]-candidate-pqrstu
   (declare (salience ?*OR6-forcing-whip[24]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[24])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
...
(defrule OR6-forcing-whip[24]-value
   (declare (salience ?*OR6-forcing-whip[24]-value-salience*))
   (technique ?cont OR6-forcing-whip[24])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
      (type partial-whip)
