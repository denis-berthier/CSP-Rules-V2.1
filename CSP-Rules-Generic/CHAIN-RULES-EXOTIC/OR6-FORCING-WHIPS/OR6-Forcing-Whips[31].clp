...
(defrule activate-OR6-forcing-whip[31]
   (declare (salience ?*activate-OR6-forcing-whip[31]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR6-forcing-whip[31]))
   (assert (technique ?cont partial-whip[30]))
   (bind ?*technique* OR6FW[31])
)



(defrule track-OR6-forcing-whip[31]
   (declare (salience ?*activate-OR6-forcing-whip[31]-salience*))
   ?level <- (technique ?cont OR6-forcing-whip[31])
=>
...
(defrule OR6-forcing-whip[31]-candidate-00000p
   (declare (salience ?*OR6-forcing-whip[31]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[31])
...
=>
   ...
   (if (or ?*print-actions* ?*print-L31* ?*print-OR6-forcing-whip* ?*print-OR6-forcing-whip-31*) then
...
(defrule OR6-forcing-whip[31]-candidate-0000pq
   (declare (salience ?*OR6-forcing-whip[31]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[31])
...
(defrule OR6-forcing-whip[31]-candidate-000pqr
   (declare (salience ?*OR6-forcing-whip[31]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[31])
...
(defrule OR6-forcing-whip[31]-candidate-00pqrs
   (declare (salience ?*OR6-forcing-whip[31]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[31])
...
(defrule OR6-forcing-whip[31]-candidate-0pqrst
   (declare (salience ?*OR6-forcing-whip[31]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[31])
...
(defrule OR6-forcing-whip[31]-candidate-pqrstu
   (declare (salience ?*OR6-forcing-whip[31]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[31])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
...
(defrule OR6-forcing-whip[31]-value
   (declare (salience ?*OR6-forcing-whip[31]-value-salience*))
   (technique ?cont OR6-forcing-whip[31])
   (ORk-relation (OR-name ?or-name) (OR-complexity ?or-compl) (context ?cont) (OR-size 6) (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6))
   (chain
      (type partial-whip)
