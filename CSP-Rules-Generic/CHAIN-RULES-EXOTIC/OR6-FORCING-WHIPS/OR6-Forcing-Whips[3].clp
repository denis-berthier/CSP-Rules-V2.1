...
(defrule activate-OR6-forcing-whip[3]
   (declare (salience ?*activate-OR6-forcing-whip[3]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   ...
   (assert (technique ?cont OR6-forcing-whip[3]))
   (assert (technique ?cont partial-whip[2]))
   (bind ?*technique* OR6FW[3])
)



(defrule track-OR6-forcing-whip[3]
   (declare (salience ?*activate-OR6-forcing-whip[3]-salience*))
   ?level <- (technique ?cont OR6-forcing-whip[3])
=>
...
(defrule OR6-forcing-whip[3]-candidate-00000p
   (declare (salience ?*OR6-forcing-whip[3]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[3])
...
=>
   (retract ?ret)
   (if (or ?*print-actions* ?*print-L3* ?*print-OR6-forcing-whip* ?*print-OR6-forcing-whip-3*) then
...
(defrule OR6-forcing-whip[3]-candidate-0000pq
   (declare (salience ?*OR6-forcing-whip[3]-candidate-salience*))
   (technique ?cont OR6-forcing-whip[3])
