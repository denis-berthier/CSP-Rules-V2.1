...
(defrule activate-OR6-gwhip[23]
   (declare (salience ?*activate-OR6-gwhip[23]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6gW23))
   (assert (technique ?cont OR6-gwhip[23]))
   (assert (technique ?cont partial-whip[22]))
   (assert (technique ?cont partial-gwhip[22]))
   (assert (technique ?cont partial-OR6-gwhip[22]))
   (bind ?*technique* OR6gW[23])
)



(defrule track-OR6-gwhip[23]
   (declare (salience ?*activate-OR6-gwhip[23]-salience*))
   ?level <- (technique ?cont OR6-gwhip[23])
=>
...
(defrule OR6-gwhip[23]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR6-gwhip[23]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L23* ?*print-OR6-gwhip* ?*print-OR6-gwhip-23*) then
...
(defrule OR6-gwhip[23]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR6-gwhip[23]-salience-2*))
   (ORk-chain
      (type partial-OR6-gwhip)
      (context ?cont)
      (length 22)
