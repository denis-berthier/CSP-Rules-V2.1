...
(defrule activate-OR6-gwhip[30]
   (declare (salience ?*activate-OR6-gwhip[30]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6gW30))
   (assert (technique ?cont OR6-gwhip[30]))
   (assert (technique ?cont partial-whip[29]))
   (assert (technique ?cont partial-gwhip[29]))
   (assert (technique ?cont partial-OR6-gwhip[29]))
   (bind ?*technique* OR6gW[30])
)



(defrule track-OR6-gwhip[30]
   (declare (salience ?*activate-OR6-gwhip[30]-salience*))
   ?level <- (technique ?cont OR6-gwhip[30])
=>
...
(defrule OR6-gwhip[30]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR6-gwhip[30]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L30* ?*print-OR6-gwhip* ?*print-OR6-gwhip-30*) then
...
(defrule OR6-gwhip[30]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR6-gwhip[30]-salience-2*))
   (ORk-chain
      (type partial-OR6-gwhip)
      (context ?cont)
      (length 29)
