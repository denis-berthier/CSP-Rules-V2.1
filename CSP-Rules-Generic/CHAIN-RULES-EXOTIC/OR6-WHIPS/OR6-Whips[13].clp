...
(defrule activate-OR6-whip[13]
   (declare (salience ?*activate-OR6-whip[13]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6W13))
   (assert (technique ?cont OR6-whip[13]))
   (assert (technique ?cont partial-whip[12]))
   (assert (technique ?cont partial-OR6-whip[12]))
   (bind ?*technique* OR6W[13])
)



(defrule track-OR6-whip[13]
   (declare (salience ?*activate-OR6-whip[13]-salience*))
   ?level <- (technique ?cont OR6-whip[13])
=>
...
(defrule OR6-whip[13]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR6-whip[13]-salience-1*))
   (ORk-chain
...
(defrule OR6-whip[13]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR6-whip[13]-salience-2*))
   (ORk-chain
      (type partial-OR6-whip)
      (context ?cont)
      (length 12)
