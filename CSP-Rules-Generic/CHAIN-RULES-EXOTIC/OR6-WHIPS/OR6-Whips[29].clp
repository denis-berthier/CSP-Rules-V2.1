...
(defrule activate-OR6-whip[29]
   (declare (salience ?*activate-OR6-whip[29]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6W29))
   (assert (technique ?cont OR6-whip[29]))
   (assert (technique ?cont partial-whip[28]))
   (assert (technique ?cont partial-OR6-whip[28]))
   (bind ?*technique* OR6W[29])
)



(defrule track-OR6-whip[29]
   (declare (salience ?*activate-OR6-whip[29]-salience*))
   ?level <- (technique ?cont OR6-whip[29])
=>
...
(defrule OR6-whip[29]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR6-whip[29]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L29* ?*print-OR6-whip* ?*print-OR6-whip-29*) then
...
(defrule OR6-whip[29]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR6-whip[29]-salience-2*))
   (ORk-chain
      (type partial-OR6-whip)
      (context ?cont)
      (length 28)
