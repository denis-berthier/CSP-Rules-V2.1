...
(defrule activate-OR6-whip[36]
   (declare (salience ?*activate-OR6-whip[36]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_OR6W36))
   (assert (technique ?cont OR6-whip[36]))
   (assert (technique ?cont partial-whip[35]))
   (assert (technique ?cont partial-OR6-whip[35]))
   (bind ?*technique* OR6W[36])
)



(defrule track-OR6-whip[36]
   (declare (salience ?*activate-OR6-whip[36]-salience*))
   ?level <- (technique ?cont OR6-whip[36])
=>
...
(defrule OR6-whip[36]-1
   ;;; case ?len2 = 0,  ?len > 1
   (declare (salience ?*OR6-whip[36]-salience-1*))
   (ORk-chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L36* ?*print-OR6-whip* ?*print-OR6-whip-36*) then
...
(defrule OR6-whip[36]-2
   ;;; case ?len2 ≥ 1
   (declare (salience ?*OR6-whip[36]-salience-2*))
   (ORk-chain
      (type partial-OR6-whip)
      (context ?cont)
      (length 35)
