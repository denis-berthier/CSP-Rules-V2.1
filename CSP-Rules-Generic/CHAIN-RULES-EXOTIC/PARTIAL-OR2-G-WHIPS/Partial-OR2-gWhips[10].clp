...
(defrule partial-OR2-gwhip[10]-1
   ...
   (logical
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont OR2-gwhip[10])
      ;;; because OR2-gwhips[10] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as OR2-gwhips[10] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-OR2-gwhip[10]-2
   (declare (salience ?*partial-OR2-gwhip[10]-salience-2*))
   (logical
      ?ORk <- (ORk-chain
...
(defrule partial-OR2-gwhip[10]-3
   ;;; in this case ?len2 = 0
   (declare (salience ?*partial-OR2-gwhip[10]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
