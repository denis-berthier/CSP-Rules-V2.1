...
(defrule partial-OR2-gwhip[32]-1
   (declare (salience ?*partial-OR2-gwhip[32]-salience-1*))
   (logical
      ?ORk <- (ORk-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont OR2-gwhip[32])
      ;;; because OR2-gwhips[32] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as OR2-gwhips[32] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-OR2-gwhip[32]-2
   (declare (salience ?*partial-OR2-gwhip[32]-salience-2*))
   (logical
      ?ORk <- (ORk-chain
...
(defrule partial-OR2-gwhip[32]-3
   ;;; in this case ?len2 = 0
   (declare (salience ?*partial-OR2-gwhip[32]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
