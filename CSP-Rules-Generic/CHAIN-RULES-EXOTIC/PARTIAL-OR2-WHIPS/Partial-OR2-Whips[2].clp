...
(defrule partial-OR2-whip[2]-1
   (declare (salience ?*partial-OR2-whip[2]-salience-1*))
   (logical
      ?ORk <- (ORk-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont OR2-whip[2])
      ;;; because OR2-whips[2] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as OR2-whips[2] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-OR2-whip[2]-2
   ;;; in this case ?len2 = 0
   (declare (salience ?*partial-OR2-whip[2]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
