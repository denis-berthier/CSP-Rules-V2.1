...
(defrule partial-OR2-whip[30]-1
   (declare (salience ?*partial-OR2-whip[30]-salience-1*))
   (logical
      ?ORk <- (ORk-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont OR2-whip[30])
      ;;; because OR2-whips[30] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as OR2-whips[30] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-OR2-whip[30]-2
   ;;; in this case ?len2 = 0
   (declare (salience ?*partial-OR2-whip[30]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
