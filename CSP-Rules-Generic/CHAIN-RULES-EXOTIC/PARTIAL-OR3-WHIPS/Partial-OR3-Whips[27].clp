...
(defrule partial-OR3-whip[27]-1
   (declare (salience ?*partial-OR3-whip[27]-salience-1*))
   (logical
      ?ORk-chain <- (ORk-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont OR3-whip[27])
      ;;; because OR3-whips[27] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as OR3-whips[27] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-OR3-whip[27]-2
   ;;; in this case ?len2 = 0
   (declare (salience ?*partial-OR3-whip[27]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
