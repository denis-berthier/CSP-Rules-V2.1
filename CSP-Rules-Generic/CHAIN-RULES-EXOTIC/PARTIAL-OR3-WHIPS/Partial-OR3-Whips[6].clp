...
(defrule partial-OR3-whip[6]-1
   (declare (salience ?*partial-OR3-whip[6]-salience-1*))
   (logical
      ?ORk-chain <- (ORk-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont OR3-whip[6])
      ;;; because OR3-whips[6] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as OR3-whips[6] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-OR3-whip[6]-2
   ;;; in this case ?len2 = 0
   (declare (salience ?*partial-OR3-whip[6]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
