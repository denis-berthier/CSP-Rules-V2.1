...
(defrule partial-OR4-whip[29]-1
   (declare (salience ?*partial-OR4-whip[29]-salience-1*))
   (logical
      ?ORk-chain <- (ORk-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont OR4-whip[29])
      ;;; because OR4-whips[29] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as OR4-whips[29] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-OR4-whip[29]-2
   ;;; in this case ?len2 = 0
   (declare (salience ?*partial-OR4-whip[29]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
