...
(defrule partial-OR5-gwhip[33]-1
   (declare (salience ?*partial-OR5-gwhip[33]-salience-1*))
   (logical
      ?ORk <- (ORk-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont OR5-gwhip[33])
      ;;; because OR5-gwhips[33] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as OR5-gwhips[33] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-OR5-gwhip[33]-2
   (declare (salience ?*partial-OR5-gwhip[33]-salience-2*))
   (logical
      ?ORk <- (ORk-chain
...
(defrule partial-OR5-gwhip[33]-3
   ;;; in this case ?len2 = 0
   (declare (salience ?*partial-OR5-gwhip[33]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
