...
(defrule partial-OR5-whip[22]-1
   (declare (salience ?*partial-OR5-whip[22]-salience-1*))
   (logical
      ?ORk-chain <- (ORk-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont OR5-whip[22])
      ;;; because OR5-whips[22] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as OR5-whips[22] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-OR5-whip[22]-2
   ;;; in this case ?len2 = 0
   (declare (salience ?*partial-OR5-whip[22]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
