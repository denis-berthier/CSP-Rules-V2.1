...
(defrule partial-OR6-gwhip[16]-1
   (declare (salience ?*partial-OR6-gwhip[16]-salience-1*))
   (logical
      ?ORk <- (ORk-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont OR6-gwhip[16])
      ;;; because OR6-gwhips[16] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as OR6-gwhips[16] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-OR6-gwhip[16]-2
   (declare (salience ?*partial-OR6-gwhip[16]-salience-2*))
   (logical
      ?ORk <- (ORk-chain
...
(defrule partial-OR6-gwhip[16]-3
   ;;; in this case ?len2 = 0
   (declare (salience ?*partial-OR6-gwhip[16]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
