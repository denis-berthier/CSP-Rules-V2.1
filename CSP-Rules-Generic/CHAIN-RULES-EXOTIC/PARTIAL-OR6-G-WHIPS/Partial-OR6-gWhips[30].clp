...
;;; 1- extension of an existing partial-OR6-gwhip with a candidate

(defrule partial-OR6-gwhip[30]-1
   (declare (salience ?*partial-OR6-gwhip[30]-salience-1*))
   (logical
      ?ORk <- (ORk-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont OR6-gwhip[30])
      ;;; because OR6-gwhips[30] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as OR6-gwhips[30] based on ?zzz have been eliminated (because they have higher salience),
   ...
   ;;; do not assert a partial OR6-gwhip with the same sequences of rlc's or the same OR-rlc or the same last-rlc
   (not (and
      (ORk-chain
         (type partial-OR6-gwhip)
         (context ?cont)
...
;;; 2- extension of an existing partial-OR6- whip or gwhip with a g-candidate

(defrule partial-OR6-gwhip[30]-2
   (declare (salience ?*partial-OR6-gwhip[30]-salience-2*))
   (logical
      ?ORk <- (ORk-chain
         (type partial-OR6-whip|partial-OR6-gwhip)
         (context ?cont)
         (length 29)
         ;;; we don't have to check the other lengths:
         ;;; they are recursively guaranteed by the previous partial-OR6-whips
...
;;; 3- extension of an existing partial-gwhip with an OR6 relation

(defrule partial-OR6-gwhip[30]-3
   ;;; in this case ?len2 = 0
   (declare (salience ?*partial-OR6-gwhip[30]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      (or
         (exists (exists-link ?cont ?zzz4 ?uuu&:(or (eq ?uuu ?last-rlc1) (member$ ?uuu $?rlcs1))))
         (exists (exists-glink ?cont ?zzz4 ?uuu&:(member$ ?uuu $?rlcs1)))
      )
      (or
         (exists (exists-link ?cont ?zzz5 ?uuu&:(or (eq ?uuu ?last-rlc1) (member$ ?uuu $?rlcs1))))
         (exists (exists-glink ?cont ?zzz5 ?uuu&:(member$ ?uuu $?rlcs1)))
      )
      ;;; useless: (not (exists-link ?cont ?last-rlc1 ??zzz6))
      
   ) ; end logical
   ;;; do not assert a partial OR6-gwhip with the same sequences of rlc's or the same OR-rlc or the same last-rlc1
   (not
      (ORk-chain
         (type partial-OR6-gwhip)
         (context ?cont)
