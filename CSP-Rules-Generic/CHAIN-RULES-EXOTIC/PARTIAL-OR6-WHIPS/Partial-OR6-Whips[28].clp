...
(defrule partial-OR6-whip[28]-1
   (declare (salience ?*partial-OR6-whip[28]-salience-1*))
   (logical
      ?ORk-chain <- (ORk-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont OR6-whip[28])
      ;;; because OR6-whips[28] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as OR6-whips[28] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-OR6-whip[28]-2
   ;;; in this case ?len2 = 0
   (declare (salience ?*partial-OR6-whip[28]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
