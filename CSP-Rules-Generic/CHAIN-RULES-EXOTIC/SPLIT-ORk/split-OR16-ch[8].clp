...
;;;
;;;                              CSP-RULES / EXOTIC
;;;                              SPLIT OR16 RELATION via C-CHAIN[8]
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule split-OR16-relation-ch[8]
    (declare (salience ?*split-OR16-relation-ch[8]-salience*))
    ...
    ?ORk <- (ORk-relation
        ...
        (OR-size ?OR-size&16)
        (symmetrified FALSE)
        (OR-candidates ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6 ?zzz7 ?zzz8 ?zzz9 ?zzz10 ?zzz11 ?zzz12 ?zzz13 ?zzz14 ?zzz15 ?zzz16)
    )
    (candidate (context ?cont) (label ?zzzi1&:(or (eq ?zzzi1 ?zzz1) (eq ?zzzi1 ?zzz2) (eq ?zzzi1 ?zzz3) (eq ?zzzi1 ?zzz4) (eq ?zzzi1 ?zzz5) (eq ?zzzi1 ?zzz6) (eq ?zzzi1 ?zzz7) (eq ?zzzi1 ?zzz8) (eq ?zzzi1 ?zzz9) (eq ?zzzi1 ?zzz10) (eq ?zzzi1 ?zzz11) (eq ?zzzi1 ?zzz12) (eq ?zzzi1 ?zzz13) (eq ?zzzi1 ?zzz14) (eq ?zzzi1 ?zzz15) (eq ?zzzi1 ?zzz16))))
    (candidate (context ?cont) (label ?zzzi2&~?zzzi1&:(or (eq ?zzzi2 ?zzz1) (eq ?zzzi2 ?zzz2) (eq ?zzzi2 ?zzz3) (eq ?zzzi2 ?zzz4) (eq ?zzzi2 ?zzz5) (eq ?zzzi2 ?zzz6) (eq ?zzzi2 ?zzz7) (eq ?zzzi2 ?zzz8) (eq ?zzzi2 ?zzz9) (eq ?zzzi2 ?zzz10) (eq ?zzzi2 ?zzz11) (eq ?zzzi2 ?zzz12) (eq ?zzzi2 ?zzz13) (eq ?zzzi2 ?zzz14) (eq ?zzzi2 ?zzz15) (eq ?zzzi2 ?zzz16))))
    (not (same-valence ?cont ?zzzi1 ?zzzi2 ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6 ?zzz7 ?zzz8 ?zzz9 ?zzz10 ?zzz11 ?zzz12 ?zzz13 ?zzz14 ?zzz15 ?zzz16))
    (not (same-valence ?cont ?zzzi2 ?zzzi1 ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6 ?zzz7 ?zzz8 ?zzz9 ?zzz10 ?zzz11 ?zzz12 ?zzz13 ?zzz14 ?zzz15 ?zzz16))
    ...
    (bivalue ?cont ?xxx7 ?zzzi2 ?csp8&~?csp1&~?csp2&~?csp3&~?csp4&~?csp5&~?csp6&~?csp7)
=>
    (retract ?ORk)
    (assert (same-valence ?cont ?zzzi1 ?zzzi2 ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6 ?zzz7 ?zzz8 ?zzz9 ?zzz10 ?zzz11 ?zzz12 ?zzz13 ?zzz14 ?zzz15 ?zzz16))
    (bind ?list1 (create$))
    ...
    (if (neq ?zzz16 ?zzzi1) then (bind ?list1 (create$ ?list1 ?zzz16)))
    (bind ?list2 (create$))
    ...
    (if (neq ?zzz16 ?zzzi2) then (bind ?list2 (create$ ?list2 ?zzz16)))
    (assert
        (ORk-relation
            (OR-name ?OR-name)
            (OR-complexity ?OR-compl)
    ...
    (if ?*print-actions* then
        ...
        (printout t ?OR-name "-OR" ?OR-size "-relation between candidates " (print-label ?zzz1) ", " (print-label ?zzz2) ", " (print-label ?zzz3) ", " (print-label ?zzz4) ", " (print-label ?zzz5) ", " (print-label ?zzz6) ", " (print-label ?zzz7) ", " (print-label ?zzz8) ", " (print-label ?zzz9) ", " (print-label ?zzz10) ", " (print-label ?zzz11) ", " (print-label ?zzz12) ", " (print-label ?zzz13) ", " (print-label ?zzz14) ", " (print-label ?zzz15) " and " (print-label ?zzz16) crlf
            "+ same valence for candidates " (print-label ?zzzi1) " and " (print-label ?zzzi2) " via c-chain[8]: " (print-label ?zzzi1) "," (print-label ?xxx1) "," (print-label ?xxx2) "," (print-label ?xxx3) "," (print-label ?xxx4) "," (print-label ?xxx5) "," (print-label ?xxx6) "," (print-label ?xxx7) "," (print-label ?zzzi2) crlf
