...
=>
   ...
   (if (or ?*print-actions* ?*print-L21* ?*print-t-whip* ?*print-t-whip-21*) then
      (print-t-whip-without-crlf 21 ?zzz 
   ...
   (assert (pseudo-blocked ?cont t-whip[21] ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1))
)



;;; apply-t-whip[21]-to-more-targets

(defrule apply-t-whip[21]-to-more-targets
   (declare (salience ?*apply-a-blocked-rule-salience-1*))
   (pseudo-blocked ?cont t-whip[21] ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1)
