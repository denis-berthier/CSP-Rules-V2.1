...
=>
   ...
   (if (or ?*print-actions* ?*print-L30* ?*print-t-whip* ?*print-t-whip-30*) then
      (print-t-whip-without-crlf 30 ?zzz 
   ...
   (assert (pseudo-blocked ?cont t-whip[30] ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1))
)



;;; apply-t-whip[30]-to-more-targets

(defrule apply-t-whip[30]-to-more-targets
   (declare (salience ?*apply-a-blocked-rule-salience-1*))
   (pseudo-blocked ?cont t-whip[30] ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1)
