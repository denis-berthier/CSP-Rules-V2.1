...
=>
   ...
   (assert (pseudo-blocked ?cont t-whip[33] ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1))
)
...
(defrule apply-t-whip[33]-to-more-targets
   ...
   (pseudo-blocked ?cont t-whip[33] ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1)
