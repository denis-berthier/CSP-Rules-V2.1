...
(defrule detect-typed-t-whip[10]
...
=>
   ...
   (if (or ?*print-actions* ?*print-L10* ?*print-typed-t-whip* ?*print-typed-t-whip-10*) then
      (print-typed-t-whip-without-crlf ?csp-type 10 ?zzz 
   ...
   (assert (pseudo-blocked ?cont typed-t-whip[10]  ?csp-type ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1))
)



;;; apply-typed-t-whip[10]-to-more-targets

(defrule apply-typed-t-whip[10]-to-more-targets
   (declare (salience ?*apply-a-blocked-rule-salience-1*))
   (pseudo-blocked ?cont typed-t-whip[10]  ?csp-type ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1)
