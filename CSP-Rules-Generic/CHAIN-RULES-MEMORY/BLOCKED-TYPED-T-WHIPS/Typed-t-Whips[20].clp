...
(defrule detect-typed-t-whip[20]
...
=>
   ...
   (if (or ?*print-actions* ?*print-L20* ?*print-typed-t-whip* ?*print-typed-t-whip-20*) then
      (print-typed-t-whip-without-crlf ?csp-type 20 ?zzz 
   ...
   (assert (pseudo-blocked ?cont typed-t-whip[20]  ?csp-type ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1))
)



;;; apply-typed-t-whip[20]-to-more-targets

(defrule apply-typed-t-whip[20]-to-more-targets
   (declare (salience ?*apply-a-blocked-rule-salience-1*))
   (pseudo-blocked ?cont typed-t-whip[20]  ?csp-type ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1)
