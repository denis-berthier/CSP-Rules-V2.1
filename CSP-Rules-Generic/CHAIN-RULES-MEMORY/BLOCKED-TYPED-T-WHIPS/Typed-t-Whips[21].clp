...
(defrule detect-typed-t-whip[21]
...
=>
   ...
   (assert (pseudo-blocked ?cont typed-t-whip[21]  ?csp-type ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1))
)
...
(defrule apply-typed-t-whip[21]-to-more-targets
   ...
   (pseudo-blocked ?cont typed-t-whip[21]  ?csp-type ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1)
