...
(defrule detect-typed-t-whip[35]
...
=>
   ...
   (if (or ?*print-actions* ?*print-L35* ?*print-typed-t-whip* ?*print-typed-t-whip-35*) then
      (print-typed-t-whip-without-crlf ?csp-type 35 ?zzz 
   ...
   (assert (pseudo-blocked ?cont typed-t-whip[35]  ?csp-type ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1))
)



;;; apply-typed-t-whip[35]-to-more-targets

(defrule apply-typed-t-whip[35]-to-more-targets
   (declare (salience ?*apply-a-blocked-rule-salience-1*))
   (pseudo-blocked ?cont typed-t-whip[35]  ?csp-type ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1)
