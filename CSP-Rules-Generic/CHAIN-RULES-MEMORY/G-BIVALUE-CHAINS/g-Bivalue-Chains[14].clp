...
(defrule activate-g-bivalue-chain[14]
   (declare (salience ?*activate-g-bivalue-chain[14]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont g-bivalue-chain))
=>
   (if ?*print-levels* then (printout t Entering_level_gBC14))
   (assert (technique ?cont g-bivalue-chain[14]))
   (bind ?*technique* gBC[14])
)



(defrule track-g-bivalue-chain[14]
   (declare (salience ?*activate-g-bivalue-chain[14]-salience*))
   ?level <- (technique ?cont g-bivalue-chain[14])
=>
...
(defrule g-bivalue-chain[14]
   (declare (salience ?*g-bivalue-chain[14]-salience*))
   (chain
...
=>
   ...
   (if (or ?*print-actions* ?*print-L14* ?*print-g-bivalue-chain* ?*print-g-bivalue-chain-14*) then
      (print-g-bivalue-chain 14 ?zzz $?llcs $?rlcs $?csp-vars)
   )
)
...
(defrule partial-g-bivalue-chain[14]-1
   (declare (salience ?*partial-g-bivalue-chain[14]-salience-1*))
   (logical
      (chain
         (type g-bivalue-chain)
         (context ?cont)
      ...
      ;;; ?new-llc
      (technique ?cont g-bivalue-chain[14])
      (or
...
(defrule partial-g-bivalue-chain[14]-2
   (declare (salience ?*partial-g-bivalue-chain[14]-salience-2*))
   (logical
      (chain
         (type g-bivalue-chain)
         (context ?cont)
