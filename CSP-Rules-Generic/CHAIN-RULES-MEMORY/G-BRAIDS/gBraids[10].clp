...
(defrule activate-gbraid[10]
   (declare (salience ?*activate-gbraid[10]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_gB10))
   (assert (technique ?cont gbraid[10]))
   (bind ?*technique* gB[10])
)



(defrule track-gbraid[10]
   (declare (salience ?*activate-gbraid[10]-salience*))
   ?level <- (technique ?cont gbraid[10])
=>
...
(defrule gbraid[10]
   (declare (salience ?*gbraid[10]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 9)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L10* ?*print-gbraid* ?*print-gbraid-10*) then
      (print-gbraid 10 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{9]-1
   (declare (salience ?*partial-gbraid[9]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[9]-2
   (declare (salience ?*partial-gbraid[9]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[9]-3
   (declare (salience ?*partial-gbraid[9]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
