...
(defrule activate-gbraid[12]
   (declare (salience ?*activate-gbraid[12]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB12))
   (assert (technique ?cont gbraid[12]))
   (bind ?*technique* gB[12])
)



(defrule track-gbraid[12]
   (declare (salience ?*activate-gbraid[12]-salience*))
   ?level <- (technique ?cont gbraid[12])
=>
...
(defrule gbraid[12]
   (declare (salience ?*gbraid[12]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 11)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L12* ?*print-gbraid* ?*print-gbraid-12*) then
      (print-gbraid 12 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{11]-1
   (declare (salience ?*partial-gbraid[11]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[11]-2
   (declare (salience ?*partial-gbraid[11]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[11]-3
   (declare (salience ?*partial-gbraid[11]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
