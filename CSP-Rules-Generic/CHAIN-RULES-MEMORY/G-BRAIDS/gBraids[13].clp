...
(defrule activate-gbraid[13]
   (declare (salience ?*activate-gbraid[13]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB13))
   (assert (technique ?cont gbraid[13]))
   (bind ?*technique* gB[13])
)



(defrule track-gbraid[13]
   (declare (salience ?*activate-gbraid[13]-salience*))
   ?level <- (technique ?cont gbraid[13])
=>
...
(defrule gbraid[13]
   (declare (salience ?*gbraid[13]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 12)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L13* ?*print-gbraid* ?*print-gbraid-13*) then
      (print-gbraid 13 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{12]-1
   (declare (salience ?*partial-gbraid[12]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[12]-2
   (declare (salience ?*partial-gbraid[12]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[12]-3
   (declare (salience ?*partial-gbraid[12]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
