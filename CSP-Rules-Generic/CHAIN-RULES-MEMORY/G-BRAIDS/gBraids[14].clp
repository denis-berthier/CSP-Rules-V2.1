...
(defrule activate-gbraid[14]
   (declare (salience ?*activate-gbraid[14]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB14))
   (assert (technique ?cont gbraid[14]))
   (bind ?*technique* gB[14])
)



(defrule track-gbraid[14]
   (declare (salience ?*activate-gbraid[14]-salience*))
   ?level <- (technique ?cont gbraid[14])
=>
...
(defrule gbraid[14]
   (declare (salience ?*gbraid[14]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 13)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L14* ?*print-gbraid* ?*print-gbraid-14*) then
      (print-gbraid 14 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{13]-1
   (declare (salience ?*partial-gbraid[13]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[13]-2
   (declare (salience ?*partial-gbraid[13]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[13]-3
   (declare (salience ?*partial-gbraid[13]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
