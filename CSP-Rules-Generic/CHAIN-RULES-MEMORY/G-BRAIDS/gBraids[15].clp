...
(defrule activate-gbraid[15]
   (declare (salience ?*activate-gbraid[15]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB15))
   (assert (technique ?cont gbraid[15]))
   (bind ?*technique* gB[15])
)



(defrule track-gbraid[15]
   (declare (salience ?*activate-gbraid[15]-salience*))
   ?level <- (technique ?cont gbraid[15])
=>
...
(defrule gbraid[15]
   (declare (salience ?*gbraid[15]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 14)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L15* ?*print-gbraid* ?*print-gbraid-15*) then
      (print-gbraid 15 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{14]-1
   (declare (salience ?*partial-gbraid[14]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[14]-2
   (declare (salience ?*partial-gbraid[14]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[14]-3
   (declare (salience ?*partial-gbraid[14]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
