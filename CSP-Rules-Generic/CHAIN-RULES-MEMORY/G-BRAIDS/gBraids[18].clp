...
(defrule activate-gbraid[18]
   (declare (salience ?*activate-gbraid[18]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB18))
   (assert (technique ?cont gbraid[18]))
   (bind ?*technique* gB[18])
)



(defrule track-gbraid[18]
   (declare (salience ?*activate-gbraid[18]-salience*))
   ?level <- (technique ?cont gbraid[18])
=>
...
(defrule gbraid[18]
   (declare (salience ?*gbraid[18]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 17)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L18* ?*print-gbraid* ?*print-gbraid-18*) then
      (print-gbraid 18 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{17]-1
   (declare (salience ?*partial-gbraid[17]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[17]-2
   (declare (salience ?*partial-gbraid[17]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[17]-3
   (declare (salience ?*partial-gbraid[17]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
