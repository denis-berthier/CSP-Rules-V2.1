...
(defrule activate-gbraid[19]
   (declare (salience ?*activate-gbraid[19]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB19))
   (assert (technique ?cont gbraid[19]))
   (bind ?*technique* gB[19])
)



(defrule track-gbraid[19]
   (declare (salience ?*activate-gbraid[19]-salience*))
   ?level <- (technique ?cont gbraid[19])
=>
...
(defrule gbraid[19]
   (declare (salience ?*gbraid[19]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 18)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L19* ?*print-gbraid* ?*print-gbraid-19*) then
      (print-gbraid 19 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{18]-1
   (declare (salience ?*partial-gbraid[18]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[18]-2
   (declare (salience ?*partial-gbraid[18]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[18]-3
   (declare (salience ?*partial-gbraid[18]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
