...
(defrule activate-gbraid[27]
   (declare (salience ?*activate-gbraid[27]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB27))
   (assert (technique ?cont gbraid[27]))
   (bind ?*technique* gB[27])
)



(defrule track-gbraid[27]
   (declare (salience ?*activate-gbraid[27]-salience*))
   ?level <- (technique ?cont gbraid[27])
=>
...
(defrule gbraid[27]
   (declare (salience ?*gbraid[27]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 26)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L27* ?*print-gbraid* ?*print-gbraid-27*) then
      (print-gbraid 27 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{26]-1
   (declare (salience ?*partial-gbraid[26]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[26]-2
   (declare (salience ?*partial-gbraid[26]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[26]-3
   (declare (salience ?*partial-gbraid[26]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
