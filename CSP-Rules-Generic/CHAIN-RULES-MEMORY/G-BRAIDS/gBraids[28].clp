...
(defrule activate-gbraid[28]
   (declare (salience ?*activate-gbraid[28]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB28))
   (assert (technique ?cont gbraid[28]))
   (bind ?*technique* gB[28])
)



(defrule track-gbraid[28]
   (declare (salience ?*activate-gbraid[28]-salience*))
   ?level <- (technique ?cont gbraid[28])
=>
...
(defrule gbraid[28]
   (declare (salience ?*gbraid[28]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 27)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L28* ?*print-gbraid* ?*print-gbraid-28*) then
      (print-gbraid 28 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{27]-1
   (declare (salience ?*partial-gbraid[27]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[27]-2
   (declare (salience ?*partial-gbraid[27]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[27]-3
   (declare (salience ?*partial-gbraid[27]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
