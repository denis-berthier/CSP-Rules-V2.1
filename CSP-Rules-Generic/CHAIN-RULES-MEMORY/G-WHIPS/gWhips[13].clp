...
(defrule activate-gwhip[13]
   (declare (salience ?*activate-gwhip[13]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gwhip))
=>
   (if ?*print-levels* then (printout t Entering_level_gW13))
   (assert (technique ?cont gwhip[13]))
   (bind ?*technique* gW[13])
)



(defrule track-gwhip[13]
   (declare (salience ?*activate-gwhip[13]-salience*))
   ?level <- (technique ?cont gwhip[13])
=>
...
(defrule gwhip[13]
   (declare (salience ?*gwhip[13]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 12)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L13* ?*print-gwhip* ?*print-gwhip-13*) then
      (print-gwhip 13 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[12]-1
   (declare (salience ?*partial-gwhip[12]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[13])
      ;;; because gwhips[12] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[12] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[12]-2
   (declare (salience ?*partial-gwhip[12]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[12] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[11] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[12]-3
   (declare (salience ?*partial-gwhip[12]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
