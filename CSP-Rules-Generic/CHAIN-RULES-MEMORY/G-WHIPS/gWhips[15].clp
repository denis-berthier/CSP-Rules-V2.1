...
(defrule activate-gwhip[15]
   (declare (salience ?*activate-gwhip[15]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_gW15))
   (assert (technique ?cont gwhip[15]))
   (bind ?*technique* gW[15])
)



(defrule track-gwhip[15]
   (declare (salience ?*activate-gwhip[15]-salience*))
   ?level <- (technique ?cont gwhip[15])
=>
...
(defrule gwhip[15]
   (declare (salience ?*gwhip[15]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 14)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L15* ?*print-gwhip* ?*print-gwhip-15*) then
      (print-gwhip 15 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[14]-1
   (declare (salience ?*partial-gwhip[14]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[15])
      ;;; because gwhips[14] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[14] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[14]-2
   (declare (salience ?*partial-gwhip[14]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[14] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[13] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[14]-3
   (declare (salience ?*partial-gwhip[14]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
