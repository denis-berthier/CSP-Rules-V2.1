...
(defrule activate-gwhip[16]
   (declare (salience ?*activate-gwhip[16]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gwhip))
=>
   (if ?*print-levels* then (printout t Entering_level_gW16))
   (assert (technique ?cont gwhip[16]))
   (bind ?*technique* gW[16])
)



(defrule track-gwhip[16]
   (declare (salience ?*activate-gwhip[16]-salience*))
   ?level <- (technique ?cont gwhip[16])
=>
...
(defrule gwhip[16]
   (declare (salience ?*gwhip[16]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 15)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L16* ?*print-gwhip* ?*print-gwhip-16*) then
      (print-gwhip 16 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[15]-1
   (declare (salience ?*partial-gwhip[15]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[16])
      ;;; because gwhips[15] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[15] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[15]-2
   (declare (salience ?*partial-gwhip[15]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[15] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[14] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[15]-3
   (declare (salience ?*partial-gwhip[15]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
