...
(defrule activate-gwhip[19]
   (declare (salience ?*activate-gwhip[19]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gwhip))
=>
   (if ?*print-levels* then (printout t Entering_level_gW19))
   (assert (technique ?cont gwhip[19]))
   (bind ?*technique* gW[19])
)



(defrule track-gwhip[19]
   (declare (salience ?*activate-gwhip[19]-salience*))
   ?level <- (technique ?cont gwhip[19])
=>
...
(defrule gwhip[19]
   (declare (salience ?*gwhip[19]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 18)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L19* ?*print-gwhip* ?*print-gwhip-19*) then
      (print-gwhip 19 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[18]-1
   (declare (salience ?*partial-gwhip[18]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[19])
      ;;; because gwhips[18] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[18] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[18]-2
   (declare (salience ?*partial-gwhip[18]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[18] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[17] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[18]-3
   (declare (salience ?*partial-gwhip[18]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
