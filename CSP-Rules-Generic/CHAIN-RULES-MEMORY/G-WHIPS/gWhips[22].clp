...
(defrule activate-gwhip[22]
   (declare (salience ?*activate-gwhip[22]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gwhip))
=>
   (if ?*print-levels* then (printout t Entering_level_gW22))
   (assert (technique ?cont gwhip[22]))
   (bind ?*technique* gW[22])
)



(defrule track-gwhip[22]
   (declare (salience ?*activate-gwhip[22]-salience*))
   ?level <- (technique ?cont gwhip[22])
=>
...
(defrule gwhip[22]
   (declare (salience ?*gwhip[22]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 21)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L22* ?*print-gwhip* ?*print-gwhip-22*) then
      (print-gwhip 22 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[21]-1
   (declare (salience ?*partial-gwhip[21]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[22])
      ;;; because gwhips[21] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[21] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[21]-2
   (declare (salience ?*partial-gwhip[21]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[21] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[20] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[21]-3
   (declare (salience ?*partial-gwhip[21]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
