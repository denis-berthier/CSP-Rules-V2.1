...
(defrule activate-gwhip[25]
   (declare (salience ?*activate-gwhip[25]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gwhip))
=>
   (if ?*print-levels* then (printout t Entering_level_gW25))
   (assert (technique ?cont gwhip[25]))
   (bind ?*technique* gW[25])
)



(defrule track-gwhip[25]
   (declare (salience ?*activate-gwhip[25]-salience*))
   ?level <- (technique ?cont gwhip[25])
=>
...
(defrule gwhip[25]
   (declare (salience ?*gwhip[25]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 24)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L25* ?*print-gwhip* ?*print-gwhip-25*) then
      (print-gwhip 25 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[24]-1
   (declare (salience ?*partial-gwhip[24]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[25])
      ;;; because gwhips[24] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[24] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[24]-2
   (declare (salience ?*partial-gwhip[24]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[24] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[23] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[24]-3
   (declare (salience ?*partial-gwhip[24]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
