...
(defrule activate-gwhip[28]
   (declare (salience ?*activate-gwhip[28]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gwhip))
=>
   (if ?*print-levels* then (printout t Entering_level_gW28))
   (assert (technique ?cont gwhip[28]))
   (bind ?*technique* gW[28])
)



(defrule track-gwhip[28]
   (declare (salience ?*activate-gwhip[28]-salience*))
   ?level <- (technique ?cont gwhip[28])
=>
...
(defrule gwhip[28]
   (declare (salience ?*gwhip[28]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 27)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L28* ?*print-gwhip* ?*print-gwhip-28*) then
      (print-gwhip 28 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[27]-1
   (declare (salience ?*partial-gwhip[27]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[28])
      ;;; because gwhips[27] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[27] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[27]-2
   (declare (salience ?*partial-gwhip[27]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[27] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[26] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[27]-3
   (declare (salience ?*partial-gwhip[27]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
