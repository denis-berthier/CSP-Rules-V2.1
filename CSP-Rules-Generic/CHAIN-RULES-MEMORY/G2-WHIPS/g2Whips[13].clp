...
(defrule activate-g2whip[13]
   (declare (salience ?*activate-g2whip[13]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_g2W13))
   (assert (technique ?cont g2whip[13]))
   (bind ?*technique* g2W[13])
)



(defrule track-g2whip[13]
   (declare (salience ?*activate-g2whip[13]-salience*))
   ?level <- (technique ?cont g2whip[13])
=>
...
(defrule g2whip[13]
   (declare (salience ?*g2whip[13]-salience*))
   (chain2r
      (type partial-g2whip)
      (context ?cont)
      (length 12)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L13* ?*print-g2whip* ?*print-g2whip-13*) then
      (print-g2whip 13 ?zzz $?llcs $?rlcsa $?rlcsb $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-g2whip[12]-1
   (declare (salience ?*partial-g2whip[12]-salience-1*))
   (logical
      (chain2r
         (type partial-g2whip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont g2whip[13])
      ;;; because whips[12] and g2-whips[12] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as g2-whips[12] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-g2whip[12]-2
   (declare (salience ?*partial-g2whip[12]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as g2whips[12] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and g2whips[11] extendable by a single candidate have already been generated (because they have higher salience),
   ...
   (not
      (chain2r
         ...
         (target ?zzz)
         (rlcsa $?rlcs ?new-rlca)
         (rlcsb $?seq&:(eq $?seq (create-list-of-0s 11)) ?new-rlcb)
      )
   )
=>
   (assert
      (chain2r
         ...
         (llcs $?llcs ?new-llc)
         (rlcsa $?rlcs ?new-rlca)
         (rlcsb (create-list-of-0s 11) ?new-rlcb)
         (csp-vars $?csp-vars ?new-csp)
         (last-rlca ?new-rlca)
         (last-rlcb ?new-rlcb)
      )
...
(defrule partial-g2whip[12]-3
   (declare (salience ?*partial-g2whip[12]-salience-3*))
   (logical
      (chain2r
         (type partial-g2whip)
         (context ?cont)
