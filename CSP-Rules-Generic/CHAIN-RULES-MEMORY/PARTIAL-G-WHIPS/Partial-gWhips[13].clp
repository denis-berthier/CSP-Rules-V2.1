...
(defrule partial-gwhip[13]-1
   (declare (salience ?*partial-gwhip[13]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont partial-gwhip[13])
      ;;; because gwhips[13] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[13] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[13]-2
   (declare (salience ?*partial-gwhip[13]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[13] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[12] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[13]-3
   (declare (salience ?*partial-gwhip[13]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
