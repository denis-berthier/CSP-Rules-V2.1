...
(defrule partial-gwhip[3]-1
   (declare (salience ?*partial-gwhip[3]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont partial-gwhip[3])
      ;;; because gwhips[3] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[3] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[3]-2
   (declare (salience ?*partial-gwhip[3]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[3] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[2] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[3]-3
   (declare (salience ?*partial-gwhip[3]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
