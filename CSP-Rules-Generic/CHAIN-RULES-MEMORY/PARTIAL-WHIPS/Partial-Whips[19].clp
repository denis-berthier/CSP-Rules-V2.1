...
(defrule partial-whip[19]
   (declare (salience ?*partial-whip[19]-salience*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
      ...
      (technique ?cont partial-whip[19])
      ;;; ?new-rlc and ?new-csp
      ;;; because whips[20] based on ?zzz (if any) have already been eliminated,
