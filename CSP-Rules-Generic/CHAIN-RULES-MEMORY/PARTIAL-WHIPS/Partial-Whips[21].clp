...
(defrule partial-whip[21]
   (declare (salience ?*partial-whip[21]-salience*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
      ...
      (technique ?cont partial-whip[21])
      ;;; ?new-rlc and ?new-csp
      ;;; because whips[22] based on ?zzz (if any) have already been eliminated,
