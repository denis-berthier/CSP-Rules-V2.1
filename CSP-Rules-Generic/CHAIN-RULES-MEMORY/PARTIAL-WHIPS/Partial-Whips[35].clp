...
(defrule partial-whip[35]
   (declare (salience ?*partial-whip[35]-salience*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
      ...
      (technique ?cont partial-whip[35])
      ;;; ?new-rlc and ?new-csp
      ;;; because whips[36] based on ?zzz (if any) have already been eliminated,
