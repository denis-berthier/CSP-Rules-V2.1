...
=>
   ...
   (if (or ?*print-actions* ?*print-L36* ?*print-t-whip* ?*print-t-whip-36*) then
      (print-t-whip-without-crlf 36 ?zzz 
   ...
   (assert (pseudo-blocked ?cont t-whip[36] ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1))
)



;;; apply-t-whip[36]-to-more-targets

(defrule apply-t-whip[36]-to-more-targets
   (declare (salience ?*apply-a-blocked-rule-salience-1*))
   (pseudo-blocked ?cont t-whip[36] ?zzz ?zzz1 $?csp-vars $?llcs $?rlcs ?last-rlc ?zzz ?csp0 ?llc0 ?zzz1)
