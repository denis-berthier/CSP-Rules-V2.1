...
=>
    ...
    (assert (pseudo-blocked ?cont typed-t-whip[2] ?csp-type ?zzz ?zzz1 ?csp1 ?llc1 ?rlc1 ?rlc1 ?zzz ?csp0 ?llc0 ?zzz1))
)
...
(defrule apply-typed-t-whip[2]-to-more-targets
    ...
    (pseudo-blocked ?cont typed-t-whip[2] ?csp-type ?zzz ?zzz1 ?csp1 ?llc1 ?rlc1 ?rlc1 ?zzz ?csp0 ?llc0 ?zzz1)
