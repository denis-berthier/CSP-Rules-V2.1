...
(defrule partial-g-bivalue-chain[2]-1
	...
	(forall (csp-linked ?cont ?new-llc ?xxx&~?new-rlc ?new-csp) 
        (or (exists-link ?cont ?xxx ?rlc1) (exists-glink ?cont ?xxx ?rlc1))
        ;;; => ?new-llc is not linked or glinked to ?rlc1 by ?new-csp
    )
	
    ;;; do not consider a g-bivalue-chain[2] with
