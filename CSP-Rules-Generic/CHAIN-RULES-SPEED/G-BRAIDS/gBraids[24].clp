...
(defrule activate-gbraid[24]
   (declare (salience ?*activate-gbraid[24]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_gB24))
   (assert (technique ?cont gbraid[24]))
   (bind ?*technique* gB[24])
)



(defrule track-gbraid[24]
   (declare (salience ?*activate-gbraid[24]-salience*))
   ?level <- (technique ?cont gbraid[24])
=>
...
(defrule gbraid[24]
   (declare (salience ?*gbraid[24]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 23)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L24* ?*print-gbraid* ?*print-gbraid-24*) then
      (print-gbraid 24 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{23]-1
   (declare (salience ?*partial-gbraid[23]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[23]-2
   (declare (salience ?*partial-gbraid[23]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[23]-3
   (declare (salience ?*partial-gbraid[23]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
