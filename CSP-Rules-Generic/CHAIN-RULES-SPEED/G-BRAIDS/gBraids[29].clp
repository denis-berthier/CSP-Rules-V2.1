...
(defrule activate-gbraid[29]
   (declare (salience ?*activate-gbraid[29]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB29))
   (assert (technique ?cont gbraid[29]))
   (bind ?*technique* gB[29])
)



(defrule track-gbraid[29]
   (declare (salience ?*activate-gbraid[29]-salience*))
   ?level <- (technique ?cont gbraid[29])
=>
...
(defrule gbraid[29]
   (declare (salience ?*gbraid[29]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 28)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L29* ?*print-gbraid* ?*print-gbraid-29*) then
      (print-gbraid 29 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{28]-1
   (declare (salience ?*partial-gbraid[28]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[28]-2
   (declare (salience ?*partial-gbraid[28]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[28]-3
   (declare (salience ?*partial-gbraid[28]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
