...
(defrule activate-gbraid[34]
   (declare (salience ?*activate-gbraid[34]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB34))
   (assert (technique ?cont gbraid[34]))
   (bind ?*technique* gB[34])
)



(defrule track-gbraid[34]
   (declare (salience ?*activate-gbraid[34]-salience*))
   ?level <- (technique ?cont gbraid[34])
=>
...
(defrule gbraid[34]
   (declare (salience ?*gbraid[34]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 33)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L34* ?*print-gbraid* ?*print-gbraid-34*) then
      (print-gbraid 34 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{33]-1
   (declare (salience ?*partial-gbraid[33]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[33]-2
   (declare (salience ?*partial-gbraid[33]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[33]-3
   (declare (salience ?*partial-gbraid[33]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
