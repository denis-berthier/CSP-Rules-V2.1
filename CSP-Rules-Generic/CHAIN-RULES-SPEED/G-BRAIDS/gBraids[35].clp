...
(defrule activate-gbraid[35]
   (declare (salience ?*activate-gbraid[35]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB35))
   (assert (technique ?cont gbraid[35]))
   (bind ?*technique* gB[35])
)



(defrule track-gbraid[35]
   (declare (salience ?*activate-gbraid[35]-salience*))
   ?level <- (technique ?cont gbraid[35])
=>
...
(defrule gbraid[35]
   (declare (salience ?*gbraid[35]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 34)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L35* ?*print-gbraid* ?*print-gbraid-35*) then
      (print-gbraid 35 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{34]-1
   (declare (salience ?*partial-gbraid[34]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[34]-2
   (declare (salience ?*partial-gbraid[34]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[34]-3
   (declare (salience ?*partial-gbraid[34]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
