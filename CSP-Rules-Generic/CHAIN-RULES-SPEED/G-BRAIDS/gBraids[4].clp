...
(defrule activate-gbraid[4]
   (declare (salience ?*activate-gbraid[4]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB4))
   (assert (technique ?cont gbraid[4]))
   (bind ?*technique* gB[4])
)



(defrule track-gbraid[4]
   (declare (salience ?*activate-gbraid[4]-salience*))
   ?level <- (technique ?cont gbraid[4])
=>
...
(defrule gbraid[4]
   (declare (salience ?*gbraid[4]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 3)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L4* ?*print-gbraid* ?*print-gbraid-4*) then
      (print-gbraid 4 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{3]-1
   (declare (salience ?*partial-gbraid[3]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[3]-2
   (declare (salience ?*partial-gbraid[3]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[3]-3
   (declare (salience ?*partial-gbraid[3]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
