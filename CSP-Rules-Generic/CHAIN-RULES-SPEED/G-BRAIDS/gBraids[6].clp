...
(defrule activate-gbraid[6]
   (declare (salience ?*activate-gbraid[6]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB6))
   (assert (technique ?cont gbraid[6]))
   (bind ?*technique* gB[6])
)



(defrule track-gbraid[6]
   (declare (salience ?*activate-gbraid[6]-salience*))
   ?level <- (technique ?cont gbraid[6])
=>
...
(defrule gbraid[6]
   (declare (salience ?*gbraid[6]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 5)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L6* ?*print-gbraid* ?*print-gbraid-6*) then
      (print-gbraid 6 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{5]-1
   (declare (salience ?*partial-gbraid[5]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[5]-2
   (declare (salience ?*partial-gbraid[5]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[5]-3
   (declare (salience ?*partial-gbraid[5]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
