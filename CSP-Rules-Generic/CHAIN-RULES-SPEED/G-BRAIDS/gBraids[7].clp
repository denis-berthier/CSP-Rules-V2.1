...
(defrule activate-gbraid[7]
   (declare (salience ?*activate-gbraid[7]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gbraid))
=>
   (if ?*print-levels* then (printout t Entering_level_gB7))
   (assert (technique ?cont gbraid[7]))
   (bind ?*technique* gB[7])
)



(defrule track-gbraid[7]
   (declare (salience ?*activate-gbraid[7]-salience*))
   ?level <- (technique ?cont gbraid[7])
=>
...
(defrule gbraid[7]
   (declare (salience ?*gbraid[7]-salience*))
   (chain
      (type partial-gbraid)
      (context ?cont)
      (length 6)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L7* ?*print-gbraid* ?*print-gbraid-7*) then
      (print-gbraid 7 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gbraid{6]-1
   (declare (salience ?*partial-gbraid[6]-salience-1*))
   (logical
      (chain
...
(defrule partial-gbraid[6]-2
   (declare (salience ?*partial-gbraid[6]-salience-2*))
   (logical
      (chain
...
(defrule partial-gbraid[6]-3
   (declare (salience ?*partial-gbraid[6]-salience-3*))
   (logical
      (chain
         (type partial-gwhip|partial-gbraid)
         (context ?cont)
