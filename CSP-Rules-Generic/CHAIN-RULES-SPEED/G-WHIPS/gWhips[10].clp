...
(defrule activate-gwhip[10]
   (declare (salience ?*activate-gwhip[10]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gwhip))
=>
   (if ?*print-levels* then (printout t Entering_level_gW10))
   (assert (technique ?cont gwhip[10]))
   (bind ?*technique* gW[10])
)



(defrule track-gwhip[10]
   (declare (salience ?*activate-gwhip[10]-salience*))
   ?level <- (technique ?cont gwhip[10])
=>
...
(defrule gwhip[10]
   (declare (salience ?*gwhip[10]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 9)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L10* ?*print-gwhip* ?*print-gwhip-10*) then
      (print-gwhip 10 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[9]-1
   (declare (salience ?*partial-gwhip[9]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[10])
      ;;; because gwhips[9] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[9] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[9]-2
   (declare (salience ?*partial-gwhip[9]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[9] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[8] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[9]-3
   (declare (salience ?*partial-gwhip[9]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
