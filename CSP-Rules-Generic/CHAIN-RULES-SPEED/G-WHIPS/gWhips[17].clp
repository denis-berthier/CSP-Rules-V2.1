...
(defrule activate-gwhip[17]
   (declare (salience ?*activate-gwhip[17]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gwhip))
=>
   (if ?*print-levels* then (printout t Entering_level_gW17))
   (assert (technique ?cont gwhip[17]))
   (bind ?*technique* gW[17])
)



(defrule track-gwhip[17]
   (declare (salience ?*activate-gwhip[17]-salience*))
   ?level <- (technique ?cont gwhip[17])
=>
...
(defrule gwhip[17]
   (declare (salience ?*gwhip[17]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 16)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L17* ?*print-gwhip* ?*print-gwhip-17*) then
      (print-gwhip 17 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[16]-1
   (declare (salience ?*partial-gwhip[16]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[17])
      ;;; because gwhips[16] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[16] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[16]-2
   (declare (salience ?*partial-gwhip[16]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[16] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[15] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[16]-3
   (declare (salience ?*partial-gwhip[16]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
