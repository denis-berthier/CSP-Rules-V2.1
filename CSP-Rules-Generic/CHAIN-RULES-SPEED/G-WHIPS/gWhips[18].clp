...
(defrule activate-gwhip[18]
   (declare (salience ?*activate-gwhip[18]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_gW18))
   (assert (technique ?cont gwhip[18]))
   (bind ?*technique* gW[18])
)



(defrule track-gwhip[18]
   (declare (salience ?*activate-gwhip[18]-salience*))
   ?level <- (technique ?cont gwhip[18])
=>
...
(defrule gwhip[18]
   (declare (salience ?*gwhip[18]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 17)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L18* ?*print-gwhip* ?*print-gwhip-18*) then
      (print-gwhip 18 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[17]-1
   (declare (salience ?*partial-gwhip[17]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[18])
      ;;; because gwhips[17] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[17] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[17]-2
   (declare (salience ?*partial-gwhip[17]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[17] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[16] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[17]-3
   (declare (salience ?*partial-gwhip[17]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
