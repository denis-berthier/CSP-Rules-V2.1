...
(defrule activate-gwhip[20]
   (declare (salience ?*activate-gwhip[20]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_gW20))
   (assert (technique ?cont gwhip[20]))
   (bind ?*technique* gW[20])
)



(defrule track-gwhip[20]
   (declare (salience ?*activate-gwhip[20]-salience*))
   ?level <- (technique ?cont gwhip[20])
=>
...
(defrule gwhip[20]
   (declare (salience ?*gwhip[20]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 19)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L20* ?*print-gwhip* ?*print-gwhip-20*) then
      (print-gwhip 20 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[19]-1
   (declare (salience ?*partial-gwhip[19]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[20])
      ;;; because gwhips[19] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[19] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[19]-2
   (declare (salience ?*partial-gwhip[19]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[19] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[18] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[19]-3
   (declare (salience ?*partial-gwhip[19]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
