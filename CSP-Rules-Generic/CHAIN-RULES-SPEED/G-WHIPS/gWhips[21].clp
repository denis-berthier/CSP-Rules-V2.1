...
(defrule activate-gwhip[21]
   (declare (salience ?*activate-gwhip[21]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gwhip))
=>
   (if ?*print-levels* then (printout t Entering_level_gW21))
   (assert (technique ?cont gwhip[21]))
   (bind ?*technique* gW[21])
)



(defrule track-gwhip[21]
   (declare (salience ?*activate-gwhip[21]-salience*))
   ?level <- (technique ?cont gwhip[21])
=>
...
(defrule gwhip[21]
   (declare (salience ?*gwhip[21]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 20)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L21* ?*print-gwhip* ?*print-gwhip-21*) then
      (print-gwhip 21 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[20]-1
   (declare (salience ?*partial-gwhip[20]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[21])
      ;;; because gwhips[20] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[20] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[20]-2
   (declare (salience ?*partial-gwhip[20]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[20] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[19] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[20]-3
   (declare (salience ?*partial-gwhip[20]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
