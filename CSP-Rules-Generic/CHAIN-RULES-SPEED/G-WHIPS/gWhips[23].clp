...
(defrule activate-gwhip[23]
   (declare (salience ?*activate-gwhip[23]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_gW23))
   (assert (technique ?cont gwhip[23]))
   (bind ?*technique* gW[23])
)



(defrule track-gwhip[23]
   (declare (salience ?*activate-gwhip[23]-salience*))
   ?level <- (technique ?cont gwhip[23])
=>
...
(defrule gwhip[23]
   (declare (salience ?*gwhip[23]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 22)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L23* ?*print-gwhip* ?*print-gwhip-23*) then
      (print-gwhip 23 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[22]-1
   (declare (salience ?*partial-gwhip[22]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[23])
      ;;; because gwhips[22] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[22] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[22]-2
   (declare (salience ?*partial-gwhip[22]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[22] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[21] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[22]-3
   (declare (salience ?*partial-gwhip[22]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
