...
(defrule activate-gwhip[26]
   (declare (salience ?*activate-gwhip[26]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_gW26))
   (assert (technique ?cont gwhip[26]))
   (bind ?*technique* gW[26])
)



(defrule track-gwhip[26]
   (declare (salience ?*activate-gwhip[26]-salience*))
   ?level <- (technique ?cont gwhip[26])
=>
...
(defrule gwhip[26]
   (declare (salience ?*gwhip[26]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 25)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L26* ?*print-gwhip* ?*print-gwhip-26*) then
      (print-gwhip 26 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[25]-1
   (declare (salience ?*partial-gwhip[25]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[26])
      ;;; because gwhips[25] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[25] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[25]-2
   (declare (salience ?*partial-gwhip[25]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[25] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[24] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[25]-3
   (declare (salience ?*partial-gwhip[25]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
