...
(defrule activate-gwhip[33]
   (declare (salience ?*activate-gwhip[33]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gwhip))
=>
   (if ?*print-levels* then (printout t Entering_level_gW33))
   (assert (technique ?cont gwhip[33]))
   (bind ?*technique* gW[33])
)



(defrule track-gwhip[33]
   (declare (salience ?*activate-gwhip[33]-salience*))
   ?level <- (technique ?cont gwhip[33])
=>
...
(defrule gwhip[33]
   (declare (salience ?*gwhip[33]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 32)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L33* ?*print-gwhip* ?*print-gwhip-33*) then
      (print-gwhip 33 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[32]-1
   (declare (salience ?*partial-gwhip[32]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[33])
      ;;; because gwhips[32] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[32] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[32]-2
   (declare (salience ?*partial-gwhip[32]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[32] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[31] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[32]-3
   (declare (salience ?*partial-gwhip[32]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
