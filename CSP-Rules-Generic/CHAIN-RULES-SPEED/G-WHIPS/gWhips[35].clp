...
(defrule activate-gwhip[35]
   (declare (salience ?*activate-gwhip[35]-salience*))
   (logical (play) (context (name ?cont)))
   (not (deactivate ?cont gwhip))
=>
   (if ?*print-levels* then (printout t Entering_level_gW35))
   (assert (technique ?cont gwhip[35]))
   (bind ?*technique* gW[35])
)



(defrule track-gwhip[35]
   (declare (salience ?*activate-gwhip[35]-salience*))
   ?level <- (technique ?cont gwhip[35])
=>
...
(defrule gwhip[35]
   (declare (salience ?*gwhip[35]-salience*))
   (chain
      (type partial-gwhip)
      (context ?cont)
      (length 34)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L35* ?*print-gwhip* ?*print-gwhip-35*) then
      (print-gwhip 35 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule partial-gwhip[34]-1
   (declare (salience ?*partial-gwhip[34]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont gwhip[35])
      ;;; because gwhips[34] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[34] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[34]-2
   (declare (salience ?*partial-gwhip[34]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[34] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[33] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[34]-3
   (declare (salience ?*partial-gwhip[34]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
