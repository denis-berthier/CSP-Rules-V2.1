...
(defrule partial-gwhip[23]-1
   (declare (salience ?*partial-gwhip[23]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont partial-gwhip[23])
      ;;; because gwhips[23] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[23] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[23]-2
   (declare (salience ?*partial-gwhip[23]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[23] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[22] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[23]-3
   (declare (salience ?*partial-gwhip[23]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
