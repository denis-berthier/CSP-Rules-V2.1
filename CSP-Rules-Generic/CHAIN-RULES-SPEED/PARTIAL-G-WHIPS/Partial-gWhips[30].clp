...
(defrule partial-gwhip[30]-1
   (declare (salience ?*partial-gwhip[30]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont partial-gwhip[30])
      ;;; because gwhips[30] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[30] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[30]-2
   (declare (salience ?*partial-gwhip[30]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[30] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[29] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[30]-3
   (declare (salience ?*partial-gwhip[30]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
