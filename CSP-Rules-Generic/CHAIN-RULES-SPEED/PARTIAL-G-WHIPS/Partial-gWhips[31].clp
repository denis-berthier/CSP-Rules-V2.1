...
(defrule partial-gwhip[31]-1
   (declare (salience ?*partial-gwhip[31]-salience-1*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont partial-gwhip[31])
      ;;; because gwhips[31] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as gwhips[31] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule partial-gwhip[31]-2
   (declare (salience ?*partial-gwhip[31]-salience-2*))
   (logical
      (chain
         (type partial-whip)
         (context ?cont)
   ...
   ;;; as gwhips[31] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and gwhips[30] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule partial-gwhip[31]-3
   (declare (salience ?*partial-gwhip[31]-salience-3*))
   (logical
      (chain
         (type partial-gwhip)
         (context ?cont)
