...
(defrule activate-typed-gwhip[10]
   (declare (salience ?*activate-typed-gwhip[10]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW10))
   (assert (technique ?cont typed-gwhip[10]))
   (bind ?*technique* TygW[10])
)



(defrule track-typed-gwhip[10]
   (declare (salience ?*activate-typed-gwhip[10]-salience*))
   ?level <- (technique ?cont typed-gwhip[10])
=>
...
(defrule typed-gwhip[10]
   (declare (salience ?*typed-gwhip[10]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L10* ?*print-typed-gwhip* ?*print-typed-gwhip-10*) then
      (print-typed-g-whip ?csp-type 10 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[9]-1
   (declare (salience ?*typed-partial-gwhip[9]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[10])
      ;;; because typed-gwhips[9] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[9] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[9]-2
   (declare (salience ?*typed-partial-gwhip[9]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[9] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[8] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[9]-3
   (declare (salience ?*typed-partial-gwhip[9]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
