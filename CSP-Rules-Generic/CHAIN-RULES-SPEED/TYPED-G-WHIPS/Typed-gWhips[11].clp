...
(defrule activate-typed-gwhip[11]
   (declare (salience ?*activate-typed-gwhip[11]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW11))
   (assert (technique ?cont typed-gwhip[11]))
   (bind ?*technique* TygW[11])
)



(defrule track-typed-gwhip[11]
   (declare (salience ?*activate-typed-gwhip[11]-salience*))
   ?level <- (technique ?cont typed-gwhip[11])
=>
...
(defrule typed-gwhip[11]
   (declare (salience ?*typed-gwhip[11]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L11* ?*print-typed-gwhip* ?*print-typed-gwhip-11*) then
      (print-typed-g-whip ?csp-type 11 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[10]-1
   (declare (salience ?*typed-partial-gwhip[10]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[11])
      ;;; because typed-gwhips[10] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[10] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[10]-2
   (declare (salience ?*typed-partial-gwhip[10]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[10] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[9] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[10]-3
   (declare (salience ?*typed-partial-gwhip[10]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
