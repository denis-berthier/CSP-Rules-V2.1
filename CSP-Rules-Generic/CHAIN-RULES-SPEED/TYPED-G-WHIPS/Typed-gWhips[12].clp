...
(defrule activate-typed-gwhip[12]
   (declare (salience ?*activate-typed-gwhip[12]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW12))
   (assert (technique ?cont typed-gwhip[12]))
   (bind ?*technique* TygW[12])
)



(defrule track-typed-gwhip[12]
   (declare (salience ?*activate-typed-gwhip[12]-salience*))
   ?level <- (technique ?cont typed-gwhip[12])
=>
...
(defrule typed-gwhip[12]
   (declare (salience ?*typed-gwhip[12]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L12* ?*print-typed-gwhip* ?*print-typed-gwhip-12*) then
      (print-typed-g-whip ?csp-type 12 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[11]-1
   (declare (salience ?*typed-partial-gwhip[11]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[12])
      ;;; because typed-gwhips[11] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[11] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[11]-2
   (declare (salience ?*typed-partial-gwhip[11]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[11] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[10] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[11]-3
   (declare (salience ?*typed-partial-gwhip[11]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
