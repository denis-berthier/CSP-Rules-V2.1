...
(defrule activate-typed-gwhip[13]
   (declare (salience ?*activate-typed-gwhip[13]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW13))
   (assert (technique ?cont typed-gwhip[13]))
   (bind ?*technique* TygW[13])
)



(defrule track-typed-gwhip[13]
   (declare (salience ?*activate-typed-gwhip[13]-salience*))
   ?level <- (technique ?cont typed-gwhip[13])
=>
...
(defrule typed-gwhip[13]
   (declare (salience ?*typed-gwhip[13]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L13* ?*print-typed-gwhip* ?*print-typed-gwhip-13*) then
      (print-typed-g-whip ?csp-type 13 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[12]-1
   (declare (salience ?*typed-partial-gwhip[12]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[13])
      ;;; because typed-gwhips[12] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[12] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[12]-2
   (declare (salience ?*typed-partial-gwhip[12]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[12] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[11] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[12]-3
   (declare (salience ?*typed-partial-gwhip[12]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
