...
(defrule activate-typed-gwhip[14]
   (declare (salience ?*activate-typed-gwhip[14]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW14))
   (assert (technique ?cont typed-gwhip[14]))
   (bind ?*technique* TygW[14])
)



(defrule track-typed-gwhip[14]
   (declare (salience ?*activate-typed-gwhip[14]-salience*))
   ?level <- (technique ?cont typed-gwhip[14])
=>
...
(defrule typed-gwhip[14]
   (declare (salience ?*typed-gwhip[14]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L14* ?*print-typed-gwhip* ?*print-typed-gwhip-14*) then
      (print-typed-g-whip ?csp-type 14 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[13]-1
   (declare (salience ?*typed-partial-gwhip[13]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[14])
      ;;; because typed-gwhips[13] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[13] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[13]-2
   (declare (salience ?*typed-partial-gwhip[13]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[13] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[12] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[13]-3
   (declare (salience ?*typed-partial-gwhip[13]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
