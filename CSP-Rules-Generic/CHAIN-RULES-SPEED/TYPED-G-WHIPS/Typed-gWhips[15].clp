...
(defrule activate-typed-gwhip[15]
   (declare (salience ?*activate-typed-gwhip[15]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW15))
   (assert (technique ?cont typed-gwhip[15]))
   (bind ?*technique* TygW[15])
)



(defrule track-typed-gwhip[15]
   (declare (salience ?*activate-typed-gwhip[15]-salience*))
   ?level <- (technique ?cont typed-gwhip[15])
=>
...
(defrule typed-gwhip[15]
   (declare (salience ?*typed-gwhip[15]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L15* ?*print-typed-gwhip* ?*print-typed-gwhip-15*) then
      (print-typed-g-whip ?csp-type 15 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[14]-1
   (declare (salience ?*typed-partial-gwhip[14]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[15])
      ;;; because typed-gwhips[14] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[14] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[14]-2
   (declare (salience ?*typed-partial-gwhip[14]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[14] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[13] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[14]-3
   (declare (salience ?*typed-partial-gwhip[14]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
