...
(defrule activate-typed-gwhip[16]
   (declare (salience ?*activate-typed-gwhip[16]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW16))
   (assert (technique ?cont typed-gwhip[16]))
   (bind ?*technique* TygW[16])
)



(defrule track-typed-gwhip[16]
   (declare (salience ?*activate-typed-gwhip[16]-salience*))
   ?level <- (technique ?cont typed-gwhip[16])
=>
...
(defrule typed-gwhip[16]
   (declare (salience ?*typed-gwhip[16]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L16* ?*print-typed-gwhip* ?*print-typed-gwhip-16*) then
      (print-typed-g-whip ?csp-type 16 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[15]-1
   (declare (salience ?*typed-partial-gwhip[15]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[16])
      ;;; because typed-gwhips[15] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[15] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[15]-2
   (declare (salience ?*typed-partial-gwhip[15]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[15] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[14] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[15]-3
   (declare (salience ?*typed-partial-gwhip[15]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
