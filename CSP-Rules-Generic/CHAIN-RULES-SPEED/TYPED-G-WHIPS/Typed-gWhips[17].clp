...
(defrule activate-typed-gwhip[17]
   (declare (salience ?*activate-typed-gwhip[17]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW17))
   (assert (technique ?cont typed-gwhip[17]))
   (bind ?*technique* TygW[17])
)



(defrule track-typed-gwhip[17]
   (declare (salience ?*activate-typed-gwhip[17]-salience*))
   ?level <- (technique ?cont typed-gwhip[17])
=>
...
(defrule typed-gwhip[17]
   (declare (salience ?*typed-gwhip[17]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L17* ?*print-typed-gwhip* ?*print-typed-gwhip-17*) then
      (print-typed-g-whip ?csp-type 17 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[16]-1
   (declare (salience ?*typed-partial-gwhip[16]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[17])
      ;;; because typed-gwhips[16] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[16] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[16]-2
   (declare (salience ?*typed-partial-gwhip[16]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[16] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[15] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[16]-3
   (declare (salience ?*typed-partial-gwhip[16]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
