...
(defrule activate-typed-gwhip[18]
   (declare (salience ?*activate-typed-gwhip[18]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW18))
   (assert (technique ?cont typed-gwhip[18]))
   (bind ?*technique* TygW[18])
)



(defrule track-typed-gwhip[18]
   (declare (salience ?*activate-typed-gwhip[18]-salience*))
   ?level <- (technique ?cont typed-gwhip[18])
=>
...
(defrule typed-gwhip[18]
   (declare (salience ?*typed-gwhip[18]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L18* ?*print-typed-gwhip* ?*print-typed-gwhip-18*) then
      (print-typed-g-whip ?csp-type 18 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[17]-1
   (declare (salience ?*typed-partial-gwhip[17]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[18])
      ;;; because typed-gwhips[17] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[17] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[17]-2
   (declare (salience ?*typed-partial-gwhip[17]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[17] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[16] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[17]-3
   (declare (salience ?*typed-partial-gwhip[17]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
