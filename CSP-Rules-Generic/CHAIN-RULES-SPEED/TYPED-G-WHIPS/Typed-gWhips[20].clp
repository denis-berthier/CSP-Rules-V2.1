...
(defrule activate-typed-gwhip[20]
   (declare (salience ?*activate-typed-gwhip[20]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW20))
   (assert (technique ?cont typed-gwhip[20]))
   (bind ?*technique* TygW[20])
)



(defrule track-typed-gwhip[20]
   (declare (salience ?*activate-typed-gwhip[20]-salience*))
   ?level <- (technique ?cont typed-gwhip[20])
=>
...
(defrule typed-gwhip[20]
   (declare (salience ?*typed-gwhip[20]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L20* ?*print-typed-gwhip* ?*print-typed-gwhip-20*) then
      (print-typed-g-whip ?csp-type 20 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[19]-1
   (declare (salience ?*typed-partial-gwhip[19]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[20])
      ;;; because typed-gwhips[19] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[19] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[19]-2
   (declare (salience ?*typed-partial-gwhip[19]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[19] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[18] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[19]-3
   (declare (salience ?*typed-partial-gwhip[19]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
