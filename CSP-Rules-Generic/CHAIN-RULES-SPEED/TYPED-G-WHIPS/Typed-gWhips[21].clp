...
(defrule activate-typed-gwhip[21]
   (declare (salience ?*activate-typed-gwhip[21]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW21))
   (assert (technique ?cont typed-gwhip[21]))
   (bind ?*technique* TygW[21])
)



(defrule track-typed-gwhip[21]
   (declare (salience ?*activate-typed-gwhip[21]-salience*))
   ?level <- (technique ?cont typed-gwhip[21])
=>
...
(defrule typed-gwhip[21]
   (declare (salience ?*typed-gwhip[21]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L21* ?*print-typed-gwhip* ?*print-typed-gwhip-21*) then
      (print-typed-g-whip ?csp-type 21 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[20]-1
   (declare (salience ?*typed-partial-gwhip[20]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[21])
      ;;; because typed-gwhips[20] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[20] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[20]-2
   (declare (salience ?*typed-partial-gwhip[20]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[20] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[19] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[20]-3
   (declare (salience ?*typed-partial-gwhip[20]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
