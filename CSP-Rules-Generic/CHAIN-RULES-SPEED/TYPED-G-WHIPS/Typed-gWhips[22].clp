...
(defrule activate-typed-gwhip[22]
   (declare (salience ?*activate-typed-gwhip[22]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW22))
   (assert (technique ?cont typed-gwhip[22]))
   (bind ?*technique* TygW[22])
)



(defrule track-typed-gwhip[22]
   (declare (salience ?*activate-typed-gwhip[22]-salience*))
   ?level <- (technique ?cont typed-gwhip[22])
=>
...
(defrule typed-gwhip[22]
   (declare (salience ?*typed-gwhip[22]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L22* ?*print-typed-gwhip* ?*print-typed-gwhip-22*) then
      (print-typed-g-whip ?csp-type 22 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[21]-1
   (declare (salience ?*typed-partial-gwhip[21]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[22])
      ;;; because typed-gwhips[21] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[21] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[21]-2
   (declare (salience ?*typed-partial-gwhip[21]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[21] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[20] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[21]-3
   (declare (salience ?*typed-partial-gwhip[21]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
