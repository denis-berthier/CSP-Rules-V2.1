...
(defrule activate-typed-gwhip[23]
   (declare (salience ?*activate-typed-gwhip[23]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW23))
   (assert (technique ?cont typed-gwhip[23]))
   (bind ?*technique* TygW[23])
)



(defrule track-typed-gwhip[23]
   (declare (salience ?*activate-typed-gwhip[23]-salience*))
   ?level <- (technique ?cont typed-gwhip[23])
=>
...
(defrule typed-gwhip[23]
   (declare (salience ?*typed-gwhip[23]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L23* ?*print-typed-gwhip* ?*print-typed-gwhip-23*) then
      (print-typed-g-whip ?csp-type 23 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[22]-1
   (declare (salience ?*typed-partial-gwhip[22]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[23])
      ;;; because typed-gwhips[22] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[22] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[22]-2
   (declare (salience ?*typed-partial-gwhip[22]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[22] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[21] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[22]-3
   (declare (salience ?*typed-partial-gwhip[22]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
