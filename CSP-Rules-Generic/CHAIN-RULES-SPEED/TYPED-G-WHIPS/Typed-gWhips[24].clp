...
(defrule activate-typed-gwhip[24]
   (declare (salience ?*activate-typed-gwhip[24]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW24))
   (assert (technique ?cont typed-gwhip[24]))
   (bind ?*technique* TygW[24])
)



(defrule track-typed-gwhip[24]
   (declare (salience ?*activate-typed-gwhip[24]-salience*))
   ?level <- (technique ?cont typed-gwhip[24])
=>
...
(defrule typed-gwhip[24]
   (declare (salience ?*typed-gwhip[24]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L24* ?*print-typed-gwhip* ?*print-typed-gwhip-24*) then
      (print-typed-g-whip ?csp-type 24 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[23]-1
   (declare (salience ?*typed-partial-gwhip[23]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[24])
      ;;; because typed-gwhips[23] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[23] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[23]-2
   (declare (salience ?*typed-partial-gwhip[23]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[23] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[22] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[23]-3
   (declare (salience ?*typed-partial-gwhip[23]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
