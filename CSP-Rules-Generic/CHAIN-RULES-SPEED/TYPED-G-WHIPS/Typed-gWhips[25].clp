...
(defrule activate-typed-gwhip[25]
   (declare (salience ?*activate-typed-gwhip[25]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW25))
   (assert (technique ?cont typed-gwhip[25]))
   (bind ?*technique* TygW[25])
)



(defrule track-typed-gwhip[25]
   (declare (salience ?*activate-typed-gwhip[25]-salience*))
   ?level <- (technique ?cont typed-gwhip[25])
=>
...
(defrule typed-gwhip[25]
   (declare (salience ?*typed-gwhip[25]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L25* ?*print-typed-gwhip* ?*print-typed-gwhip-25*) then
      (print-typed-g-whip ?csp-type 25 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[24]-1
   (declare (salience ?*typed-partial-gwhip[24]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[25])
      ;;; because typed-gwhips[24] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[24] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[24]-2
   (declare (salience ?*typed-partial-gwhip[24]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[24] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[23] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[24]-3
   (declare (salience ?*typed-partial-gwhip[24]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
