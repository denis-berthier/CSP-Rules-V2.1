...
(defrule activate-typed-gwhip[26]
   (declare (salience ?*activate-typed-gwhip[26]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW26))
   (assert (technique ?cont typed-gwhip[26]))
   (bind ?*technique* TygW[26])
)



(defrule track-typed-gwhip[26]
   (declare (salience ?*activate-typed-gwhip[26]-salience*))
   ?level <- (technique ?cont typed-gwhip[26])
=>
...
(defrule typed-gwhip[26]
   (declare (salience ?*typed-gwhip[26]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L26* ?*print-typed-gwhip* ?*print-typed-gwhip-26*) then
      (print-typed-g-whip ?csp-type 26 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[25]-1
   (declare (salience ?*typed-partial-gwhip[25]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[26])
      ;;; because typed-gwhips[25] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[25] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[25]-2
   (declare (salience ?*typed-partial-gwhip[25]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[25] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[24] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[25]-3
   (declare (salience ?*typed-partial-gwhip[25]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
