...
(defrule activate-typed-gwhip[27]
   (declare (salience ?*activate-typed-gwhip[27]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW27))
   (assert (technique ?cont typed-gwhip[27]))
   (bind ?*technique* TygW[27])
)



(defrule track-typed-gwhip[27]
   (declare (salience ?*activate-typed-gwhip[27]-salience*))
   ?level <- (technique ?cont typed-gwhip[27])
=>
...
(defrule typed-gwhip[27]
   (declare (salience ?*typed-gwhip[27]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L27* ?*print-typed-gwhip* ?*print-typed-gwhip-27*) then
      (print-typed-g-whip ?csp-type 27 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[26]-1
   (declare (salience ?*typed-partial-gwhip[26]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[27])
      ;;; because typed-gwhips[26] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[26] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[26]-2
   (declare (salience ?*typed-partial-gwhip[26]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[26] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[25] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[26]-3
   (declare (salience ?*typed-partial-gwhip[26]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
