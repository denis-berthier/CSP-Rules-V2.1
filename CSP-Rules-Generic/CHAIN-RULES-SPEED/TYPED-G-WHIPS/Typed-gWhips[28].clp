...
(defrule activate-typed-gwhip[28]
   (declare (salience ?*activate-typed-gwhip[28]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW28))
   (assert (technique ?cont typed-gwhip[28]))
   (bind ?*technique* TygW[28])
)



(defrule track-typed-gwhip[28]
   (declare (salience ?*activate-typed-gwhip[28]-salience*))
   ?level <- (technique ?cont typed-gwhip[28])
=>
...
(defrule typed-gwhip[28]
   (declare (salience ?*typed-gwhip[28]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L28* ?*print-typed-gwhip* ?*print-typed-gwhip-28*) then
      (print-typed-g-whip ?csp-type 28 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[27]-1
   (declare (salience ?*typed-partial-gwhip[27]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[28])
      ;;; because typed-gwhips[27] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[27] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[27]-2
   (declare (salience ?*typed-partial-gwhip[27]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[27] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[26] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[27]-3
   (declare (salience ?*typed-partial-gwhip[27]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
