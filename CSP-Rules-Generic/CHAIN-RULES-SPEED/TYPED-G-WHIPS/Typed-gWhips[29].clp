...
(defrule activate-typed-gwhip[29]
   (declare (salience ?*activate-typed-gwhip[29]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW29))
   (assert (technique ?cont typed-gwhip[29]))
   (bind ?*technique* TygW[29])
)



(defrule track-typed-gwhip[29]
   (declare (salience ?*activate-typed-gwhip[29]-salience*))
   ?level <- (technique ?cont typed-gwhip[29])
=>
...
(defrule typed-gwhip[29]
   (declare (salience ?*typed-gwhip[29]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L29* ?*print-typed-gwhip* ?*print-typed-gwhip-29*) then
      (print-typed-g-whip ?csp-type 29 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[28]-1
   (declare (salience ?*typed-partial-gwhip[28]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[29])
      ;;; because typed-gwhips[28] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[28] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[28]-2
   (declare (salience ?*typed-partial-gwhip[28]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[28] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[27] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[28]-3
   (declare (salience ?*typed-partial-gwhip[28]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
