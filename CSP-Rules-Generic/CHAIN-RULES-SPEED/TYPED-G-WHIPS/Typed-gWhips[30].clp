...
(defrule activate-typed-gwhip[30]
   (declare (salience ?*activate-typed-gwhip[30]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW30))
   (assert (technique ?cont typed-gwhip[30]))
   (bind ?*technique* TygW[30])
)



(defrule track-typed-gwhip[30]
   (declare (salience ?*activate-typed-gwhip[30]-salience*))
   ?level <- (technique ?cont typed-gwhip[30])
=>
...
(defrule typed-gwhip[30]
   (declare (salience ?*typed-gwhip[30]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L30* ?*print-typed-gwhip* ?*print-typed-gwhip-30*) then
      (print-typed-g-whip ?csp-type 30 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[29]-1
   (declare (salience ?*typed-partial-gwhip[29]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[30])
      ;;; because typed-gwhips[29] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[29] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[29]-2
   (declare (salience ?*typed-partial-gwhip[29]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[29] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[28] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[29]-3
   (declare (salience ?*typed-partial-gwhip[29]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
