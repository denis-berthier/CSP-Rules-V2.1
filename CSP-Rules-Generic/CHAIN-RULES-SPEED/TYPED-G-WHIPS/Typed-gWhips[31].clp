...
(defrule activate-typed-gwhip[31]
   (declare (salience ?*activate-typed-gwhip[31]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW31))
   (assert (technique ?cont typed-gwhip[31]))
   (bind ?*technique* TygW[31])
)



(defrule track-typed-gwhip[31]
   (declare (salience ?*activate-typed-gwhip[31]-salience*))
   ?level <- (technique ?cont typed-gwhip[31])
=>
...
(defrule typed-gwhip[31]
   (declare (salience ?*typed-gwhip[31]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L31* ?*print-typed-gwhip* ?*print-typed-gwhip-31*) then
      (print-typed-g-whip ?csp-type 31 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[30]-1
   (declare (salience ?*typed-partial-gwhip[30]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[31])
      ;;; because typed-gwhips[30] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[30] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[30]-2
   (declare (salience ?*typed-partial-gwhip[30]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[30] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[29] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[30]-3
   (declare (salience ?*typed-partial-gwhip[30]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
