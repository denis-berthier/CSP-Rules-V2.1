...
(defrule activate-typed-gwhip[32]
   (declare (salience ?*activate-typed-gwhip[32]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW32))
   (assert (technique ?cont typed-gwhip[32]))
   (bind ?*technique* TygW[32])
)



(defrule track-typed-gwhip[32]
   (declare (salience ?*activate-typed-gwhip[32]-salience*))
   ?level <- (technique ?cont typed-gwhip[32])
=>
...
(defrule typed-gwhip[32]
   (declare (salience ?*typed-gwhip[32]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L32* ?*print-typed-gwhip* ?*print-typed-gwhip-32*) then
      (print-typed-g-whip ?csp-type 32 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[31]-1
   (declare (salience ?*typed-partial-gwhip[31]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[32])
      ;;; because typed-gwhips[31] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[31] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[31]-2
   (declare (salience ?*typed-partial-gwhip[31]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[31] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[30] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[31]-3
   (declare (salience ?*typed-partial-gwhip[31]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
