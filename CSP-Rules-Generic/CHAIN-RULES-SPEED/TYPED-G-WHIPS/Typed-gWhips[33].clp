...
(defrule activate-typed-gwhip[33]
   (declare (salience ?*activate-typed-gwhip[33]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW33))
   (assert (technique ?cont typed-gwhip[33]))
   (bind ?*technique* TygW[33])
)



(defrule track-typed-gwhip[33]
   (declare (salience ?*activate-typed-gwhip[33]-salience*))
   ?level <- (technique ?cont typed-gwhip[33])
=>
...
(defrule typed-gwhip[33]
   (declare (salience ?*typed-gwhip[33]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L33* ?*print-typed-gwhip* ?*print-typed-gwhip-33*) then
      (print-typed-g-whip ?csp-type 33 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[32]-1
   (declare (salience ?*typed-partial-gwhip[32]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[33])
      ;;; because typed-gwhips[32] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[32] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[32]-2
   (declare (salience ?*typed-partial-gwhip[32]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[32] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[31] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[32]-3
   (declare (salience ?*typed-partial-gwhip[32]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
