...
(defrule activate-typed-gwhip[34]
   (declare (salience ?*activate-typed-gwhip[34]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW34))
   (assert (technique ?cont typed-gwhip[34]))
   (bind ?*technique* TygW[34])
)



(defrule track-typed-gwhip[34]
   (declare (salience ?*activate-typed-gwhip[34]-salience*))
   ?level <- (technique ?cont typed-gwhip[34])
=>
...
(defrule typed-gwhip[34]
   (declare (salience ?*typed-gwhip[34]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L34* ?*print-typed-gwhip* ?*print-typed-gwhip-34*) then
      (print-typed-g-whip ?csp-type 34 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[33]-1
   (declare (salience ?*typed-partial-gwhip[33]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[34])
      ;;; because typed-gwhips[33] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[33] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[33]-2
   (declare (salience ?*typed-partial-gwhip[33]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[33] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[32] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[33]-3
   (declare (salience ?*typed-partial-gwhip[33]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
