...
(defrule activate-typed-gwhip[35]
   (declare (salience ?*activate-typed-gwhip[35]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW35))
   (assert (technique ?cont typed-gwhip[35]))
   (bind ?*technique* TygW[35])
)



(defrule track-typed-gwhip[35]
   (declare (salience ?*activate-typed-gwhip[35]-salience*))
   ?level <- (technique ?cont typed-gwhip[35])
=>
...
(defrule typed-gwhip[35]
   (declare (salience ?*typed-gwhip[35]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L35* ?*print-typed-gwhip* ?*print-typed-gwhip-35*) then
      (print-typed-g-whip ?csp-type 35 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[34]-1
   (declare (salience ?*typed-partial-gwhip[34]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[35])
      ;;; because typed-gwhips[34] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[34] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[34]-2
   (declare (salience ?*typed-partial-gwhip[34]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[34] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[33] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[34]-3
   (declare (salience ?*typed-partial-gwhip[34]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
