...
(defrule activate-typed-gwhip[36]
   (declare (salience ?*activate-typed-gwhip[36]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW36))
   (assert (technique ?cont typed-gwhip[36]))
   (bind ?*technique* TygW[36])
)



(defrule track-typed-gwhip[36]
   (declare (salience ?*activate-typed-gwhip[36]-salience*))
   ?level <- (technique ?cont typed-gwhip[36])
=>
...
(defrule typed-gwhip[36]
   (declare (salience ?*typed-gwhip[36]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L36* ?*print-typed-gwhip* ?*print-typed-gwhip-36*) then
      (print-typed-g-whip ?csp-type 36 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[35]-1
   (declare (salience ?*typed-partial-gwhip[35]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-gwhip[36])
      ;;; because typed-gwhips[35] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as typed-gwhips[35] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[35]-2
   (declare (salience ?*typed-partial-gwhip[35]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[35] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[34] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[35]-3
   (declare (salience ?*typed-partial-gwhip[35]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
