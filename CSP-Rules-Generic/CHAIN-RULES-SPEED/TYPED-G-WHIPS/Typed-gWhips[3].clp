...
(defrule activate-typed-gwhip[3]
   (declare (salience ?*activate-typed-gwhip[3]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level_TygW3))
   (assert (technique ?cont typed-gwhip[3]))
   (bind ?*technique* TygW[3])
)



(defrule track-typed-gwhip[3]
   (declare (salience ?*activate-typed-gwhip[3]-salience*))
   ?level <- (technique ?cont typed-gwhip[3])
=>
...
(defrule typed-gwhip[3]
   (declare (salience ?*typed-gwhip[3]-salience*))
   (typed-chain
      (csp-type ?csp-type)
...
=>
   ...
   (if (or ?*print-actions* ?*print-L3* ?*print-typed-gwhip* ?*print-typed-gwhip-3*) then
      (print-typed-g-whip ?csp-type 3 ?zzz $?llcs $?rlcs $?csp-vars ?new-llc . ?new-csp)
   )
)
...
(defrule typed-partial-gwhip[2]-1
   (declare (salience ?*typed-partial-gwhip[2]-salience-1*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
   ...
   ;;; as typed-gwhips[2] based on ?zzz have been eliminated (because they have higher salience),
...
(defrule typed-partial-gwhip[2]-2
   (declare (salience ?*typed-partial-gwhip[2]-salience-2*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
   ...
   ;;; as typed-gwhips[2] based on ?zzz have been eliminated (because they have higher salience),
   ;;; and typed-gwhips[1] extendable by a single candidate have already been generated (because they have higher salience),
...
(defrule typed-partial-gwhip[2]-3
   (declare (salience ?*typed-partial-gwhip[2]-salience-3*))
   (logical
      (typed-chain
         (csp-type ?csp-type)
         (type typed-partial-gwhip)
