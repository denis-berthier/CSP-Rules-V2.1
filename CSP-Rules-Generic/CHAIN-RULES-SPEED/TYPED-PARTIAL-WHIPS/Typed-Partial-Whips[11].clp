...
(defrule typed-partial-whip[11]
   (declare (salience ?*typed-partial-whip[11]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[11])
      ;;; because typed-whips[11] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[11] have been eliminated (because they have higher salience),
