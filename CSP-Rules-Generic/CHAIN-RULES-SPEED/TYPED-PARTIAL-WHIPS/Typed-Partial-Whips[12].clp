...
(defrule typed-partial-whip[12]
   (declare (salience ?*typed-partial-whip[12]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[12])
      ;;; because typed-whips[12] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[12] have been eliminated (because they have higher salience),
