...
(defrule typed-partial-whip[13]
   (declare (salience ?*typed-partial-whip[13]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[13])
      ;;; because typed-whips[13] based on ?zzz (if any) have already been eliminated,
