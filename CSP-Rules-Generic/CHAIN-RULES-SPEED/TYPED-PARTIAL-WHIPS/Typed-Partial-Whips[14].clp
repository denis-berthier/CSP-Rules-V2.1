...
(defrule typed-partial-whip[14]
   (declare (salience ?*typed-partial-whip[14]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[14])
      ;;; because typed-whips[14] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[14] have been eliminated (because they have higher salience),
