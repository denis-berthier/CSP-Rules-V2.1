...
(defrule typed-partial-whip[15]
   (declare (salience ?*typed-partial-whip[15]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[15])
      ;;; because typed-whips[15] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[15] have been eliminated (because they have higher salience),
