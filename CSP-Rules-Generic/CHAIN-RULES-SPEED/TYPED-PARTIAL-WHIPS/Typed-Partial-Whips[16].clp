...
(defrule typed-partial-whip[16]
   (declare (salience ?*typed-partial-whip[16]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[16])
      ;;; because typed-whips[16] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[16] have been eliminated (because they have higher salience),
