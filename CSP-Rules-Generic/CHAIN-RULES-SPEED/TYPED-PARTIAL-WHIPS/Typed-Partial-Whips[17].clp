...
(defrule typed-partial-whip[17]
   (declare (salience ?*typed-partial-whip[17]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[17])
      ;;; because typed-whips[17] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[17] have been eliminated (because they have higher salience),
