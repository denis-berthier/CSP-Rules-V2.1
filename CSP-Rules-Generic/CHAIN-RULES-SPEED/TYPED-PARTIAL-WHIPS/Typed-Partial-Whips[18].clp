...
(defrule typed-partial-whip[18]
   (declare (salience ?*typed-partial-whip[18]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[18])
      ;;; because typed-whips[18] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[18] have been eliminated (because they have higher salience),
