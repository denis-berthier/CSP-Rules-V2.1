...
(defrule typed-partial-whip[19]
   (declare (salience ?*typed-partial-whip[19]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[19])
      ;;; because typed-whips[19] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[19] have been eliminated (because they have higher salience),
