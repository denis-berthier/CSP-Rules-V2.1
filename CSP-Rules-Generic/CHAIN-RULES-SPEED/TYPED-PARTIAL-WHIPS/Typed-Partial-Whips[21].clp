...
(defrule typed-partial-whip[21]
   (declare (salience ?*typed-partial-whip[21]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[21])
      ;;; because typed-whips[21] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[21] have been eliminated (because they have higher salience),
