...
(defrule typed-partial-whip[22]
   (declare (salience ?*typed-partial-whip[22]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[22])
      ;;; because typed-whips[22] based on ?zzz (if any) have already been eliminated,
