...
(defrule typed-partial-whip[23]
   (declare (salience ?*typed-partial-whip[23]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[23])
      ;;; because typed-whips[23] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[23] have been eliminated (because they have higher salience),
