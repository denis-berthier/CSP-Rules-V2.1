...
(defrule typed-partial-whip[24]
   (declare (salience ?*typed-partial-whip[24]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[24])
      ;;; because typed-whips[24] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[24] have been eliminated (because they have higher salience),
