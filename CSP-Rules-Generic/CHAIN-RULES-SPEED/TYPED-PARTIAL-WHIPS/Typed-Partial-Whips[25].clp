...
(defrule typed-partial-whip[25]
   (declare (salience ?*typed-partial-whip[25]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[25])
      ;;; because typed-whips[25] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[25] have been eliminated (because they have higher salience),
