...
(defrule typed-partial-whip[27]
   (declare (salience ?*typed-partial-whip[27]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[27])
      ;;; because typed-whips[27] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[27] have been eliminated (because they have higher salience),
