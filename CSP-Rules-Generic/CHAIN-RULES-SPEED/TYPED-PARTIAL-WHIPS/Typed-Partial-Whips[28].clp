...
(defrule typed-partial-whip[28]
   (declare (salience ?*typed-partial-whip[28]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[28])
      ;;; because typed-whips[28] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[28] have been eliminated (because they have higher salience),
