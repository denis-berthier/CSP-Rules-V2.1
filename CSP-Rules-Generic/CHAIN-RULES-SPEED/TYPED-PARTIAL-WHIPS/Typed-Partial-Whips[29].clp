...
(defrule typed-partial-whip[29]
   (declare (salience ?*typed-partial-whip[29]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[29])
      ;;; because typed-whips[29] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[29] have been eliminated (because they have higher salience),
