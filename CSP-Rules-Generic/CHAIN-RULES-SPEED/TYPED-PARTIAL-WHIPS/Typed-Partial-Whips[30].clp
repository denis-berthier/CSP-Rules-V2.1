...
(defrule typed-partial-whip[30]
   (declare (salience ?*typed-partial-whip[30]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[30])
      ;;; because typed-whips[30] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[30] have been eliminated (because they have higher salience),
