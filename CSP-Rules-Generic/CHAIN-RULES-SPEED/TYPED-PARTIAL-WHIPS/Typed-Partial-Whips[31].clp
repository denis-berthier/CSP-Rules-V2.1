...
(defrule typed-partial-whip[31]
   (declare (salience ?*typed-partial-whip[31]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[31])
      ;;; because typed-whips[31] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[31] have been eliminated (because they have higher salience),
