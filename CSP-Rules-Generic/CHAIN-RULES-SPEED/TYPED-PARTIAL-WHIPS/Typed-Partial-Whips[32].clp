...
(defrule typed-partial-whip[32]
   (declare (salience ?*typed-partial-whip[32]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[32])
      ;;; because typed-whips[32] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[32] have been eliminated (because they have higher salience),
