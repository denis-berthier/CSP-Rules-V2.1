...
(defrule typed-partial-whip[33]
   (declare (salience ?*typed-partial-whip[33]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[33])
      ;;; because typed-whips[33] based on ?zzz (if any) have already been eliminated,
