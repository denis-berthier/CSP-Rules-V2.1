...
(defrule typed-partial-whip[34]
   (declare (salience ?*typed-partial-whip[34]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[34])
      ;;; because typed-whips[34] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[34] have been eliminated (because they have higher salience),
