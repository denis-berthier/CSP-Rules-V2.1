...
(defrule typed-partial-whip[35]
   (declare (salience ?*typed-partial-whip[35]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[35])
      ;;; because typed-whips[35] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[35] have been eliminated (because they have higher salience),
