...
(defrule typed-partial-whip[3]
   (declare (salience ?*typed-partial-whip[3]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[3])
      ;;; because typed-whips[3] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[3] have been eliminated (because they have higher salience),
