...
(defrule typed-partial-whip[4]
   (declare (salience ?*typed-partial-whip[4]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[4])
      ;;; because typed-whips[4] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[4] have been eliminated (because they have higher salience),
