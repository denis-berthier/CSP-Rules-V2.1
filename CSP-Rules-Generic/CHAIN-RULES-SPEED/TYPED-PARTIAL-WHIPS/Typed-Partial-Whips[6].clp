...
(defrule typed-partial-whip[6]
   (declare (salience ?*typed-partial-whip[6]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[6])
      ;;; because typed-whips[6] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[6] have been eliminated (because they have higher salience),
