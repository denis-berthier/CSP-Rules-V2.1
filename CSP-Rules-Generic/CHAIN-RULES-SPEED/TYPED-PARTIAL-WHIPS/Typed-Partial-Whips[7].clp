...
(defrule typed-partial-whip[7]
   (declare (salience ?*typed-partial-whip[7]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[7])
      ;;; because typed-whips[7] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[7] have been eliminated (because they have higher salience),
