...
(defrule typed-partial-whip[8]
   (declare (salience ?*typed-partial-whip[8]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[8])
      ;;; because typed-whips[8] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[8] have been eliminated (because they have higher salience),
