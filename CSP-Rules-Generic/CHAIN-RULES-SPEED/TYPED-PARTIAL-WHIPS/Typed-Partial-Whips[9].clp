...
(defrule typed-partial-whip[9]
   (declare (salience ?*typed-partial-whip[9]-salience*))
   (logical
      (typed-chain
      ...
      ;;; ?new-rlc and ?new-csp
      (technique ?cont typed-partial-whip[9])
      ;;; because typed-whips[9] based on ?zzz (if any) have already been eliminated,
   ...
   ;;; as whips[9] have been eliminated (because they have higher salience),
