...
(deffunction print-forcing-whip-assert-value (?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?cand)
    ...
    (printout t crlf "....") (print-partial-chain "partial-whip" ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1)
    (printout t crlf "....") (print-partial-chain "partial-whip" ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2)
...
(deffunction print-forcing-gwhip-assert-value (?chain-type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?chain-type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?cand)
    ...
    (printout t crlf "....") (print-partial-chain ?chain-type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1)
    (printout t crlf "....") (print-partial-chain ?chain-type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2)
    (printout t crlf ?*implication-sign*) (print-asserted-candidate ?cand)
    (printout t crlf)
)
