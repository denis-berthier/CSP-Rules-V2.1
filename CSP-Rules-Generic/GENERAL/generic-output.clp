...
;;; ORk-forcing-gwhips
(deffunction print-OR2-forcing-gwhip-assert-value (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?cand)
    (printout t "OR2-forcing-gwhip-assert[" (+ ?p1 ?p2 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
...
(deffunction print-OR2-forcing-gwhip-elim-candidate (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?cand)
    (printout t "OR2-forcing-gwhip-elim[" (+ ?p1 ?p2 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
    (if (neq ?p1 0) then (print-partial-chain ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "   || " (print-label ?zzz2) " - ")
    (if (neq ?p2 0) then (print-partial-chain ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2))
...
(deffunction print-OR3-forcing-gwhip-assert-value (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3 ?cand)
    (printout t "OR3-forcing-gwhip-assert[" (+ ?p1 ?p2 ?p3 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
    (if (neq ?p1 0) then (print-partial-chain ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "   || " (print-label ?zzz2) " - ")
    (if (neq ?p2 0) then (print-partial-chain ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2))
    (printout t crlf "   || " (print-label ?zzz3) " - ")
    (if (neq ?p3 0) then (print-partial-chain ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3))
    (printout t crlf ?*implication-sign*) (print-asserted-candidate ?cand)
    (printout t crlf)
)

(deffunction print-OR3-forcing-gwhip-elim-candidate (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3 ?cand)
    (printout t "OR3-forcing-gwhip-elim[" (+ ?p1 ?p2 ?p3 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
    (if (neq ?p1 0) then (print-partial-chain ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "   || " (print-label ?zzz2) " - ")
    (if (neq ?p2 0) then (print-partial-chain ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2))
...
(deffunction print-OR4-forcing-gwhip-assert-value (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3 ?type4 ?p4 ?zzz4 ?llcs4 ?rlcs4 ?csps4 ?cand)
    (printout t "OR4-forcing-gwhip-assert[" (+ ?p1 ?p2 ?p3 ?p4 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
    (if (neq ?p1 0) then (print-partial-chain ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "   || " (print-label ?zzz2) " - ")
    (if (neq ?p2 0) then (print-partial-chain ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2))
    ...
    (if (neq ?p3 0) then (print-partial-chain ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3))
    (printout t crlf "   || " (print-label ?zzz4) " - ")
    (if (neq ?p4 0) then (print-partial-chain ?type4 ?p4 ?zzz4 ?llcs4 ?rlcs4 ?csps4))
    (printout t crlf ?*implication-sign*) (print-asserted-candidate ?cand)
    (printout t crlf)
)

(deffunction print-OR4-forcing-gwhip-elim-candidate (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3 ?type4 ?p4 ?zzz4 ?llcs4 ?rlcs4 ?csps4 ?cand)
    (printout t "OR4-forcing-gwhip-elim[" (+ ?p1 ?p2 ?p3 ?p4 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
    (if (neq ?p1 0) then (print-partial-chain ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "   || " (print-label ?zzz2) " - ")
    (if (neq ?p2 0) then (print-partial-chain ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2))
...
(deffunction print-OR5-forcing-gwhip-assert-value (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3 ?type4 ?p4 ?zzz4 ?llcs4 ?rlcs4 ?csps4 ?type5 ?p5 ?zzz5 ?llcs5 ?rlcs5 ?csps5 ?cand)
    (printout t "OR5-forcing-gwhip-assert[" (+ ?p1 ?p2 ?p3 ?p4 ?p5 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
    (if (neq ?p1 0) then (print-partial-chain ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "   || " (print-label ?zzz2) " - ")
    (if (neq ?p2 0) then (print-partial-chain ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2))
    ...
    (if (neq ?p4 0) then (print-partial-chain ?type4 ?p4 ?zzz4 ?llcs4 ?rlcs4 ?csps4))
    (printout t crlf "   || " (print-label ?zzz5) " - ")
    (if (neq ?p5 0) then (print-partial-chain ?type5 ?p5 ?zzz5 ?llcs5 ?rlcs5 ?csps5))
    (printout t crlf ?*implication-sign*) (print-asserted-candidate ?cand)
    (printout t crlf)
)

(deffunction print-OR5-forcing-gwhip-elim-candidate (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3 ?type4 ?p4 ?zzz4 ?llcs4 ?rlcs4 ?csps4 ?type5 ?p5 ?zzz5 ?llcs5 ?rlcs5 ?csps5 ?cand)
    (printout t "OR5-forcing-gwhip-elim[" (+ ?p1 ?p2 ?p3 ?p4 ?p5 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
    (if (neq ?p1 0) then (print-partial-chain ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "   || " (print-label ?zzz2) " - ")
    (if (neq ?p2 0) then (print-partial-chain ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2))
...
(deffunction print-OR6-forcing-gwhip-assert-value (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3 ?type4 ?p4 ?zzz4 ?llcs4 ?rlcs4 ?csps4 ?type5 ?p5 ?zzz5 ?llcs5 ?rlcs5 ?csps5 ?type6 ?p6 ?zzz6 ?llcs6 ?rlcs6 ?csps6 ?cand)
    (printout t "OR6-forcing-gwhip-assert[" (+ ?p1 ?p2 ?p3 ?p4 ?p5 ?p6 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
    (if (neq ?p1 0) then (print-partial-chain ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "   || " (print-label ?zzz2) " - ")
    (if (neq ?p2 0) then (print-partial-chain ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2))
    ...
    (if (neq ?p5 0) then (print-partial-chain ?type5 ?p5 ?zzz5 ?llcs5 ?rlcs5 ?csps5))
    (printout t crlf "   || " (print-label ?zzz6) " - ")
    (if (neq ?p6 0) then (print-partial-chain ?type6 ?p6 ?zzz6 ?llcs6 ?rlcs6 ?csps6))
    (printout t crlf ?*implication-sign*) (print-asserted-candidate ?cand)
    (printout t crlf)
)

(deffunction print-OR6-forcing-gwhip-elim-candidate (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3 ?type4 ?p4 ?zzz4 ?llcs4 ?rlcs4 ?csps4 ?type5 ?p5 ?zzz5 ?llcs5 ?rlcs5 ?csps5 ?type6 ?p6 ?zzz6 ?llcs6 ?rlcs6 ?csps6 ?cand)
    (printout t "OR6-forcing-gwhip-elim[" (+ ?p1 ?p2 ?p3 ?p4 ?p5 ?p6 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
    (if (neq ?p1 0) then (print-partial-chain ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "   || " (print-label ?zzz2) " - ")
    (if (neq ?p2 0) then (print-partial-chain ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2))
...
(deffunction print-OR7-forcing-gwhip-assert-value (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3 ?type4 ?p4 ?zzz4 ?llcs4 ?rlcs4 ?csps4 ?type5 ?p5 ?zzz5 ?llcs5 ?rlcs5 ?csps5 ?type6 ?p6 ?zzz6 ?llcs6 ?rlcs6 ?csps6 ?type7 ?p7 ?zzz7 ?llcs7 ?rlcs7 ?csps7 ?cand)
    (printout t "OR7-forcing-gwhip-assert[" (+ ?p1 ?p2 ?p3 ?p4 ?p5 ?p6 ?p7 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
    (if (neq ?p1 0) then (print-partial-chain ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "   || " (print-label ?zzz2) " - ")
    (if (neq ?p2 0) then (print-partial-chain ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2))
    ...
    (if (neq ?p6 0) then (print-partial-chain ?type6 ?p6 ?zzz6 ?llcs6 ?rlcs6 ?csps6))
    (printout t crlf "   || " (print-label ?zzz7) " - ")
    (if (neq ?p7 0) then (print-partial-chain ?type7 ?p7 ?zzz7 ?llcs7 ?rlcs7 ?csps7))
    (printout t crlf ?*implication-sign*) (print-asserted-candidate ?cand)
    (printout t crlf)
)

(deffunction print-OR7-forcing-gwhip-elim-candidate (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3 ?type4 ?p4 ?zzz4 ?llcs4 ?rlcs4 ?csps4 ?type5 ?p5 ?zzz5 ?llcs5 ?rlcs5 ?csps5 ?type6 ?p6 ?zzz6 ?llcs6 ?rlcs6 ?csps6 ?type7 ?p7 ?zzz7 ?llcs7 ?rlcs7 ?csps7 ?cand)
    (printout t "OR7-forcing-gwhip-elim[" (+ ?p1 ?p2 ?p3 ?p4 ?p5 ?p6 ?p7 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
    (if (neq ?p1 0) then (print-partial-chain ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "   || " (print-label ?zzz2) " - ")
    (if (neq ?p2 0) then (print-partial-chain ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2))
...
(deffunction print-OR8-forcing-gwhip-assert-value (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3 ?type4 ?p4 ?zzz4 ?llcs4 ?rlcs4 ?csps4 ?type5 ?p5 ?zzz5 ?llcs5 ?rlcs5 ?csps5 ?type6 ?p6 ?zzz6 ?llcs6 ?rlcs6 ?csps6 ?type7 ?p7 ?zzz7 ?llcs7 ?rlcs7 ?csps7 ?type8 ?p8 ?zzz8 ?llcs8 ?rlcs8 ?csps8 ?cand)
    (printout t "OR8-forcing-gwhip-assert[" (+ ?p1 ?p2 ?p3 ?p4 ?p5 ?p6 ?p7 ?p8 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
    (if (neq ?p1 0) then (print-partial-chain ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "   || " (print-label ?zzz2) " - ")
    (if (neq ?p2 0) then (print-partial-chain ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2))
    ...
    (if (neq ?p7 0) then (print-partial-chain ?type7 ?p7 ?zzz7 ?llcs7 ?rlcs7 ?csps7))
    (printout t crlf "   || " (print-label ?zzz8) " - ")
    (if (neq ?p8 0) then (print-partial-chain ?type8 ?p8 ?zzz8 ?llcs8 ?rlcs8 ?csps8))
    (printout t crlf ?*implication-sign*) (print-asserted-candidate ?cand)
    (printout t crlf)
)

(deffunction print-OR8-forcing-gwhip-elim-candidate (?or-name ?or-compl ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?type2 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?type3 ?p3 ?zzz3 ?llcs3 ?rlcs3 ?csps3 ?type4 ?p4 ?zzz4 ?llcs4 ?rlcs4 ?csps4 ?type5 ?p5 ?zzz5 ?llcs5 ?rlcs5 ?csps5 ?type6 ?p6 ?zzz6 ?llcs6 ?rlcs6 ?csps6 ?type7 ?p7 ?zzz7 ?llcs7 ?rlcs7 ?csps7 ?type8 ?p8 ?zzz8 ?llcs8 ?rlcs8 ?csps8 ?cand)
    (bind ?name (str-cat ?or-name "-" (if (eq (+ ?p1 ?p2 ?p3 ?p4 ?p5 ?p6 ?p7 ?p8) 0) then "OR8-whip" else "OR8-forcing-gwhip-elim")))
    (printout t ?name "[" (+ ?p1 ?p2 ?p3 ?p4 ?p5 ?p6 ?p7 ?p8 1) "]:")
    (printout t crlf "   || " (print-label ?zzz1) " - ")
    (if (neq ?p1 0) then (print-partial-chain ?type1 ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "   || " (print-label ?zzz2) " - ")
...
(deffunction print-OR6-contrad-gwhip (?or-name ?or-compl ?p ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6 ?cand ?llcs ?rlcs ?csps)
    (bind ?name (str-cat ?or-name "-" (if (eq ?p 0) then "OR6-gwhip" else "OR6-ctr-gwhip")))
    (printout t ?name "[" (+ ?p 1) "]: ")
    (print-partial-ORk-chain ?p ?llcs ?rlcs ?csps)
    (printout t ?*link-symbol*)
    (print-final-ORk-cell 6 ?zzz1 ?zzz2 ?zzz3 ?zzz4 ?zzz5 ?zzz6)
