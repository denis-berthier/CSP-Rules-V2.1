...
(defglobal ?*update-OR13-salience* = 0)
(defglobal ?*update-OR14-salience* = 0)
(defglobal ?*update-OR15-salience* = 0)
(defglobal ?*update-OR16-salience* = 0)
(defglobal ?*update-OR17-salience* = 0)
(defglobal ?*update-OR18-salience* = 0)
(defglobal ?*update-OR19-salience* = 0)
(defglobal ?*update-OR20-salience* = 0)
...
(deffunction define-blocked-rule-saliences ()
    ...
    (bind ?*update-OR13-salience* (bind ?*next-rule-salience* (- ?*next-rule-salience* 1)))
    (bind ?*update-OR14-salience* (bind ?*next-rule-salience* (- ?*next-rule-salience* 1)))
    (bind ?*update-OR15-salience* (bind ?*next-rule-salience* (- ?*next-rule-salience* 1)))
    (bind ?*update-OR16-salience* (bind ?*next-rule-salience* (- ?*next-rule-salience* 1)))
    (bind ?*update-OR17-salience* (bind ?*next-rule-salience* (- ?*next-rule-salience* 1)))
    (bind ?*update-OR18-salience* (bind ?*next-rule-salience* (- ?*next-rule-salience* 1)))
    (bind ?*update-OR19-salience* (bind ?*next-rule-salience* (- ?*next-rule-salience* 1)))
