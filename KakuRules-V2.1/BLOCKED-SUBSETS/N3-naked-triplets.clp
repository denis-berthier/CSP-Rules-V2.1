...
=>
    ...
    (assert (blocked ?cont naked-triplets-in-horizontal-sector ?row ?col1 ?col2 ?col3 ?nb1 ?nb2 ?nb3 ?sec))
	(if (or ?*print-actions* ?*print-L3* ?*print-naked-triplets*) then
        (bind ?*blocked-rule-description*
            (str-cat
			    "naked-triplets-in-horiz-sector: "
				(row-name ?row)
...
(defrule apply-L3-naked-triplets-in-a-row
    ...
    (blocked ?cont naked-triplets-in-horizontal-sector ?row ?col1 ?col2 ?col3 ?nb1 ?nb2 ?nb3 ?sec)
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont naked-triplets-in-vertical-sector ?col ?row1 ?row2 ?row3 ?nb1 ?nb2 ?nb3 ?sec))
	(if (or ?*print-actions* ?*print-L3* ?*print-naked-triplets*) then
        (bind ?*blocked-rule-description*
            (str-cat
                "naked-triplets-in-verti-sector: "
				(column-name ?col)
...
(defrule apply-L3-naked-triplets-in-a-column
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont naked-triplets-in-vertical-sector ?col ?row1 ?row2 ?row3 ?nb1 ?nb2 ?nb3 ?sec)
    ;;; identify the targets
