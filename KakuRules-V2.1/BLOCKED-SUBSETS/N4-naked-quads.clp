...
=>
    ...
    (assert (blocked ?cont naked-quads-in-horizontal-sector ?row ?col1 ?col2 ?col3 ?col4 ?nb1 ?nb2 ?nb3 ?nb4 ?sec))
	(if (or ?*print-actions* ?*print-L4* ?*print-naked-quads*) then
        (bind ?*blocked-rule-description*
            (str-cat
			    "naked-quads-in-horiz-sector: "
				(row-name ?row)
...
(defrule apply-L4-naked-quads-in-a-row
    ...
    (blocked ?cont naked-quads-in-horizontal-sector ?row ?col1 ?col2 ?col3 ?col4 ?nb1 ?nb2 ?nb3 ?nb4 ?sec)
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont naked-quads-in-vertical-sector ?col ?row1 ?row2 ?row3 ?row4 ?nb1 ?nb2 ?nb3 ?nb4 ?sec))
	(if (or ?*print-actions* ?*print-L4* ?*print-naked-quads*) then
        (bind ?*blocked-rule-description*
            (str-cat
			    "naked-quads-in-verti-sector: "
				(column-name ?col)
...
(defrule apply-L4-naked-quads-in-a-column
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont naked-quads-in-vertical-sector ?col ?row1 ?row2 ?row3 ?row4 ?nb1 ?nb2 ?nb3 ?nb4 ?sec)
    ;;; identify the targets
