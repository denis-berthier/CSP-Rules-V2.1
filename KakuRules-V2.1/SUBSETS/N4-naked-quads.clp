...
=>
    ...
    (if ?*blocked-Subsets* then
        ...
        (assert (pseudo-blocked ?cont naked-quads-in-horizontal-sector ?zzz ?row ?col1 ?col2 ?col3 ?col4 ?nb1 ?nb2 ?nb3 ?nb4 ?sec))
    )
)
...
(defrule apply-to-more-targets-L4-naked-quads-in-a-row
    ...
    (pseudo-blocked ?cont naked-quads-in-horizontal-sector ?zzz ?row ?col1 ?col2 ?col3 ?col4 ?nb1 ?nb2 ?nb3 ?nb4 ?sec)
...
=>
    ...
    (if ?*blocked-Subsets* then
        (assert (apply-rule-as-a-pseudo-block ?cont))
        (assert (pseudo-blocked ?cont naked-quads-in-vertical-sector ?zzz ?col ?row1 ?row2 ?row3 ?row4 ?nb1 ?nb2 ?nb3 ?nb4 ?sec))
    )
)
...
(defrule apply-to-more-targets-L4-naked-quads-in-a-column
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (pseudo-blocked ?cont naked-quads-in-vertical-sector ?zzz ?col ?row1 ?row2 ?row3 ?row4 ?nb1 ?nb2 ?nb3 ?nb4 ?sec)
    ;;; identify the targets
