...
(defrule detect-L2-hidden-pairs-in-a-diagonal
...
=>
    ...
    (assert (blocked ?cont hidden-pairs-in-a-diagonal ?diag ?anti-diag1 ?anti-diag2 ?nb1 ?nb2))
    (if (or ?*print-actions* ?*print-L2* ?*print-hidden-pairs*) then
        (bind ?*blocked-rule-description*
			(str-cat "hidden-pairs-in-a-diagonal: "
				(diagonal-name ?diag)
...
(defrule apply-L2-hidden-pairs-in-a-diagonal
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont hidden-pairs-in-a-diagonal ?diag ?anti-diag1 ?anti-diag2 ?nb1 ?nb2)
...
(defrule detect-L2-hidden-pairs-in-an-anti-diagonal
	(declare (salience ?*hidden-pairs-salience*))
	(technique ?cont hidden-pairs)
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont hidden-pairs-in-an-anti-diagonal ?anti-diag ?diag1 ?diag2 ?nb1 ?nb2))
	(if (or ?*print-actions* ?*print-L2* ?*print-hidden-pairs*) then
        (bind ?*blocked-rule-description*
			(str-cat "hidden-pairs-in-an-anti-diagonal: "
...
(defrule apply-L2-hidden-pairs-in-an-anti-diagonal
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont hidden-pairs-in-an-anti-diagonal ?anti-diag ?diag1 ?diag2 ?nb1 ?nb2)
