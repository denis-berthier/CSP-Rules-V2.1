...
(defrule detect-L3-naked-triplets-in-a-diagonal
...
=>
    ...
    (assert (blocked ?cont naked-triplets-in-a-diagonal ?diag ?anti-diag1 ?anti-diag2 ?anti-diag3 ?nb1 ?nb2 ?nb3))
	(if (or ?*print-actions* ?*print-L3* ?*print-naked-triplets*) then
        (bind ?*blocked-rule-description*
            (str-cat "naked-triplets-in-a-diagonal: "
				(diagonal-name ?diag)
...
(defrule apply-L3-naked-triplets-in-a-diagonal
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont naked-triplets-in-a-diagonal ?diag ?anti-diag1 ?anti-diag2 ?anti-diag3 ?nb1 ?nb2 ?nb3)
...
(defrule detect-L3-naked-triplets-in-an-anti-diagonal
	(declare (salience ?*naked-triplets-salience*))
	(technique ?cont naked-triplets)
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont naked-triplets-in-an-anti-diagonal ?anti-diag ?diag1 ?diag2 ?diag3 ?nb1 ?nb2 ?nb3))
	(if (or ?*print-actions* ?*print-L3* ?*print-naked-triplets*) then
        (bind ?*blocked-rule-description*
            (str-cat "naked-triplets-in-an-anti-diagonal: "
...
(defrule apply-L3-naked-triplets-in-an-anti-diagonal
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont naked-triplets-in-an-anti-diagonal ?anti-diag ?diag1 ?diag2 ?diag3 ?nb1 ?nb2 ?nb3)
