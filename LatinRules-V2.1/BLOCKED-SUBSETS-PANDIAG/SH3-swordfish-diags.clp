...
(defrule detect-L3-swordfish-in-diagonals
...
=>
    ...
    (assert (blocked ?cont swordfish-in-diagonals ?nb ?diag1 ?diag2 ?diag3 ?anti-diag1 ?anti-diag2 ?anti-diag3))
	(if (or ?*print-actions* ?*print-L3* ?*print-swordfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "swordfish-in-diagonals: "
				(number-name ?nb) 
...
(defrule apply-L3-swordfish-in-diagonals
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont swordfish-in-diagonals ?nb ?diag1 ?diag2 ?diag3 ?anti-diag1 ?anti-diag2 ?anti-diag3)
...
(defrule detect-L3-swordfish-in-anti-diagonals
	(declare (salience ?*swordfish-salience*))
	(technique ?cont swordfish)
	;;; if, in a context, there is a number ?nb
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont swordfish-in-anti-diagonals ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?diag1 ?diag2 ?diag3))
	(if (or ?*print-actions* ?*print-L3* ?*print-swordfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "swordfish-in-anti-diagonals: "
				(number-name ?nb) 
				?*starting-cell-symbol* (anti-diagonal-name ?anti-diag1) ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag2)
				?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag3) ?*ending-cell-symbol*
				?*starting-cell-symbol* (diagonal-name ?diag1) ?*separation-sign-in-cell* (diagonal-name ?diag2)
...
(defrule apply-L3-swordfish-in-anti-diagonals
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont swordfish-in-anti-diagonals ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?diag1 ?diag2 ?diag3)
...
(defrule detect-L3-swordfish-in-rows-w-transv-diags
    (declare (salience ?*swordfish-salience*))
    (technique ?cont swordfish)
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont swordfish-in-rows-w-transv-diags ?nb ?row1 ?row2 ?row3 ?diag1 ?diag2 ?diag3))
    (if (or ?*print-actions* ?*print-L3* ?*print-swordfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "swordfish-in-rows-w-transv-diags: "
                (number-name ?nb)
...
(defrule apply-L3-swordfish-in-rows-w-transv-diags
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont swordfish-in-rows-w-transv-diags ?nb ?row1 ?row2 ?row3 ?diag1 ?diag2 ?diag3)
...
(defrule detect-L3-swordfish-in-columns-w-transv-diags
    (declare (salience ?*swordfish-salience*))
    (technique ?cont swordfish)
    ;;; if, in a context, there is a number ?nb
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont swordfish-in-columns-w-transv-diags ?nb ?col1 ?col2 ?col3 ?diag1 ?diag2 ?diag3))
    (if (or ?*print-actions* ?*print-L3* ?*print-swordfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "swordfish-in-columns-w-transv-diags: "
                (number-name ?nb)
...
(defrule apply-L3-swordfish-in-columns-w-transv-diags
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont swordfish-in-columns-w-transv-diags ?nb ?col1 ?col2 ?col3 ?diag1 ?diag2 ?diag3)
...
(defrule detect-L3-swordfish-in-rows-w-transv-anti-diags
    (declare (salience ?*swordfish-salience*))
    (technique ?cont swordfish)
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont swordfish-in-rows-w-transv-anti-diags ?nb ?row1 ?row2 ?row3 ?anti-diag1 ?anti-diag2 ?anti-diag3))
    (if (or ?*print-actions* ?*print-L3* ?*print-swordfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "swordfish-in-rows-w-transv-anti-diags: "
                (number-name ?nb)
                ?*starting-cell-symbol* (row-name ?row1) ?*separation-sign-in-cell* (row-name ?row2)
                ?*separation-sign-in-cell* (row-name ?row3) ?*ending-cell-symbol*
                ?*starting-cell-symbol* (anti-diagonal-name ?anti-diag1) ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag2)
...
(defrule apply-L3-swordfish-in-rows-w-transv-anti-diags
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont swordfish-in-rows-w-transv-anti-diags ?nb ?row1 ?row2 ?row3 ?anti-diag1 ?anti-diag2 ?anti-diag3)
...
(defrule detect-L3-swordfish-in-columns-w-transv-anti-diags
    (declare (salience ?*swordfish-salience*))
    (technique ?cont swordfish)
    ;;; if, in a context, there is a number ?nb
    ;;; and there are three columns ?col1 < ?col2 < ?col3,
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont swordfish-in-columns-w-transv-anti-diags ?nb ?col1 ?col2 ?col3 ?anti-diag1 ?anti-diag2 ?anti-diag3))
    (if (or ?*print-actions* ?*print-L3* ?*print-swordfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "swordfish-in-columns-w-transv-anti-diags: "
                (number-name ?nb)
                ?*starting-cell-symbol* (column-name ?col1) ?*separation-sign-in-cell* (column-name ?col2)
                ?*separation-sign-in-cell* (column-name ?col3) ?*ending-cell-symbol*
                ?*starting-cell-symbol* (anti-diagonal-name ?anti-diag1) ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag2)
...
(defrule apply-L3-swordfish-in-columns-w-transv-anti-diags
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont swordfish-in-columns-w-transv-anti-diags ?nb ?col1 ?col2 ?col3 ?anti-diag1 ?anti-diag2 ?anti-diag3)
...
(defrule detect-L3-swordfish-in-diags-w-transv-columns
    (declare (salience ?*swordfish-salience*))
    (technique ?cont swordfish)
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont swordfish-in-diags-w-transv-columns ?nb ?diag1 ?diag2 ?diag3 ?col1 ?col2 ?col3))
    (if (or ?*print-actions* ?*print-L3* ?*print-swordfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "swordfish-in-diags-w-transv-columns: "
                (number-name ?nb)
                ?*starting-cell-symbol* (diagonal-name ?diag1) ?*separation-sign-in-cell* (diagonal-name ?diag2)
                ?*separation-sign-in-cell* (diagonal-name ?diag3) ?*ending-cell-symbol*
                ?*starting-cell-symbol* (column-name ?col1) ?*separation-sign-in-cell* (column-name ?col2)
...
(defrule apply-L3-swordfish-in-diags-w-transv-columns
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont swordfish-in-diags-w-transv-columns ?nb ?diag1 ?diag2 ?diag3 ?col1 ?col2 ?col3)
...
(defrule detect-L3-swordfish-in-diags-w-transv-rows
    (declare (salience ?*swordfish-salience*))
    (technique ?cont swordfish)
    ;;; if, in a context, there is a number ?nb
    ;;; and there are three diagonals ?diag1 < ?diag2 < ?diag3,
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont swordfish-in-diags-w-transv-rows ?nb ?diag1 ?diag2 ?diag3 ?row1 ?row2 ?row3))
    (if (or ?*print-actions* ?*print-L3* ?*print-swordfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "swordfish-in-diags-w-transv-rows: "
                (number-name ?nb)
                ?*starting-cell-symbol* (diagonal-name ?diag1) ?*separation-sign-in-cell* (diagonal-name ?diag2)
                ?*separation-sign-in-cell* (diagonal-name ?diag3) ?*ending-cell-symbol*
                ?*starting-cell-symbol* (row-name ?row1) ?*separation-sign-in-cell* (row-name ?row2)
...
(defrule apply-L3-swordfish-in-diags-w-transv-rows
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont swordfish-in-diags-w-transv-rows ?nb ?diag1 ?diag2 ?diag3 ?row1 ?row2 ?row3)
...
(defrule detect-L3-swordfish-in-anti-diags-w-transv-columns
    (declare (salience ?*swordfish-salience*))
    (technique ?cont swordfish)
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont swordfish-in-anti-diags-w-transv-columns ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?col1 ?col2 ?col3))
    (if (or ?*print-actions* ?*print-L3* ?*print-swordfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "swordfish-in-anti-diags-w-transv-columns: "
                (number-name ?nb)
                ?*starting-cell-symbol* (anti-diagonal-name ?anti-diag1) ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag2)
                ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag3) ?*ending-cell-symbol*
                ?*starting-cell-symbol* (column-name ?col1) ?*separation-sign-in-cell* (column-name ?col2)
...
(defrule apply-L3-swordfish-in-anti-diags-w-transv-columns
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont swordfish-in-anti-diags-w-transv-columns ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?col1 ?col2 ?col3)
...
(defrule detect-L3-swordfish-in-anti-diags-w-transv-rows
    (declare (salience ?*swordfish-salience*))
    (technique ?cont swordfish)
    ;;; if, in a context, there is a number ?nb
    ;;; and there are three anti-diagonals ?anti-diag1 < ?anti-diag2 < ?anti-diag3,
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont swordfish-in-anti-diags-w-transv-rows ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?row1 ?row2 ?row3))
    (if (or ?*print-actions* ?*print-L3* ?*print-swordfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "swordfish-in-anti-diags-w-transv-rows: "
                (number-name ?nb)
                ?*starting-cell-symbol* (anti-diagonal-name ?anti-diag1) ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag2)
                ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag3) ?*ending-cell-symbol*
                ?*starting-cell-symbol* (row-name ?row1) ?*separation-sign-in-cell* (row-name ?row2)
...
(defrule apply-L3-swordfish-in-anti-diags-w-transv-rows
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont swordfish-in-anti-diags-w-transv-rows ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?row1 ?row2 ?row3)
