...
(defrule detect-L4-jellyfish-in-diagonals
	...
	;;; such that, in each of these diagonals, ?nb is confined exactly to ?anti-diag1, ?anti-diag2, ?anti-diag3 and ?anti-diag4
...
=>
    ...
    (assert (blocked ?cont jellyfish-in-diagonals ?nb ?diag1 ?diag2 ?diag3 ?diag4 ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4))
	(if (or ?*print-actions* ?*print-L4* ?*print-jellyfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "jellyfish-in-diagonals: "
				(number-name ?nb) 
...
(defrule apply-L4-jellyfish-in-diagonals
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont jellyfish-in-diagonals ?nb ?diag1 ?diag2 ?diag3 ?diag4 ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4)
...
(defrule detect-L4-jellyfish-in-anti-diagonals
	(declare (salience ?*jellyfish-salience*))
	(technique ?cont jellyfish)
	...
	;;; such that, in each of these anti-diagonals, ?nb is confined exactly to ?diag1, ?diag2, ?diag3 and ?diag4
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont jellyfish-in-anti-diagonals ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?diag1 ?diag2 ?diag3 ?diag4))
	(if (or ?*print-actions* ?*print-L4* ?*print-jellyfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "jellyfish-in-anti-diagonals: "
				(number-name ?nb) 
				?*starting-cell-symbol* (anti-diagonal-name ?anti-diag1) ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag2)
				?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag3) ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag4) ?*ending-cell-symbol*
				?*starting-cell-symbol* (diagonal-name ?diag1) ?*separation-sign-in-cell* (diagonal-name ?diag2)
...
(defrule apply-L4-jellyfish-in-anti-diagonals
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont jellyfish-in-anti-diagonals ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?diag1 ?diag2 ?diag3 ?diag4)
...
(defrule detect-L4-jellyfish-in-rows-w-transv-diags
    (declare (salience ?*jellyfish-salience*))
    (technique ?cont jellyfish)
    ...
    ;;; such that, in each of these rows, ?nb is confined exactly to ?diag1, ?diag2, ?diag3 and ?diag4
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont jellyfish-in-rows-w-transv-diags ?nb ?row1 ?row2 ?row3 ?row4 ?diag1 ?diag2 ?diag3 ?diag4))
    (if (or ?*print-actions* ?*print-L4* ?*print-jellyfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "jellyfish-in-rows-w-transv-diags: "
                (number-name ?nb)
...
(defrule apply-L4-jellyfish-in-rows-w-transv-diags
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont jellyfish-in-rows-w-transv-diags ?nb ?row1 ?row2 ?row3 ?row4 ?diag1 ?diag2 ?diag3 ?diag4)
...
(defrule detect-L4-jellyfish-in-columns-w-transv-diags
    (declare (salience ?*jellyfish-salience*))
    (technique ?cont jellyfish)
    ...
    ;;; such that, in each of these columns, ?nb is confined exactly to ?diag1, ?diag2, ?diag3 and ?diag4
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont jellyfish-in-columns-w-transv-diags ?nb ?col1 ?col2 ?col3 ?col4 ?diag1 ?diag2 ?diag3 ?diag4))
    (if (or ?*print-actions* ?*print-L4* ?*print-jellyfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "jellyfish-in-columns-w-transv-diags: "
                (number-name ?nb)
...
(defrule apply-L4-jellyfish-in-columns-w-transv-diags
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont jellyfish-in-columns-w-transv-diags ?nb ?col1 ?col2 ?col3 ?col4 ?diag1 ?diag2 ?diag3 ?diag4)
...
(defrule detect-L4-jellyfish-in-rows-w-transv-anti-diags
    (declare (salience ?*jellyfish-salience*))
    (technique ?cont jellyfish)
    ...
    ;;; such that, in each of these rows, ?nb is confined exactly to ?anti-diag1, ?anti-diag2, ?anti-diag3 and ?anti-diag4
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont jellyfish-in-rows-w-transv-anti-diags ?nb ?row1 ?row2 ?row3 ?row4 ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4))
    (if (or ?*print-actions* ?*print-L4* ?*print-jellyfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "jellyfish-in-rows-w-transv-anti-diags: "
                (number-name ?nb)
                ?*starting-cell-symbol* (row-name ?row1) ?*separation-sign-in-cell* (row-name ?row2)
                ?*separation-sign-in-cell* (row-name ?row3) ?*separation-sign-in-cell* (row-name ?row4) ?*ending-cell-symbol*
                ?*starting-cell-symbol* (anti-diagonal-name ?anti-diag1) ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag2)
...
(defrule apply-L4-jellyfish-in-rows-w-transv-anti-diags
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont jellyfish-in-rows-w-transv-anti-diags ?nb ?row1 ?row2 ?row3 ?row4 ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4)
...
(defrule detect-L4-jellyfish-in-columns-w-transv-anti-diags
    (declare (salience ?*jellyfish-salience*))
    (technique ?cont jellyfish)
    ...
    ;;; such that, in each of these columns, ?nb is confined exactly to ?anti-diag1, ?anti-diag2, ?anti-diag3 and ?anti-diag4
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont jellyfish-in-columns-w-transv-anti-diags ?nb ?col1 ?col2 ?col3 ?col4 ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4))
    (if (or ?*print-actions* ?*print-L4* ?*print-jellyfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "jellyfish-in-columns-w-transv-anti-diags: "
                (number-name ?nb)
                ?*starting-cell-symbol* (column-name ?col1) ?*separation-sign-in-cell* (column-name ?col2)
                ?*separation-sign-in-cell* (column-name ?col3) ?*separation-sign-in-cell* (column-name ?col4) ?*ending-cell-symbol*
                ?*starting-cell-symbol* (anti-diagonal-name ?anti-diag1) ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag2)
...
(defrule apply-L4-jellyfish-in-columns-w-transv-anti-diags
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont jellyfish-in-columns-w-transv-anti-diags ?nb ?col1 ?col2 ?col3 ?col4 ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4)
...
(defrule detect-L4-jellyfish-in-diags-w-transv-columns
    (declare (salience ?*jellyfish-salience*))
    (technique ?cont jellyfish)
    ...
    ;;; such that, in each of these diagonals, ?nb is confined exactly to ?col1, ?col2, ?col3 and ?col4
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont jellyfish-in-diags-w-transv-columns ?nb ?diag1 ?diag2 ?diag3 ?diag4 ?col1 ?col2 ?col3 ?col4))
    (if (or ?*print-actions* ?*print-L4* ?*print-jellyfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "jellyfish-in-diags-w-transv-columns: "
                (number-name ?nb)
                ?*starting-cell-symbol* (diagonal-name ?diag1) ?*separation-sign-in-cell* (diagonal-name ?diag2)
                ?*separation-sign-in-cell* (diagonal-name ?diag3) ?*separation-sign-in-cell* (diagonal-name ?diag4) ?*ending-cell-symbol*
                ?*starting-cell-symbol* (column-name ?col1) ?*separation-sign-in-cell* (column-name ?col2)
...
(defrule apply-L4-jellyfish-in-diags-w-transv-columns
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont jellyfish-in-diags-w-transv-columns ?nb ?diag1 ?diag2 ?diag3 ?diag4 ?col1 ?col2 ?col3 ?col4)
...
(defrule detect-L4-jellyfish-in-diags-w-transv-rows
    (declare (salience ?*jellyfish-salience*))
    (technique ?cont jellyfish)
    ...
    ;;; such that, in each of these diagonals, ?nb is confined exactly to ?row1, ?row2, ?row3 and ?row4
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont jellyfish-in-diags-w-transv-rows ?nb ?diag1 ?diag2 ?diag3 ?diag4 ?row1 ?row2 ?row3 ?row4))
    (if (or ?*print-actions* ?*print-L4* ?*print-jellyfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "jellyfish-in-diags-w-transv-rows: "
                (number-name ?nb)
                ?*starting-cell-symbol* (diagonal-name ?diag1) ?*separation-sign-in-cell* (diagonal-name ?diag2)
                ?*separation-sign-in-cell* (diagonal-name ?diag3) ?*separation-sign-in-cell* (diagonal-name ?diag4) ?*ending-cell-symbol*
                ?*starting-cell-symbol* (row-name ?row1) ?*separation-sign-in-cell* (row-name ?row2)
...
(defrule apply-L4-jellyfish-in-diags-w-transv-rows
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont jellyfish-in-diags-w-transv-rows ?nb ?diag1 ?diag2 ?diag3 ?diag4 ?row1 ?row2 ?row3 ?row4)
...
(defrule detect-L4-jellyfish-in-anti-diags-w-transv-columns
    (declare (salience ?*jellyfish-salience*))
    (technique ?cont jellyfish)
    ...
    ;;; such that, in each of these anti-diagonals, ?nb is confined exactly to ?col1, ?col2, ?col3 and ?col4
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont jellyfish-in-anti-diags-w-transv-columns ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?col1 ?col2 ?col3 ?col4))
    (if (or ?*print-actions* ?*print-L4* ?*print-jellyfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "jellyfish-in-anti-diags-w-transv-columns: "
                (number-name ?nb)
                ?*starting-cell-symbol* (anti-diagonal-name ?anti-diag1) ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag2)
                ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag3) ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag4) ?*ending-cell-symbol*
                ?*starting-cell-symbol* (column-name ?col1) ?*separation-sign-in-cell* (column-name ?col2)
...
(defrule apply-L4-jellyfish-in-anti-diags-w-transv-columns
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont jellyfish-in-anti-diags-w-transv-columns ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?col1 ?col2 ?col3 ?col4)
...
(defrule detect-L4-jellyfish-in-anti-diags-w-transv-rows
    (declare (salience ?*jellyfish-salience*))
    (technique ?cont jellyfish)
    ...
    ;;; such that, in each of these anti-diagonals, ?nb is confined exactly to ?row1, ?row2, ?row3 and ?row4
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont jellyfish-in-anti-diags-w-transv-rows ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?row1 ?row2 ?row3 ?row4))
    (if (or ?*print-actions* ?*print-L4* ?*print-jellyfish*) then
        (bind ?*blocked-rule-description*
            (str-cat "jellyfish-in-anti-diags-w-transv-rows: "
                (number-name ?nb)
                ?*starting-cell-symbol* (anti-diagonal-name ?anti-diag1) ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag2)
                ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag3) ?*separation-sign-in-cell* (anti-diagonal-name ?anti-diag4) ?*ending-cell-symbol*
                ?*starting-cell-symbol* (row-name ?row1) ?*separation-sign-in-cell* (row-name ?row2)
...
(defrule apply-L4-jellyfish-in-anti-diags-w-transv-rows
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont jellyfish-in-anti-diags-w-transv-rows ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?row1 ?row2 ?row3 ?row4)
