...
(defrule detect-L4-special-naked-quads-in-a-diagonal
...
=>
    ...
    (assert (blocked ?cont special-naked-quads-in-a-diagonal ?diag ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?nb1 ?nb2 ?nb3 ?nb4))
	(if (or ?*print-actions* ?*print-L4* ?*print-naked-quads* ?*print-exceptional-patterns*) then
        (bind ?*blocked-rule-description*
            (str-cat "special-naked-quads-in-a-diagonal: "
				(diagonal-name ?diag)
...
(defrule apply-L4-special-naked-quads-in-a-diagonal
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont special-naked-quads-in-a-diagonal ?diag ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?nb1 ?nb2 ?nb3 ?nb4)
...
(defrule detect-L4-special-naked-quads-in-an-anti-diagonal
	(declare (salience ?*naked-quads-salience*))
	(technique ?cont naked-quads)
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont special-naked-quads-in-an-anti-diagonal ?anti-diag ?diag1 ?diag2 ?diag3 ?diag4 ?nb1 ?nb2 ?nb3 ?nb4))
	(if (or ?*print-actions* ?*print-L4* ?*print-naked-quads* ?*print-exceptional-patterns*) then
        (bind ?*blocked-rule-description*
            (str-cat "special-naked-quads-in-an-anti-diagonal: "
...
(defrule apply-L4-special-naked-quads-in-an-anti-diagonal
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont special-naked-quads-in-an-anti-diagonal ?anti-diag ?diag1 ?diag2 ?diag3 ?diag4 ?nb1 ?nb2 ?nb3 ?nb4)
