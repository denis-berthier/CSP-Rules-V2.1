...
(defrule detect-L4-special-jellyfish-in-rows
...
=>
    ...
    (assert (blocked ?cont special-jellyfish-in-rows ?nb ?row1 ?row2 ?row3 ?row4 ?col1 ?col2 ?col3 ?col4))
	(if (or ?*print-actions* ?*print-L4* ?*print-jellyfish* ?*print-exceptional-patterns*) then
        (bind ?*blocked-rule-description*
        (str-cat "special-jellyfish-in-rows: "
				(number-name ?nb) 
...
(defrule apply-L4-special-jellyfish-in-rows
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont special-jellyfish-in-rows ?nb ?row1 ?row2 ?row3 ?row4 ?col1 ?col2 ?col3 ?col4)
...
(defrule detect-L4-special-jellyfish-in-columns
	(declare (salience ?*jellyfish-salience*))
	(technique ?cont jellyfish)
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont special-jellyfish-in-columns ?nb ?col1 ?col2 ?col3 ?col4 ?row1 ?row2 ?row3 ?row4))
	(if (or ?*print-actions* ?*print-L4* ?*print-jellyfish* ?*print-exceptional-patterns*) then
        (bind ?*blocked-rule-description*
            (str-cat "special-jellyfish-in-columns: "
				(number-name ?nb) 
				?*starting-cell-symbol* (column-name ?col1) ?*separation-sign-in-cell* (column-name ?col2) 
				?*separation-sign-in-cell* (column-name ?col3) ?*separation-sign-in-cell* (column-name ?col4) ?*ending-cell-symbol*
				?*starting-cell-symbol* (row-name ?row1) ?*separation-sign-in-cell* (row-name ?row2) 
...
(defrule apply-L4-special-jellyfish-in-columns
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont special-jellyfish-in-columns ?nb ?col1 ?col2 ?col3 ?col4 ?row1 ?row2 ?row3 ?row4)
