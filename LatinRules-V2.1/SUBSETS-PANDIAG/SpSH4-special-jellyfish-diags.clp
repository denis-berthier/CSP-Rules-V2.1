...
=>
    ...
    (if ?*blocked-Subsets* then
        ...
        (assert (pseudo-blocked ?cont special-jellyfish-in-diagonals ?zzz ?nb ?diag1 ?diag2 ?diag3 ?diag4 ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4))
	)
)


(defrule apply-to-more-targets-L4-special-jellyfish-in-diagonals
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (pseudo-blocked ?cont special-jellyfish-in-diagonals ?zzz ?nb ?diag1 ?diag2 ?diag3 ?diag4 ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4)
...
=>
    ...
    (if ?*blocked-Subsets* then
        (assert (apply-rule-as-a-pseudo-block ?cont))
        (assert (pseudo-blocked ?cont special-jellyfish-in-anti-diagonals ?zzz ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?diag1 ?diag2 ?diag3 ?diag4))
	)
)


(defrule apply-to-more-targets-L4-special-jellyfish-in-anti-diagonals
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (pseudo-blocked ?cont special-jellyfish-in-anti-diagonals ?zzz ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?diag1 ?diag2 ?diag3 ?diag4)
    ?cand <- (candidate (context ?cont) (status cand) (label ?zzz2&~?zzz) (number ?nb)
                        (diagonal ?diagz&:(or (eq ?diagz ?diag1) (eq ?diagz ?diag2) (eq ?diagz ?diag3) (eq ?diagz ?diag4)))
                        (anti-diagonal ?anti-diagz&~?anti-diag1&~?anti-diag2&~?anti-diag3&~?anti-diag4))
...
=>
    ...
    (if ?*blocked-Subsets* then
        (assert (apply-rule-as-a-pseudo-block ?cont))
        (assert (pseudo-blocked ?cont special-jellyfish-in-rows-w-transv-diags ?zzz ?nb ?row1 ?row2 ?row3 ?row4 ?diag1 ?diag2 ?diag3 ?diag4))
    )
)


(defrule apply-to-more-targets-L4-special-jellyfish-in-rows-w-transv-diags
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (pseudo-blocked ?cont special-jellyfish-in-rows-w-transv-diags ?zzz ?nb ?row1 ?row2 ?row3 ?row4 ?diag1 ?diag2 ?diag3 ?diag4)
    ?cand <- (candidate (context ?cont) (status cand) (label ?zzz2&~?zzz) (number ?nb)
                        (diagonal ?diagz&:(or (eq ?diagz ?diag1) (eq ?diagz ?diag2) (eq ?diagz ?diag3) (eq ?diagz ?diag4)))
                        (row ?rowz&~?row1&~?row2&~?row3&~?row4))
=>
...
=>
    ...
    (if ?*blocked-Subsets* then
        (assert (apply-rule-as-a-pseudo-block ?cont))
        (assert (pseudo-blocked ?cont special-jellyfish-in-columns-w-transv-diags ?zzz ?nb ?col1 ?col2 ?col3 ?col4 ?diag1 ?diag2 ?diag3 ?diag4))
    )
)


(defrule apply-to-more-targets-L4-special-jellyfish-in-columns-w-transv-diags
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (pseudo-blocked ?cont special-jellyfish-in-columns-w-transv-diags ?zzz ?nb ?col1 ?col2 ?col3 ?col4 ?diag1 ?diag2 ?diag3 ?diag4)
    ?cand <- (candidate (context ?cont) (status cand) (label ?zzz2&~?zzz) (number ?nb)
                        (diagonal ?diagz&:(or (eq ?diagz ?diag1) (eq ?diagz ?diag2) (eq ?diagz ?diag3) (eq ?diagz ?diag4)))
                        (column ?colz&~?col1&~?col2&~?col3&~?col4))
...
=>
    ...
    (if ?*blocked-Subsets* then
        (assert (apply-rule-as-a-pseudo-block ?cont))
        (assert (pseudo-blocked ?cont special-jellyfish-in-rows-w-transv-anti-diags ?zzz ?nb ?row1 ?row2 ?row3 ?row4 ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4))
    )
)


(defrule apply-to-more-targets-L4-special-jellyfish-in-rows-w-transv-anti-diags
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (pseudo-blocked ?cont special-jellyfish-in-rows-w-transv-anti-diags ?zzz ?nb ?row1 ?row2 ?row3 ?row4 ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4)
    ?cand <- (candidate (context ?cont) (status cand) (label ?zzz2&~?zzz) (number ?nb)
                        (anti-diagonal ?anti-diagz&:(or (eq ?anti-diagz ?anti-diag1) (eq ?anti-diagz ?anti-diag2) (eq ?anti-diagz ?anti-diag3) (eq ?anti-diagz ?anti-diag4)))
                        (row ?rowz&~?row1&~?row2&~?row3&~?row4))
=>
...
=>
    ...
    (if ?*blocked-Subsets* then
        (assert (apply-rule-as-a-pseudo-block ?cont))
        (assert (pseudo-blocked ?cont special-jellyfish-in-columns-w-transv-anti-diags ?zzz ?nb ?col1 ?col2 ?col3 ?col4 ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4))
    )
)

(defrule apply-to-more-targets-L4-special-jellyfish-in-columns-w-transv-anti-diags
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (pseudo-blocked ?cont special-jellyfish-in-columns-w-transv-anti-diags ?zzz ?nb ?col1 ?col2 ?col3 ?col4 ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4)
    ?cand <- (candidate (context ?cont) (status cand) (label ?zzz2&~?zzz) (number ?nb)
                        (anti-diagonal ?anti-diagz&:(or (eq ?anti-diagz ?anti-diag1) (eq ?anti-diagz ?anti-diag2) (eq ?anti-diagz ?anti-diag3) (eq ?anti-diagz ?anti-diag4)))
                        (column ?colz&~?col1&~?col2&~?col3&~?col4))
...
=>
    ...
    (if ?*blocked-Subsets* then
        (assert (apply-rule-as-a-pseudo-block ?cont))
        (assert (pseudo-blocked ?cont special-jellyfish-in-diags-w-transv-columns ?zzz ?nb ?diag1 ?diag2 ?diag3 ?diag4 ?col1 ?col2 ?col3 ?col4))
    )
)


(defrule apply-to-more-targets-L4-special-jellyfish-in-diags-w-transv-columns
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (pseudo-blocked ?cont special-jellyfish-in-diags-w-transv-columns ?zzz ?nb ?diag1 ?diag2 ?diag3 ?diag4 ?col1 ?col2 ?col3 ?col4)
    ?cand <- (candidate (context ?cont) (status cand) (label ?zzz2&~?zzz) (number ?nb)
                        (column ?colz&:(or (eq ?colz ?col1) (eq ?colz ?col2) (eq ?colz ?col3) (eq ?colz ?col4)))
                        (diagonal ?diagz&~?diag1&~?diag2&~?diag3&~?diag4))
=>
...
=>
    ...
    (if ?*blocked-Subsets* then
        (assert (apply-rule-as-a-pseudo-block ?cont))
        (assert (pseudo-blocked ?cont special-jellyfish-in-diags-w-transv-rows ?zzz ?nb ?diag1 ?diag2 ?diag3 ?diag4 ?row1 ?row2 ?row3 ?row4))
    )
)


(defrule apply-to-more-targets-L4-special-jellyfish-in-diags-w-transv-rows
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (pseudo-blocked ?cont special-jellyfish-in-diags-w-transv-rows ?zzz ?nb ?diag1 ?diag2 ?diag3 ?diag4 ?row1 ?row2 ?row3 ?row4)
    ?cand <- (candidate (context ?cont) (status cand) (label ?zzz2&~?zzz) (number ?nb)
                        (row ?rowz&:(or (eq ?rowz ?row1) (eq ?rowz ?row2) (eq ?rowz ?row3) (eq ?rowz ?row4)))
                        (diagonal ?diagz&~?diag1&~?diag2&~?diag3&~?diag4))
...
=>
    ...
    (if ?*blocked-Subsets* then
        (assert (apply-rule-as-a-pseudo-block ?cont))
        (assert (pseudo-blocked ?cont special-jellyfish-in-anti-diags-w-transv-columns ?zzz ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?col1 ?col2 ?col3 ?col4))
    )
)


(defrule apply-to-more-targets-L4-special-jellyfish-in-anti-diags-w-transv-columns
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (pseudo-blocked ?cont special-jellyfish-in-anti-diags-w-transv-columns ?zzz ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?col1 ?col2 ?col3 ?col4)
    ?cand <- (candidate (context ?cont) (status cand) (label ?zzz2&~?zzz) (number ?nb)
                        (column ?colz&:(or (eq ?colz ?col1) (eq ?colz ?col2) (eq ?colz ?col3) (eq ?colz ?col4)))
                        (anti-diagonal ?anti-diagz&~?anti-diag1&~?anti-diag2&~?anti-diag3&~?anti-diag4))
=>
...
=>
    ...
    (if ?*blocked-Subsets* then
        (assert (apply-rule-as-a-pseudo-block ?cont))
        (assert (pseudo-blocked ?cont special-jellyfish-in-anti-diags-w-transv-rows ?zzz ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?row1 ?row2 ?row3 ?row4))
    )
)


(defrule apply-to-more-targets-L4-special-jellyfish-in-anti-diags-w-transv-rows
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (pseudo-blocked ?cont special-jellyfish-in-anti-diags-w-transv-rows ?zzz ?nb ?anti-diag1 ?anti-diag2 ?anti-diag3 ?anti-diag4 ?row1 ?row2 ?row3 ?row4)
    ?cand <- (candidate (context ?cont) (status cand) (label ?zzz2&~?zzz) (number ?nb)
                        (row ?rowz&:(or (eq ?rowz ?row1) (eq ?rowz ?row2) (eq ?rowz ?row3) (eq ?rowz ?row4)))
                        (anti-diagonal ?anti-diagz&~?anti-diag1&~?anti-diag2&~?anti-diag3&~?anti-diag4))
