...
(defrule activate-isolated-HV-chain[10]
   (declare (salience ?*activate-xtd-loop[11]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[10]))
   (bind ?*technique* isolated-HV-chain[10])
)
...
(defrule isolated-HV-chain-extension[10]
   (declare (salience ?*partial-loop[10]-salience*))
   (logical
      (isolated-HV-chain
         (context ?cont)
         (length 9)
      ...
      (technique ?cont isolated-HV-chain[10])
      ;;; extension
