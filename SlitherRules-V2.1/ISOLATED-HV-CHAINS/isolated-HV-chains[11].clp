...
(defrule activate-isolated-HV-chain[11]
   (declare (salience ?*activate-xtd-loop[12]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[11]))
   (bind ?*technique* isolated-HV-chain[11])
)
...
(defrule isolated-HV-chain-extension[11]
   ...
   (logical
      ...
      (technique ?cont isolated-HV-chain[11])
      ;;; extension
