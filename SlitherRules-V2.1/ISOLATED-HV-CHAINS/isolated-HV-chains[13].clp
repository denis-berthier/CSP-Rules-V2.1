...
(defrule activate-isolated-HV-chain[13]
   (declare (salience ?*activate-xtd-loop[14]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[13]))
   (bind ?*technique* isolated-HV-chain[13])
)
...
(defrule isolated-HV-chain-extension[13]
   ...
   (logical
      ...
      (technique ?cont isolated-HV-chain[13])
      ;;; extension
