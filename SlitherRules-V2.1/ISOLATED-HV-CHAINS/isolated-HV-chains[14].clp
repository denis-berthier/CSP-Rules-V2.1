...
(defrule activate-isolated-HV-chain[14]
   (declare (salience ?*activate-xtd-loop[15]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[14]))
   (bind ?*technique* isolated-HV-chain[14])
)
...
(defrule isolated-HV-chain-extension[14]
   (declare (salience ?*partial-loop[14]-salience*))
   (logical
      (isolated-HV-chain
         (context ?cont)
         (length 13)
      ...
      (technique ?cont isolated-HV-chain[14])
      ;;; extension
