...
(defrule activate-isolated-HV-chain[15]
   (declare (salience ?*activate-xtd-loop[16]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[15]))
   (bind ?*technique* isolated-HV-chain[15])
)
...
(defrule isolated-HV-chain-extension[15]
   ...
   (logical
      ...
      (technique ?cont isolated-HV-chain[15])
      ;;; extension
