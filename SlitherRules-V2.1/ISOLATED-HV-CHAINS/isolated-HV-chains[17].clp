...
(defrule activate-isolated-HV-chain[17]
   (declare (salience ?*activate-xtd-loop[18]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[17]))
   (bind ?*technique* isolated-HV-chain[17])
)
...
(defrule isolated-HV-chain-extension[17]
   ...
   (logical
      ...
      (technique ?cont isolated-HV-chain[17])
      ;;; extension
