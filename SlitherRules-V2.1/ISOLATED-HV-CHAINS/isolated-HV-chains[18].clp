...
(defrule activate-isolated-HV-chain[18]
   (declare (salience ?*activate-xtd-loop[19]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[18]))
   (bind ?*technique* isolated-HV-chain[18])
)
...
(defrule isolated-HV-chain-extension[18]
   (declare (salience ?*partial-loop[18]-salience*))
   (logical
      (isolated-HV-chain
         (context ?cont)
         (length 17)
      ...
      (technique ?cont isolated-HV-chain[18])
      ;;; extension
