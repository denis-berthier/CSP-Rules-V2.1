...
(defrule activate-isolated-HV-chain[19]
   (declare (salience ?*activate-xtd-loop[20]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[19]))
   (bind ?*technique* isolated-HV-chain[19])
)
...
(defrule isolated-HV-chain-extension[19]
   ...
   (logical
      ...
      (technique ?cont isolated-HV-chain[19])
      ;;; extension
