...
(defrule activate-isolated-HV-chain[20]
   (declare (salience ?*activate-xtd-loop[21]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[20]))
   (bind ?*technique* isolated-HV-chain[20])
)
...
(defrule isolated-HV-chain-extension[20]
   ...
   (logical
      ...
      (technique ?cont isolated-HV-chain[20])
      ;;; extension
