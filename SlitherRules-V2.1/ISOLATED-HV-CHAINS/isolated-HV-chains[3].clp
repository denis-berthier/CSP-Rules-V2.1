...
(defrule activate-isolated-HV-chain[3]
   (declare (salience ?*activate-xtd-loop[4]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[3]))
   (bind ?*technique* isolated-HV-chain[3])
)
...
(defrule isolated-HV-chain-extension[3]
   ...
   (logical
      ...
      (technique ?cont isolated-HV-chain[3])
      ;;; extension
