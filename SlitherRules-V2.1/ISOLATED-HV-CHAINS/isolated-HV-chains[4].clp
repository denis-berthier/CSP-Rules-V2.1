...
(defrule activate-isolated-HV-chain[4]
   (declare (salience ?*activate-xtd-loop[5]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[4]))
   (bind ?*technique* isolated-HV-chain[4])
)
...
(defrule isolated-HV-chain-extension[4]
   ...
   (logical
      ...
      (technique ?cont isolated-HV-chain[4])
      ;;; extension
