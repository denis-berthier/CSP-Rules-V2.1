...
(defrule activate-isolated-HV-chain[5]
   (declare (salience ?*activate-xtd-loop[6]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[5]))
   (bind ?*technique* isolated-HV-chain[5])
)
...
(defrule isolated-HV-chain-extension[5]
   ...
   (logical
      ...
      (technique ?cont isolated-HV-chain[5])
      ;;; extension
