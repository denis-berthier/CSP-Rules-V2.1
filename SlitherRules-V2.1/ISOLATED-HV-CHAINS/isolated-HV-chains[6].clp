...
(defrule activate-isolated-HV-chain[6]
   (declare (salience ?*activate-xtd-loop[7]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[6]))
   (bind ?*technique* isolated-HV-chain[6])
)
...
(defrule isolated-HV-chain-extension[6]
   (declare (salience ?*partial-loop[6]-salience*))
   (logical
      (isolated-HV-chain
         (context ?cont)
         (length 5)
      ...
      (technique ?cont isolated-HV-chain[6])
      ;;; extension
