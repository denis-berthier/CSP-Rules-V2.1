...
(defrule activate-isolated-HV-chain[8]
   (declare (salience ?*activate-xtd-loop[9]-salience*))
   (logical (context (name ?cont)) (technique ?cont BRT))
   (not (deactivate ?cont isolated-HV-chain))
=>
   (assert (technique ?cont isolated-HV-chain[8]))
   (bind ?*technique* isolated-HV-chain[8])
)
...
(defrule isolated-HV-chain-extension[8]
   (declare (salience ?*partial-loop[8]-salience*))
   (logical
      (isolated-HV-chain
         (context ?cont)
         (length 7)
      ...
      (technique ?cont isolated-HV-chain[8])
      ;;; extension
