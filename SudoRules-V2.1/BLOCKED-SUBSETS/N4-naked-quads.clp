...
(defrule detect-L4-naked-quads-in-a-row
...
=>
    ...
    (assert (blocked ?cont naked-quads-in-a-row ?row ?col1 ?col2 ?col3 ?col4 ?nb1 ?nb2 ?nb3 ?nb4))
	(if (or ?*print-actions* ?*print-L4* ?*print-naked-quads*) then
        (bind ?*blocked-rule-description*
            (str-cat "naked-quads-in-a-row: "
				(row-name ?row)
...
(defrule apply-L4-naked-quads-in-a-row
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont naked-quads-in-a-row ?row ?col1 ?col2 ?col3 ?col4 ?nb1 ?nb2 ?nb3 ?nb4)
...
(defrule detect-L4-naked-quads-in-a-column
	(declare (salience ?*naked-quads-salience*))
	(technique ?cont naked-quads)
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont naked-quads-in-a-column ?col ?row1 ?row2 ?row3 ?row4 ?nb1 ?nb2 ?nb3 ?nb4))
	(if (or ?*print-actions* ?*print-L4* ?*print-naked-quads*) then
        (bind ?*blocked-rule-description*
            (str-cat "naked-quads-in-a-column: "
				(column-name ?col)
...
(defrule apply-L4-naked-quads-in-a-column
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont naked-quads-in-a-column ?col ?row1 ?row2 ?row3 ?row4 ?nb1 ?nb2 ?nb3 ?nb4)
...
(defrule detect-L4-naked-quads-in-a-block
	(declare (salience ?*naked-quads-salience*))
	(technique ?cont naked-quads)
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont naked-quads-in-a-block ?bl ?sq1 ?sq2 ?sq3 ?sq4 ?nb1 ?nb2 ?nb3 ?nb4))
	(if (or ?*print-actions* ?*print-L4* ?*print-naked-quads*) then
        (bind ?*blocked-rule-description*
            (str-cat "naked-quads-in-a-block: "
				(block-name ?bl)
...
(defrule apply-L4-naked-quads-in-a-block
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont naked-quads-in-a-block ?bl ?sq1 ?sq2 ?sq3 ?sq4 ?nb1 ?nb2 ?nb3 ?nb4)
