...
(defrule detect-L4-hidden-quads-in-a-row
	(declare (salience ?*hidden-quads-salience*))
...
=>
    ...
    (assert (blocked ?cont hidden-quads-in-a-row ?row ?col1 ?col2 ?col3 ?col4 ?nb1 ?nb2 ?nb3 ?nb4))
	(if (or ?*print-actions* ?*print-L4* ?*print-hidden-quads*) then
        (bind ?*blocked-rule-description*
            (str-cat "hidden-quads-in-a-row: "
				(row-name ?row)
...
(defrule apply-L4-hidden-quads-in-a-row
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont hidden-quads-in-a-row ?row ?col1 ?col2 ?col3 ?col4 ?nb1 ?nb2 ?nb3 ?nb4)
...
(defrule detect-L4-hidden-quads-in-a-column
	(declare (salience ?*hidden-quads-salience*))
	(technique ?cont hidden-quads)
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont hidden-quads-in-a-column ?col ?row1 ?row2 ?row3 ?row4 ?nb1 ?nb2 ?nb3 ?nb4))
	(if (or ?*print-actions* ?*print-L4* ?*print-hidden-quads*) then
        (bind ?*blocked-rule-description*
            (str-cat "hidden-quads-in-a-column: "
				(column-name ?col)
				?*starting-cell-symbol* (number-name ?nb1) ?*separation-sign-in-cell* (number-name ?nb2) 
				?*separation-sign-in-cell* (number-name ?nb3) ?*separation-sign-in-cell* (number-name ?nb4) ?*ending-cell-symbol*
...
(defrule apply-L4-hidden-quads-in-a-column
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont hidden-quads-in-a-column ?col ?row1 ?row2 ?row3 ?row4 ?nb1 ?nb2 ?nb3 ?nb4)
    ;;; identify the targets, i.e.  any other number in these four cells
...
(defrule detect-L4-hidden-quads-in-a-block
	(declare (salience ?*hidden-quads-salience*))
	(technique ?cont hidden-quads)
	...
	;;; and there are four numbers ?nb1, ?nb2, ?nb3 and ?nb4,
	;;; such that, in this block, these four numbers are confined exactly to ?sq1, ?sq2, ?sq3 and ?sq4
	...
	(candidate (context ?cont) (status cand) (block ?bl) (square ?sq3) (number ?nb3&~?nb2&:(< ?nb1 ?nb3)))
	(candidate (context ?cont) (status cand) (block ?bl) (number ?nb3) (square ?sq4&~?sq1&~?sq2&~?sq3))
	
	(not (candidate (context ?cont) (status cand) (block ?bl) (number ?nb1) (square ?sqx&~?sq1&~?sq2&~?sq3&~?sq4)))
	(not (candidate (context ?cont) (status cand) (block ?bl) (number ?nb2) (square ?sqx&~?sq1&~?sq2&~?sq3&~?sq4)))
	(not (candidate (context ?cont) (status cand) (block ?bl) (number ?nb3) (square ?sqx&~?sq1&~?sq2&~?sq3&~?sq4)))
	
	(candidate (context ?cont) (status cand) (block ?bl) (square ?sq4) (number ?nb4&~?nb2&~?nb3&:(or (< ?nb2 ?nb4) (< ?nb3 ?nb4))))
	(candidate (context ?cont) (status cand) (block ?bl) (number ?nb4) (square ?sq1))
	(not (candidate (context ?cont) (status cand) (block ?bl) (number ?nb4) (square ?sqx&~?sq1&~?sq2&~?sq3&~?sq4)))
...
=>
    (assert (apply-rule-as-a-block ?cont))
    (assert (blocked ?cont hidden-quads-in-a-block ?bl ?sq1 ?sq2 ?sq3 ?sq4 ?nb1 ?nb2 ?nb3 ?nb4))
	(if (or ?*print-actions* ?*print-L4* ?*print-hidden-quads*) then
        (bind ?*blocked-rule-description*
            (str-cat "hidden-quads-in-a-block: "
				(block-name ?bl)
...
(defrule apply-L4-hidden-quads-in-a-block
    (declare (salience ?*apply-a-blocked-rule-salience-1*))
    (blocked ?cont hidden-quads-in-a-block ?bl ?sq1 ?sq2 ?sq3 ?sq4 ?nb1 ?nb2 ?nb3 ?nb4)
