...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              3-DIGIT IMPOSSIBLE PATTERN: Imp630-10c#15  (EL10c15)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-3-digit-pattern-rule-EL10c15
...
=>
   (if ?*print-levels* then (printout t Entering_level EL10c15))
   (assert (3-digit-pattern ".................X.....XXX............X..X..X..X..X..X..........................."))
)


(defrule 3-digit-pattern-rule-EL10c15
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6&~?row2&~?row3&~?row5) (column ?col3) (block ?blk4) (band ?bnd2) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL10c15 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
...
(defrule activate-3-digit-pattern-rule-EL10c15s
   (declare (salience ?*activate-ork-Imp630-10c-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level EL10c15s))
   (assert (3-digit-pattern "......................XX.......................X.XX.....X........X.......X..XX..."))
)


(defrule 3-digit-pattern-rule-EL10c15s
   (declare (salience ?*ork-Imp630-10c-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
   ...
   (3-digit-pattern ?pattern-string)
   (test (eq (str-compare ?pattern-string "......................XX.......................X.XX.....X........X.......X..XX..." ) 0))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6&~?row3) (column ?col3&~?col5&~?col6) (block ?blk4&~?blk2) (band ?bnd2&~?bnd1) (stack ?stk1&~?stk2))
   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row6) (column ?col3) (block ?blk4) (band ?bnd2) (stack ?stk1))
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row6) (column ?col3) (block ?blk4) (band ?bnd2) (stack ?stk1))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row7&~?row3&~?row6) (column ?col3) (block ?blk7&~?blk2&~?blk4&~?blk5) (band ?bnd3&~?bnd1&~?bnd2) (stack ?stk1))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row8&~?row3&~?row6&~?row7) (column ?col3) (block ?blk7) (band ?bnd3) (stack ?stk1))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row9&~?row3&~?row6&~?row7&~?row8) (column ?col2&~?col5&~?col6&~?col3) (block ?blk7) (band ?bnd3) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL10c15s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
