...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              3-DIGIT IMPOSSIBLE PATTERN: Imp630-12c#24  (EL12c24)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-3-digit-pattern-rule-EL12c24
...
=>
   (if ?*print-levels* then (printout t Entering_level EL12c24))
   (assert (3-digit-pattern "...........X..X..X..X..X.X............X.X...X.X...X..X..........................."))
)


(defrule 3-digit-pattern-rule-EL12c24
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row5) (column ?col5&~?col3&~?col6&~?col9&~?col8) (block ?blk5&~?blk1&~?blk2&~?blk3&~?blk4) (band ?bnd2) (stack ?stk2))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6&~?row2&~?row3&~?row5) (column ?col2&~?col3&~?col6&~?col9&~?col8&~?col5) (block ?blk4) (band ?bnd2) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL12c24 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
...
(defrule activate-3-digit-pattern-rule-EL12c24s
   (declare (salience ?*activate-ork-Imp630-12c-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level EL12c24s))
   (assert (3-digit-pattern "..............X....XX.X.................X.....XX..X..............X.......X..XX..."))
)


(defrule 3-digit-pattern-rule-EL12c24s
   (declare (salience ?*ork-Imp630-12c-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
   ...
   (3-digit-pattern ?pattern-string)
   (test (eq (str-compare ?pattern-string "..............X....XX.X.................X.....XX..X..............X.......X..XX..." ) 0))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL12c24s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
