...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              3-DIGIT IMPOSSIBLE PATTERN: Imp630-12c#25  (EL12c25)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-3-digit-pattern-rule-EL12c25
...
=>
   (if ?*print-levels* then (printout t Entering_level EL12c25))
   (assert (3-digit-pattern "...........X..X..X..X.X..X............X..X..X.X...X.X............................"))
)


(defrule 3-digit-pattern-rule-EL12c25
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row5) (column ?col9) (block ?blk6&~?blk1&~?blk2&~?blk3&~?blk4&~?blk5) (band ?bnd2) (stack ?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6&~?row2&~?row3&~?row5) (column ?col2&~?col3&~?col6&~?col9&~?col5&~?col8) (block ?blk4) (band ?bnd2) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL12c25 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
...
(defrule activate-3-digit-pattern-rule-EL12c25s
   (declare (salience ?*activate-ork-Imp630-12c-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level EL12c25s))
   (assert (3-digit-pattern "..............X....XX.X...............X.......X..XX..............X..X....X..X...."))
)


(defrule 3-digit-pattern-rule-EL12c25s
   (declare (salience ?*ork-Imp630-12c-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL12c25s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
