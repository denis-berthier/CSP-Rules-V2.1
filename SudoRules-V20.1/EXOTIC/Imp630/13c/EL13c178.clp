...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              3-DIGIT IMPOSSIBLE PATTERN: Imp630-13c#178  (EL13c178)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-3-digit-pattern-rule-EL13c178
...
=>
   (if ?*print-levels* then (printout t Entering_level EL13c178))
   (assert (3-digit-pattern "...........X..X..X..X.X..X......X.X....X..X....X..XX............................."))
)


(defrule 3-digit-pattern-rule-EL13c178
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row4) (column ?col8) (block ?blk6&~?blk1&~?blk2&~?blk3&~?blk5) (band ?bnd2) (stack ?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row5&~?row2&~?row3&~?row4) (column ?col4&~?col3&~?col6&~?col9&~?col5&~?col8) (block ?blk5) (band ?bnd2) (stack ?stk2))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row5) (column ?col7&~?col3&~?col6&~?col9&~?col5&~?col8&~?col4) (block ?blk6) (band ?bnd2) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL13c178 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
...
(defrule activate-3-digit-pattern-rule-EL13c178s
   (declare (salience ?*activate-ork-Imp630-13c-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level EL13c178s))
   (assert (3-digit-pattern "...................XX..X.......X......X.......X.X.X.......XX.....XX......X......."))
)


(defrule 3-digit-pattern-rule-EL13c178s
   (declare (salience ?*ork-Imp630-13c-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
   ...
   (3-digit-pattern ?pattern-string)
   (test (eq (str-compare ?pattern-string "...................XX..X.......X......X.......X.X.X.......XX.....XX......X......." ) 0))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL13c178s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
