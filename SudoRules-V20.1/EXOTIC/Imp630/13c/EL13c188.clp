...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              3-DIGIT IMPOSSIBLE PATTERN: Imp630-13c#188  (EL13c188)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-3-digit-pattern-rule-EL13c188
...
=>
   (if ?*print-levels* then (printout t Entering_level EL13c188))
   (assert (3-digit-pattern "........X........X..X..X.X......X..X..X.X.X....X.X.X............................."))
)


(defrule 3-digit-pattern-rule-EL13c188
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row2&~?row1) (column ?col9) (block ?blk3) (band ?bnd1) (stack ?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row3&~?row1&~?row2) (column ?col3&~?col9) (block ?blk1&~?blk3) (band ?bnd1) (stack ?stk1&~?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row3) (column ?col6&~?col9&~?col3) (block ?blk2&~?blk3&~?blk1) (band ?bnd1) (stack ?stk2&~?stk3&~?stk1))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row5) (column ?col5&~?col9&~?col3&~?col6&~?col8) (block ?blk5) (band ?bnd2) (stack ?stk2))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL13c188 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
...
(defrule activate-3-digit-pattern-rule-EL13c188s
   (declare (salience ?*activate-ork-Imp630-13c-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level EL13c188s))
   (assert (3-digit-pattern "....................X.XX................XX.....XX.........XX.....X......XX.X....."))
)


(defrule 3-digit-pattern-rule-EL13c188s
   (declare (salience ?*ork-Imp630-13c-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
   ...
   (3-digit-pattern ?pattern-string)
   (test (eq (str-compare ?pattern-string "....................X.XX................XX.....XX.........XX.....X......XX.X....." ) 0))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6&~?row3&~?row5) (column ?col3) (block ?blk4&~?blk1&~?blk2&~?blk5) (band ?bnd2) (stack ?stk1))
   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row6) (column ?col3) (block ?blk4) (band ?bnd2) (stack ?stk1))
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row6) (column ?col3) (block ?blk4) (band ?bnd2) (stack ?stk1))

   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6) (column ?col4&~?col3&~?col5&~?col6) (block ?blk5) (band ?bnd2) (stack ?stk2))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row9&~?row3&~?row5&~?row6&~?row7&~?row8) (column ?col1&~?col3&~?col5&~?col6&~?col4) (block ?blk7) (band ?bnd3) (stack ?stk1))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row9) (column ?col2&~?col3&~?col5&~?col6&~?col4&~?col1) (block ?blk7) (band ?bnd3) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL13c188s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
