...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              3-DIGIT IMPOSSIBLE PATTERN: Imp630-13c#199  (EL13c199)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-3-digit-pattern-rule-EL13c199
...
=>
   (if ?*print-levels* then (printout t Entering_level EL13c199))
   (assert (3-digit-pattern "........X.....X..X....XX.X......X.....X.X...XXX.X................................"))
)


(defrule 3-digit-pattern-rule-EL13c199
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6) (column ?col4&~?col9&~?col6&~?col5&~?col8&~?col3&~?col1&~?col2) (block ?blk5) (band ?bnd2) (stack ?stk2))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL13c199 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
...
(defrule activate-3-digit-pattern-rule-EL13c199s
   (declare (salience ?*activate-ork-Imp630-13c-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level EL13c199s))
   (assert (3-digit-pattern ".....X........X.......X.........X.....X.X.....XXX................X......XX..X...."))
)


(defrule 3-digit-pattern-rule-EL13c199s
   (declare (salience ?*ork-Imp630-13c-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row4&~?row1&~?row2&~?row3) (column ?col6) (block ?blk5&~?blk2) (band ?bnd2&~?bnd1) (stack ?stk2))
   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row4) (column ?col6) (block ?blk5) (band ?bnd2) (stack ?stk2))
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row4) (column ?col6) (block ?blk5) (band ?bnd2) (stack ?stk2))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL13c199s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
