...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              3-DIGIT IMPOSSIBLE PATTERN: Imp630-13c#2  (EL13c2)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-3-digit-pattern-rule-EL13c2
...
=>
   (if ?*print-levels* then (printout t Entering_level EL13c2))
   (assert (3-digit-pattern "..............X..X..X....XX.....XXX...X.....XXX...X.............................."))
)


(defrule 3-digit-pattern-rule-EL13c2
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row4) (column ?col7&~?col6&~?col9&~?col3&~?col8) (block ?blk6&~?blk2&~?blk3&~?blk1&~?blk5) (band ?bnd2) (stack ?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6&~?row2&~?row3&~?row4&~?row5) (column ?col1&~?col6&~?col9&~?col3&~?col8&~?col7) (block ?blk4) (band ?bnd2) (stack ?stk1))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6) (column ?col2&~?col6&~?col9&~?col3&~?col8&~?col7&~?col1) (block ?blk4) (band ?bnd2) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL13c2 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
...
(defrule activate-3-digit-pattern-rule-EL13c2s
   (declare (salience ?*activate-ork-Imp630-13c-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level EL13c2s))
   (assert (3-digit-pattern ".....X........X.....X.X.......................X.X.X......X.......XX......XX.X...."))
)


(defrule 3-digit-pattern-rule-EL13c2s
   (declare (salience ?*ork-Imp630-13c-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL13c2s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
