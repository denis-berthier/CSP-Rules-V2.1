...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              3-DIGIT IMPOSSIBLE PATTERN: Imp630-13c#200  (EL13c200)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-3-digit-pattern-rule-EL13c200
...
=>
   (if ?*print-levels* then (printout t Entering_level EL13c200))
   (assert (3-digit-pattern "........X.....X..X....XX.X......X.....XX....X.XX.X..............................."))
)


(defrule 3-digit-pattern-rule-EL13c200
   ...
   (test (eq (str-compare ?pattern-string "........X.....X..X....XX.X......X.....XX....X.XX.X..............................." ) 0))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6&~?row1&~?row2&~?row3&~?row4&~?row5) (column ?col2&~?col9&~?col6&~?col5&~?col8&~?col3&~?col4) (block ?blk4) (band ?bnd2) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL13c200 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
...
(defrule activate-3-digit-pattern-rule-EL13c200s
   (declare (salience ?*activate-ork-Imp630-13c-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level EL13c200s))
   (assert (3-digit-pattern "..............X.......XX.......X......X..X....XXX................X......XX..X...."))
)


(defrule 3-digit-pattern-rule-EL13c200s
   (declare (salience ?*ork-Imp630-13c-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row4&~?row2&~?row3) (column ?col5) (block ?blk5&~?blk2) (band ?bnd2&~?bnd1) (stack ?stk2))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row5&~?row2&~?row3&~?row4) (column ?col3&~?col6&~?col5) (block ?blk4&~?blk2&~?blk5) (band ?bnd2) (stack ?stk1&~?stk2))
   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row5) (column ?col3) (block ?blk4) (band ?bnd2) (stack ?stk1))
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row5) (column ?col3) (block ?blk4) (band ?bnd2) (stack ?stk1))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row8&~?row2&~?row3&~?row4&~?row5&~?row6) (column ?col3) (block ?blk7&~?blk2&~?blk5&~?blk4) (band ?bnd3&~?bnd1&~?bnd2) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL13c200s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
