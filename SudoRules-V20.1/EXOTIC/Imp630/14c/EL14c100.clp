...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              3-DIGIT IMPOSSIBLE PATTERN: Imp630-14c#100  (EL14c100)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-3-digit-pattern-rule-EL14c100
...
=>
   (if ?*print-levels* then (printout t Entering_level EL14c100))
   (assert (3-digit-pattern "........X..X..X.X..X..X..X...X.X......X.X....X..X....X..........................."))
)


(defrule 3-digit-pattern-rule-EL14c100
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6) (column ?col4&~?col9&~?col3&~?col6&~?col8&~?col2&~?col5&~?col1) (block ?blk5) (band ?bnd2) (stack ?stk2))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL14c100 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
...
;;;     +-------+-------+-------+
;;;
;;; .....X.....X.......X.XX.........X.....XXX.....X.................XX......X....X...
;;;
;;; Variables in the following rule are named after this pattern



(defrule activate-3-digit-pattern-rule-EL14c100s
   (declare (salience ?*activate-ork-Imp630-14c-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level EL14c100s))
   (assert (3-digit-pattern ".....X.....X.......X.XX.........X.....XXX.....X.................XX......X....X..."))
)


(defrule 3-digit-pattern-rule-EL14c100s
   (declare (salience ?*ork-Imp630-14c-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
   ...
   (3-digit-pattern ?pattern-string)
   (test (eq (str-compare ?pattern-string ".....X.....X.......X.XX.........X.....XXX.....X.................XX......X....X..." ) 0))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL14c100s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
