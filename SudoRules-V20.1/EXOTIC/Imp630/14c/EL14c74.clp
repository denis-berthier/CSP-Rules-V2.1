...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              3-DIGIT IMPOSSIBLE PATTERN: Imp630-14c#74  (EL14c74)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-3-digit-pattern-rule-EL14c74
...
=>
   (if ?*print-levels* then (printout t Entering_level EL14c74))
   (assert (3-digit-pattern "........X..X..X..X..X.X..X...X....X..X......X.X...XX............................."))
)


(defrule 3-digit-pattern-rule-EL14c74
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6) (column ?col7&~?col9&~?col3&~?col6&~?col5&~?col8&~?col2) (block ?blk6) (band ?bnd2) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL14c74 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
...
;;;     +-------+-------+-------+
;;;
;;; .............XX....XXX................X.......X...X........X.....XX.....XX..X....
;;;
;;; Variables in the following rule are named after this pattern



(defrule activate-3-digit-pattern-rule-EL14c74s
   (declare (salience ?*activate-ork-Imp630-14c-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level EL14c74s))
   (assert (3-digit-pattern ".............XX....XXX................X.......X...X........X.....XX.....XX..X...."))
)


(defrule 3-digit-pattern-rule-EL14c74s
   (declare (salience ?*ork-Imp630-14c-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
   ...
   (3-digit-pattern ?pattern-string)
   (test (eq (str-compare ?pattern-string ".............XX....XXX................X.......X...X........X.....XX.....XX..X...." ) 0))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL14c74s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
