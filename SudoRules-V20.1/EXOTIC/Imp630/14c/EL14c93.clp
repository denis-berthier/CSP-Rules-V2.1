...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              3-DIGIT IMPOSSIBLE PATTERN: Imp630-14c#93  (EL14c93)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-3-digit-pattern-rule-EL14c93
   (declare (salience ?*activate-ork-EL14c93-salience*))
   (logical
      (play)
      (context (name ?cont))
   )
=>
   (if ?*print-levels* then (printout t Entering_level EL14c93))
   (assert (3-digit-pattern "........X..X..X.X...X.X.X.......XX.....X.X.X...X.....X..........................."))
)


(defrule 3-digit-pattern-rule-EL14c93
   (declare (salience ?*ork-EL14c93-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row3) (column ?col5&~?col9&~?col3&~?col6&~?col8) (block ?blk2) (band ?bnd1) (stack ?stk2))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row3) (column ?col7&~?col9&~?col3&~?col6&~?col8&~?col5) (block ?blk3) (band ?bnd1) (stack ?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row4) (column ?col7) (block ?blk6&~?blk3&~?blk1&~?blk2&~?blk5) (band ?bnd2) (stack ?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row5&~?row1&~?row2&~?row3&~?row4) (column ?col4&~?col9&~?col3&~?col6&~?col8&~?col5&~?col7) (block ?blk5) (band ?bnd2) (stack ?stk2))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6&~?row1&~?row2&~?row3&~?row4&~?row5) (column ?col3) (block ?blk4&~?blk3&~?blk1&~?blk2&~?blk5&~?blk6) (band ?bnd2) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL14c93 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
...
(defrule activate-3-digit-pattern-rule-EL14c93s
   (declare (salience ?*activate-ork-EL14c93-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level EL14c93s))
   (assert (3-digit-pattern "...................XX..X.......X......X.......X.XX......XX......X..X....X....X..."))
)


(defrule 3-digit-pattern-rule-EL14c93s
   (declare (salience ?*ork-EL14c93-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
   ...
   (3-digit-pattern ?pattern-string)
   (test (eq (str-compare ?pattern-string "...................XX..X.......X......X.......X.XX......XX......X..X....X....X..." ) 0))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6) (column ?col4&~?col2&~?col3&~?col6&~?col5) (block ?blk5) (band ?bnd2) (stack ?stk2))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row9&~?row3&~?row4&~?row5&~?row6&~?row7&~?row8) (column ?col1&~?col2&~?col3&~?col6&~?col5&~?col4) (block ?blk7) (band ?bnd3) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL14c93s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
