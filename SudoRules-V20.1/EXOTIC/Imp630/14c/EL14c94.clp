...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              3-DIGIT IMPOSSIBLE PATTERN: Imp630-14c#94  (EL14c94)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-3-digit-pattern-rule-EL14c94
...
=>
   (if ?*print-levels* then (printout t Entering_level EL14c94))
   (assert (3-digit-pattern "........X..X..X.X..X..X..X......X..X....X.X....X.X...X..........................."))
)


(defrule 3-digit-pattern-rule-EL14c94
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row5) (column ?col7&~?col9&~?col3&~?col6&~?col8&~?col2&~?col5) (block ?blk6) (band ?bnd2) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL14c94 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
...
(defrule activate-3-digit-pattern-rule-EL14c94s
   (declare (salience ?*activate-ork-Imp630-14c-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level EL14c94s))
   (assert (3-digit-pattern "...........X.......X...X..............X.XX....X.X.........X.....XX......X..X.X..."))
)


(defrule 3-digit-pattern-rule-EL14c94s
   (declare (salience ?*ork-Imp630-14c-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
   ...
   (3-digit-pattern ?pattern-string)
   (test (eq (str-compare ?pattern-string "...........X.......X...X..............X.XX....X.X.........X.....XX......X..X.X..." ) 0))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row7&~?row2&~?row3&~?row5&~?row6) (column ?col5) (block ?blk8&~?blk1&~?blk2&~?blk4&~?blk5) (band ?bnd3&~?bnd1&~?bnd2) (stack ?stk2))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row8&~?row2&~?row3&~?row5&~?row6&~?row7) (column ?col2) (block ?blk7&~?blk1&~?blk2&~?blk4&~?blk5&~?blk8) (band ?bnd3) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL14c94s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
