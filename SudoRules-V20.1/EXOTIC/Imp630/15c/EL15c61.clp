...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              3-DIGIT IMPOSSIBLE PATTERN: Imp630-15c#61  (EL15c61)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-3-digit-pattern-rule-EL15c61
...
=>
   (if ?*print-levels* then (printout t Entering_level EL15c61))
   (assert (3-digit-pattern "........X..X..X.X..X..X.X.......X..X..XX....X.X..X..X............................"))
)


(defrule 3-digit-pattern-rule-EL15c61
   ...
   (test (eq (str-compare ?pattern-string "........X..X..X.X..X..X.X.......X..X..XX....X.X..X..X............................" ) 0))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row5) (column ?col4&~?col9&~?col3&~?col6&~?col8&~?col2&~?col5&~?col7) (block ?blk5) (band ?bnd2) (stack ?stk2))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL15c61 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
...
(defrule activate-3-digit-pattern-rule-EL15c61s
   (declare (salience ?*activate-ork-Imp630-15c-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level EL15c61s))
   (assert (3-digit-pattern "...........X..X....X..X........X......X..X....X.X.......X.......X...X...X..XX...."))
)


(defrule 3-digit-pattern-rule-EL15c61s
   (declare (salience ?*ork-Imp630-15c-salience*))
   (number ?nb1)
   (number ?nb2&:(< ?nb1 ?nb2))
   (number ?nb3&:(< ?nb2 ?nb3))
   ...
   (3-digit-pattern ?pattern-string)
   (test (eq (str-compare ?pattern-string "...........X..X....X..X........X......X..X....X.X.......X.......X...X...X..XX...." ) 0))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row9&~?row2&~?row3&~?row4&~?row5&~?row6&~?row7&~?row8) (column ?col1&~?col3&~?col6&~?col2&~?col5&~?col4) (block ?blk7) (band ?bnd3) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            EL15c61s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ", " ?nb2 " and " ?nb3 " " crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
