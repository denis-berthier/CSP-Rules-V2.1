...
(defrule activate-J3-Exocet
	(declare (salience ?*activate-J3-Exocet-salience*))
	(logical (play) (context (name ?cont)))
    (not (deactivate ?cont J3-Exocet))
=>
	(if ?*print-levels* then (printout t "entering level J3E"))
	(assert (technique ?cont J3-Exocet))
	(bind ?*technique* J3-Exocet)
)



(defrule track-J3-Exocet
	(declare (salience ?*activate-J3-Exocet-salience*))
	(logical (play))
	?level <- (technique ?cont J3-Exocet)
=>
...
(defrule J3-Exocet-in-rows-detection
	(declare (salience ?*J3-Exocet-detection-salience*))
    ...
    (not (candidate (context ?cont) (number ?nb&?nb1|?nb2|?nb3) (column ?colCQ) (row ?rowSQ)))
    (column-intersects ?colCR&~?colB ?blkB)
    (not (candidate (context ?cont) (number ?nb&?nb1|?nb2|?nb3) (column ?colCR) (row ?rowSR)))
    
    ;;; conditions on digits in Base Cells
    (not (candidate (context ?cont) (column ?colB) (row ?row1) (number ?nb&~?nb1&~?nb2&~?nb3)))
    (not (candidate (context ?cont) (column ?colB) (row ?row2) (number ?nb&~?nb1&~?nb2&~?nb3)))
    ...
    (exists (candidate (context ?cont) (status cand) (number ?nbx1&?nb1|?nb2|?nb3) (column ?colTQ) (row ?rowSQ)))
    (column-intersects ?colTR&~?colB&~?colCR ?blkB)
    (exists (candidate (context ?cont) (status cand) (number ?nbx1&?nb1|?nb2|?nb3) (column ?colTR) (row ?rowSR)))
    
    (exists (candidate (context ?cont) (status cand) (number ?nbz1&?nb1|?nb2|?nb3) (column ?colz1&?colTQ|?colTR) (row ?rowz1&?rowSQ|?rowSR))
        (test (target-cell ?rowz1 ?colz1 ?rowSQ ?colTQ ?rowSR ?colTR))
        (exists (candidate (context ?cont) (status cand) (number ?nbz2&:(<  ?nbz1 ?nbz2)&:(or (eq ?nbz2 ?nb1) (eq ?nbz2 ?nb2) (eq ?nbz2 ?nb3))) (column ?colz2&?colTQ|?colTR) (row ?rowz2&?rowSQ|?rowSR))
            (test (target-cell ?rowz2 ?colz2 ?rowSQ ?colTQ ?rowSR ?colTR))
        )
    )

    (not (j3-exocet-in-rows ?cont ?nb1 ?nb2 ?nb3 ?colB ?row1 ?row2 ?rowSB ?rowSQ ?rowSR ?colTQ ?colTR))

 =>
	(assert (j3-exocet-in-rows ?cont ?nb1 ?nb2 ?nb3 ?colB ?row1 ?row2 ?rowSB ?rowSQ ?rowSR ?colTQ ?colTR))
    (bind ?*has-J-exocet* TRUE)
	(if (or ?*print-actions* ?*print-JExocet*) then
            (printout t 
                "J3-Exocet-in-rows: " crlf
                "     base digits = " (number-name ?nb1) ", " (number-name ?nb2) ", " (number-name ?nb3) crlf
...
(defrule J3-Exocet-in-rows-elimination
	(declare (salience ?*apply-a-blocked-rule-salience*))
	(technique ?cont J3-Exocet)
	(j3-exocet-in-rows ?cont ?nb1 ?nb2 ?nb3 ?colB ?row1 ?row2 ?rowSB ?rowSQ ?rowSR ?colTQ ?colTR)

    ;;; target candidate
    ?candz <- (candidate (context ?cont) (status cand) (number ?nbz&~?nb1&~?nb2&~?nb3) (column ?colz&?colTQ|?colTR) (row ?rowz&?rowSQ|?rowSR))
...
(defrule J3-Exocet-in-columns-detection
	(declare (salience ?*J3-Exocet-detection-salience*))
    ...
    (not (candidate (context ?cont) (number ?nb&?nb1|?nb2|?nb3) (row ?rowCQ) (column ?colSQ)))
    (row-intersects ?rowCR&~?rowB ?blkB)
    (not (candidate (context ?cont) (number ?nb&?nb1|?nb2|?nb3) (row ?rowCR) (column ?colSR)))

    ;;; conditions on digits in Base Cells
    (not (candidate (context ?cont) (row ?rowB) (column ?col1) (number ?nb&~?nb1&~?nb2&~?nb3)))
    (not (candidate (context ?cont) (row ?rowB) (column ?col2) (number ?nb&~?nb1&~?nb2&~?nb3)))
    ...
    (exists (candidate (context ?cont) (status cand) (number ?nbx1&?nb1|?nb2|?nb3) (row ?rowTQ) (column ?colSQ)))
    (row-intersects ?rowTR&~?rowB&~?rowCR ?blkB)
    (exists (candidate (context ?cont) (status cand) (number ?nbx1&?nb1|?nb2|?nb3) (row ?rowTR) (column ?colSR)))
    
    (exists (candidate (context ?cont) (status cand) (number ?nbz1&?nb1|?nb2|?nb3) (row ?rowz1&?rowTQ|?rowTR) (column ?colz1&?colSQ|?colSR))
        (test (target-cell ?rowz1 ?colz1 ?rowTQ ?colSQ ?rowTR ?colSR))
        (exists (candidate (context ?cont) (status cand) (number ?nbz2&:(<  ?nbz1 ?nbz2)&:(or (eq ?nbz2 ?nb1) (eq ?nbz2 ?nb2) (eq ?nbz2 ?nb3))) (row ?rowz2&?rowTQ|?rowTR) (column ?colz2&?colSQ|?colSR))
            (test (target-cell ?rowz2 ?colz2 ?rowTQ ?colSQ ?rowTR ?colSR))
        )
    )

    (not (j3-exocet-in-columns ?cont ?nb1 ?nb2 ?nb3 ?rowB ?col1 ?col2 ?colSB ?colSQ ?colSR ?rowTQ ?rowTR))

 =>
	(assert (j3-exocet-in-columns ?cont ?nb1 ?nb2 ?nb3 ?rowB ?col1 ?col2 ?colSB ?colSQ ?colSR ?rowTQ ?rowTR))
    (bind ?*has-J-exocet* TRUE)
	(if (or ?*print-actions* ?*print-JExocet*) then
            (printout t 
                "J3-Exocet-in-columns: " crlf
                "     base digits = " (number-name ?nb1) ", " (number-name ?nb2) ", " (number-name ?nb3) crlf
...
(defrule J3-Exocet-in-columns-elimination
	(declare (salience ?*apply-a-blocked-rule-salience*))
	(technique ?cont J3-Exocet)
	(j3-exocet-in-columns ?cont ?nb1 ?nb2 ?nb3 ?rowB ?col1 ?col2 ?colSB ?colSQ ?colSR ?rowTQ ?rowTR)

    ;;; target candidate
    ?candz <- (candidate (context ?cont) (status cand) (number ?nbz&~?nb1&~?nb2&~?nb3) (row ?rowz&?rowTQ|?rowTR) (column ?colz&?colSQ|?colSR))
