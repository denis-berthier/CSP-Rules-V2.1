...
(defrule J5-Exocet-in-rows-detection
    ...
    (exists (column ?colx2&:(not (column-intersects ?colx2 ?blkB)))
        (exists (column ?coly2&:(< ?colx2 ?coly2)&:(not (column-intersects ?coly2 ?blkB)))
            (not (candidate (context ?cont) (number ?nb1) (row ?rowz&?rowSB|?rowSQ|?rowSR) (column ?colz&~?colx2&~?coly2&:(not (column-intersects ?colz ?blkB)))))
        )
    )
    ...
    (exists (column ?colx5&:(not (column-intersects ?colx5 ?blkB)))
        (exists (column ?coly5&:(< ?colx5 ?coly5)&:(not (column-intersects ?coly5 ?blkB)))
            (not (candidate (context ?cont) (number ?nb5) (row ?rowz&?rowSB|?rowSQ|?rowSR) (column ?colz&~?colx5&~?coly5&:(not (column-intersects ?colz ?blkB)))))
        )
    )
...
(defrule J5-Exocet-in-columns-detection
    ...
    (exists (row ?rowx5&:(not (row-intersects ?rowx5 ?blkB)))
        (exists (row ?rowy5&:(< ?rowx5 ?rowy5)&:(not (row-intersects ?rowy5 ?blkB)))
            (not (candidate (context ?cont) (number ?nb5) (column ?colz&?colSB|?colSQ|?colSR) (row ?rowz&~?rowx5&~?rowy5&:(not (row-intersects ?rowz ?blkB)))))
        )
    )

    ;;; conditions on digits in first and second Companion Cells, resp. (rowCQ, colSQ) and (rowCR, colSR)
    (row-intersects ?rowCQ&~?rowB ?blkB)
    (not (candidate (context ?cont) (number ?nb&?nb1|?nb2|?nb3|?nb4|?nb5) (row ?rowCQ) (column ?colSQ)))
    (row-intersects ?rowCR&~?rowB ?blkB)
    (not (candidate (context ?cont) (number ?nb&?nb1|?nb2|?nb3|?nb4|?nb5) (row ?rowCR) (column ?colSR)))
