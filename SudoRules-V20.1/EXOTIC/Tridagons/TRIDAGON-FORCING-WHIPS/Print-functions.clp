...
(deffunction print-tridagon-forcing-whip-assert-value (?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1 ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2 ?cand)
    ...
    (printout t crlf "....for ") (print-label ?zzz1) (printout t ": ")
        (if (eq ?p1 0) then (printout t "-") else (print-partial-chain "partial-whip" ?p1 ?zzz1 ?llcs1 ?rlcs1 ?csps1))
    (printout t crlf "....for ") (print-label ?zzz2) (printout t ": ") (print-partial-chain "partial-whip" ?p2 ?zzz2 ?llcs2 ?rlcs2 ?csps2)
