...
(deffunction SGS-TE2-extract-pkEU-expansion-path-from-some-minimal-to-a-puzzle-in-pkEU-for-Usol-i (?i ?max-expansion-phases ?puzzle-in-pkEU-mex)
    ;;; all the expansion steps up to pkmex are supposed to have been calculated (this is not checked)
    ;;; ?max-expansion-phases is cut out at 15
    (if (> ?max-expansion-phases 15) then (printout t "?max-expansion-phases has been limited to 15." crlf))
    (bind ?max-expansion-phases (min ?max-expansion-phases 15))
    ...
    (if (>= ?max-expansion-phases 1) then
        (bind ?pk1-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 1)) ".txt"))
    ...
    (if (= ?max-expansion-phases 1) then
        (bind ?pk1U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 1)) ".txt"))
    ...
    (if (>= ?max-expansion-phases 2) then
        (bind ?pk2-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 2)) ".txt"))
    ...
    (if (= ?max-expansion-phases 2) then
        (bind ?pk2U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 2)) ".txt"))
    ...
    (if (>= ?max-expansion-phases 3) then
        (bind ?pk3-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 3)) ".txt"))
    ...
    (if (= ?max-expansion-phases 3) then
        (bind ?pk3U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 3)) ".txt"))
    ...
    (if (>= ?max-expansion-phases 4) then
        (bind ?pk4-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 4)) ".txt"))
    ...
    (if (= ?max-expansion-phases 4) then
        (bind ?pk4U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 4)) ".txt"))
    ...
    (if (>= ?max-expansion-phases 5) then
        (bind ?pk5-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 5)) ".txt"))
    ...
    (if (= ?max-expansion-phases 5) then
        (bind ?pk5U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 5)) ".txt"))
    ...
    (if (>= ?max-expansion-phases 6) then
        (bind ?pk6-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 6)) ".txt"))
    ...
    (if (= ?max-expansion-phases 6) then
        (bind ?pk6U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 6)) ".txt"))
    ...
    (if (>= ?max-expansion-phases 7) then
        (bind ?pk7-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 7)) ".txt"))
    ...
    (if (= ?max-expansion-phases 7) then
        (bind ?pk7U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 7)) ".txt"))
    ...
    (if (>= ?max-expansion-phases 8) then
        (bind ?pk8-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 8)) ".txt"))
    ...
    (if (= ?max-expansion-phases 8) then
        (bind ?pk8U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 8)) ".txt"))
    ...
    (if (>= ?max-expansion-phases 9) then
        (bind ?pk9-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 9)) ".txt"))
    ...
    (if (= ?max-expansion-phases 9) then
        (bind ?pk9U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 9)) ".txt"))
    ...
    (if (>= ?max-expansion-phases 10) then
        (bind ?pk10-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 10)) ".txt"))
   ...
   (if (= ?max-expansion-phases 10) then
       (bind ?pk10U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 10)) ".txt"))
   ...
   (if (>= ?max-expansion-phases 11) then
       (bind ?pk11-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 11)) ".txt"))
   ...
   (if (= ?max-expansion-phases 11) then
       (bind ?pk11U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 11)) ".txt"))
   ...
   (if (>= ?max-expansion-phases 12) then
       (bind ?pk12-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 12)) ".txt"))
   ...
   (if (= ?max-expansion-phases 12) then
       (bind ?pk12U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 12)) ".txt"))
   ...
   (if (>= ?max-expansion-phases 13) then
       (bind ?pk13-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 13)) ".txt"))
   ...
   (if (= ?max-expansion-phases 13) then
       (bind ?pk13U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 13)) ".txt"))
   ...
   (if (>= ?max-expansion-phases 14) then
       (bind ?pk14-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 14)) ".txt"))
    ...
    (if (= ?max-expansion-phases 14) then
        (bind ?pk14U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 14)) ".txt"))
    ...
    (if (>= ?max-expansion-phases 15) then
        (bind ?pk15-EU-file (str-cat ?USOL-i-DIR (TE2-phase-k-self-expand-type-at-d2 (- ?max-expansion-phases 15)) ".txt"))
     ...
     (if (= ?max-expansion-phases 15) then
         (bind ?pk15U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 (- ?max-expansion-phases 15)) ".txt"))
...
;;; No longer used:
;;; longest path in TE2 to a puzzle in p<k>EU-mex
;;; ex "safe-extract", renamed "unsafe-extract"
(deffunction SGS-TE2-unsafe-extract-pkEU-expansion-path-from-some-minimal-to-a-puzzle-in-pkEU-for-Usol-i (?i ?max-expansion-phases ?puzzle-in-pkEU-mex)
    ;;; all the expansion steps up to pkmex are supposed to have been calculated (this is not checked)
    ;;; ?max-expansion-phases is cut out at 15
    (if (> ?max-expansion-phases 15) then (printout t "?max-expansion-phases has been limited to 15." crlf))
    (bind ?max-expansion-phases (min ?max-expansion-phases 15))
    ...
    (bind ?pk0U-file (str-cat ?USOL-i-DIR (TE2-phase-k-pkU-d2-expansion-type-at-d2 ?max-expansion-phases) ".txt"))
