...
(defglobal ?*module-TRIDAGON-ORk-FW-loaded* = FALSE)
(defglobal ?*module-TRIDAGON-ORk-CW-loaded* = FALSE)

(defglobal ?*list-of-application-specific-modules* = (create$ S2 S3 S4 S2Fin S3Fin S4Fin REVERSIBLE-PATTERNS TRIDAGONS TRIDAGON-FW TRIDAGON-ORk-FW TRIDAGON-FW TRIDAGON-ORk-CW))
...
(deffunction load-modules ($?modules)
    ...
    (foreach ?module $?modules
        (switch ?module
            ...
            (case TRIDAGON-ORk-FW then
                (if (not ?*module-TRIDAGON-ORk-FW-loaded*) then
                    (batch* (str-cat ?*Application-Dir* "MODULES" ?*Directory-symbol* "TRIDAGON-ORk-FW-module.clp"))
                    (bind ?*module-TRIDAGON-ORk-FW-loaded* TRUE)
            ))

            (case TRIDAGON-ORk-CW then
                (if (not ?*module-TRIDAGON-ORk-FW-loaded*) then
                    (batch* (str-cat ?*Application-Dir* "MODULES" ?*Directory-symbol* "TRIDAGON-ORk-CW-module.clp"))
                    (bind ?*module-TRIDAGON-ORk-CW-loaded* TRUE)
            ))
