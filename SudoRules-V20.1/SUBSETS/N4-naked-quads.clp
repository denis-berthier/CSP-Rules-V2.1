...
=>
    ...
    (if ?*blocked-Subsets* then
        ...
        (assert (pseudo-blocked ?cont naked-quads-in-a-row ?zzz ?row ?col1 ?col2 ?col3 ?col4 ?nb1 ?nb2 ?nb3 ?nb4))
    )
)


(defrule apply-to-more-targets-L4-naked-quads-in-a-row
    (declare (salience ?*apply-a-blocked-rule-salience*))
    (pseudo-blocked ?cont naked-quads-in-a-row ?zzz ?row ?col1 ?col2 ?col3 ?col4 ?nb1 ?nb2 ?nb3 ?nb4)
...
=>
    ...
    (if ?*blocked-Subsets* then
        (assert (apply-rule-as-a-pseudo-block ?cont))
        (assert (pseudo-blocked ?cont naked-quads-in-a-column ?zzz ?col ?row1 ?row2 ?row3 ?row4 ?nb1 ?nb2 ?nb3 ?nb4))
    )
)


(defrule apply-to-more-targets-L4-naked-quads-in-a-column
    (declare (salience ?*apply-a-blocked-rule-salience*))
    (pseudo-blocked ?cont naked-quads-in-a-column ?zzz ?col ?row1 ?row2 ?row3 ?row4 ?nb1 ?nb2 ?nb3 ?nb4)
...
=>
    ...
    (if ?*blocked-Subsets* then
        (assert (apply-rule-as-a-pseudo-block ?cont))
        (assert (pseudo-blocked ?cont naked-quads-in-a-block ?zzz ?bl ?sq1 ?sq2 ?sq3 ?sq4 ?nb1 ?nb2 ?nb3 ?nb4))
    )
)


(defrule apply-to-more-targets-L4-naked-quads-in-a-block
    (declare (salience ?*apply-a-blocked-rule-salience*))
    (pseudo-blocked ?cont naked-quads-in-a-block ?zzz ?bl ?sq1 ?sq2 ?sq3 ?sq4 ?nb1 ?nb2 ?nb3 ?nb4)
