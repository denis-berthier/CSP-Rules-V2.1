...
(defrule TE3-detect-contradiction-in-non-first-context-rc
...
(defrule TE3-detect-contradiction-in-non-first-context-rn
	(declare (salience ?*contradiction-in-context-salience*))
	;;; if, in a context which is not the first,
	(context (name ?cont&~0) (parent ?par) (generating-cand ?gen-cand))
	?g <- (candidate (context ?par) (label ?gen-cand))
...
(defrule TE3-detect-contradiction-in-non-first-context-cn
	(declare (salience ?*contradiction-in-context-salience*))
	;;; if, in a context which is not the first,
	(context (name ?cont&~0) (parent ?par) (generating-cand ?gen-cand))
	?g <- (candidate (context ?par) (label ?gen-cand))
...
(defrule TE3-detect-contradiction-in-non-first-context-bn
	(declare (salience ?*contradiction-in-context-salience*))
	;;; if, in a context which is not the first,
	(context (name ?cont&~0) (parent ?par) (generating-cand ?gen-cand))
	?g <- (candidate (context ?par) (label ?gen-cand))
