...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              10-CELL 3-DIGIT DEADLY PATTERN #32 (DP10-3-32)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 13 23 . . . . . . . . . . . . 12 . . . . . 12 . . 12 . . . 13 23 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-3-32
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-3-32))
   (assert (deadly-pattern DP10-3-32 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 13 23 . . . . . . . . . . . . 12 . . . . . 12 . . 12 . . . 13 23 .))
)


(defrule deadly-pattern-rule-DP10-3-32
   (declare (salience ?*deadly-pattern-rule[10-3]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-3-32 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-3-32 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . 13 . . 13 . . . . . 23 . . 23 . . . . 12 . . 12 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-3-32s
   (declare (salience ?*activate-deadly-pattern-rule[10-3]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-3-32s))
   (assert (deadly-pattern DP10-3-32s . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . 13 . . 13 . . . . . 23 . . 23 . . . . 12 . . 12 .))
)


(defrule deadly-pattern-rule-DP10-3-32s
   (declare (salience ?*deadly-pattern-rule[10-3]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-3-32s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-3-32s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
