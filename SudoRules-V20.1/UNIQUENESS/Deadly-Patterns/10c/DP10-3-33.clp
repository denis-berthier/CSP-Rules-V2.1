...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              10-CELL 3-DIGIT DEADLY PATTERN #33 (DP10-3-33)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 13 23 . . . . . . . . . . . . 13 . . . . 23 12 . . 13 . . . 13 . .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-3-33
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-3-33))
   (assert (deadly-pattern DP10-3-33 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 13 23 . . . . . . . . . . . . 13 . . . . 23 12 . . 13 . . . 13 . .))
)


(defrule deadly-pattern-rule-DP10-3-33
   (declare (salience ?*deadly-pattern-rule[10-3]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-3-33 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-3-33 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . . . . . . . 13 13 . . . . . . . . 12 . . 12 . . . . . 32 . 32 . . . . . 13 . . 13 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-3-33s
   (declare (salience ?*activate-deadly-pattern-rule[10-3]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-3-33s))
   (assert (deadly-pattern DP10-3-33s . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . . . . . . . 13 13 . . . . . . . . 12 . . 12 . . . . . 32 . 32 . . . . . 13 . . 13 .))
)


(defrule deadly-pattern-rule-DP10-3-33s
   (declare (salience ?*deadly-pattern-rule[10-3]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-3-33s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-3-33s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
