...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              10-CELL 4-DIGIT DEADLY PATTERN #21 (DP10-4-21)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . 34 34 . . . . . . . . . . . . . . 12 . 13 23 . . . . 12 . . 14 24)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-4-21
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-4-21))
   (assert (deadly-pattern DP10-4-21 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . 34 34 . . . . . . . . . . . . . . 12 . 13 23 . . . . 12 . . 14 24))
)


(defrule deadly-pattern-rule-DP10-4-21
   (declare (salience ?*deadly-pattern-rule[10-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-4-21 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-4-21 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
...
(defrule activate-deadly-pattern-rule-DP10-4-21s
   (declare (salience ?*activate-deadly-pattern-rule[10-4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-4-21s))
   (assert (deadly-pattern DP10-4-21s . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 . 12 . . . . . . . . . . . . . . . 34 . 13 14 . . . . . 34 . 23 24))
)


(defrule deadly-pattern-rule-DP10-4-21s
   (declare (salience ?*deadly-pattern-rule[10-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-4-21s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-4-21s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
