...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              10-CELL 4-DIGIT DEADLY PATTERN #29 (DP10-4-29)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 . 12 . . . . . . . . . . . . 34 . . . . 13 14 . . 34 . . . . 23 24)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-4-29
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-4-29))
   (assert (deadly-pattern DP10-4-29 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 . 12 . . . . . . . . . . . . 34 . . . . 13 14 . . 34 . . . . 23 24))
)


(defrule deadly-pattern-rule-DP10-4-29
   (declare (salience ?*deadly-pattern-rule[10-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-4-29 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-4-29 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . . 12 . 13 23 . . . . 12 . . 14 24)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-4-29s
   (declare (salience ?*activate-deadly-pattern-rule[10-4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-4-29s))
   (assert (deadly-pattern DP10-4-29s . . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . . 12 . 13 23 . . . . 12 . . 14 24))
)


(defrule deadly-pattern-rule-DP10-4-29s
   (declare (salience ?*deadly-pattern-rule[10-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-4-29s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-4-29s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
