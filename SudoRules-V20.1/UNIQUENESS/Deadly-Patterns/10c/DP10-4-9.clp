...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              10-CELL 4-DIGIT DEADLY PATTERN #9 (DP10-4-9)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . 34 . 13 24 . . 12 . . 34 . 13 24 . 12 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-4-9
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-4-9))
   (assert (deadly-pattern DP10-4-9 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . 34 . 13 24 . . 12 . . 34 . 13 24 . 12 .))
)


(defrule deadly-pattern-rule-DP10-4-9
   (declare (salience ?*deadly-pattern-rule[10-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-4-9 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-4-9 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . 13 13 . . . . . . . 24 24 . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 . 12 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-4-9s
   (declare (salience ?*activate-deadly-pattern-rule[10-4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-4-9s))
   (assert (deadly-pattern DP10-4-9s . . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . 13 13 . . . . . . . 24 24 . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 . 12 .))
)


(defrule deadly-pattern-rule-DP10-4-9s
   (declare (salience ?*deadly-pattern-rule[10-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-4-9s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-4-9s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
