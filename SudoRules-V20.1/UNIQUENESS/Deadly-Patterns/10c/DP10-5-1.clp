...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              10-CELL 5-DIGIT DEADLY PATTERN #1 (DP10-5-1)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . 13 45 . 24 35 . . 12 . 13 45 . 24 35)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-5-1
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-5-1))
   (assert (deadly-pattern DP10-5-1 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . 13 45 . 24 35 . . 12 . 13 45 . 24 35))
)


(defrule deadly-pattern-rule-DP10-5-1
   ...
   (deadly-pattern DP10-5-1 $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row8) (column ?col5&~?col3) (block ?blk8&~?blk7) (band ?bnd3) (stack ?stk2&~?stk1))
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row8) (column ?col5) (block ?blk8) (band ?bnd3) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb4) (row ?row8) (column ?col6&~?col3&~?col5) (block ?blk8) (band ?bnd3) (stack ?stk2))
   (candidate (context ?cont) (status cand) (number ?nb5) (row ?row8) (column ?col6) (block ?blk8) (band ?bnd3) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row8) (column ?col8&~?col3&~?col5&~?col6) (block ?blk9&~?blk7&~?blk8) (band ?bnd3) (stack ?stk3&~?stk1&~?stk2))
   (candidate (context ?cont) (status cand) (number ?nb4) (row ?row8) (column ?col8) (block ?blk9) (band ?bnd3) (stack ?stk3))

   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row8) (column ?col9&~?col3&~?col5&~?col6&~?col8) (block ?blk9) (band ?bnd3) (stack ?stk3))
   (candidate (context ?cont) (status cand) (number ?nb5) (row ?row8) (column ?col9) (block ?blk9) (band ?bnd3) (stack ?stk3))

   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row9&~?row8) (column ?col3) (block ?blk7) (band ?bnd3) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-5-1 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . 13 13 . . . . . . . 45 45 . . . . . . . . . . . . . . . . 24 24 . . . . . . . 35 35)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-5-1s
   (declare (salience ?*activate-deadly-pattern-rule[10-5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-5-1s))
   (assert (deadly-pattern DP10-5-1s . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . 13 13 . . . . . . . 45 45 . . . . . . . . . . . . . . . . 24 24 . . . . . . . 35 35))
)


(defrule deadly-pattern-rule-DP10-5-1s
   (declare (salience ?*deadly-pattern-rule[10-5]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (number ?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-5-1s $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row9&~?row3&~?row5&~?row6&~?row8) (column ?col8) (block ?blk9) (band ?bnd3) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-5-1s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
