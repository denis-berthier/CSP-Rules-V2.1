...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              10-CELL 5-DIGIT DEADLY PATTERN #13 (DP10-5-13)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . 34 . . 34 . . . . . 35 . 15 13 . . . . . 45 . 25 24)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-5-13
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-5-13))
   (assert (deadly-pattern DP10-5-13 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . 34 . . 34 . . . . . 35 . 15 13 . . . . . 45 . 25 24))
)


(defrule deadly-pattern-rule-DP10-5-13
   ...
   (deadly-pattern DP10-5-13 $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row8&~?row6&~?row7) (column ?col6) (block ?blk8) (band ?bnd3) (stack ?stk2))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-5-13 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 34 35 45 . . . . . . . . . . . . . . 12 . 15 25 . . . . . 12 34 13 24)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-5-13s
   (declare (salience ?*activate-deadly-pattern-rule[10-5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-5-13s))
   (assert (deadly-pattern DP10-5-13s . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 34 35 45 . . . . . . . . . . . . . . 12 . 15 25 . . . . . 12 34 13 24))
)


(defrule deadly-pattern-rule-DP10-5-13s
   (declare (salience ?*deadly-pattern-rule[10-5]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (number ?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-5-13s $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row6) (column ?col8&~?col7) (block ?blk6) (band ?bnd2) (stack ?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row8&~?row6) (column ?col6&~?col7&~?col8&~?col9) (block ?blk8&~?blk6) (band ?bnd3&~?bnd2) (stack ?stk2&~?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row9&~?row6&~?row8) (column ?col6) (block ?blk8) (band ?bnd3) (stack ?stk2))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-5-13s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
