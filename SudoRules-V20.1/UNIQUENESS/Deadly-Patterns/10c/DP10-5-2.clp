...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              10-CELL 5-DIGIT DEADLY PATTERN #2 (DP10-5-2)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . 34 15 . 35 14 . . . . 34 25 . 35 24)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-5-2
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-5-2))
   (assert (deadly-pattern DP10-5-2 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . 34 15 . 35 14 . . . . 34 25 . 35 24))
)


(defrule deadly-pattern-rule-DP10-5-2
   ...
   (deadly-pattern DP10-5-2 $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row8&~?row7) (column ?col5&~?col6&~?col9) (block ?blk8) (band ?bnd3) (stack ?stk2))
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row8) (column ?col8&~?col6&~?col9&~?col5) (block ?blk9) (band ?bnd3) (stack ?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row9&~?row7&~?row8) (column ?col5) (block ?blk8) (band ?bnd3) (stack ?stk2))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-5-2 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . 34 35 45 . . . . . . . . . . . . . . . . 15 15 . . . . . . 34 32 42)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-5-2s
   (declare (salience ?*activate-deadly-pattern-rule[10-5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-5-2s))
   (assert (deadly-pattern DP10-5-2s . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . 34 35 45 . . . . . . . . . . . . . . . . 15 15 . . . . . . 34 32 42))
)


(defrule deadly-pattern-rule-DP10-5-2s
   (declare (salience ?*deadly-pattern-rule[10-5]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (number ?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-5-2s $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row8&~?row5&~?row6) (column ?col8) (block ?blk9&~?blk6) (band ?bnd3&~?bnd2) (stack ?stk3))
   (candidate (context ?cont) (status cand) (number ?nb5) (row ?row8) (column ?col8) (block ?blk9) (band ?bnd3) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-5-2s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
