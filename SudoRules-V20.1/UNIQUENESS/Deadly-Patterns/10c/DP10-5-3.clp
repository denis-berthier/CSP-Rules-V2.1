...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              10-CELL 5-DIGIT DEADLY PATTERN #3 (DP10-5-3)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-deadly-pattern-rule-DP10-5-3
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-5-3))
   (assert (deadly-pattern DP10-5-3 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . 34 . . 15 . 35 14 . . 34 . . 25 . 35 24))
)


(defrule deadly-pattern-rule-DP10-5-3
   ...
   (deadly-pattern DP10-5-3 $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row8) (column ?col8&~?col6&~?col9&~?col3) (block ?blk9) (band ?bnd3) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-5-3 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . . . . . . . . . 12 15 25 . . . . . . . . . . . . . . . . 35 35 . . . . . . 12 14 24)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-5-3s
   (declare (salience ?*activate-deadly-pattern-rule[10-5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-5-3s))
   (assert (deadly-pattern DP10-5-3s . . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . . . . . . . . . 12 15 25 . . . . . . . . . . . . . . . . 35 35 . . . . . . 12 14 24))
)


(defrule deadly-pattern-rule-DP10-5-3s
   (declare (salience ?*deadly-pattern-rule[10-5]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (number ?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-5-3s $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row9&~?row3&~?row6&~?row8) (column ?col7) (block ?blk9) (band ?bnd3) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-5-3s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
