...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              10-CELL 5-DIGIT DEADLY PATTERN #8 (DP10-5-8)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . 34 . . 35 . 14 15 . . 34 . . 35 . 24 25)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-5-8
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-5-8))
   (assert (deadly-pattern DP10-5-8 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . 34 . . 35 . 14 15 . . 34 . . 35 . 24 25))
)


(defrule deadly-pattern-rule-DP10-5-8
   ...
   (deadly-pattern DP10-5-8 $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row8) (column ?col6&~?col8&~?col9&~?col3) (block ?blk8&~?blk6&~?blk7) (band ?bnd3) (stack ?stk2&~?stk3&~?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-5-8 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . . . . . . . . . . 35 35 . . . . . . . . . . . . . . 12 . 14 24 . . . . . 12 . 15 25)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP10-5-8s
   (declare (salience ?*activate-deadly-pattern-rule[10-5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP10-5-8s))
   (assert (deadly-pattern DP10-5-8s . . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . . . . . . . . . . 35 35 . . . . . . . . . . . . . . 12 . 14 24 . . . . . 12 . 15 25))
)


(defrule deadly-pattern-rule-DP10-5-8s
   (declare (salience ?*deadly-pattern-rule[10-5]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (number ?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP10-5-8s $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row8&~?row3&~?row6) (column ?col6&~?col8&~?col9) (block ?blk8&~?blk3&~?blk6) (band ?bnd3&~?bnd1&~?bnd2) (stack ?stk2&~?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP10-5-8s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
