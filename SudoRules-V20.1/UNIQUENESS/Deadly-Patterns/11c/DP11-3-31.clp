...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              11-CELL 3-DIGIT DEADLY PATTERN #31 (DP11-3-31)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . . . . . . . . . 13 . 13 . . . . . 12 . 12 . . . 23 . . . . . 23 . . 23 . . 12 13 . .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-3-31
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-3-31))
   (assert (deadly-pattern DP11-3-31 . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . . . . . . . . . 13 . 13 . . . . . 12 . 12 . . . 23 . . . . . 23 . . 23 . . 12 13 . .))
)


(defrule deadly-pattern-rule-DP11-3-31
   (declare (salience ?*deadly-pattern-rule[11-3]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (deadly-pattern DP11-3-31 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-3-31 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 23 23 . . . . . . . . . . . . . . . . . . . . . . . . 12 . 12 . . . . . 13 . . 13 . . 12 . . . 12 . . . . 12 . . 13 . 23 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-3-31s
   (declare (salience ?*activate-deadly-pattern-rule[11-3]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-3-31s))
   (assert (deadly-pattern DP11-3-31s . . . . . . . . . . . . . . . . . . . . . . . . . 23 23 . . . . . . . . . . . . . . . . . . . . . . . . 12 . 12 . . . . . 13 . . 13 . . 12 . . . 12 . . . . 12 . . 13 . 23 .))
)


(defrule deadly-pattern-rule-DP11-3-31s
   (declare (salience ?*deadly-pattern-rule[11-3]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (deadly-pattern DP11-3-31s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-3-31s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
