...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              11-CELL 4-DIGIT DEADLY PATTERN #2 (DP11-4-2)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . 13 . . 13 . . 34 . 24 . . . 23 . . 34 . 24 13 . 12 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-4-2
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-4-2))
   (assert (deadly-pattern DP11-4-2 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . 13 . . 13 . . 34 . 24 . . . 23 . . 34 . 24 13 . 12 .))
)


(defrule deadly-pattern-rule-DP11-4-2
   (declare (salience ?*deadly-pattern-rule[11-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP11-4-2 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-4-2 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . 24 24 . . . . . . 13 . 13 . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 13 23 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-4-2s
   (declare (salience ?*activate-deadly-pattern-rule[11-4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-4-2s))
   (assert (deadly-pattern DP11-4-2s . . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . 24 24 . . . . . . 13 . 13 . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 13 23 .))
)


(defrule deadly-pattern-rule-DP11-4-2s
   (declare (salience ?*deadly-pattern-rule[11-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP11-4-2s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-4-2s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
