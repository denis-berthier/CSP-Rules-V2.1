...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              11-CELL 4-DIGIT DEADLY PATTERN #22 (DP11-4-22)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 13 23 . . . . . . . . . . . . 14 . . . . 24 12 . . 14 . . . 13 34 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-4-22
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-4-22))
   (assert (deadly-pattern DP11-4-22 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 13 23 . . . . . . . . . . . . 14 . . . . 24 12 . . 14 . . . 13 34 .))
)


(defrule deadly-pattern-rule-DP11-4-22
   (declare (salience ?*deadly-pattern-rule[11-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP11-4-22 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-4-22 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 14 14 . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . 13 . . 13 . . . . . 23 . 24 34 . . . . 12 . . 12 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-4-22s
   (declare (salience ?*activate-deadly-pattern-rule[11-4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-4-22s))
   (assert (deadly-pattern DP11-4-22s . . . . . . . . . . . . . . . . . . . . . . . . . 14 14 . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . 13 . . 13 . . . . . 23 . 24 34 . . . . 12 . . 12 .))
)


(defrule deadly-pattern-rule-DP11-4-22s
   (declare (salience ?*deadly-pattern-rule[11-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP11-4-22s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-4-22s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
