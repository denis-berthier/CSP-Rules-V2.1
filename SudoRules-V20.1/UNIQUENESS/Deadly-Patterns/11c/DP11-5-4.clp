...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              11-CELL 5-DIGIT DEADLY PATTERN #4 (DP11-5-4)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . 34 . 13 14 . . 25 . . 35 . 23 . . . 25 . . 45 . . 24)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-5-4
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-5-4))
   (assert (deadly-pattern DP11-5-4 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . 34 . 13 14 . . 25 . . 35 . 23 . . . 25 . . 45 . . 24))
)


(defrule deadly-pattern-rule-DP11-5-4
   ...
   (deadly-pattern DP11-5-4 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-5-4 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 25 25 . . . . . . . . . . . . . . . . . . . . . . . . 34 35 45 . . . . . . . . . . . . . . 12 13 23 . . . . . . 12 14 . 24)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-5-4s
   (declare (salience ?*activate-deadly-pattern-rule[11-5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-5-4s))
   (assert (deadly-pattern DP11-5-4s . . . . . . . . . . . . . . . . . . . . . . . . . 25 25 . . . . . . . . . . . . . . . . . . . . . . . . 34 35 45 . . . . . . . . . . . . . . 12 13 23 . . . . . . 12 14 . 24))
)


(defrule deadly-pattern-rule-DP11-5-4s
   (declare (salience ?*deadly-pattern-rule[11-5]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (number ?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP11-5-4s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-5-4s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
