...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              11-CELL 5-DIGIT DEADLY PATTERN #5 (DP11-5-5)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . 34 . 13 14 . . 35 . . . . 23 25 . . 35 . . 34 . . 45)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-5-5
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-5-5))
   (assert (deadly-pattern DP11-5-5 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . 34 . 13 14 . . 35 . . . . 23 25 . . 35 . . 34 . . 45))
)


(defrule deadly-pattern-rule-DP11-5-5
   ...
   (deadly-pattern DP11-5-5 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-5-5 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . . . . . . . . . 13 . 13 . . . . . . . . . . . . . . 45 41 51 . . . . . . 45 43 52 32)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-5-5s
   (declare (salience ?*activate-deadly-pattern-rule[11-5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-5-5s))
   (assert (deadly-pattern DP11-5-5s . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . . . . . . . . . 13 . 13 . . . . . . . . . . . . . . 45 41 51 . . . . . . 45 43 52 32))
)


(defrule deadly-pattern-rule-DP11-5-5s
   (declare (salience ?*deadly-pattern-rule[11-5]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (number ?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP11-5-5s $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb4) (row ?row8&~?row3&~?row6) (column ?col6&~?col8&~?col9&~?col7) (block ?blk8&~?blk3&~?blk6) (band ?bnd3&~?bnd1&~?bnd2) (stack ?stk2&~?stk3))
   (candidate (context ?cont) (status cand) (number ?nb5) (row ?row8) (column ?col6) (block ?blk8) (band ?bnd3) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb4) (row ?row8) (column ?col7) (block ?blk9&~?blk3&~?blk6&~?blk8) (band ?bnd3) (stack ?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb4) (row ?row9&~?row3&~?row6&~?row8) (column ?col6) (block ?blk8) (band ?bnd3) (stack ?stk2))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-5-5s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
