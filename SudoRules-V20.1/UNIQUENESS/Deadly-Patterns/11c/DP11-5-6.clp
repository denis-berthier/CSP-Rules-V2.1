...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              11-CELL 5-DIGIT DEADLY PATTERN #6 (DP11-5-6)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 13 23 . . . . . . . . . . . 14 . . 45 . 13 35 . . 14 . . 45 12 . 25)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-5-6
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-5-6))
   (assert (deadly-pattern DP11-5-6 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 13 23 . . . . . . . . . . . 14 . . 45 . 13 35 . . 14 . . 45 12 . 25))
)


(defrule deadly-pattern-rule-DP11-5-6
   ...
   (deadly-pattern DP11-5-6 $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row8&~?row6) (column ?col3&~?col7&~?col8&~?col9) (block ?blk7&~?blk6) (band ?bnd3&~?bnd2) (stack ?stk1&~?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-5-6 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 14 14 . . . . . . . . . . . . . . . . . . . . . . . . . 45 45 . . . . . 12 . . 12 . . . . . 13 . 13 . . . . . . 23 . 35 25)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-5-6s
   (declare (salience ?*activate-deadly-pattern-rule[11-5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-5-6s))
   (assert (deadly-pattern DP11-5-6s . . . . . . . . . . . . . . . . . . . . . . . . . 14 14 . . . . . . . . . . . . . . . . . . . . . . . . . 45 45 . . . . . 12 . . 12 . . . . . 13 . 13 . . . . . . 23 . 35 25))
)


(defrule deadly-pattern-rule-DP11-5-6s
   (declare (salience ?*deadly-pattern-rule[11-5]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (number ?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP11-5-6s $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb4) (row ?row6&~?row3) (column ?col8) (block ?blk6&~?blk3) (band ?bnd2&~?bnd1) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-5-6s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
