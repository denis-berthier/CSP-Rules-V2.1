...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              11-CELL 5-DIGIT DEADLY PATTERN #9 (DP11-5-9)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 13 23 . . . . . 14 . 13 34 . . . . . 15 12 . 25 . . . . . 45 . . 45)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-5-9
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-5-9))
   (assert (deadly-pattern DP11-5-9 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 13 23 . . . . . 14 . 13 34 . . . . . 15 12 . 25 . . . . . 45 . . 45))
)


(defrule deadly-pattern-rule-DP11-5-9
   ...
   (deadly-pattern DP11-5-9 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-5-9 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 14 15 45 . . . . . 12 . 12 . . . . . . 13 13 . . . . . . . 23 34 25 45)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP11-5-9s
   (declare (salience ?*activate-deadly-pattern-rule[11-5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP11-5-9s))
   (assert (deadly-pattern DP11-5-9s . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 14 15 45 . . . . . 12 . 12 . . . . . . 13 13 . . . . . . . 23 34 25 45))
)


(defrule deadly-pattern-rule-DP11-5-9s
   (declare (salience ?*deadly-pattern-rule[11-5]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (number ?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP11-5-9s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP11-5-9s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
