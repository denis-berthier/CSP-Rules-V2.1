...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              12-CELL 2-DIGIT DEADLY PATTERN #308 (DP12-2-308)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-deadly-pattern-rule-DP12-2-308
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-2-308))
   (assert (deadly-pattern DP12-2-308 . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . 12 . . 12 . . . . 12 . 12 . . . . . . . 12 . 12 . . . 12 . . . 12 . . . . 12 . 12 . . . .))
)


(defrule deadly-pattern-rule-DP12-2-308
   (declare (salience ?*deadly-pattern-rule[12-2]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (deadly-pattern DP12-2-308 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-2-308 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 crlf 
...
(defrule activate-deadly-pattern-rule-DP12-2-308s
   (declare (salience ?*activate-deadly-pattern-rule[12-2]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-2-308s))
   (assert (deadly-pattern DP12-2-308s . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . 12 . . 12 . . . . 12 . 12 . . . . . . . 12 . 12 . . . 12 . . . 12 . . . . 12 . 12 . . . .))
)


(defrule deadly-pattern-rule-DP12-2-308s
   (declare (salience ?*deadly-pattern-rule[12-2]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (deadly-pattern DP12-2-308s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-2-308s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
