...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              12-CELL 3-DIGIT DEADLY PATTERN #112 (DP12-3-112)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-deadly-pattern-rule-DP12-3-112
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-3-112))
   (assert (deadly-pattern DP12-3-112 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . 12 13 23 . . . . . . 12 . . . . 12 . . 12 . . . . 12 . . . 12 . 13 23 . . .))
)


(defrule deadly-pattern-rule-DP12-3-112
   (declare (salience ?*deadly-pattern-rule[12-3]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (deadly-pattern DP12-3-112 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-3-112 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 crlf 
...
(defrule activate-deadly-pattern-rule-DP12-3-112s
   (declare (salience ?*activate-deadly-pattern-rule[12-3]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-3-112s))
   (assert (deadly-pattern DP12-3-112s . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . 12 12 . . . . . . . 13 . . 13 . . . . . 23 . . 23 . . . . . . . . . . . . . 12 . . 12 . . . . . 12 . 12 . .))
)


(defrule deadly-pattern-rule-DP12-3-112s
   (declare (salience ?*deadly-pattern-rule[12-3]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (deadly-pattern DP12-3-112s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-3-112s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
