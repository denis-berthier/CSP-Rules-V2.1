...
=>
   ...
   (assert (deadly-pattern DP12-3-237s . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . 12 . 12 . . . 31 32 12 . . . . . . . . . . . . . . . . . 12 12 . . . . . 31 32 . . 12 .))
)
...
(defrule deadly-pattern-rule-DP12-3-237s
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row6&~?row3&~?row5) (column ?col4&~?col8&~?col9&~?col7) (block ?blk5&~?blk3&~?blk6) (band ?bnd2) (stack ?stk2&~?stk3))
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6) (column ?col4) (block ?blk5) (band ?bnd2) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row6) (column ?col5&~?col8&~?col9&~?col7&~?col4) (block ?blk5) (band ?bnd2) (stack ?stk2))
   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row6) (column ?col5) (block ?blk5) (band ?bnd2) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6) (column ?col6&~?col8&~?col9&~?col7&~?col4&~?col5) (block ?blk5) (band ?bnd2) (stack ?stk2))
