...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . 12 . . 12 . . . 31 32 . 12 . . . . . . . . . . . . . . . . 12 . 12 . . . . 31 32 . 12 . .)
;;; Variables in the following rule are named after this pattern
...
=>
   ...
   (assert (deadly-pattern DP12-3-241s . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . 12 . . 12 . . . 31 32 . 12 . . . . . . . . . . . . . . . . 12 . 12 . . . . 31 32 . 12 . .))
)
...
(defrule deadly-pattern-rule-DP12-3-241s
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row6&~?row3&~?row5) (column ?col4&~?col8&~?col9&~?col6) (block ?blk5) (band ?bnd2) (stack ?stk2))
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6) (column ?col4) (block ?blk5) (band ?bnd2) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row6) (column ?col5&~?col8&~?col9&~?col6&~?col4) (block ?blk5) (band ?bnd2) (stack ?stk2))
   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row6) (column ?col5) (block ?blk5) (band ?bnd2) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6) (column ?col7&~?col8&~?col9&~?col6&~?col4&~?col5) (block ?blk6) (band ?bnd2) (stack ?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row9&~?row3&~?row5&~?row6&~?row8) (column ?col4) (block ?blk8) (band ?bnd3) (stack ?stk2))
