...
=>
   ...
   (assert (deadly-pattern DP12-3-314s . . . . . . . . . . . . . . 23 . . 23 . . . . . 23 . 23 . . . . . . . . . . . . . . 13 . . . 13 . . . . 13 . . 13 . . . . . . . . . . . . 12 . . . . . 12 . . 12 . . . . 12 .))
)
...
(defrule deadly-pattern-rule-DP12-3-314s
   ...
   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row2) (column ?col9&~?col6) (block ?blk3&~?blk2) (band ?bnd1) (stack ?stk3&~?stk2))
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row2) (column ?col9) (block ?blk3) (band ?bnd1) (stack ?stk3))

   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row3&~?row2) (column ?col6) (block ?blk2) (band ?bnd1) (stack ?stk2))
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row3) (column ?col6) (block ?blk2) (band ?bnd1) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row3) (column ?col8&~?col6&~?col9) (block ?blk3) (band ?bnd1) (stack ?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row8&~?row2&~?row3&~?row5&~?row6) (column ?col3&~?col6&~?col9&~?col8&~?col5) (block ?blk7&~?blk2&~?blk3&~?blk5&~?blk6) (band ?bnd3&~?bnd1&~?bnd2) (stack ?stk1&~?stk2&~?stk3))
   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row8) (column ?col3) (block ?blk7) (band ?bnd3) (stack ?stk1))

   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row8) (column ?col9) (block ?blk9&~?blk2&~?blk3&~?blk5&~?blk6&~?blk7) (band ?bnd3) (stack ?stk3))
   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row8) (column ?col9) (block ?blk9) (band ?bnd3) (stack ?stk3))
