...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              12-CELL 4-DIGIT DEADLY PATTERN #109 (DP12-4-109)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . 12 13 23 . . . . . . . . 24 . . 24 . . . . 13 34 . . 14 . . . 12 . . . 12 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP12-4-109
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-4-109))
   (assert (deadly-pattern DP12-4-109 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . 12 13 23 . . . . . . . . 24 . . 24 . . . . 13 34 . . 14 . . . 12 . . . 12 .))
)


(defrule deadly-pattern-rule-DP12-4-109
   (declare (salience ?*deadly-pattern-rule[12-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP12-4-109 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-4-109 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . . 13 . 13 . . . . . . 23 24 34 . . . . . . . . . . . . . . 12 . . . 12 . . . . 12 . 24 14 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP12-4-109s
   (declare (salience ?*activate-deadly-pattern-rule[12-4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-4-109s))
   (assert (deadly-pattern DP12-4-109s . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . . 13 . 13 . . . . . . 23 24 34 . . . . . . . . . . . . . . 12 . . . 12 . . . . 12 . 24 14 .))
)


(defrule deadly-pattern-rule-DP12-4-109s
   (declare (salience ?*deadly-pattern-rule[12-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP12-4-109s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-4-109s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
