...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              12-CELL 4-DIGIT DEADLY PATTERN #193 (DP12-4-193)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . 13 23 . 14 24 . . . . . . . . . . . . . . . 12 . . 12 . . . 13 23 . 14 24 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP12-4-193
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-4-193))
   (assert (deadly-pattern DP12-4-193 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . 13 23 . 14 24 . . . . . . . . . . . . . . . 12 . . 12 . . . 13 23 . 14 24 .))
)


(defrule deadly-pattern-rule-DP12-4-193
   (declare (salience ?*deadly-pattern-rule[12-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP12-4-193 $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6&~?row5) (column ?col4&~?col6&~?col9) (block ?blk5) (band ?bnd2) (stack ?stk2))
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row6) (column ?col4) (block ?blk5) (band ?bnd2) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row6) (column ?col5&~?col6&~?col9&~?col4) (block ?blk5) (band ?bnd2) (stack ?stk2))
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row6) (column ?col5) (block ?blk5) (band ?bnd2) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row6) (column ?col7&~?col6&~?col9&~?col4&~?col5) (block ?blk6) (band ?bnd2) (stack ?stk3))
   (candidate (context ?cont) (status cand) (number ?nb4) (row ?row6) (column ?col7) (block ?blk6) (band ?bnd2) (stack ?stk3))

   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row6) (column ?col8&~?col6&~?col9&~?col4&~?col5&~?col7) (block ?blk6) (band ?bnd2) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-4-193 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 13 . . 13 . . . . . 23 . . 23 . . . . 12 . . 12 . . . . . . 14 . . 14 . . . . . 24 . . 24 . . . . 12 . . 12 .)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP12-4-193s
   (declare (salience ?*activate-deadly-pattern-rule[12-4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-4-193s))
   (assert (deadly-pattern DP12-4-193s . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 13 . . 13 . . . . . 23 . . 23 . . . . 12 . . 12 . . . . . . 14 . . 14 . . . . . 24 . . 24 . . . . 12 . . 12 .))
)


(defrule deadly-pattern-rule-DP12-4-193s
   (declare (salience ?*deadly-pattern-rule[12-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP12-4-193s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-4-193s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
