...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . 31 32 . . 12 . . . . 41 42 . 12 . . . . . . . . . . . . 34 . . 34 . . . . . 34 . 34 . . . .)
;;; Variables in the following rule are named after this pattern
...
=>
   ...
   (assert (deadly-pattern DP12-4-315s . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . 31 32 . . 12 . . . . 41 42 . 12 . . . . . . . . . . . . 34 . . 34 . . . . . 34 . 34 . . . .))
)
...
(defrule deadly-pattern-rule-DP12-4-315s
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row5&~?row3) (column ?col5&~?col8&~?col9) (block ?blk5&~?blk3) (band ?bnd2&~?bnd1) (stack ?stk2&~?stk3))
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row5) (column ?col5) (block ?blk5) (band ?bnd2) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row5) (column ?col6&~?col8&~?col9&~?col5) (block ?blk5) (band ?bnd2) (stack ?stk2))
   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row5) (column ?col6) (block ?blk5) (band ?bnd2) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row5) (column ?col9) (block ?blk6&~?blk3&~?blk5) (band ?bnd2) (stack ?stk3))
   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row5) (column ?col9) (block ?blk6) (band ?bnd2) (stack ?stk3))

   (candidate (context ?cont) (status cand) (number ?nb4) (row ?row6&~?row3&~?row5) (column ?col5) (block ?blk5) (band ?bnd2) (stack ?stk2))
