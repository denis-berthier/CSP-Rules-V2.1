...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              12-CELL 5-DIGIT DEADLY PATTERN #22 (DP12-5-22)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . 12 . . 12 . . . . 34 15 . 13 45 . . . . 34 25 . 23 45)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP12-5-22
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-5-22))
   (assert (deadly-pattern DP12-5-22 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . 12 . . 12 . . . . 34 15 . 13 45 . . . . 34 25 . 23 45))
)


(defrule deadly-pattern-rule-DP12-5-22
   ...
   (deadly-pattern DP12-5-22 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-5-22 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . 34 35 45 . . . . . . . . . . . . . . 34 . 31 41 . . . . . 34 34 25 25)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP12-5-22s
   (declare (salience ?*activate-deadly-pattern-rule[12-5]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-5-22s))
   (assert (deadly-pattern DP12-5-22s . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . 34 35 45 . . . . . . . . . . . . . . 34 . 31 41 . . . . . 34 34 25 25))
)


(defrule deadly-pattern-rule-DP12-5-22s
   (declare (salience ?*deadly-pattern-rule[12-5]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (number ?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP12-5-22s $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row8&~?row5&~?row6) (column ?col6&~?col8&~?col9&~?col7) (block ?blk8&~?blk6) (band ?bnd3&~?bnd2) (stack ?stk2&~?stk3))
   (candidate (context ?cont) (status cand) (number ?nb4) (row ?row8) (column ?col6) (block ?blk8) (band ?bnd3) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row8) (column ?col8) (block ?blk9&~?blk6&~?blk8) (band ?bnd3) (stack ?stk3))
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row8) (column ?col8) (block ?blk9) (band ?bnd3) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-5-22s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
