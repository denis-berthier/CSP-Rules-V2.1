...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              12-CELL 6-DIGIT DEADLY PATTERN #199 (DP12-6-199)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . 13 23 . . . . . 12 . 14 24 . . . . . . . . . . . 56 . . . . 35 36 . . 56 . . . . 45 46)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP12-6-199
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-6-199))
   (assert (deadly-pattern DP12-6-199 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . 13 23 . . . . . 12 . 14 24 . . . . . . . . . . . 56 . . . . 35 36 . . 56 . . . . 45 46))
)


(defrule deadly-pattern-rule-DP12-6-199
   ...
   (deadly-pattern DP12-6-199 $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb5) (row ?row8&~?row5&~?row6) (column ?col3&~?col6&~?col8&~?col9) (block ?blk7&~?blk5&~?blk6) (band ?bnd3&~?bnd2) (stack ?stk1&~?stk2&~?stk3))
   (candidate (context ?cont) (status cand) (number ?nb6) (row ?row8) (column ?col3) (block ?blk7) (band ?bnd3) (stack ?stk1))

   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row8) (column ?col8) (block ?blk9&~?blk5&~?blk6&~?blk7) (band ?bnd3) (stack ?stk3))
   ...
   (candidate (context ?cont) (status cand) (number ?nb5) (row ?row9&~?row5&~?row6&~?row8) (column ?col3) (block ?blk7) (band ?bnd3) (stack ?stk1))
   (candidate (context ?cont) (status cand) (number ?nb6) (row ?row9) (column ?col3) (block ?blk7) (band ?bnd3) (stack ?stk1))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-6-199 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 ?nb6 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 56 56 . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . 13 14 . 35 45 . . . . 23 24 . 36 46)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP12-6-199s
   (declare (salience ?*activate-deadly-pattern-rule[12-6]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-6-199s))
   (assert (deadly-pattern DP12-6-199s . . . . . . . . . . . . . . . . . . . . . . . . . 56 56 . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . 13 14 . 35 45 . . . . 23 24 . 36 46))
)


(defrule deadly-pattern-rule-DP12-6-199s
   (declare (salience ?*deadly-pattern-rule[12-6]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   ...
   (number ?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (number ?nb6&~?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP12-6-199s $?pattern-list)

   (candidate (context ?cont) (status cand) (number ?nb5) (row ?row3) (column ?col8) (block ?blk3) (band ?bnd1) (stack ?stk3))
   (candidate (context ?cont) (status cand) (number ?nb6) (row ?row3) (column ?col8) (block ?blk3) (band ?bnd1) (stack ?stk3))

   (candidate (context ?cont) (status cand) (number ?nb5) (row ?row3) (column ?col9&~?col8) (block ?blk3) (band ?bnd1) (stack ?stk3))
   (candidate (context ?cont) (status cand) (number ?nb6) (row ?row3) (column ?col9) (block ?blk3) (band ?bnd1) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-6-199s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 ?nb6 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
