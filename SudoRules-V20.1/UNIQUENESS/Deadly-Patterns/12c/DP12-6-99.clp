...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              12-CELL 6-DIGIT DEADLY PATTERN #99 (DP12-6-99)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . 34 34 . . . . . . . . . . . . . . . . 35 36 . 15 16 . . . . 45 46 . 25 26)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP12-6-99
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-6-99))
   (assert (deadly-pattern DP12-6-99 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . 34 34 . . . . . . . . . . . . . . . . 35 36 . 15 16 . . . . 45 46 . 25 26))
)


(defrule deadly-pattern-rule-DP12-6-99
   ...
   (deadly-pattern DP12-6-99 $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row8&~?row5&~?row6) (column ?col5) (block ?blk8&~?blk6&~?blk5) (band ?bnd3&~?bnd2) (stack ?stk2))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-6-99 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 ?nb6 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . 13 23 . . . . . 12 . 14 24 . . . . . . . . . . . . . 56 . . 53 63 . . . . 56 . . 54 64)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP12-6-99s
   (declare (salience ?*activate-deadly-pattern-rule[12-6]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP12-6-99s))
   (assert (deadly-pattern DP12-6-99s . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . 13 23 . . . . . 12 . 14 24 . . . . . . . . . . . . . 56 . . 53 63 . . . . 56 . . 54 64))
)


(defrule deadly-pattern-rule-DP12-6-99s
   (declare (salience ?*deadly-pattern-rule[12-6]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   ...
   (number ?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (number ?nb6&~?nb5&~?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP12-6-99s $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb5) (row ?row8&~?row5&~?row6) (column ?col5&~?col6&~?col8&~?col9) (block ?blk8&~?blk5&~?blk6) (band ?bnd3&~?bnd2) (stack ?stk2))
   (candidate (context ?cont) (status cand) (number ?nb6) (row ?row8) (column ?col5) (block ?blk8) (band ?bnd3) (stack ?stk2))
   ...
   (candidate (context ?cont) (status cand) (number ?nb5) (row ?row9&~?row5&~?row6&~?row8) (column ?col5) (block ?blk8) (band ?bnd3) (stack ?stk2))
   (candidate (context ?cont) (status cand) (number ?nb6) (row ?row9) (column ?col5) (block ?blk8) (band ?bnd3) (stack ?stk2))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP12-6-99s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 ?nb5 ?nb6 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
