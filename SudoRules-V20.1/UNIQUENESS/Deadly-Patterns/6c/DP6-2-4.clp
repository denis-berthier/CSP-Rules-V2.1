...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              6-CELL 2-DIGIT DEADLY PATTERN #4 (DP6-2-4)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-deadly-pattern-rule-DP6-2-4
...
=>
   (if ?*print-levels* then (printout t Entering_level DP6-2-4))
   (assert (deadly-pattern DP6-2-4 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 . 12 .))
)


(defrule deadly-pattern-rule-DP6-2-4
   (declare (salience ?*deadly-pattern-rule[6-2]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (deadly-pattern DP6-2-4 $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row8) (column ?col9) (block ?blk9&~?blk6&~?blk8) (band ?bnd3) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP6-2-4 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 crlf 
...
(defrule activate-deadly-pattern-rule-DP6-2-4s
   (declare (salience ?*activate-deadly-pattern-rule[6-2]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP6-2-4s))
   (assert (deadly-pattern DP6-2-4s . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . 12 . . 12 . . . . . 12 . 12 .))
)


(defrule deadly-pattern-rule-DP6-2-4s
   (declare (salience ?*deadly-pattern-rule[6-2]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (deadly-pattern DP6-2-4s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP6-2-4s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
