...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              8-CELL 2-DIGIT DEADLY PATTERN #9 (DP8-2-9)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-deadly-pattern-rule-DP8-2-9
...
=>
   (if ?*print-levels* then (printout t Entering_level DP8-2-9))
   (assert (deadly-pattern DP8-2-9 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . 12 . . 12 . . . . . . . . . . . . . . . 12 . . 12 . . . . 12 . . 12 .))
)


(defrule deadly-pattern-rule-DP8-2-9
   (declare (salience ?*deadly-pattern-rule[8-2]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (deadly-pattern DP8-2-9 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP8-2-9 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 crlf 
...
(defrule activate-deadly-pattern-rule-DP8-2-9s
   (declare (salience ?*activate-deadly-pattern-rule[8-2]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP8-2-9s))
   (assert (deadly-pattern DP8-2-9s . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . . . 12 . . 12 . . . . . . . . . . . . . . . 12 . . 12 . . . . 12 . . 12 .))
)


(defrule deadly-pattern-rule-DP8-2-9s
   (declare (salience ?*deadly-pattern-rule[8-2]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (deadly-pattern DP8-2-9s $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP8-2-9s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
