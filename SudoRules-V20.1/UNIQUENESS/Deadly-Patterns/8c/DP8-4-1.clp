...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              8-CELL 4-DIGIT DEADLY PATTERN #1 (DP8-4-1)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(defrule activate-deadly-pattern-rule-DP8-4-1
...
=>
   (if ?*print-levels* then (printout t Entering_level DP8-4-1))
   (assert (deadly-pattern DP8-4-1 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 34 . 13 24 . . 12 . . 34 . 13 24))
)


(defrule deadly-pattern-rule-DP8-4-1
   (declare (salience ?*deadly-pattern-rule[8-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP8-4-1 $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row8) (column ?col6&~?col3) (block ?blk8&~?blk7) (band ?bnd3) (stack ?stk2&~?stk1))
   (candidate (context ?cont) (status cand) (number ?nb4) (row ?row8) (column ?col6) (block ?blk8) (band ?bnd3) (stack ?stk2))

   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row8) (column ?col8&~?col3&~?col6) (block ?blk9&~?blk7&~?blk8) (band ?bnd3) (stack ?stk3&~?stk1&~?stk2))
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row8) (column ?col8) (block ?blk9) (band ?bnd3) (stack ?stk3))

   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row8) (column ?col9&~?col3&~?col6&~?col8) (block ?blk9) (band ?bnd3) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP8-4-1 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . 13 13 . . . . . . . 24 24)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP8-4-1s
   (declare (salience ?*activate-deadly-pattern-rule[8-4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP8-4-1s))
   (assert (deadly-pattern DP8-4-1s . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . 13 13 . . . . . . . 24 24))
)


(defrule deadly-pattern-rule-DP8-4-1s
   (declare (salience ?*deadly-pattern-rule[8-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP8-4-1s $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb2) (row ?row9&~?row3&~?row6&~?row8) (column ?col8) (block ?blk9) (band ?bnd3) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP8-4-1s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
