...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              8-CELL 4-DIGIT DEADLY PATTERN #2 (DP8-4-2)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . 34 . . 13 . . 14 . . 34 . . 23 . . 24)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP8-4-2
   (declare (salience ?*activate-deadly-pattern-rule[8-4]-salience*))
   (logical
      (play)
      (context (name ?cont))
   )
=>
   (if ?*print-levels* then (printout t Entering_level DP8-4-2))
   (assert (deadly-pattern DP8-4-2 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 . . 12 . . 34 . . 13 . . 14 . . 34 . . 23 . . 24))
)


(defrule deadly-pattern-rule-DP8-4-2
   (declare (salience ?*deadly-pattern-rule[8-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP8-4-2 $?pattern-list)
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP8-4-2 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . . . . . . . . . 12 13 23 . . . . . . . . . . . . . . . . . . . . . . . . 12 14 24)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP8-4-2s
   (declare (salience ?*activate-deadly-pattern-rule[8-4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP8-4-2s))
   (assert (deadly-pattern DP8-4-2s . . . . . . . . . . . . . . . . . . . . . . . . . 34 34 . . . . . . . . . . . . . . . . . . . . . . . . 12 13 23 . . . . . . . . . . . . . . . . . . . . . . . . 12 14 24))
)


(defrule deadly-pattern-rule-DP8-4-2s
   (declare (salience ?*deadly-pattern-rule[8-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP8-4-2s $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb1) (row ?row9&~?row3&~?row6) (column ?col7) (block ?blk9&~?blk3&~?blk6) (band ?bnd3&~?bnd1&~?bnd2) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP8-4-2s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
