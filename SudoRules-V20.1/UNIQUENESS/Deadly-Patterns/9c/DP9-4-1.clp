...
;;;
;;;                              CSP-RULES / SUDORULES
;;;                              9-CELL 4-DIGIT DEADLY PATTERN #1 (DP9-4-1)
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . 13 . . 13 . . . . . 14 . 14 . . . . . . 34 . 24 23)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP9-4-1
   (declare (salience ?*activate-deadly-pattern-rule[9-4]-salience*))
   (logical
      (play)
      (context (name ?cont))
   )
=>
   (if ?*print-levels* then (printout t Entering_level DP9-4-1))
   (assert (deadly-pattern DP9-4-1 . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 12 12 . . . . . 13 . . 13 . . . . . 14 . 14 . . . . . . 34 . 24 23))
)


(defrule deadly-pattern-rule-DP9-4-1
   (declare (salience ?*deadly-pattern-rule[9-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP9-4-1 $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row9&~?row6&~?row7&~?row8) (column ?col6) (block ?blk8) (band ?bnd3) (stack ?stk2))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP9-4-1 "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
...
;;; (. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 13 14 34 . . . . . . . . . . . . . . 12 . 14 24 . . . . . 12 13 . 23)
;;; Variables in the following rule are named after this pattern


(defrule activate-deadly-pattern-rule-DP9-4-1s
   (declare (salience ?*activate-deadly-pattern-rule[9-4]-salience*))
   (logical
      (play)
      (context (name ?cont))
...
=>
   (if ?*print-levels* then (printout t Entering_level DP9-4-1s))
   (assert (deadly-pattern DP9-4-1s . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 13 14 34 . . . . . . . . . . . . . . 12 . 14 24 . . . . . 12 13 . 23))
)


(defrule deadly-pattern-rule-DP9-4-1s
   (declare (salience ?*deadly-pattern-rule[9-4]-salience*))
   (number ?nb1)
   (number ?nb2&~?nb1)
   (number ?nb3&~?nb2&~?nb1)
   (number ?nb4&~?nb3&~?nb2&~?nb1)
   (deadly-pattern DP9-4-1s $?pattern-list)
   ...
   (candidate (context ?cont) (status cand) (number ?nb3) (row ?row6) (column ?col9&~?col7&~?col8) (block ?blk6) (band ?bnd2) (stack ?stk3))
...
=>
   ...
   (if 
      ...
      (if ?*print-actions* then
         (printout t crlf
            DP9-4-1s "-OR" ?nb-real-guardians  "-relation for digits: " ?nb1 ?nb2 ?nb3 ?nb4 crlf 
            "   in cells (marked #): " ?real-cells " " crlf 
            "   with " ?nb-real-guardians " guardians (in cells marked @) : " (print-list-of-labels ?real-guardians) " " crlf 
         )
         ;;; find the real cell indices in the pattern
